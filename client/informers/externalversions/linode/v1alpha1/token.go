	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LinodeV1alpha1().Tokens(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LinodeV1alpha1().Tokens(namespace).Watch(context.TODO(), options)
			},
		},
		&linodev1alpha1.Token{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tokenInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&linodev1alpha1.Token{}, f.defaultInformer)
}
