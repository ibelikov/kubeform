...
// ApiManagementCertificateInformer provides access to a shared informer and lister for
// ApiManagementCertificates.
type ApiManagementCertificateInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ApiManagementCertificateLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().ApiManagementCertificates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().ApiManagementCertificates(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *apiManagementCertificateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.ApiManagementCertificate{}, f.defaultInformer)
}

func (f *apiManagementCertificateInformer) Lister() v1alpha1.ApiManagementCertificateLister {
	return v1alpha1.NewApiManagementCertificateLister(f.Informer().GetIndexer())
}
