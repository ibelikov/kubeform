...
// ExpressRouteCircuitAuthorizationInformer provides access to a shared informer and lister for
// ExpressRouteCircuitAuthorizations.
type ExpressRouteCircuitAuthorizationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ExpressRouteCircuitAuthorizationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().ExpressRouteCircuitAuthorizations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().ExpressRouteCircuitAuthorizations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *expressRouteCircuitAuthorizationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.ExpressRouteCircuitAuthorization{}, f.defaultInformer)
}

func (f *expressRouteCircuitAuthorizationInformer) Lister() v1alpha1.ExpressRouteCircuitAuthorizationLister {
	return v1alpha1.NewExpressRouteCircuitAuthorizationLister(f.Informer().GetIndexer())
}
