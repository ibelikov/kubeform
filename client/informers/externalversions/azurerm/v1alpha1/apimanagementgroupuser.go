...
// ApiManagementGroupUserInformer provides access to a shared informer and lister for
// ApiManagementGroupUsers.
type ApiManagementGroupUserInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ApiManagementGroupUserLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().ApiManagementGroupUsers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().ApiManagementGroupUsers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *apiManagementGroupUserInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.ApiManagementGroupUser{}, f.defaultInformer)
}

func (f *apiManagementGroupUserInformer) Lister() v1alpha1.ApiManagementGroupUserLister {
	return v1alpha1.NewApiManagementGroupUserLister(f.Informer().GetIndexer())
}
