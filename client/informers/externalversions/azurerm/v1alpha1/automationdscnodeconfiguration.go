...
// AutomationDscNodeconfigurationInformer provides access to a shared informer and lister for
// AutomationDscNodeconfigurations.
type AutomationDscNodeconfigurationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.AutomationDscNodeconfigurationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().AutomationDscNodeconfigurations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().AutomationDscNodeconfigurations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *automationDscNodeconfigurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.AutomationDscNodeconfiguration{}, f.defaultInformer)
}

func (f *automationDscNodeconfigurationInformer) Lister() v1alpha1.AutomationDscNodeconfigurationLister {
	return v1alpha1.NewAutomationDscNodeconfigurationLister(f.Informer().GetIndexer())
}
