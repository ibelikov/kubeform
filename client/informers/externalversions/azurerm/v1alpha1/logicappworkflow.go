...
// LogicAppWorkflowInformer provides access to a shared informer and lister for
// LogicAppWorkflows.
type LogicAppWorkflowInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.LogicAppWorkflowLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().LogicAppWorkflows(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().LogicAppWorkflows(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *logicAppWorkflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.LogicAppWorkflow{}, f.defaultInformer)
}

func (f *logicAppWorkflowInformer) Lister() v1alpha1.LogicAppWorkflowLister {
	return v1alpha1.NewLogicAppWorkflowLister(f.Informer().GetIndexer())
}
