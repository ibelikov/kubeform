...
// ServicebusQueueAuthorizationRuleInformer provides access to a shared informer and lister for
// ServicebusQueueAuthorizationRules.
type ServicebusQueueAuthorizationRuleInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ServicebusQueueAuthorizationRuleLister
}
...
func (f *servicebusQueueAuthorizationRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.ServicebusQueueAuthorizationRule{}, f.defaultInformer)
}

func (f *servicebusQueueAuthorizationRuleInformer) Lister() v1alpha1.ServicebusQueueAuthorizationRuleLister {
	return v1alpha1.NewServicebusQueueAuthorizationRuleLister(f.Informer().GetIndexer())
}
