...
// LogAnalyticsLinkedServiceInformer provides access to a shared informer and lister for
// LogAnalyticsLinkedServices.
type LogAnalyticsLinkedServiceInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.LogAnalyticsLinkedServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().LogAnalyticsLinkedServices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().LogAnalyticsLinkedServices(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *logAnalyticsLinkedServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.LogAnalyticsLinkedService{}, f.defaultInformer)
}

func (f *logAnalyticsLinkedServiceInformer) Lister() v1alpha1.LogAnalyticsLinkedServiceLister {
	return v1alpha1.NewLogAnalyticsLinkedServiceLister(f.Informer().GetIndexer())
}
