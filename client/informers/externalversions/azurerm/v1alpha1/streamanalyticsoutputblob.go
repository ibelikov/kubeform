...
// StreamAnalyticsOutputBlobInformer provides access to a shared informer and lister for
// StreamAnalyticsOutputBlobs.
type StreamAnalyticsOutputBlobInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.StreamAnalyticsOutputBlobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().StreamAnalyticsOutputBlobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().StreamAnalyticsOutputBlobs(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *streamAnalyticsOutputBlobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.StreamAnalyticsOutputBlob{}, f.defaultInformer)
}

func (f *streamAnalyticsOutputBlobInformer) Lister() v1alpha1.StreamAnalyticsOutputBlobLister {
	return v1alpha1.NewStreamAnalyticsOutputBlobLister(f.Informer().GetIndexer())
}
