...
// SharedImageGalleryInformer provides access to a shared informer and lister for
// SharedImageGalleries.
type SharedImageGalleryInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SharedImageGalleryLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().SharedImageGalleries(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().SharedImageGalleries(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sharedImageGalleryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.SharedImageGallery{}, f.defaultInformer)
}

func (f *sharedImageGalleryInformer) Lister() v1alpha1.SharedImageGalleryLister {
	return v1alpha1.NewSharedImageGalleryLister(f.Informer().GetIndexer())
}
