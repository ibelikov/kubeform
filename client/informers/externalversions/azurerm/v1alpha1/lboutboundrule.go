...
// LbOutboundRuleInformer provides access to a shared informer and lister for
// LbOutboundRules.
type LbOutboundRuleInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.LbOutboundRuleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().LbOutboundRules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().LbOutboundRules(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *lbOutboundRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.LbOutboundRule{}, f.defaultInformer)
}

func (f *lbOutboundRuleInformer) Lister() v1alpha1.LbOutboundRuleLister {
	return v1alpha1.NewLbOutboundRuleLister(f.Informer().GetIndexer())
}
