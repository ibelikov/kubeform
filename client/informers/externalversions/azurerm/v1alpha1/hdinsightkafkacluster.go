...
// HdinsightKafkaClusterInformer provides access to a shared informer and lister for
// HdinsightKafkaClusters.
type HdinsightKafkaClusterInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.HdinsightKafkaClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().HdinsightKafkaClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().HdinsightKafkaClusters(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *hdinsightKafkaClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.HdinsightKafkaCluster{}, f.defaultInformer)
}

func (f *hdinsightKafkaClusterInformer) Lister() v1alpha1.HdinsightKafkaClusterLister {
	return v1alpha1.NewHdinsightKafkaClusterLister(f.Informer().GetIndexer())
}
