...
// StreamAnalyticsStreamInputEventhubInformer provides access to a shared informer and lister for
// StreamAnalyticsStreamInputEventhubs.
type StreamAnalyticsStreamInputEventhubInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.StreamAnalyticsStreamInputEventhubLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().StreamAnalyticsStreamInputEventhubs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().StreamAnalyticsStreamInputEventhubs(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *streamAnalyticsStreamInputEventhubInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.StreamAnalyticsStreamInputEventhub{}, f.defaultInformer)
}

func (f *streamAnalyticsStreamInputEventhubInformer) Lister() v1alpha1.StreamAnalyticsStreamInputEventhubLister {
	return v1alpha1.NewStreamAnalyticsStreamInputEventhubLister(f.Informer().GetIndexer())
}
