...
// AppServiceCustomHostnameBindingInformer provides access to a shared informer and lister for
// AppServiceCustomHostnameBindings.
type AppServiceCustomHostnameBindingInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.AppServiceCustomHostnameBindingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().AppServiceCustomHostnameBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().AppServiceCustomHostnameBindings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *appServiceCustomHostnameBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.AppServiceCustomHostnameBinding{}, f.defaultInformer)
}

func (f *appServiceCustomHostnameBindingInformer) Lister() v1alpha1.AppServiceCustomHostnameBindingLister {
	return v1alpha1.NewAppServiceCustomHostnameBindingLister(f.Informer().GetIndexer())
}
