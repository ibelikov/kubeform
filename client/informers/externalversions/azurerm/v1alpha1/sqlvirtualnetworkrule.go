...
// SqlVirtualNetworkRuleInformer provides access to a shared informer and lister for
// SqlVirtualNetworkRules.
type SqlVirtualNetworkRuleInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SqlVirtualNetworkRuleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().SqlVirtualNetworkRules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().SqlVirtualNetworkRules(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sqlVirtualNetworkRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.SqlVirtualNetworkRule{}, f.defaultInformer)
}

func (f *sqlVirtualNetworkRuleInformer) Lister() v1alpha1.SqlVirtualNetworkRuleLister {
	return v1alpha1.NewSqlVirtualNetworkRuleLister(f.Informer().GetIndexer())
}
