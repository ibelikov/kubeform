...
// AutomationVariableBoolInformer provides access to a shared informer and lister for
// AutomationVariableBools.
type AutomationVariableBoolInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.AutomationVariableBoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().AutomationVariableBools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().AutomationVariableBools(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *automationVariableBoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.AutomationVariableBool{}, f.defaultInformer)
}

func (f *automationVariableBoolInformer) Lister() v1alpha1.AutomationVariableBoolLister {
	return v1alpha1.NewAutomationVariableBoolLister(f.Informer().GetIndexer())
}
