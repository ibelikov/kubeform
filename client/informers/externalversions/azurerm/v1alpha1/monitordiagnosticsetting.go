...
// MonitorDiagnosticSettingInformer provides access to a shared informer and lister for
// MonitorDiagnosticSettings.
type MonitorDiagnosticSettingInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.MonitorDiagnosticSettingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().MonitorDiagnosticSettings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().MonitorDiagnosticSettings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *monitorDiagnosticSettingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.MonitorDiagnosticSetting{}, f.defaultInformer)
}

func (f *monitorDiagnosticSettingInformer) Lister() v1alpha1.MonitorDiagnosticSettingLister {
	return v1alpha1.NewMonitorDiagnosticSettingLister(f.Informer().GetIndexer())
}
