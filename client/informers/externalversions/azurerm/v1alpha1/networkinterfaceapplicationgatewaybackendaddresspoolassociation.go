...
// NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationInformer provides access to a shared informer and lister for
// NetworkInterfaceApplicationGatewayBackendAddressPoolAssociations.
type NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().NetworkInterfaceApplicationGatewayBackendAddressPoolAssociations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().NetworkInterfaceApplicationGatewayBackendAddressPoolAssociations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *networkInterfaceApplicationGatewayBackendAddressPoolAssociationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation{}, f.defaultInformer)
}

func (f *networkInterfaceApplicationGatewayBackendAddressPoolAssociationInformer) Lister() v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationLister {
	return v1alpha1.NewNetworkInterfaceApplicationGatewayBackendAddressPoolAssociationLister(f.Informer().GetIndexer())
}
