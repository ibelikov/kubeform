...
// ApplicationInsightsInformer provides access to a shared informer and lister for
// ApplicationInsightses.
type ApplicationInsightsInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ApplicationInsightsLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().ApplicationInsightses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().ApplicationInsightses(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *applicationInsightsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.ApplicationInsights{}, f.defaultInformer)
}

func (f *applicationInsightsInformer) Lister() v1alpha1.ApplicationInsightsLister {
	return v1alpha1.NewApplicationInsightsLister(f.Informer().GetIndexer())
}
