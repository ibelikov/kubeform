...
// VirtualNetworkGatewayConnectionInformer provides access to a shared informer and lister for
// VirtualNetworkGatewayConnections.
type VirtualNetworkGatewayConnectionInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.VirtualNetworkGatewayConnectionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().VirtualNetworkGatewayConnections(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().VirtualNetworkGatewayConnections(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *virtualNetworkGatewayConnectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.VirtualNetworkGatewayConnection{}, f.defaultInformer)
}

func (f *virtualNetworkGatewayConnectionInformer) Lister() v1alpha1.VirtualNetworkGatewayConnectionLister {
	return v1alpha1.NewVirtualNetworkGatewayConnectionLister(f.Informer().GetIndexer())
}
