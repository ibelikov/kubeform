...
// PostgresqlVirtualNetworkRuleInformer provides access to a shared informer and lister for
// PostgresqlVirtualNetworkRules.
type PostgresqlVirtualNetworkRuleInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.PostgresqlVirtualNetworkRuleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().PostgresqlVirtualNetworkRules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().PostgresqlVirtualNetworkRules(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *postgresqlVirtualNetworkRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.PostgresqlVirtualNetworkRule{}, f.defaultInformer)
}

func (f *postgresqlVirtualNetworkRuleInformer) Lister() v1alpha1.PostgresqlVirtualNetworkRuleLister {
	return v1alpha1.NewPostgresqlVirtualNetworkRuleLister(f.Informer().GetIndexer())
}
