...
// SqlElasticpoolInformer provides access to a shared informer and lister for
// SqlElasticpools.
type SqlElasticpoolInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SqlElasticpoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().SqlElasticpools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().SqlElasticpools(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sqlElasticpoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.SqlElasticpool{}, f.defaultInformer)
}

func (f *sqlElasticpoolInformer) Lister() v1alpha1.SqlElasticpoolLister {
	return v1alpha1.NewSqlElasticpoolLister(f.Informer().GetIndexer())
}
