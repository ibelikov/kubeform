...
// FirewallApplicationRuleCollectionInformer provides access to a shared informer and lister for
// FirewallApplicationRuleCollections.
type FirewallApplicationRuleCollectionInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.FirewallApplicationRuleCollectionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().FirewallApplicationRuleCollections(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().FirewallApplicationRuleCollections(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *firewallApplicationRuleCollectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.FirewallApplicationRuleCollection{}, f.defaultInformer)
}

func (f *firewallApplicationRuleCollectionInformer) Lister() v1alpha1.FirewallApplicationRuleCollectionLister {
	return v1alpha1.NewFirewallApplicationRuleCollectionLister(f.Informer().GetIndexer())
}
