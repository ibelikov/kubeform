...
// ApiManagementPropertyInformer provides access to a shared informer and lister for
// ApiManagementProperties.
type ApiManagementPropertyInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ApiManagementPropertyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().ApiManagementProperties(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().ApiManagementProperties(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *apiManagementPropertyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.ApiManagementProperty{}, f.defaultInformer)
}

func (f *apiManagementPropertyInformer) Lister() v1alpha1.ApiManagementPropertyLister {
	return v1alpha1.NewApiManagementPropertyLister(f.Informer().GetIndexer())
}
