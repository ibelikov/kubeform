	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().PacketCaptures(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().PacketCaptures(namespace).Watch(context.TODO(), options)
			},
		},
		&azurermv1alpha1.PacketCapture{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *packetCaptureInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.PacketCapture{}, f.defaultInformer)
}
