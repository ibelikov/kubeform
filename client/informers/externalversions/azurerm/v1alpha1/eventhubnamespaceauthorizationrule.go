...
// EventhubNamespaceAuthorizationRuleInformer provides access to a shared informer and lister for
// EventhubNamespaceAuthorizationRules.
type EventhubNamespaceAuthorizationRuleInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.EventhubNamespaceAuthorizationRuleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().EventhubNamespaceAuthorizationRules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().EventhubNamespaceAuthorizationRules(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *eventhubNamespaceAuthorizationRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.EventhubNamespaceAuthorizationRule{}, f.defaultInformer)
}

func (f *eventhubNamespaceAuthorizationRuleInformer) Lister() v1alpha1.EventhubNamespaceAuthorizationRuleLister {
	return v1alpha1.NewEventhubNamespaceAuthorizationRuleLister(f.Informer().GetIndexer())
}
