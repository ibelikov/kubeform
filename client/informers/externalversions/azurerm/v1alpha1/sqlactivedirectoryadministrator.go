...
// SqlActiveDirectoryAdministratorInformer provides access to a shared informer and lister for
// SqlActiveDirectoryAdministrators.
type SqlActiveDirectoryAdministratorInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SqlActiveDirectoryAdministratorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().SqlActiveDirectoryAdministrators(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().SqlActiveDirectoryAdministrators(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sqlActiveDirectoryAdministratorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.SqlActiveDirectoryAdministrator{}, f.defaultInformer)
}

func (f *sqlActiveDirectoryAdministratorInformer) Lister() v1alpha1.SqlActiveDirectoryAdministratorLister {
	return v1alpha1.NewSqlActiveDirectoryAdministratorLister(f.Informer().GetIndexer())
}
