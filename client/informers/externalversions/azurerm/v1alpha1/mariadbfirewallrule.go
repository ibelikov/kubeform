...
// MariadbFirewallRuleInformer provides access to a shared informer and lister for
// MariadbFirewallRules.
type MariadbFirewallRuleInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.MariadbFirewallRuleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().MariadbFirewallRules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().MariadbFirewallRules(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *mariadbFirewallRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.MariadbFirewallRule{}, f.defaultInformer)
}

func (f *mariadbFirewallRuleInformer) Lister() v1alpha1.MariadbFirewallRuleLister {
	return v1alpha1.NewMariadbFirewallRuleLister(f.Informer().GetIndexer())
}
