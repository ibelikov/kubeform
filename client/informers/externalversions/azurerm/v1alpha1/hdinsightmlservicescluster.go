...
// HdinsightMlServicesClusterInformer provides access to a shared informer and lister for
// HdinsightMlServicesClusters.
type HdinsightMlServicesClusterInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.HdinsightMlServicesClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().HdinsightMlServicesClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().HdinsightMlServicesClusters(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *hdinsightMlServicesClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.HdinsightMlServicesCluster{}, f.defaultInformer)
}

func (f *hdinsightMlServicesClusterInformer) Lister() v1alpha1.HdinsightMlServicesClusterLister {
	return v1alpha1.NewHdinsightMlServicesClusterLister(f.Informer().GetIndexer())
}
