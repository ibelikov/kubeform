...
// DataFactoryDatasetMysqlInformer provides access to a shared informer and lister for
// DataFactoryDatasetMysqls.
type DataFactoryDatasetMysqlInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.DataFactoryDatasetMysqlLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().DataFactoryDatasetMysqls(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().DataFactoryDatasetMysqls(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *dataFactoryDatasetMysqlInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.DataFactoryDatasetMysql{}, f.defaultInformer)
}

func (f *dataFactoryDatasetMysqlInformer) Lister() v1alpha1.DataFactoryDatasetMysqlLister {
	return v1alpha1.NewDataFactoryDatasetMysqlLister(f.Informer().GetIndexer())
}
