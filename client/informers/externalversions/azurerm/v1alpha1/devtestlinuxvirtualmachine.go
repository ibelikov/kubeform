...
// DevTestLinuxVirtualMachineInformer provides access to a shared informer and lister for
// DevTestLinuxVirtualMachines.
type DevTestLinuxVirtualMachineInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.DevTestLinuxVirtualMachineLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().DevTestLinuxVirtualMachines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().DevTestLinuxVirtualMachines(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *devTestLinuxVirtualMachineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.DevTestLinuxVirtualMachine{}, f.defaultInformer)
}

func (f *devTestLinuxVirtualMachineInformer) Lister() v1alpha1.DevTestLinuxVirtualMachineLister {
	return v1alpha1.NewDevTestLinuxVirtualMachineLister(f.Informer().GetIndexer())
}
