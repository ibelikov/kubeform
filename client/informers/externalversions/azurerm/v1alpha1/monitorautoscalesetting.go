...
// MonitorAutoscaleSettingInformer provides access to a shared informer and lister for
// MonitorAutoscaleSettings.
type MonitorAutoscaleSettingInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.MonitorAutoscaleSettingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzurermV1alpha1().MonitorAutoscaleSettings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzurermV1alpha1().MonitorAutoscaleSettings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *monitorAutoscaleSettingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurermv1alpha1.MonitorAutoscaleSetting{}, f.defaultInformer)
}

func (f *monitorAutoscaleSettingInformer) Lister() v1alpha1.MonitorAutoscaleSettingLister {
	return v1alpha1.NewMonitorAutoscaleSettingLister(f.Informer().GetIndexer())
}
