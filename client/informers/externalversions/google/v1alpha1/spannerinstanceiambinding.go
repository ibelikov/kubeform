...
// SpannerInstanceIamBindingInformer provides access to a shared informer and lister for
// SpannerInstanceIamBindings.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().SpannerInstanceIamBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().SpannerInstanceIamBindings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *spannerInstanceIamBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.SpannerInstanceIamBinding{}, f.defaultInformer)
}

func (f *spannerInstanceIamBindingInformer) Lister() v1alpha1.SpannerInstanceIamBindingLister {
	return v1alpha1.NewSpannerInstanceIamBindingLister(f.Informer().GetIndexer())
}
