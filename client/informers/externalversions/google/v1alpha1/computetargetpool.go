...
// ComputeTargetPoolInformer provides access to a shared informer and lister for
// ComputeTargetPools.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().ComputeTargetPools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().ComputeTargetPools(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *computeTargetPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.ComputeTargetPool{}, f.defaultInformer)
}

func (f *computeTargetPoolInformer) Lister() v1alpha1.ComputeTargetPoolLister {
	return v1alpha1.NewComputeTargetPoolLister(f.Informer().GetIndexer())
}
