...
// LoggingBillingAccountExclusionInformer provides access to a shared informer and lister for
// LoggingBillingAccountExclusions.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().LoggingBillingAccountExclusions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().LoggingBillingAccountExclusions(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *loggingBillingAccountExclusionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.LoggingBillingAccountExclusion{}, f.defaultInformer)
}

func (f *loggingBillingAccountExclusionInformer) Lister() v1alpha1.LoggingBillingAccountExclusionLister {
	return v1alpha1.NewLoggingBillingAccountExclusionLister(f.Informer().GetIndexer())
}
