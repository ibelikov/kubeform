...
// BillingAccountIamPolicyInformer provides access to a shared informer and lister for
// BillingAccountIamPolicies.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().BillingAccountIamPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().BillingAccountIamPolicies(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *billingAccountIamPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.BillingAccountIamPolicy{}, f.defaultInformer)
}

func (f *billingAccountIamPolicyInformer) Lister() v1alpha1.BillingAccountIamPolicyLister {
	return v1alpha1.NewBillingAccountIamPolicyLister(f.Informer().GetIndexer())
}
