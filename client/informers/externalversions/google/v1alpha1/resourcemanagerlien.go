...
// ResourceManagerLienInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().ResourceManagerLiens(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().ResourceManagerLiens(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *resourceManagerLienInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.ResourceManagerLien{}, f.defaultInformer)
}

func (f *resourceManagerLienInformer) Lister() v1alpha1.ResourceManagerLienLister {
	return v1alpha1.NewResourceManagerLienLister(f.Informer().GetIndexer())
}
