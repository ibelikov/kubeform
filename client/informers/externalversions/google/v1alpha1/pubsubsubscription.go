...
// PubsubSubscriptionInformer provides access to a shared informer and lister for
// PubsubSubscriptions.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().PubsubSubscriptions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().PubsubSubscriptions(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *pubsubSubscriptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.PubsubSubscription{}, f.defaultInformer)
}

func (f *pubsubSubscriptionInformer) Lister() v1alpha1.PubsubSubscriptionLister {
	return v1alpha1.NewPubsubSubscriptionLister(f.Informer().GetIndexer())
}
