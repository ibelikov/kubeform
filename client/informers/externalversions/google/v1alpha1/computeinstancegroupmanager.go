...
// ComputeInstanceGroupManagerInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().ComputeInstanceGroupManagers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().ComputeInstanceGroupManagers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *computeInstanceGroupManagerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.ComputeInstanceGroupManager{}, f.defaultInformer)
}

func (f *computeInstanceGroupManagerInformer) Lister() v1alpha1.ComputeInstanceGroupManagerLister {
	return v1alpha1.NewComputeInstanceGroupManagerLister(f.Informer().GetIndexer())
}
