...
// StorageBucketIamBindingInformer provides access to a shared informer and lister for
// StorageBucketIamBindings.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().StorageBucketIamBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().StorageBucketIamBindings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *storageBucketIamBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.StorageBucketIamBinding{}, f.defaultInformer)
}

func (f *storageBucketIamBindingInformer) Lister() v1alpha1.StorageBucketIamBindingLister {
	return v1alpha1.NewStorageBucketIamBindingLister(f.Informer().GetIndexer())
}
