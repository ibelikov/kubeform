...
// ComputeSharedVpcServiceProjectInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().ComputeSharedVpcServiceProjects(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().ComputeSharedVpcServiceProjects(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *computeSharedVpcServiceProjectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.ComputeSharedVpcServiceProject{}, f.defaultInformer)
}

func (f *computeSharedVpcServiceProjectInformer) Lister() v1alpha1.ComputeSharedVpcServiceProjectLister {
	return v1alpha1.NewComputeSharedVpcServiceProjectLister(f.Informer().GetIndexer())
}
