...
// MonitoringNotificationChannelInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().MonitoringNotificationChannels(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().MonitoringNotificationChannels(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *monitoringNotificationChannelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.MonitoringNotificationChannel{}, f.defaultInformer)
}

func (f *monitoringNotificationChannelInformer) Lister() v1alpha1.MonitoringNotificationChannelLister {
	return v1alpha1.NewMonitoringNotificationChannelLister(f.Informer().GetIndexer())
}
