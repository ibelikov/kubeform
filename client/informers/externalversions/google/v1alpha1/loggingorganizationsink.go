...
// LoggingOrganizationSinkInformer provides access to a shared informer and lister for
// LoggingOrganizationSinks.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().LoggingOrganizationSinks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().LoggingOrganizationSinks(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *loggingOrganizationSinkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.LoggingOrganizationSink{}, f.defaultInformer)
}

func (f *loggingOrganizationSinkInformer) Lister() v1alpha1.LoggingOrganizationSinkLister {
	return v1alpha1.NewLoggingOrganizationSinkLister(f.Informer().GetIndexer())
}
