...
// PubsubSubscriptionIamPolicyInformer provides access to a shared informer and lister for
// PubsubSubscriptionIamPolicies.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().PubsubSubscriptionIamPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().PubsubSubscriptionIamPolicies(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *pubsubSubscriptionIamPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.PubsubSubscriptionIamPolicy{}, f.defaultInformer)
}

func (f *pubsubSubscriptionIamPolicyInformer) Lister() v1alpha1.PubsubSubscriptionIamPolicyLister {
	return v1alpha1.NewPubsubSubscriptionIamPolicyLister(f.Informer().GetIndexer())
}
