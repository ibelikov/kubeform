...
// SqlDatabaseInstanceInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().SqlDatabaseInstances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().SqlDatabaseInstances(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sqlDatabaseInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.SqlDatabaseInstance{}, f.defaultInformer)
}

func (f *sqlDatabaseInstanceInformer) Lister() v1alpha1.SqlDatabaseInstanceLister {
	return v1alpha1.NewSqlDatabaseInstanceLister(f.Informer().GetIndexer())
}
