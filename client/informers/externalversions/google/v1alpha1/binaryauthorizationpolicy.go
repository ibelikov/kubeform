...
// BinaryAuthorizationPolicyInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().BinaryAuthorizationPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().BinaryAuthorizationPolicies(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *binaryAuthorizationPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.BinaryAuthorizationPolicy{}, f.defaultInformer)
}

func (f *binaryAuthorizationPolicyInformer) Lister() v1alpha1.BinaryAuthorizationPolicyLister {
	return v1alpha1.NewBinaryAuthorizationPolicyLister(f.Informer().GetIndexer())
}
