...
// CloudbuildTriggerInformer provides access to a shared informer and lister for
// CloudbuildTriggers.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().CloudbuildTriggers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().CloudbuildTriggers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cloudbuildTriggerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.CloudbuildTrigger{}, f.defaultInformer)
}

func (f *cloudbuildTriggerInformer) Lister() v1alpha1.CloudbuildTriggerLister {
	return v1alpha1.NewCloudbuildTriggerLister(f.Informer().GetIndexer())
}
