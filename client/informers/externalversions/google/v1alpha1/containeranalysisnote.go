...
// ContainerAnalysisNoteInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().ContainerAnalysisNotes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().ContainerAnalysisNotes(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *containerAnalysisNoteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.ContainerAnalysisNote{}, f.defaultInformer)
}

func (f *containerAnalysisNoteInformer) Lister() v1alpha1.ContainerAnalysisNoteLister {
	return v1alpha1.NewContainerAnalysisNoteLister(f.Informer().GetIndexer())
}
