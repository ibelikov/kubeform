...
// PubsubTopicIamPolicyInformer provides access to a shared informer and lister for
// PubsubTopicIamPolicies.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().PubsubTopicIamPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().PubsubTopicIamPolicies(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *pubsubTopicIamPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.PubsubTopicIamPolicy{}, f.defaultInformer)
}

func (f *pubsubTopicIamPolicyInformer) Lister() v1alpha1.PubsubTopicIamPolicyLister {
	return v1alpha1.NewPubsubTopicIamPolicyLister(f.Informer().GetIndexer())
}
