...
// ProjectIamCustomRoleInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().ProjectIamCustomRoles(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().ProjectIamCustomRoles(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *projectIamCustomRoleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.ProjectIamCustomRole{}, f.defaultInformer)
}

func (f *projectIamCustomRoleInformer) Lister() v1alpha1.ProjectIamCustomRoleLister {
	return v1alpha1.NewProjectIamCustomRoleLister(f.Informer().GetIndexer())
}
