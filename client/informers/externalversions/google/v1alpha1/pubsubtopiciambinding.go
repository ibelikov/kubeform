...
// PubsubTopicIamBindingInformer provides access to a shared informer and lister for
// PubsubTopicIamBindings.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().PubsubTopicIamBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().PubsubTopicIamBindings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *pubsubTopicIamBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.PubsubTopicIamBinding{}, f.defaultInformer)
}

func (f *pubsubTopicIamBindingInformer) Lister() v1alpha1.PubsubTopicIamBindingLister {
	return v1alpha1.NewPubsubTopicIamBindingLister(f.Informer().GetIndexer())
}
