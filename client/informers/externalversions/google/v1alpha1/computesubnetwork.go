...
// ComputeSubnetworkInformer provides access to a shared informer and lister for
// ComputeSubnetworks.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().ComputeSubnetworks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().ComputeSubnetworks(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *computeSubnetworkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.ComputeSubnetwork{}, f.defaultInformer)
}

func (f *computeSubnetworkInformer) Lister() v1alpha1.ComputeSubnetworkLister {
	return v1alpha1.NewComputeSubnetworkLister(f.Informer().GetIndexer())
}
