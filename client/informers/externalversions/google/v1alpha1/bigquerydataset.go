...
// BigqueryDatasetInformer provides access to a shared informer and lister for
// BigqueryDatasets.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().BigqueryDatasets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().BigqueryDatasets(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *bigqueryDatasetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.BigqueryDataset{}, f.defaultInformer)
}

func (f *bigqueryDatasetInformer) Lister() v1alpha1.BigqueryDatasetLister {
	return v1alpha1.NewBigqueryDatasetLister(f.Informer().GetIndexer())
}
