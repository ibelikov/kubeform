...
// ComputeNetworkPeeringInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().ComputeNetworkPeerings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().ComputeNetworkPeerings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *computeNetworkPeeringInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.ComputeNetworkPeering{}, f.defaultInformer)
}

func (f *computeNetworkPeeringInformer) Lister() v1alpha1.ComputeNetworkPeeringLister {
	return v1alpha1.NewComputeNetworkPeeringLister(f.Informer().GetIndexer())
}
