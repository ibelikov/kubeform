...
// OrganizationIamBindingInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().OrganizationIamBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().OrganizationIamBindings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *organizationIamBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.OrganizationIamBinding{}, f.defaultInformer)
}

func (f *organizationIamBindingInformer) Lister() v1alpha1.OrganizationIamBindingLister {
	return v1alpha1.NewOrganizationIamBindingLister(f.Informer().GetIndexer())
}
