...
// KmsKeyRingIamBindingInformer provides access to a shared informer and lister for
// KmsKeyRingIamBindings.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().KmsKeyRingIamBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().KmsKeyRingIamBindings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *kmsKeyRingIamBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.KmsKeyRingIamBinding{}, f.defaultInformer)
}

func (f *kmsKeyRingIamBindingInformer) Lister() v1alpha1.KmsKeyRingIamBindingLister {
	return v1alpha1.NewKmsKeyRingIamBindingLister(f.Informer().GetIndexer())
}
