...
// LoggingBillingAccountSinkInformer provides access to a shared informer and lister for
// LoggingBillingAccountSinks.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().LoggingBillingAccountSinks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().LoggingBillingAccountSinks(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *loggingBillingAccountSinkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.LoggingBillingAccountSink{}, f.defaultInformer)
}

func (f *loggingBillingAccountSinkInformer) Lister() v1alpha1.LoggingBillingAccountSinkLister {
	return v1alpha1.NewLoggingBillingAccountSinkLister(f.Informer().GetIndexer())
}
