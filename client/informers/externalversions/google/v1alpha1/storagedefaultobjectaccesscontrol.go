...
// StorageDefaultObjectAccessControlInformer provides access to a shared informer and lister for
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1alpha1().StorageDefaultObjectAccessControls(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1alpha1().StorageDefaultObjectAccessControls(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *storageDefaultObjectAccessControlInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&googlev1alpha1.StorageDefaultObjectAccessControl{}, f.defaultInformer)
}

func (f *storageDefaultObjectAccessControlInformer) Lister() v1alpha1.StorageDefaultObjectAccessControlLister {
	return v1alpha1.NewStorageDefaultObjectAccessControlLister(f.Informer().GetIndexer())
}
