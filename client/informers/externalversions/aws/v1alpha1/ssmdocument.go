...
// SsmDocumentInformer provides access to a shared informer and lister for
// SsmDocuments.
type SsmDocumentInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SsmDocumentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SsmDocuments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SsmDocuments(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *ssmDocumentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SsmDocument{}, f.defaultInformer)
}

func (f *ssmDocumentInformer) Lister() v1alpha1.SsmDocumentLister {
	return v1alpha1.NewSsmDocumentLister(f.Informer().GetIndexer())
}
