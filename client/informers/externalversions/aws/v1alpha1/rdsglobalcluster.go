...
// RdsGlobalClusterInformer provides access to a shared informer and lister for
// RdsGlobalClusters.
type RdsGlobalClusterInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.RdsGlobalClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().RdsGlobalClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().RdsGlobalClusters(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *rdsGlobalClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.RdsGlobalCluster{}, f.defaultInformer)
}

func (f *rdsGlobalClusterInformer) Lister() v1alpha1.RdsGlobalClusterLister {
	return v1alpha1.NewRdsGlobalClusterLister(f.Informer().GetIndexer())
}
