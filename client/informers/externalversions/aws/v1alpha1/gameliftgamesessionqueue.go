...
// GameliftGameSessionQueueInformer provides access to a shared informer and lister for
// GameliftGameSessionQueues.
type GameliftGameSessionQueueInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.GameliftGameSessionQueueLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().GameliftGameSessionQueues(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().GameliftGameSessionQueues(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *gameliftGameSessionQueueInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.GameliftGameSessionQueue{}, f.defaultInformer)
}

func (f *gameliftGameSessionQueueInformer) Lister() v1alpha1.GameliftGameSessionQueueLister {
	return v1alpha1.NewGameliftGameSessionQueueLister(f.Informer().GetIndexer())
}
