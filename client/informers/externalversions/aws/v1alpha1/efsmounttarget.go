...
// EfsMountTargetInformer provides access to a shared informer and lister for
// EfsMountTargets.
type EfsMountTargetInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.EfsMountTargetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().EfsMountTargets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().EfsMountTargets(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *efsMountTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.EfsMountTarget{}, f.defaultInformer)
}

func (f *efsMountTargetInformer) Lister() v1alpha1.EfsMountTargetLister {
	return v1alpha1.NewEfsMountTargetLister(f.Informer().GetIndexer())
}
