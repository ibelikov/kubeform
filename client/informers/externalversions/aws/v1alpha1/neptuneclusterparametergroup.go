...
// NeptuneClusterParameterGroupInformer provides access to a shared informer and lister for
// NeptuneClusterParameterGroups.
type NeptuneClusterParameterGroupInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.NeptuneClusterParameterGroupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().NeptuneClusterParameterGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().NeptuneClusterParameterGroups(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *neptuneClusterParameterGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.NeptuneClusterParameterGroup{}, f.defaultInformer)
}

func (f *neptuneClusterParameterGroupInformer) Lister() v1alpha1.NeptuneClusterParameterGroupLister {
	return v1alpha1.NewNeptuneClusterParameterGroupLister(f.Informer().GetIndexer())
}
