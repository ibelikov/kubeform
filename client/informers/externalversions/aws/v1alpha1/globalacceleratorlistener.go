...
// GlobalacceleratorListenerInformer provides access to a shared informer and lister for
// GlobalacceleratorListeners.
type GlobalacceleratorListenerInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.GlobalacceleratorListenerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().GlobalacceleratorListeners(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().GlobalacceleratorListeners(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *globalacceleratorListenerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.GlobalacceleratorListener{}, f.defaultInformer)
}

func (f *globalacceleratorListenerInformer) Lister() v1alpha1.GlobalacceleratorListenerLister {
	return v1alpha1.NewGlobalacceleratorListenerLister(f.Informer().GetIndexer())
}
