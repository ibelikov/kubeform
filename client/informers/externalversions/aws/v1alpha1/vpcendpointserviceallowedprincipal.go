...
// VpcEndpointServiceAllowedPrincipalInformer provides access to a shared informer and lister for
// VpcEndpointServiceAllowedPrincipals.
type VpcEndpointServiceAllowedPrincipalInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.VpcEndpointServiceAllowedPrincipalLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().VpcEndpointServiceAllowedPrincipals(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().VpcEndpointServiceAllowedPrincipals(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *vpcEndpointServiceAllowedPrincipalInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.VpcEndpointServiceAllowedPrincipal{}, f.defaultInformer)
}

func (f *vpcEndpointServiceAllowedPrincipalInformer) Lister() v1alpha1.VpcEndpointServiceAllowedPrincipalLister {
	return v1alpha1.NewVpcEndpointServiceAllowedPrincipalLister(f.Informer().GetIndexer())
}
