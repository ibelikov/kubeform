...
// OpsworksRailsAppLayerInformer provides access to a shared informer and lister for
// OpsworksRailsAppLayers.
type OpsworksRailsAppLayerInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.OpsworksRailsAppLayerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().OpsworksRailsAppLayers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().OpsworksRailsAppLayers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *opsworksRailsAppLayerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.OpsworksRailsAppLayer{}, f.defaultInformer)
}

func (f *opsworksRailsAppLayerInformer) Lister() v1alpha1.OpsworksRailsAppLayerLister {
	return v1alpha1.NewOpsworksRailsAppLayerLister(f.Informer().GetIndexer())
}
