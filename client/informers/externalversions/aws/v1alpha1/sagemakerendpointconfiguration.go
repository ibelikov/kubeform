...
// SagemakerEndpointConfigurationInformer provides access to a shared informer and lister for
// SagemakerEndpointConfigurations.
type SagemakerEndpointConfigurationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SagemakerEndpointConfigurationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SagemakerEndpointConfigurations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SagemakerEndpointConfigurations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sagemakerEndpointConfigurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SagemakerEndpointConfiguration{}, f.defaultInformer)
}

func (f *sagemakerEndpointConfigurationInformer) Lister() v1alpha1.SagemakerEndpointConfigurationLister {
	return v1alpha1.NewSagemakerEndpointConfigurationLister(f.Informer().GetIndexer())
}
