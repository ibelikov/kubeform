...
// AppautoscalingPolicyInformer provides access to a shared informer and lister for
// AppautoscalingPolicies.
type AppautoscalingPolicyInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.AppautoscalingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().AppautoscalingPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().AppautoscalingPolicies(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *appautoscalingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.AppautoscalingPolicy{}, f.defaultInformer)
}

func (f *appautoscalingPolicyInformer) Lister() v1alpha1.AppautoscalingPolicyLister {
	return v1alpha1.NewAppautoscalingPolicyLister(f.Informer().GetIndexer())
}
