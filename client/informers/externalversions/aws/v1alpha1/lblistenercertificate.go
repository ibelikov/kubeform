...
// LbListenerCertificateInformer provides access to a shared informer and lister for
// LbListenerCertificates.
type LbListenerCertificateInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.LbListenerCertificateLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().LbListenerCertificates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().LbListenerCertificates(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *lbListenerCertificateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.LbListenerCertificate{}, f.defaultInformer)
}

func (f *lbListenerCertificateInformer) Lister() v1alpha1.LbListenerCertificateLister {
	return v1alpha1.NewLbListenerCertificateLister(f.Informer().GetIndexer())
}
