...
// SagemakerNotebookInstanceInformer provides access to a shared informer and lister for
// SagemakerNotebookInstances.
type SagemakerNotebookInstanceInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SagemakerNotebookInstanceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SagemakerNotebookInstances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SagemakerNotebookInstances(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sagemakerNotebookInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SagemakerNotebookInstance{}, f.defaultInformer)
}

func (f *sagemakerNotebookInstanceInformer) Lister() v1alpha1.SagemakerNotebookInstanceLister {
	return v1alpha1.NewSagemakerNotebookInstanceLister(f.Informer().GetIndexer())
}
