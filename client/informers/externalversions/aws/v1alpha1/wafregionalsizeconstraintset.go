...
// WafregionalSizeConstraintSetInformer provides access to a shared informer and lister for
// WafregionalSizeConstraintSets.
type WafregionalSizeConstraintSetInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.WafregionalSizeConstraintSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().WafregionalSizeConstraintSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().WafregionalSizeConstraintSets(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *wafregionalSizeConstraintSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.WafregionalSizeConstraintSet{}, f.defaultInformer)
}

func (f *wafregionalSizeConstraintSetInformer) Lister() v1alpha1.WafregionalSizeConstraintSetLister {
	return v1alpha1.NewWafregionalSizeConstraintSetLister(f.Informer().GetIndexer())
}
