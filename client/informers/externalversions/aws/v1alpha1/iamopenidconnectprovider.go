...
// IamOpenidConnectProviderInformer provides access to a shared informer and lister for
// IamOpenidConnectProviders.
type IamOpenidConnectProviderInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.IamOpenidConnectProviderLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().IamOpenidConnectProviders(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().IamOpenidConnectProviders(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *iamOpenidConnectProviderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.IamOpenidConnectProvider{}, f.defaultInformer)
}

func (f *iamOpenidConnectProviderInformer) Lister() v1alpha1.IamOpenidConnectProviderLister {
	return v1alpha1.NewIamOpenidConnectProviderLister(f.Informer().GetIndexer())
}
