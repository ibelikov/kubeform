...
// StoragegatewayCachedIscsiVolumeInformer provides access to a shared informer and lister for
// StoragegatewayCachedIscsiVolumes.
type StoragegatewayCachedIscsiVolumeInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.StoragegatewayCachedIscsiVolumeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().StoragegatewayCachedIscsiVolumes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().StoragegatewayCachedIscsiVolumes(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *storagegatewayCachedIscsiVolumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.StoragegatewayCachedIscsiVolume{}, f.defaultInformer)
}

func (f *storagegatewayCachedIscsiVolumeInformer) Lister() v1alpha1.StoragegatewayCachedIscsiVolumeLister {
	return v1alpha1.NewStoragegatewayCachedIscsiVolumeLister(f.Informer().GetIndexer())
}
