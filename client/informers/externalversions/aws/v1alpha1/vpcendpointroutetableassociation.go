...
// VpcEndpointRouteTableAssociationInformer provides access to a shared informer and lister for
// VpcEndpointRouteTableAssociations.
type VpcEndpointRouteTableAssociationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.VpcEndpointRouteTableAssociationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().VpcEndpointRouteTableAssociations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().VpcEndpointRouteTableAssociations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *vpcEndpointRouteTableAssociationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.VpcEndpointRouteTableAssociation{}, f.defaultInformer)
}

func (f *vpcEndpointRouteTableAssociationInformer) Lister() v1alpha1.VpcEndpointRouteTableAssociationLister {
	return v1alpha1.NewVpcEndpointRouteTableAssociationLister(f.Informer().GetIndexer())
}
