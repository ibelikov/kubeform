...
// WafregionalGeoMatchSetInformer provides access to a shared informer and lister for
// WafregionalGeoMatchSets.
type WafregionalGeoMatchSetInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.WafregionalGeoMatchSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().WafregionalGeoMatchSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().WafregionalGeoMatchSets(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *wafregionalGeoMatchSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.WafregionalGeoMatchSet{}, f.defaultInformer)
}

func (f *wafregionalGeoMatchSetInformer) Lister() v1alpha1.WafregionalGeoMatchSetLister {
	return v1alpha1.NewWafregionalGeoMatchSetLister(f.Informer().GetIndexer())
}
