...
// OpsworksCustomLayerInformer provides access to a shared informer and lister for
// OpsworksCustomLayers.
type OpsworksCustomLayerInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.OpsworksCustomLayerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().OpsworksCustomLayers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().OpsworksCustomLayers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *opsworksCustomLayerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.OpsworksCustomLayer{}, f.defaultInformer)
}

func (f *opsworksCustomLayerInformer) Lister() v1alpha1.OpsworksCustomLayerLister {
	return v1alpha1.NewOpsworksCustomLayerLister(f.Informer().GetIndexer())
}
