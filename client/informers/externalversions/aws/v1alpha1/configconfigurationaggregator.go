...
// ConfigConfigurationAggregatorInformer provides access to a shared informer and lister for
// ConfigConfigurationAggregators.
type ConfigConfigurationAggregatorInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ConfigConfigurationAggregatorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().ConfigConfigurationAggregators(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().ConfigConfigurationAggregators(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *configConfigurationAggregatorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.ConfigConfigurationAggregator{}, f.defaultInformer)
}

func (f *configConfigurationAggregatorInformer) Lister() v1alpha1.ConfigConfigurationAggregatorLister {
	return v1alpha1.NewConfigConfigurationAggregatorLister(f.Informer().GetIndexer())
}
