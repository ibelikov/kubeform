...
// BatchComputeEnvironmentInformer provides access to a shared informer and lister for
// BatchComputeEnvironments.
type BatchComputeEnvironmentInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.BatchComputeEnvironmentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().BatchComputeEnvironments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().BatchComputeEnvironments(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *batchComputeEnvironmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.BatchComputeEnvironment{}, f.defaultInformer)
}

func (f *batchComputeEnvironmentInformer) Lister() v1alpha1.BatchComputeEnvironmentLister {
	return v1alpha1.NewBatchComputeEnvironmentLister(f.Informer().GetIndexer())
}
