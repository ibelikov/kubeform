...
// GameliftAliasInformer provides access to a shared informer and lister for
// GameliftAliases.
type GameliftAliasInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.GameliftAliasLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().GameliftAliases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().GameliftAliases(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *gameliftAliasInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.GameliftAlias{}, f.defaultInformer)
}

func (f *gameliftAliasInformer) Lister() v1alpha1.GameliftAliasLister {
	return v1alpha1.NewGameliftAliasLister(f.Informer().GetIndexer())
}
