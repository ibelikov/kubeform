...
// IamUserLoginProfileInformer provides access to a shared informer and lister for
// IamUserLoginProfiles.
type IamUserLoginProfileInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.IamUserLoginProfileLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().IamUserLoginProfiles(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().IamUserLoginProfiles(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *iamUserLoginProfileInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.IamUserLoginProfile{}, f.defaultInformer)
}

func (f *iamUserLoginProfileInformer) Lister() v1alpha1.IamUserLoginProfileLister {
	return v1alpha1.NewIamUserLoginProfileLister(f.Informer().GetIndexer())
}
