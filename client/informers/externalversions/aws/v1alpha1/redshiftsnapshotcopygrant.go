...
// RedshiftSnapshotCopyGrantInformer provides access to a shared informer and lister for
// RedshiftSnapshotCopyGrants.
type RedshiftSnapshotCopyGrantInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.RedshiftSnapshotCopyGrantLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().RedshiftSnapshotCopyGrants(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().RedshiftSnapshotCopyGrants(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *redshiftSnapshotCopyGrantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.RedshiftSnapshotCopyGrant{}, f.defaultInformer)
}

func (f *redshiftSnapshotCopyGrantInformer) Lister() v1alpha1.RedshiftSnapshotCopyGrantLister {
	return v1alpha1.NewRedshiftSnapshotCopyGrantLister(f.Informer().GetIndexer())
}
