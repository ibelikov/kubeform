...
// SecretsmanagerSecretVersionInformer provides access to a shared informer and lister for
// SecretsmanagerSecretVersions.
type SecretsmanagerSecretVersionInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SecretsmanagerSecretVersionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SecretsmanagerSecretVersions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SecretsmanagerSecretVersions(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *secretsmanagerSecretVersionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SecretsmanagerSecretVersion{}, f.defaultInformer)
}

func (f *secretsmanagerSecretVersionInformer) Lister() v1alpha1.SecretsmanagerSecretVersionLister {
	return v1alpha1.NewSecretsmanagerSecretVersionLister(f.Informer().GetIndexer())
}
