...
// DxHostedPrivateVirtualInterfaceAccepterInformer provides access to a shared informer and lister for
// DxHostedPrivateVirtualInterfaceAccepters.
type DxHostedPrivateVirtualInterfaceAccepterInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.DxHostedPrivateVirtualInterfaceAccepterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().DxHostedPrivateVirtualInterfaceAccepters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().DxHostedPrivateVirtualInterfaceAccepters(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *dxHostedPrivateVirtualInterfaceAccepterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.DxHostedPrivateVirtualInterfaceAccepter{}, f.defaultInformer)
}

func (f *dxHostedPrivateVirtualInterfaceAccepterInformer) Lister() v1alpha1.DxHostedPrivateVirtualInterfaceAccepterLister {
	return v1alpha1.NewDxHostedPrivateVirtualInterfaceAccepterLister(f.Informer().GetIndexer())
}
