...
// DirectoryServiceLogSubscriptionInformer provides access to a shared informer and lister for
// DirectoryServiceLogSubscriptions.
type DirectoryServiceLogSubscriptionInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.DirectoryServiceLogSubscriptionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().DirectoryServiceLogSubscriptions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().DirectoryServiceLogSubscriptions(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *directoryServiceLogSubscriptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.DirectoryServiceLogSubscription{}, f.defaultInformer)
}

func (f *directoryServiceLogSubscriptionInformer) Lister() v1alpha1.DirectoryServiceLogSubscriptionLister {
	return v1alpha1.NewDirectoryServiceLogSubscriptionLister(f.Informer().GetIndexer())
}
