...
// Route53ResolverRuleAssociationInformer provides access to a shared informer and lister for
// Route53ResolverRuleAssociations.
type Route53ResolverRuleAssociationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.Route53ResolverRuleAssociationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().Route53ResolverRuleAssociations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().Route53ResolverRuleAssociations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *route53ResolverRuleAssociationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.Route53ResolverRuleAssociation{}, f.defaultInformer)
}

func (f *route53ResolverRuleAssociationInformer) Lister() v1alpha1.Route53ResolverRuleAssociationLister {
	return v1alpha1.NewRoute53ResolverRuleAssociationLister(f.Informer().GetIndexer())
}
