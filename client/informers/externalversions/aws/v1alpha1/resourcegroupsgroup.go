...
// ResourcegroupsGroupInformer provides access to a shared informer and lister for
// ResourcegroupsGroups.
type ResourcegroupsGroupInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ResourcegroupsGroupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().ResourcegroupsGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().ResourcegroupsGroups(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *resourcegroupsGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.ResourcegroupsGroup{}, f.defaultInformer)
}

func (f *resourcegroupsGroupInformer) Lister() v1alpha1.ResourcegroupsGroupLister {
	return v1alpha1.NewResourcegroupsGroupLister(f.Informer().GetIndexer())
}
