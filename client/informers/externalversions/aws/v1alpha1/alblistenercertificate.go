...
// AlbListenerCertificateInformer provides access to a shared informer and lister for
// AlbListenerCertificates.
type AlbListenerCertificateInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.AlbListenerCertificateLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().AlbListenerCertificates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().AlbListenerCertificates(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *albListenerCertificateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.AlbListenerCertificate{}, f.defaultInformer)
}

func (f *albListenerCertificateInformer) Lister() v1alpha1.AlbListenerCertificateLister {
	return v1alpha1.NewAlbListenerCertificateLister(f.Informer().GetIndexer())
}
