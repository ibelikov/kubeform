...
// NeptuneClusterSnapshotInformer provides access to a shared informer and lister for
// NeptuneClusterSnapshots.
type NeptuneClusterSnapshotInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.NeptuneClusterSnapshotLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().NeptuneClusterSnapshots(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().NeptuneClusterSnapshots(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *neptuneClusterSnapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.NeptuneClusterSnapshot{}, f.defaultInformer)
}

func (f *neptuneClusterSnapshotInformer) Lister() v1alpha1.NeptuneClusterSnapshotLister {
	return v1alpha1.NewNeptuneClusterSnapshotLister(f.Informer().GetIndexer())
}
