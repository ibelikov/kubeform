...
// SesConfigurationSetInformer provides access to a shared informer and lister for
// SesConfigurationSets.
type SesConfigurationSetInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SesConfigurationSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SesConfigurationSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SesConfigurationSets(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sesConfigurationSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SesConfigurationSet{}, f.defaultInformer)
}

func (f *sesConfigurationSetInformer) Lister() v1alpha1.SesConfigurationSetLister {
	return v1alpha1.NewSesConfigurationSetLister(f.Informer().GetIndexer())
}
