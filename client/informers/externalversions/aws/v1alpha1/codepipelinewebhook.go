...
// CodepipelineWebhookInformer provides access to a shared informer and lister for
// CodepipelineWebhooks.
type CodepipelineWebhookInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.CodepipelineWebhookLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().CodepipelineWebhooks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().CodepipelineWebhooks(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *codepipelineWebhookInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.CodepipelineWebhook{}, f.defaultInformer)
}

func (f *codepipelineWebhookInformer) Lister() v1alpha1.CodepipelineWebhookLister {
	return v1alpha1.NewCodepipelineWebhookLister(f.Informer().GetIndexer())
}
