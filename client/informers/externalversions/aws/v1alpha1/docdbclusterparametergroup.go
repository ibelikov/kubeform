...
// DocdbClusterParameterGroupInformer provides access to a shared informer and lister for
// DocdbClusterParameterGroups.
type DocdbClusterParameterGroupInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.DocdbClusterParameterGroupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().DocdbClusterParameterGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().DocdbClusterParameterGroups(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *docdbClusterParameterGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.DocdbClusterParameterGroup{}, f.defaultInformer)
}

func (f *docdbClusterParameterGroupInformer) Lister() v1alpha1.DocdbClusterParameterGroupLister {
	return v1alpha1.NewDocdbClusterParameterGroupLister(f.Informer().GetIndexer())
}
