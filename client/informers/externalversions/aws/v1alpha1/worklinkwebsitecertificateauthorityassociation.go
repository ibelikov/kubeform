...
// WorklinkWebsiteCertificateAuthorityAssociationInformer provides access to a shared informer and lister for
// WorklinkWebsiteCertificateAuthorityAssociations.
type WorklinkWebsiteCertificateAuthorityAssociationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.WorklinkWebsiteCertificateAuthorityAssociationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().WorklinkWebsiteCertificateAuthorityAssociations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().WorklinkWebsiteCertificateAuthorityAssociations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *worklinkWebsiteCertificateAuthorityAssociationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.WorklinkWebsiteCertificateAuthorityAssociation{}, f.defaultInformer)
}

func (f *worklinkWebsiteCertificateAuthorityAssociationInformer) Lister() v1alpha1.WorklinkWebsiteCertificateAuthorityAssociationLister {
	return v1alpha1.NewWorklinkWebsiteCertificateAuthorityAssociationLister(f.Informer().GetIndexer())
}
