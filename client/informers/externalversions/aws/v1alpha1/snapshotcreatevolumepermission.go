...
// SnapshotCreateVolumePermissionInformer provides access to a shared informer and lister for
// SnapshotCreateVolumePermissions.
type SnapshotCreateVolumePermissionInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SnapshotCreateVolumePermissionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SnapshotCreateVolumePermissions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SnapshotCreateVolumePermissions(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *snapshotCreateVolumePermissionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SnapshotCreateVolumePermission{}, f.defaultInformer)
}

func (f *snapshotCreateVolumePermissionInformer) Lister() v1alpha1.SnapshotCreateVolumePermissionLister {
	return v1alpha1.NewSnapshotCreateVolumePermissionLister(f.Informer().GetIndexer())
}
