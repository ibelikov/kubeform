...
// OpsworksRdsDbInstanceInformer provides access to a shared informer and lister for
// OpsworksRdsDbInstances.
type OpsworksRdsDbInstanceInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.OpsworksRdsDbInstanceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().OpsworksRdsDbInstances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().OpsworksRdsDbInstances(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *opsworksRdsDbInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.OpsworksRdsDbInstance{}, f.defaultInformer)
}

func (f *opsworksRdsDbInstanceInformer) Lister() v1alpha1.OpsworksRdsDbInstanceLister {
	return v1alpha1.NewOpsworksRdsDbInstanceLister(f.Informer().GetIndexer())
}
