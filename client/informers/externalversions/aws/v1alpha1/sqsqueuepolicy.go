...
// SqsQueuePolicyInformer provides access to a shared informer and lister for
// SqsQueuePolicies.
type SqsQueuePolicyInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SqsQueuePolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SqsQueuePolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SqsQueuePolicies(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sqsQueuePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SqsQueuePolicy{}, f.defaultInformer)
}

func (f *sqsQueuePolicyInformer) Lister() v1alpha1.SqsQueuePolicyLister {
	return v1alpha1.NewSqsQueuePolicyLister(f.Informer().GetIndexer())
}
