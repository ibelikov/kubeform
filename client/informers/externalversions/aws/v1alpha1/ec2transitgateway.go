...
// Ec2TransitGatewayInformer provides access to a shared informer and lister for
// Ec2TransitGateways.
type Ec2TransitGatewayInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.Ec2TransitGatewayLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().Ec2TransitGateways(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().Ec2TransitGateways(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *ec2TransitGatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.Ec2TransitGateway{}, f.defaultInformer)
}

func (f *ec2TransitGatewayInformer) Lister() v1alpha1.Ec2TransitGatewayLister {
	return v1alpha1.NewEc2TransitGatewayLister(f.Informer().GetIndexer())
}
