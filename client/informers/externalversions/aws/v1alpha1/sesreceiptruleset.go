...
// SesReceiptRuleSetInformer provides access to a shared informer and lister for
// SesReceiptRuleSets.
type SesReceiptRuleSetInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SesReceiptRuleSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SesReceiptRuleSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SesReceiptRuleSets(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sesReceiptRuleSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SesReceiptRuleSet{}, f.defaultInformer)
}

func (f *sesReceiptRuleSetInformer) Lister() v1alpha1.SesReceiptRuleSetLister {
	return v1alpha1.NewSesReceiptRuleSetLister(f.Informer().GetIndexer())
}
