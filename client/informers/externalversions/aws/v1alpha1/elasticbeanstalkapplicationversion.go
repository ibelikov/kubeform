...
// ElasticBeanstalkApplicationVersionInformer provides access to a shared informer and lister for
// ElasticBeanstalkApplicationVersions.
type ElasticBeanstalkApplicationVersionInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ElasticBeanstalkApplicationVersionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().ElasticBeanstalkApplicationVersions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().ElasticBeanstalkApplicationVersions(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *elasticBeanstalkApplicationVersionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.ElasticBeanstalkApplicationVersion{}, f.defaultInformer)
}

func (f *elasticBeanstalkApplicationVersionInformer) Lister() v1alpha1.ElasticBeanstalkApplicationVersionLister {
	return v1alpha1.NewElasticBeanstalkApplicationVersionLister(f.Informer().GetIndexer())
}
