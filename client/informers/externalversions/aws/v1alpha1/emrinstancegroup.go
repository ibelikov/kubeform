...
// EmrInstanceGroupInformer provides access to a shared informer and lister for
// EmrInstanceGroups.
type EmrInstanceGroupInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.EmrInstanceGroupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().EmrInstanceGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().EmrInstanceGroups(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *emrInstanceGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.EmrInstanceGroup{}, f.defaultInformer)
}

func (f *emrInstanceGroupInformer) Lister() v1alpha1.EmrInstanceGroupLister {
	return v1alpha1.NewEmrInstanceGroupLister(f.Informer().GetIndexer())
}
