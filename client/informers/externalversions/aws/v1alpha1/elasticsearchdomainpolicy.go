...
// ElasticsearchDomainPolicyInformer provides access to a shared informer and lister for
// ElasticsearchDomainPolicies.
type ElasticsearchDomainPolicyInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ElasticsearchDomainPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().ElasticsearchDomainPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().ElasticsearchDomainPolicies(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *elasticsearchDomainPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.ElasticsearchDomainPolicy{}, f.defaultInformer)
}

func (f *elasticsearchDomainPolicyInformer) Lister() v1alpha1.ElasticsearchDomainPolicyLister {
	return v1alpha1.NewElasticsearchDomainPolicyLister(f.Informer().GetIndexer())
}
