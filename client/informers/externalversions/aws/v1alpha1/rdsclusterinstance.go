...
// RdsClusterInstanceInformer provides access to a shared informer and lister for
// RdsClusterInstances.
type RdsClusterInstanceInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.RdsClusterInstanceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().RdsClusterInstances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().RdsClusterInstances(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *rdsClusterInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.RdsClusterInstance{}, f.defaultInformer)
}

func (f *rdsClusterInstanceInformer) Lister() v1alpha1.RdsClusterInstanceLister {
	return v1alpha1.NewRdsClusterInstanceLister(f.Informer().GetIndexer())
}
