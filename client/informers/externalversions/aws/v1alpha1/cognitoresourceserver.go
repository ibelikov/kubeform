...
// CognitoResourceServerInformer provides access to a shared informer and lister for
// CognitoResourceServers.
type CognitoResourceServerInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.CognitoResourceServerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().CognitoResourceServers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().CognitoResourceServers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cognitoResourceServerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.CognitoResourceServer{}, f.defaultInformer)
}

func (f *cognitoResourceServerInformer) Lister() v1alpha1.CognitoResourceServerLister {
	return v1alpha1.NewCognitoResourceServerLister(f.Informer().GetIndexer())
}
