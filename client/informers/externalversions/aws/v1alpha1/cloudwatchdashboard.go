...
// CloudwatchDashboardInformer provides access to a shared informer and lister for
// CloudwatchDashboards.
type CloudwatchDashboardInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.CloudwatchDashboardLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().CloudwatchDashboards(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().CloudwatchDashboards(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cloudwatchDashboardInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.CloudwatchDashboard{}, f.defaultInformer)
}

func (f *cloudwatchDashboardInformer) Lister() v1alpha1.CloudwatchDashboardLister {
	return v1alpha1.NewCloudwatchDashboardLister(f.Informer().GetIndexer())
}
