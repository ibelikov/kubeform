...
// ConfigDeliveryChannelInformer provides access to a shared informer and lister for
// ConfigDeliveryChannels.
type ConfigDeliveryChannelInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.ConfigDeliveryChannelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().ConfigDeliveryChannels(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().ConfigDeliveryChannels(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *configDeliveryChannelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.ConfigDeliveryChannel{}, f.defaultInformer)
}

func (f *configDeliveryChannelInformer) Lister() v1alpha1.ConfigDeliveryChannelLister {
	return v1alpha1.NewConfigDeliveryChannelLister(f.Informer().GetIndexer())
}
