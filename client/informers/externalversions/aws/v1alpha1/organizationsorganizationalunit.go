...
// OrganizationsOrganizationalUnitInformer provides access to a shared informer and lister for
// OrganizationsOrganizationalUnits.
type OrganizationsOrganizationalUnitInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.OrganizationsOrganizationalUnitLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().OrganizationsOrganizationalUnits(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().OrganizationsOrganizationalUnits(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *organizationsOrganizationalUnitInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.OrganizationsOrganizationalUnit{}, f.defaultInformer)
}

func (f *organizationsOrganizationalUnitInformer) Lister() v1alpha1.OrganizationsOrganizationalUnitLister {
	return v1alpha1.NewOrganizationsOrganizationalUnitLister(f.Informer().GetIndexer())
}
