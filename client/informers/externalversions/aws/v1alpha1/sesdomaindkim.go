...
// SesDomainDkimInformer provides access to a shared informer and lister for
// SesDomainDkims.
type SesDomainDkimInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.SesDomainDkimLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().SesDomainDkims(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().SesDomainDkims(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *sesDomainDkimInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.SesDomainDkim{}, f.defaultInformer)
}

func (f *sesDomainDkimInformer) Lister() v1alpha1.SesDomainDkimLister {
	return v1alpha1.NewSesDomainDkimLister(f.Informer().GetIndexer())
}
