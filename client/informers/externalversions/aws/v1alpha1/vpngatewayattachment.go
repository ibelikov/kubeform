...
// VpnGatewayAttachmentInformer provides access to a shared informer and lister for
// VpnGatewayAttachments.
type VpnGatewayAttachmentInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.VpnGatewayAttachmentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().VpnGatewayAttachments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().VpnGatewayAttachments(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *vpnGatewayAttachmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.VpnGatewayAttachment{}, f.defaultInformer)
}

func (f *vpnGatewayAttachmentInformer) Lister() v1alpha1.VpnGatewayAttachmentLister {
	return v1alpha1.NewVpnGatewayAttachmentLister(f.Informer().GetIndexer())
}
