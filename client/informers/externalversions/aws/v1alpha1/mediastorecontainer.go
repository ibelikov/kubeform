...
// MediaStoreContainerInformer provides access to a shared informer and lister for
// MediaStoreContainers.
type MediaStoreContainerInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.MediaStoreContainerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().MediaStoreContainers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().MediaStoreContainers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *mediaStoreContainerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.MediaStoreContainer{}, f.defaultInformer)
}

func (f *mediaStoreContainerInformer) Lister() v1alpha1.MediaStoreContainerLister {
	return v1alpha1.NewMediaStoreContainerLister(f.Informer().GetIndexer())
}
