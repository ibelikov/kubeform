...
// AppsyncDatasourceInformer provides access to a shared informer and lister for
// AppsyncDatasources.
type AppsyncDatasourceInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.AppsyncDatasourceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().AppsyncDatasources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().AppsyncDatasources(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *appsyncDatasourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.AppsyncDatasource{}, f.defaultInformer)
}

func (f *appsyncDatasourceInformer) Lister() v1alpha1.AppsyncDatasourceLister {
	return v1alpha1.NewAppsyncDatasourceLister(f.Informer().GetIndexer())
}
