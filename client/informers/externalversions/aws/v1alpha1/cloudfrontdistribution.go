...
// CloudfrontDistributionInformer provides access to a shared informer and lister for
// CloudfrontDistributions.
type CloudfrontDistributionInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.CloudfrontDistributionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().CloudfrontDistributions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().CloudfrontDistributions(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cloudfrontDistributionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.CloudfrontDistribution{}, f.defaultInformer)
}

func (f *cloudfrontDistributionInformer) Lister() v1alpha1.CloudfrontDistributionLister {
	return v1alpha1.NewCloudfrontDistributionLister(f.Informer().GetIndexer())
}
