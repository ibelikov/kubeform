...
// RamPrincipalAssociationInformer provides access to a shared informer and lister for
// RamPrincipalAssociations.
type RamPrincipalAssociationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.RamPrincipalAssociationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().RamPrincipalAssociations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().RamPrincipalAssociations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *ramPrincipalAssociationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.RamPrincipalAssociation{}, f.defaultInformer)
}

func (f *ramPrincipalAssociationInformer) Lister() v1alpha1.RamPrincipalAssociationLister {
	return v1alpha1.NewRamPrincipalAssociationLister(f.Informer().GetIndexer())
}
