...
// CloudwatchLogSubscriptionFilterInformer provides access to a shared informer and lister for
// CloudwatchLogSubscriptionFilters.
type CloudwatchLogSubscriptionFilterInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.CloudwatchLogSubscriptionFilterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().CloudwatchLogSubscriptionFilters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().CloudwatchLogSubscriptionFilters(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cloudwatchLogSubscriptionFilterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.CloudwatchLogSubscriptionFilter{}, f.defaultInformer)
}

func (f *cloudwatchLogSubscriptionFilterInformer) Lister() v1alpha1.CloudwatchLogSubscriptionFilterLister {
	return v1alpha1.NewCloudwatchLogSubscriptionFilterLister(f.Informer().GetIndexer())
}
