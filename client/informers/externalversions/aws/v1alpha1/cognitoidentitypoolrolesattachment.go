...
// CognitoIdentityPoolRolesAttachmentInformer provides access to a shared informer and lister for
// CognitoIdentityPoolRolesAttachments.
type CognitoIdentityPoolRolesAttachmentInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.CognitoIdentityPoolRolesAttachmentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().CognitoIdentityPoolRolesAttachments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().CognitoIdentityPoolRolesAttachments(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cognitoIdentityPoolRolesAttachmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.CognitoIdentityPoolRolesAttachment{}, f.defaultInformer)
}

func (f *cognitoIdentityPoolRolesAttachmentInformer) Lister() v1alpha1.CognitoIdentityPoolRolesAttachmentLister {
	return v1alpha1.NewCognitoIdentityPoolRolesAttachmentLister(f.Informer().GetIndexer())
}
