...
// CodecommitRepositoryInformer provides access to a shared informer and lister for
// CodecommitRepositories.
type CodecommitRepositoryInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.CodecommitRepositoryLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().CodecommitRepositories(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().CodecommitRepositories(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *codecommitRepositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.CodecommitRepository{}, f.defaultInformer)
}

func (f *codecommitRepositoryInformer) Lister() v1alpha1.CodecommitRepositoryLister {
	return v1alpha1.NewCodecommitRepositoryLister(f.Informer().GetIndexer())
}
