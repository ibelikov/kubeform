...
// DxGatewayAssociationProposalInformer provides access to a shared informer and lister for
// DxGatewayAssociationProposals.
type DxGatewayAssociationProposalInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.DxGatewayAssociationProposalLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().DxGatewayAssociationProposals(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().DxGatewayAssociationProposals(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *dxGatewayAssociationProposalInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.DxGatewayAssociationProposal{}, f.defaultInformer)
}

func (f *dxGatewayAssociationProposalInformer) Lister() v1alpha1.DxGatewayAssociationProposalLister {
	return v1alpha1.NewDxGatewayAssociationProposalLister(f.Informer().GetIndexer())
}
