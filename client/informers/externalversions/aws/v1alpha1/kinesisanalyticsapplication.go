...
// KinesisAnalyticsApplicationInformer provides access to a shared informer and lister for
// KinesisAnalyticsApplications.
type KinesisAnalyticsApplicationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.KinesisAnalyticsApplicationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().KinesisAnalyticsApplications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().KinesisAnalyticsApplications(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *kinesisAnalyticsApplicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.KinesisAnalyticsApplication{}, f.defaultInformer)
}

func (f *kinesisAnalyticsApplicationInformer) Lister() v1alpha1.KinesisAnalyticsApplicationLister {
	return v1alpha1.NewKinesisAnalyticsApplicationLister(f.Informer().GetIndexer())
}
