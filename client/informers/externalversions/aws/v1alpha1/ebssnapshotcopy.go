...
// EbsSnapshotCopyInformer provides access to a shared informer and lister for
// EbsSnapshotCopies.
type EbsSnapshotCopyInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.EbsSnapshotCopyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().EbsSnapshotCopies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().EbsSnapshotCopies(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *ebsSnapshotCopyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.EbsSnapshotCopy{}, f.defaultInformer)
}

func (f *ebsSnapshotCopyInformer) Lister() v1alpha1.EbsSnapshotCopyLister {
	return v1alpha1.NewEbsSnapshotCopyLister(f.Informer().GetIndexer())
}
