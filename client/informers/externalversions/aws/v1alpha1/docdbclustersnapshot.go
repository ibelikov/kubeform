...
// DocdbClusterSnapshotInformer provides access to a shared informer and lister for
// DocdbClusterSnapshots.
type DocdbClusterSnapshotInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.DocdbClusterSnapshotLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().DocdbClusterSnapshots(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().DocdbClusterSnapshots(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *docdbClusterSnapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.DocdbClusterSnapshot{}, f.defaultInformer)
}

func (f *docdbClusterSnapshotInformer) Lister() v1alpha1.DocdbClusterSnapshotLister {
	return v1alpha1.NewDocdbClusterSnapshotLister(f.Informer().GetIndexer())
}
