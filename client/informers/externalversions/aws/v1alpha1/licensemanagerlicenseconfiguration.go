...
// LicensemanagerLicenseConfigurationInformer provides access to a shared informer and lister for
// LicensemanagerLicenseConfigurations.
type LicensemanagerLicenseConfigurationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.LicensemanagerLicenseConfigurationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsV1alpha1().LicensemanagerLicenseConfigurations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsV1alpha1().LicensemanagerLicenseConfigurations(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *licensemanagerLicenseConfigurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsv1alpha1.LicensemanagerLicenseConfiguration{}, f.defaultInformer)
}

func (f *licensemanagerLicenseConfigurationInformer) Lister() v1alpha1.LicensemanagerLicenseConfigurationLister {
	return v1alpha1.NewLicensemanagerLicenseConfigurationLister(f.Informer().GetIndexer())
}
