...
// computeGlobalAddressLister implements the ComputeGlobalAddressLister interface.
type computeGlobalAddressLister struct {
...
func NewComputeGlobalAddressLister(indexer cache.Indexer) ComputeGlobalAddressLister {
	return &computeGlobalAddressLister{indexer: indexer}
}

// List lists all ComputeGlobalAddresses in the indexer.
func (s *computeGlobalAddressLister) List(selector labels.Selector) (ret []*v1alpha1.ComputeGlobalAddress, err error) {
...
func (s computeGlobalAddressNamespaceLister) Get(name string) (*v1alpha1.ComputeGlobalAddress, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("computeglobaladdress"), name)
	}
	return obj.(*v1alpha1.ComputeGlobalAddress), nil
}
