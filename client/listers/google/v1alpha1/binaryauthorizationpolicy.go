...
// binaryAuthorizationPolicyLister implements the BinaryAuthorizationPolicyLister interface.
type binaryAuthorizationPolicyLister struct {
...
func NewBinaryAuthorizationPolicyLister(indexer cache.Indexer) BinaryAuthorizationPolicyLister {
	return &binaryAuthorizationPolicyLister{indexer: indexer}
}

// List lists all BinaryAuthorizationPolicies in the indexer.
func (s *binaryAuthorizationPolicyLister) List(selector labels.Selector) (ret []*v1alpha1.BinaryAuthorizationPolicy, err error) {
...
func (s binaryAuthorizationPolicyNamespaceLister) Get(name string) (*v1alpha1.BinaryAuthorizationPolicy, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("binaryauthorizationpolicy"), name)
	}
	return obj.(*v1alpha1.BinaryAuthorizationPolicy), nil
}
