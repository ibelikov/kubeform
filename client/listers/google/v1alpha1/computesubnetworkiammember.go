...
// computeSubnetworkIamMemberLister implements the ComputeSubnetworkIamMemberLister interface.
type computeSubnetworkIamMemberLister struct {
...
func NewComputeSubnetworkIamMemberLister(indexer cache.Indexer) ComputeSubnetworkIamMemberLister {
	return &computeSubnetworkIamMemberLister{indexer: indexer}
}

// List lists all ComputeSubnetworkIamMembers in the indexer.
func (s *computeSubnetworkIamMemberLister) List(selector labels.Selector) (ret []*v1alpha1.ComputeSubnetworkIamMember, err error) {
...
func (s computeSubnetworkIamMemberNamespaceLister) Get(name string) (*v1alpha1.ComputeSubnetworkIamMember, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("computesubnetworkiammember"), name)
	}
	return obj.(*v1alpha1.ComputeSubnetworkIamMember), nil
}
