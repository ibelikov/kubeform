...
// computeRouteLister implements the ComputeRouteLister interface.
type computeRouteLister struct {
...
func NewComputeRouteLister(indexer cache.Indexer) ComputeRouteLister {
	return &computeRouteLister{indexer: indexer}
}

// List lists all ComputeRoutes in the indexer.
func (s *computeRouteLister) List(selector labels.Selector) (ret []*v1alpha1.ComputeRoute, err error) {
...
func (s computeRouteNamespaceLister) Get(name string) (*v1alpha1.ComputeRoute, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("computeroute"), name)
	}
	return obj.(*v1alpha1.ComputeRoute), nil
}
