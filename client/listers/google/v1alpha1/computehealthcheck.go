...
// computeHealthCheckLister implements the ComputeHealthCheckLister interface.
...
func NewComputeHealthCheckLister(indexer cache.Indexer) ComputeHealthCheckLister {
	return &computeHealthCheckLister{indexer: indexer}
}

// List lists all ComputeHealthChecks in the indexer.
func (s *computeHealthCheckLister) List(selector labels.Selector) (ret []*v1alpha1.ComputeHealthCheck, err error) {
...
func (s computeHealthCheckNamespaceLister) Get(name string) (*v1alpha1.ComputeHealthCheck, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("computehealthcheck"), name)
	}
	return obj.(*v1alpha1.ComputeHealthCheck), nil
}
