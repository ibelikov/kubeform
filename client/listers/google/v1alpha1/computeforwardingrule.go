...
// computeForwardingRuleLister implements the ComputeForwardingRuleLister interface.
...
func NewComputeForwardingRuleLister(indexer cache.Indexer) ComputeForwardingRuleLister {
	return &computeForwardingRuleLister{indexer: indexer}
}

// List lists all ComputeForwardingRules in the indexer.
func (s *computeForwardingRuleLister) List(selector labels.Selector) (ret []*v1alpha1.ComputeForwardingRule, err error) {
