...
// computeInstanceGroupManagerLister implements the ComputeInstanceGroupManagerLister interface.
...
func NewComputeInstanceGroupManagerLister(indexer cache.Indexer) ComputeInstanceGroupManagerLister {
	return &computeInstanceGroupManagerLister{indexer: indexer}
}

// List lists all ComputeInstanceGroupManagers in the indexer.
func (s *computeInstanceGroupManagerLister) List(selector labels.Selector) (ret []*v1alpha1.ComputeInstanceGroupManager, err error) {
...
func (s computeInstanceGroupManagerNamespaceLister) Get(name string) (*v1alpha1.ComputeInstanceGroupManager, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("computeinstancegroupmanager"), name)
	}
	return obj.(*v1alpha1.ComputeInstanceGroupManager), nil
}
