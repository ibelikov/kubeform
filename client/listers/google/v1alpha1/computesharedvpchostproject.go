...
// computeSharedVpcHostProjectLister implements the ComputeSharedVpcHostProjectLister interface.
type computeSharedVpcHostProjectLister struct {
...
func NewComputeSharedVpcHostProjectLister(indexer cache.Indexer) ComputeSharedVpcHostProjectLister {
	return &computeSharedVpcHostProjectLister{indexer: indexer}
}

// List lists all ComputeSharedVpcHostProjects in the indexer.
func (s *computeSharedVpcHostProjectLister) List(selector labels.Selector) (ret []*v1alpha1.ComputeSharedVpcHostProject, err error) {
...
func (s computeSharedVpcHostProjectNamespaceLister) Get(name string) (*v1alpha1.ComputeSharedVpcHostProject, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("computesharedvpchostproject"), name)
	}
	return obj.(*v1alpha1.ComputeSharedVpcHostProject), nil
}
