...
// ServicebusQueueLister helps list ServicebusQueues.
...
// servicebusQueueLister implements the ServicebusQueueLister interface.
type servicebusQueueLister struct {
	indexer cache.Indexer
}

// NewServicebusQueueLister returns a new ServicebusQueueLister.
func NewServicebusQueueLister(indexer cache.Indexer) ServicebusQueueLister {
	return &servicebusQueueLister{indexer: indexer}
}

// List lists all ServicebusQueues in the indexer.
func (s *servicebusQueueLister) List(selector labels.Selector) (ret []*v1alpha1.ServicebusQueue, err error) {
...
func (s servicebusQueueNamespaceLister) Get(name string) (*v1alpha1.ServicebusQueue, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("servicebusqueue"), name)
	}
	return obj.(*v1alpha1.ServicebusQueue), nil
}
