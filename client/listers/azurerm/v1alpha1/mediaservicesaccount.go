...
// MediaServicesAccountLister helps list MediaServicesAccounts.
...
// mediaServicesAccountLister implements the MediaServicesAccountLister interface.
type mediaServicesAccountLister struct {
	indexer cache.Indexer
}

// NewMediaServicesAccountLister returns a new MediaServicesAccountLister.
func NewMediaServicesAccountLister(indexer cache.Indexer) MediaServicesAccountLister {
	return &mediaServicesAccountLister{indexer: indexer}
}

// List lists all MediaServicesAccounts in the indexer.
func (s *mediaServicesAccountLister) List(selector labels.Selector) (ret []*v1alpha1.MediaServicesAccount, err error) {
...
func (s mediaServicesAccountNamespaceLister) Get(name string) (*v1alpha1.MediaServicesAccount, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("mediaservicesaccount"), name)
	}
	return obj.(*v1alpha1.MediaServicesAccount), nil
}
