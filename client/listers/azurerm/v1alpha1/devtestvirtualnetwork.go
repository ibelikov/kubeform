...
// DevTestVirtualNetworkLister helps list DevTestVirtualNetworks.
...
// devTestVirtualNetworkLister implements the DevTestVirtualNetworkLister interface.
type devTestVirtualNetworkLister struct {
	indexer cache.Indexer
}

// NewDevTestVirtualNetworkLister returns a new DevTestVirtualNetworkLister.
func NewDevTestVirtualNetworkLister(indexer cache.Indexer) DevTestVirtualNetworkLister {
	return &devTestVirtualNetworkLister{indexer: indexer}
}

// List lists all DevTestVirtualNetworks in the indexer.
func (s *devTestVirtualNetworkLister) List(selector labels.Selector) (ret []*v1alpha1.DevTestVirtualNetwork, err error) {
...
func (s devTestVirtualNetworkNamespaceLister) Get(name string) (*v1alpha1.DevTestVirtualNetwork, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("devtestvirtualnetwork"), name)
	}
	return obj.(*v1alpha1.DevTestVirtualNetwork), nil
}
