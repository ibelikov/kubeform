...
// ServicebusNamespaceLister helps list ServicebusNamespaces.
...
// servicebusNamespaceLister implements the ServicebusNamespaceLister interface.
type servicebusNamespaceLister struct {
	indexer cache.Indexer
}

// NewServicebusNamespaceLister returns a new ServicebusNamespaceLister.
func NewServicebusNamespaceLister(indexer cache.Indexer) ServicebusNamespaceLister {
	return &servicebusNamespaceLister{indexer: indexer}
}

// List lists all ServicebusNamespaces in the indexer.
func (s *servicebusNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.ServicebusNamespace, err error) {
...
func (s servicebusNamespaceNamespaceLister) Get(name string) (*v1alpha1.ServicebusNamespace, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("servicebusnamespace"), name)
	}
	return obj.(*v1alpha1.ServicebusNamespace), nil
}
