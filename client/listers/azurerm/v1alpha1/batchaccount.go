...
// BatchAccountLister helps list BatchAccounts.
...
// batchAccountLister implements the BatchAccountLister interface.
type batchAccountLister struct {
	indexer cache.Indexer
}

// NewBatchAccountLister returns a new BatchAccountLister.
func NewBatchAccountLister(indexer cache.Indexer) BatchAccountLister {
	return &batchAccountLister{indexer: indexer}
}

// List lists all BatchAccounts in the indexer.
func (s *batchAccountLister) List(selector labels.Selector) (ret []*v1alpha1.BatchAccount, err error) {
...
func (s batchAccountNamespaceLister) Get(name string) (*v1alpha1.BatchAccount, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("batchaccount"), name)
	}
	return obj.(*v1alpha1.BatchAccount), nil
}
