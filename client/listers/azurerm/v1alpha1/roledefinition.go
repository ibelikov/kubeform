...
// RoleDefinitionLister helps list RoleDefinitions.
...
// roleDefinitionLister implements the RoleDefinitionLister interface.
type roleDefinitionLister struct {
	indexer cache.Indexer
}

// NewRoleDefinitionLister returns a new RoleDefinitionLister.
func NewRoleDefinitionLister(indexer cache.Indexer) RoleDefinitionLister {
	return &roleDefinitionLister{indexer: indexer}
}

// List lists all RoleDefinitions in the indexer.
func (s *roleDefinitionLister) List(selector labels.Selector) (ret []*v1alpha1.RoleDefinition, err error) {
...
func (s roleDefinitionNamespaceLister) Get(name string) (*v1alpha1.RoleDefinition, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("roledefinition"), name)
	}
	return obj.(*v1alpha1.RoleDefinition), nil
}
