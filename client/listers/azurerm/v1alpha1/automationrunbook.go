...
// AutomationRunbookLister helps list AutomationRunbooks.
...
// automationRunbookLister implements the AutomationRunbookLister interface.
type automationRunbookLister struct {
	indexer cache.Indexer
}

// NewAutomationRunbookLister returns a new AutomationRunbookLister.
func NewAutomationRunbookLister(indexer cache.Indexer) AutomationRunbookLister {
	return &automationRunbookLister{indexer: indexer}
}

// List lists all AutomationRunbooks in the indexer.
func (s *automationRunbookLister) List(selector labels.Selector) (ret []*v1alpha1.AutomationRunbook, err error) {
...
func (s automationRunbookNamespaceLister) Get(name string) (*v1alpha1.AutomationRunbook, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("automationrunbook"), name)
	}
	return obj.(*v1alpha1.AutomationRunbook), nil
}
