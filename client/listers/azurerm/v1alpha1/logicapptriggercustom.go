...
// LogicAppTriggerCustomLister helps list LogicAppTriggerCustoms.
...
// logicAppTriggerCustomLister implements the LogicAppTriggerCustomLister interface.
type logicAppTriggerCustomLister struct {
	indexer cache.Indexer
}

// NewLogicAppTriggerCustomLister returns a new LogicAppTriggerCustomLister.
func NewLogicAppTriggerCustomLister(indexer cache.Indexer) LogicAppTriggerCustomLister {
	return &logicAppTriggerCustomLister{indexer: indexer}
}

// List lists all LogicAppTriggerCustoms in the indexer.
func (s *logicAppTriggerCustomLister) List(selector labels.Selector) (ret []*v1alpha1.LogicAppTriggerCustom, err error) {
...
func (s logicAppTriggerCustomNamespaceLister) Get(name string) (*v1alpha1.LogicAppTriggerCustom, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("logicapptriggercustom"), name)
	}
	return obj.(*v1alpha1.LogicAppTriggerCustom), nil
}
