...
// AutomationVariableDatetimeLister helps list AutomationVariableDatetimes.
...
// automationVariableDatetimeLister implements the AutomationVariableDatetimeLister interface.
type automationVariableDatetimeLister struct {
	indexer cache.Indexer
}

// NewAutomationVariableDatetimeLister returns a new AutomationVariableDatetimeLister.
func NewAutomationVariableDatetimeLister(indexer cache.Indexer) AutomationVariableDatetimeLister {
	return &automationVariableDatetimeLister{indexer: indexer}
}

// List lists all AutomationVariableDatetimes in the indexer.
func (s *automationVariableDatetimeLister) List(selector labels.Selector) (ret []*v1alpha1.AutomationVariableDatetime, err error) {
...
func (s automationVariableDatetimeNamespaceLister) Get(name string) (*v1alpha1.AutomationVariableDatetime, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("automationvariabledatetime"), name)
	}
	return obj.(*v1alpha1.AutomationVariableDatetime), nil
}
