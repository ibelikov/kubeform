...
// DataLakeAnalyticsAccountLister helps list DataLakeAnalyticsAccounts.
...
// dataLakeAnalyticsAccountLister implements the DataLakeAnalyticsAccountLister interface.
type dataLakeAnalyticsAccountLister struct {
	indexer cache.Indexer
}

// NewDataLakeAnalyticsAccountLister returns a new DataLakeAnalyticsAccountLister.
func NewDataLakeAnalyticsAccountLister(indexer cache.Indexer) DataLakeAnalyticsAccountLister {
	return &dataLakeAnalyticsAccountLister{indexer: indexer}
}

// List lists all DataLakeAnalyticsAccounts in the indexer.
func (s *dataLakeAnalyticsAccountLister) List(selector labels.Selector) (ret []*v1alpha1.DataLakeAnalyticsAccount, err error) {
...
func (s dataLakeAnalyticsAccountNamespaceLister) Get(name string) (*v1alpha1.DataLakeAnalyticsAccount, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("datalakeanalyticsaccount"), name)
	}
	return obj.(*v1alpha1.DataLakeAnalyticsAccount), nil
}
