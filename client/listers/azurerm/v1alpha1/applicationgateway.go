...
// ApplicationGatewayLister helps list ApplicationGateways.
...
// applicationGatewayLister implements the ApplicationGatewayLister interface.
type applicationGatewayLister struct {
	indexer cache.Indexer
}

// NewApplicationGatewayLister returns a new ApplicationGatewayLister.
func NewApplicationGatewayLister(indexer cache.Indexer) ApplicationGatewayLister {
	return &applicationGatewayLister{indexer: indexer}
}

// List lists all ApplicationGateways in the indexer.
func (s *applicationGatewayLister) List(selector labels.Selector) (ret []*v1alpha1.ApplicationGateway, err error) {
...
func (s applicationGatewayNamespaceLister) Get(name string) (*v1alpha1.ApplicationGateway, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("applicationgateway"), name)
	}
	return obj.(*v1alpha1.ApplicationGateway), nil
}
