...
// StorageTableLister helps list StorageTables.
...
// storageTableLister implements the StorageTableLister interface.
type storageTableLister struct {
	indexer cache.Indexer
}

// NewStorageTableLister returns a new StorageTableLister.
func NewStorageTableLister(indexer cache.Indexer) StorageTableLister {
	return &storageTableLister{indexer: indexer}
}

// List lists all StorageTables in the indexer.
func (s *storageTableLister) List(selector labels.Selector) (ret []*v1alpha1.StorageTable, err error) {
...
func (s storageTableNamespaceLister) Get(name string) (*v1alpha1.StorageTable, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("storagetable"), name)
	}
	return obj.(*v1alpha1.StorageTable), nil
}
