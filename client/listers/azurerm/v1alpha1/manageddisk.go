...
// ManagedDiskLister helps list ManagedDisks.
...
// managedDiskLister implements the ManagedDiskLister interface.
type managedDiskLister struct {
	indexer cache.Indexer
}

// NewManagedDiskLister returns a new ManagedDiskLister.
func NewManagedDiskLister(indexer cache.Indexer) ManagedDiskLister {
	return &managedDiskLister{indexer: indexer}
}

// List lists all ManagedDisks in the indexer.
func (s *managedDiskLister) List(selector labels.Selector) (ret []*v1alpha1.ManagedDisk, err error) {
...
func (s managedDiskNamespaceLister) Get(name string) (*v1alpha1.ManagedDisk, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("manageddisk"), name)
	}
	return obj.(*v1alpha1.ManagedDisk), nil
}
