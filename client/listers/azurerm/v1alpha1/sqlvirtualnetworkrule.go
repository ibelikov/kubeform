...
// SqlVirtualNetworkRuleLister helps list SqlVirtualNetworkRules.
...
// sqlVirtualNetworkRuleLister implements the SqlVirtualNetworkRuleLister interface.
type sqlVirtualNetworkRuleLister struct {
	indexer cache.Indexer
}

// NewSqlVirtualNetworkRuleLister returns a new SqlVirtualNetworkRuleLister.
func NewSqlVirtualNetworkRuleLister(indexer cache.Indexer) SqlVirtualNetworkRuleLister {
	return &sqlVirtualNetworkRuleLister{indexer: indexer}
}

// List lists all SqlVirtualNetworkRules in the indexer.
func (s *sqlVirtualNetworkRuleLister) List(selector labels.Selector) (ret []*v1alpha1.SqlVirtualNetworkRule, err error) {
