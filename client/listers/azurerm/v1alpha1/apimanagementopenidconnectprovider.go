...
// ApiManagementOpenidConnectProviderLister helps list ApiManagementOpenidConnectProviders.
...
// apiManagementOpenidConnectProviderLister implements the ApiManagementOpenidConnectProviderLister interface.
type apiManagementOpenidConnectProviderLister struct {
	indexer cache.Indexer
}

// NewApiManagementOpenidConnectProviderLister returns a new ApiManagementOpenidConnectProviderLister.
func NewApiManagementOpenidConnectProviderLister(indexer cache.Indexer) ApiManagementOpenidConnectProviderLister {
	return &apiManagementOpenidConnectProviderLister{indexer: indexer}
}

// List lists all ApiManagementOpenidConnectProviders in the indexer.
func (s *apiManagementOpenidConnectProviderLister) List(selector labels.Selector) (ret []*v1alpha1.ApiManagementOpenidConnectProvider, err error) {
...
func (s apiManagementOpenidConnectProviderNamespaceLister) Get(name string) (*v1alpha1.ApiManagementOpenidConnectProvider, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("apimanagementopenidconnectprovider"), name)
	}
	return obj.(*v1alpha1.ApiManagementOpenidConnectProvider), nil
}
