...
// StreamAnalyticsStreamInputIothubLister helps list StreamAnalyticsStreamInputIothubs.
...
// streamAnalyticsStreamInputIothubLister implements the StreamAnalyticsStreamInputIothubLister interface.
type streamAnalyticsStreamInputIothubLister struct {
	indexer cache.Indexer
}

// NewStreamAnalyticsStreamInputIothubLister returns a new StreamAnalyticsStreamInputIothubLister.
func NewStreamAnalyticsStreamInputIothubLister(indexer cache.Indexer) StreamAnalyticsStreamInputIothubLister {
	return &streamAnalyticsStreamInputIothubLister{indexer: indexer}
}

// List lists all StreamAnalyticsStreamInputIothubs in the indexer.
func (s *streamAnalyticsStreamInputIothubLister) List(selector labels.Selector) (ret []*v1alpha1.StreamAnalyticsStreamInputIothub, err error) {
...
func (s streamAnalyticsStreamInputIothubNamespaceLister) Get(name string) (*v1alpha1.StreamAnalyticsStreamInputIothub, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("streamanalyticsstreaminputiothub"), name)
	}
	return obj.(*v1alpha1.StreamAnalyticsStreamInputIothub), nil
}
