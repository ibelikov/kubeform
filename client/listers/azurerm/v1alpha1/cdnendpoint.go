...
// CdnEndpointLister helps list CdnEndpoints.
...
// cdnEndpointLister implements the CdnEndpointLister interface.
type cdnEndpointLister struct {
	indexer cache.Indexer
}

// NewCdnEndpointLister returns a new CdnEndpointLister.
func NewCdnEndpointLister(indexer cache.Indexer) CdnEndpointLister {
	return &cdnEndpointLister{indexer: indexer}
}

// List lists all CdnEndpoints in the indexer.
func (s *cdnEndpointLister) List(selector labels.Selector) (ret []*v1alpha1.CdnEndpoint, err error) {
...
func (s cdnEndpointNamespaceLister) Get(name string) (*v1alpha1.CdnEndpoint, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("cdnendpoint"), name)
	}
	return obj.(*v1alpha1.CdnEndpoint), nil
}
