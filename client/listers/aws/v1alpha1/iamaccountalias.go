...
// iamAccountAliasLister implements the IamAccountAliasLister interface.
...
func NewIamAccountAliasLister(indexer cache.Indexer) IamAccountAliasLister {
	return &iamAccountAliasLister{indexer: indexer}
}

// List lists all IamAccountAliases in the indexer.
func (s *iamAccountAliasLister) List(selector labels.Selector) (ret []*v1alpha1.IamAccountAlias, err error) {
...
func (s iamAccountAliasNamespaceLister) Get(name string) (*v1alpha1.IamAccountAlias, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("iamaccountalias"), name)
	}
	return obj.(*v1alpha1.IamAccountAlias), nil
}
