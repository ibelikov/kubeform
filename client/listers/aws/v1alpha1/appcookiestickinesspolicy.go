...
// appCookieStickinessPolicyLister implements the AppCookieStickinessPolicyLister interface.
type appCookieStickinessPolicyLister struct {
...
func NewAppCookieStickinessPolicyLister(indexer cache.Indexer) AppCookieStickinessPolicyLister {
	return &appCookieStickinessPolicyLister{indexer: indexer}
}

// List lists all AppCookieStickinessPolicies in the indexer.
func (s *appCookieStickinessPolicyLister) List(selector labels.Selector) (ret []*v1alpha1.AppCookieStickinessPolicy, err error) {
...
func (s appCookieStickinessPolicyNamespaceLister) Get(name string) (*v1alpha1.AppCookieStickinessPolicy, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("appcookiestickinesspolicy"), name)
	}
	return obj.(*v1alpha1.AppCookieStickinessPolicy), nil
}
