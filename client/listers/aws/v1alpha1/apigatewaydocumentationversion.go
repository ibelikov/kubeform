...
// apiGatewayDocumentationVersionLister implements the ApiGatewayDocumentationVersionLister interface.
type apiGatewayDocumentationVersionLister struct {
...
func NewApiGatewayDocumentationVersionLister(indexer cache.Indexer) ApiGatewayDocumentationVersionLister {
	return &apiGatewayDocumentationVersionLister{indexer: indexer}
}

// List lists all ApiGatewayDocumentationVersions in the indexer.
func (s *apiGatewayDocumentationVersionLister) List(selector labels.Selector) (ret []*v1alpha1.ApiGatewayDocumentationVersion, err error) {
...
func (s apiGatewayDocumentationVersionNamespaceLister) Get(name string) (*v1alpha1.ApiGatewayDocumentationVersion, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("apigatewaydocumentationversion"), name)
	}
	return obj.(*v1alpha1.ApiGatewayDocumentationVersion), nil
}
