...
// mskConfigurationLister implements the MskConfigurationLister interface.
...
func NewMskConfigurationLister(indexer cache.Indexer) MskConfigurationLister {
	return &mskConfigurationLister{indexer: indexer}
}

// List lists all MskConfigurations in the indexer.
func (s *mskConfigurationLister) List(selector labels.Selector) (ret []*v1alpha1.MskConfiguration, err error) {
...
func (s mskConfigurationNamespaceLister) Get(name string) (*v1alpha1.MskConfiguration, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("mskconfiguration"), name)
	}
	return obj.(*v1alpha1.MskConfiguration), nil
}
