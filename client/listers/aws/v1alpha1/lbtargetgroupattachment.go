...
// lbTargetGroupAttachmentLister implements the LbTargetGroupAttachmentLister interface.
type lbTargetGroupAttachmentLister struct {
...
func NewLbTargetGroupAttachmentLister(indexer cache.Indexer) LbTargetGroupAttachmentLister {
	return &lbTargetGroupAttachmentLister{indexer: indexer}
}

// List lists all LbTargetGroupAttachments in the indexer.
func (s *lbTargetGroupAttachmentLister) List(selector labels.Selector) (ret []*v1alpha1.LbTargetGroupAttachment, err error) {
...
func (s lbTargetGroupAttachmentNamespaceLister) Get(name string) (*v1alpha1.LbTargetGroupAttachment, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("lbtargetgroupattachment"), name)
	}
	return obj.(*v1alpha1.LbTargetGroupAttachment), nil
}
