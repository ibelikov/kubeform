...
// securityhubProductSubscriptionLister implements the SecurityhubProductSubscriptionLister interface.
type securityhubProductSubscriptionLister struct {
...
func NewSecurityhubProductSubscriptionLister(indexer cache.Indexer) SecurityhubProductSubscriptionLister {
	return &securityhubProductSubscriptionLister{indexer: indexer}
}

// List lists all SecurityhubProductSubscriptions in the indexer.
func (s *securityhubProductSubscriptionLister) List(selector labels.Selector) (ret []*v1alpha1.SecurityhubProductSubscription, err error) {
...
func (s securityhubProductSubscriptionNamespaceLister) Get(name string) (*v1alpha1.SecurityhubProductSubscription, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("securityhubproductsubscription"), name)
	}
	return obj.(*v1alpha1.SecurityhubProductSubscription), nil
}
