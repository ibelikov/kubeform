...
// opsworksInstanceLister implements the OpsworksInstanceLister interface.
...
func NewOpsworksInstanceLister(indexer cache.Indexer) OpsworksInstanceLister {
	return &opsworksInstanceLister{indexer: indexer}
}

// List lists all OpsworksInstances in the indexer.
func (s *opsworksInstanceLister) List(selector labels.Selector) (ret []*v1alpha1.OpsworksInstance, err error) {
...
func (s opsworksInstanceNamespaceLister) Get(name string) (*v1alpha1.OpsworksInstance, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("opsworksinstance"), name)
	}
	return obj.(*v1alpha1.OpsworksInstance), nil
}
