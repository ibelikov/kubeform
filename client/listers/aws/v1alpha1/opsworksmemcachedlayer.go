...
// opsworksMemcachedLayerLister implements the OpsworksMemcachedLayerLister interface.
type opsworksMemcachedLayerLister struct {
...
func NewOpsworksMemcachedLayerLister(indexer cache.Indexer) OpsworksMemcachedLayerLister {
	return &opsworksMemcachedLayerLister{indexer: indexer}
}

// List lists all OpsworksMemcachedLayers in the indexer.
func (s *opsworksMemcachedLayerLister) List(selector labels.Selector) (ret []*v1alpha1.OpsworksMemcachedLayer, err error) {
...
func (s opsworksMemcachedLayerNamespaceLister) Get(name string) (*v1alpha1.OpsworksMemcachedLayer, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("opsworksmemcachedlayer"), name)
	}
	return obj.(*v1alpha1.OpsworksMemcachedLayer), nil
}
