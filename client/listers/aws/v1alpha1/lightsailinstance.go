...
// lightsailInstanceLister implements the LightsailInstanceLister interface.
...
func NewLightsailInstanceLister(indexer cache.Indexer) LightsailInstanceLister {
	return &lightsailInstanceLister{indexer: indexer}
}

// List lists all LightsailInstances in the indexer.
func (s *lightsailInstanceLister) List(selector labels.Selector) (ret []*v1alpha1.LightsailInstance, err error) {
...
func (s lightsailInstanceNamespaceLister) Get(name string) (*v1alpha1.LightsailInstance, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("lightsailinstance"), name)
	}
	return obj.(*v1alpha1.LightsailInstance), nil
}
