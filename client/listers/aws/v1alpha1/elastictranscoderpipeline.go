...
// elastictranscoderPipelineLister implements the ElastictranscoderPipelineLister interface.
...
func NewElastictranscoderPipelineLister(indexer cache.Indexer) ElastictranscoderPipelineLister {
	return &elastictranscoderPipelineLister{indexer: indexer}
}

// List lists all ElastictranscoderPipelines in the indexer.
func (s *elastictranscoderPipelineLister) List(selector labels.Selector) (ret []*v1alpha1.ElastictranscoderPipeline, err error) {
...
func (s elastictranscoderPipelineNamespaceLister) Get(name string) (*v1alpha1.ElastictranscoderPipeline, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("elastictranscoderpipeline"), name)
	}
	return obj.(*v1alpha1.ElastictranscoderPipeline), nil
}
