...
// globalacceleratorListenerLister implements the GlobalacceleratorListenerLister interface.
...
func NewGlobalacceleratorListenerLister(indexer cache.Indexer) GlobalacceleratorListenerLister {
	return &globalacceleratorListenerLister{indexer: indexer}
}

// List lists all GlobalacceleratorListeners in the indexer.
func (s *globalacceleratorListenerLister) List(selector labels.Selector) (ret []*v1alpha1.GlobalacceleratorListener, err error) {
...
func (s globalacceleratorListenerNamespaceLister) Get(name string) (*v1alpha1.GlobalacceleratorListener, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("globalacceleratorlistener"), name)
	}
	return obj.(*v1alpha1.GlobalacceleratorListener), nil
}
