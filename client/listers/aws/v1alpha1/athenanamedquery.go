...
// athenaNamedQueryLister implements the AthenaNamedQueryLister interface.
...
func NewAthenaNamedQueryLister(indexer cache.Indexer) AthenaNamedQueryLister {
	return &athenaNamedQueryLister{indexer: indexer}
}

// List lists all AthenaNamedQueries in the indexer.
func (s *athenaNamedQueryLister) List(selector labels.Selector) (ret []*v1alpha1.AthenaNamedQuery, err error) {
...
func (s athenaNamedQueryNamespaceLister) Get(name string) (*v1alpha1.AthenaNamedQuery, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("athenanamedquery"), name)
	}
	return obj.(*v1alpha1.AthenaNamedQuery), nil
}
