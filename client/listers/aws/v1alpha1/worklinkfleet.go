...
// worklinkFleetLister implements the WorklinkFleetLister interface.
type worklinkFleetLister struct {
...
func NewWorklinkFleetLister(indexer cache.Indexer) WorklinkFleetLister {
	return &worklinkFleetLister{indexer: indexer}
}

// List lists all WorklinkFleets in the indexer.
func (s *worklinkFleetLister) List(selector labels.Selector) (ret []*v1alpha1.WorklinkFleet, err error) {
...
func (s worklinkFleetNamespaceLister) Get(name string) (*v1alpha1.WorklinkFleet, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("worklinkfleet"), name)
	}
	return obj.(*v1alpha1.WorklinkFleet), nil
}
