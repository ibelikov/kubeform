...
// appsyncDatasourceLister implements the AppsyncDatasourceLister interface.
type appsyncDatasourceLister struct {
...
func NewAppsyncDatasourceLister(indexer cache.Indexer) AppsyncDatasourceLister {
	return &appsyncDatasourceLister{indexer: indexer}
}
