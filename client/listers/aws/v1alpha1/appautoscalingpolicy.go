...
// appautoscalingPolicyLister implements the AppautoscalingPolicyLister interface.
type appautoscalingPolicyLister struct {
...
func NewAppautoscalingPolicyLister(indexer cache.Indexer) AppautoscalingPolicyLister {
	return &appautoscalingPolicyLister{indexer: indexer}
}
...
func (s appautoscalingPolicyNamespaceLister) Get(name string) (*v1alpha1.AppautoscalingPolicy, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("appautoscalingpolicy"), name)
	}
	return obj.(*v1alpha1.AppautoscalingPolicy), nil
}
