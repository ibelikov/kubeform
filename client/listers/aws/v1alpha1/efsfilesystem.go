...
// efsFileSystemLister implements the EfsFileSystemLister interface.
...
func NewEfsFileSystemLister(indexer cache.Indexer) EfsFileSystemLister {
	return &efsFileSystemLister{indexer: indexer}
}

// List lists all EfsFileSystems in the indexer.
func (s *efsFileSystemLister) List(selector labels.Selector) (ret []*v1alpha1.EfsFileSystem, err error) {
...
func (s efsFileSystemNamespaceLister) Get(name string) (*v1alpha1.EfsFileSystem, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("efsfilesystem"), name)
	}
	return obj.(*v1alpha1.EfsFileSystem), nil
}
