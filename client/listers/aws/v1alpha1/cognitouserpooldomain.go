...
// cognitoUserPoolDomainLister implements the CognitoUserPoolDomainLister interface.
...
func NewCognitoUserPoolDomainLister(indexer cache.Indexer) CognitoUserPoolDomainLister {
	return &cognitoUserPoolDomainLister{indexer: indexer}
}

// List lists all CognitoUserPoolDomains in the indexer.
func (s *cognitoUserPoolDomainLister) List(selector labels.Selector) (ret []*v1alpha1.CognitoUserPoolDomain, err error) {
...
func (s cognitoUserPoolDomainNamespaceLister) Get(name string) (*v1alpha1.CognitoUserPoolDomain, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("cognitouserpooldomain"), name)
	}
	return obj.(*v1alpha1.CognitoUserPoolDomain), nil
}
