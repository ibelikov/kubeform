...
// dynamodbTableItemLister implements the DynamodbTableItemLister interface.
...
func NewDynamodbTableItemLister(indexer cache.Indexer) DynamodbTableItemLister {
	return &dynamodbTableItemLister{indexer: indexer}
}

// List lists all DynamodbTableItems in the indexer.
func (s *dynamodbTableItemLister) List(selector labels.Selector) (ret []*v1alpha1.DynamodbTableItem, err error) {
...
func (s dynamodbTableItemNamespaceLister) Get(name string) (*v1alpha1.DynamodbTableItem, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("dynamodbtableitem"), name)
	}
	return obj.(*v1alpha1.DynamodbTableItem), nil
}
