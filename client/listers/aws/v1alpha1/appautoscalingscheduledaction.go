...
// appautoscalingScheduledActionLister implements the AppautoscalingScheduledActionLister interface.
type appautoscalingScheduledActionLister struct {
...
func NewAppautoscalingScheduledActionLister(indexer cache.Indexer) AppautoscalingScheduledActionLister {
	return &appautoscalingScheduledActionLister{indexer: indexer}
}

// List lists all AppautoscalingScheduledActions in the indexer.
func (s *appautoscalingScheduledActionLister) List(selector labels.Selector) (ret []*v1alpha1.AppautoscalingScheduledAction, err error) {
...
func (s appautoscalingScheduledActionNamespaceLister) Get(name string) (*v1alpha1.AppautoscalingScheduledAction, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("appautoscalingscheduledaction"), name)
	}
	return obj.(*v1alpha1.AppautoscalingScheduledAction), nil
}
