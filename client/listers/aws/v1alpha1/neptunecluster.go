...
// neptuneClusterLister implements the NeptuneClusterLister interface.
...
func NewNeptuneClusterLister(indexer cache.Indexer) NeptuneClusterLister {
	return &neptuneClusterLister{indexer: indexer}
}

// List lists all NeptuneClusters in the indexer.
func (s *neptuneClusterLister) List(selector labels.Selector) (ret []*v1alpha1.NeptuneCluster, err error) {
...
func (s neptuneClusterNamespaceLister) Get(name string) (*v1alpha1.NeptuneCluster, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("neptunecluster"), name)
	}
	return obj.(*v1alpha1.NeptuneCluster), nil
}
