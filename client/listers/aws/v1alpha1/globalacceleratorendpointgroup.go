...
// globalacceleratorEndpointGroupLister implements the GlobalacceleratorEndpointGroupLister interface.
...
func NewGlobalacceleratorEndpointGroupLister(indexer cache.Indexer) GlobalacceleratorEndpointGroupLister {
	return &globalacceleratorEndpointGroupLister{indexer: indexer}
}

// List lists all GlobalacceleratorEndpointGroups in the indexer.
func (s *globalacceleratorEndpointGroupLister) List(selector labels.Selector) (ret []*v1alpha1.GlobalacceleratorEndpointGroup, err error) {
...
func (s globalacceleratorEndpointGroupNamespaceLister) Get(name string) (*v1alpha1.GlobalacceleratorEndpointGroup, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("globalacceleratorendpointgroup"), name)
	}
	return obj.(*v1alpha1.GlobalacceleratorEndpointGroup), nil
}
