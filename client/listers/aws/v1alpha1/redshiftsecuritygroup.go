...
// redshiftSecurityGroupLister implements the RedshiftSecurityGroupLister interface.
type redshiftSecurityGroupLister struct {
...
func NewRedshiftSecurityGroupLister(indexer cache.Indexer) RedshiftSecurityGroupLister {
	return &redshiftSecurityGroupLister{indexer: indexer}
}

// List lists all RedshiftSecurityGroups in the indexer.
func (s *redshiftSecurityGroupLister) List(selector labels.Selector) (ret []*v1alpha1.RedshiftSecurityGroup, err error) {
...
func (s redshiftSecurityGroupNamespaceLister) Get(name string) (*v1alpha1.RedshiftSecurityGroup, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("redshiftsecuritygroup"), name)
	}
	return obj.(*v1alpha1.RedshiftSecurityGroup), nil
}
