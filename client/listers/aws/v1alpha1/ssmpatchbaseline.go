...
// ssmPatchBaselineLister implements the SsmPatchBaselineLister interface.
...
func NewSsmPatchBaselineLister(indexer cache.Indexer) SsmPatchBaselineLister {
	return &ssmPatchBaselineLister{indexer: indexer}
}

// List lists all SsmPatchBaselines in the indexer.
func (s *ssmPatchBaselineLister) List(selector labels.Selector) (ret []*v1alpha1.SsmPatchBaseline, err error) {
...
func (s ssmPatchBaselineNamespaceLister) Get(name string) (*v1alpha1.SsmPatchBaseline, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("ssmpatchbaseline"), name)
	}
	return obj.(*v1alpha1.SsmPatchBaseline), nil
}
