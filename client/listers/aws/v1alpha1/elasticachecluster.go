...
// elasticacheClusterLister implements the ElasticacheClusterLister interface.
...
func NewElasticacheClusterLister(indexer cache.Indexer) ElasticacheClusterLister {
	return &elasticacheClusterLister{indexer: indexer}
}

// List lists all ElasticacheClusters in the indexer.
func (s *elasticacheClusterLister) List(selector labels.Selector) (ret []*v1alpha1.ElasticacheCluster, err error) {
