...
// cognitoIdentityPoolRolesAttachmentLister implements the CognitoIdentityPoolRolesAttachmentLister interface.
type cognitoIdentityPoolRolesAttachmentLister struct {
...
func NewCognitoIdentityPoolRolesAttachmentLister(indexer cache.Indexer) CognitoIdentityPoolRolesAttachmentLister {
	return &cognitoIdentityPoolRolesAttachmentLister{indexer: indexer}
}

// List lists all CognitoIdentityPoolRolesAttachments in the indexer.
func (s *cognitoIdentityPoolRolesAttachmentLister) List(selector labels.Selector) (ret []*v1alpha1.CognitoIdentityPoolRolesAttachment, err error) {
...
func (s cognitoIdentityPoolRolesAttachmentNamespaceLister) Get(name string) (*v1alpha1.CognitoIdentityPoolRolesAttachment, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("cognitoidentitypoolrolesattachment"), name)
	}
	return obj.(*v1alpha1.CognitoIdentityPoolRolesAttachment), nil
}
