...
// vpcPeeringConnectionOptionsLister implements the VpcPeeringConnectionOptionsLister interface.
type vpcPeeringConnectionOptionsLister struct {
...
func NewVpcPeeringConnectionOptionsLister(indexer cache.Indexer) VpcPeeringConnectionOptionsLister {
	return &vpcPeeringConnectionOptionsLister{indexer: indexer}
}

// List lists all VpcPeeringConnectionOptionses in the indexer.
func (s *vpcPeeringConnectionOptionsLister) List(selector labels.Selector) (ret []*v1alpha1.VpcPeeringConnectionOptions, err error) {
...
func (s vpcPeeringConnectionOptionsNamespaceLister) Get(name string) (*v1alpha1.VpcPeeringConnectionOptions, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("vpcpeeringconnectionoptions"), name)
	}
	return obj.(*v1alpha1.VpcPeeringConnectionOptions), nil
}
