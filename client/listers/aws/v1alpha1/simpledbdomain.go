...
// simpledbDomainLister implements the SimpledbDomainLister interface.
...
func NewSimpledbDomainLister(indexer cache.Indexer) SimpledbDomainLister {
	return &simpledbDomainLister{indexer: indexer}
}

// List lists all SimpledbDomains in the indexer.
func (s *simpledbDomainLister) List(selector labels.Selector) (ret []*v1alpha1.SimpledbDomain, err error) {
...
func (s simpledbDomainNamespaceLister) Get(name string) (*v1alpha1.SimpledbDomain, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("simpledbdomain"), name)
	}
	return obj.(*v1alpha1.SimpledbDomain), nil
}
