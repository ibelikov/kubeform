...
// dlmLifecyclePolicyLister implements the DlmLifecyclePolicyLister interface.
...
func NewDlmLifecyclePolicyLister(indexer cache.Indexer) DlmLifecyclePolicyLister {
	return &dlmLifecyclePolicyLister{indexer: indexer}
}

// List lists all DlmLifecyclePolicies in the indexer.
func (s *dlmLifecyclePolicyLister) List(selector labels.Selector) (ret []*v1alpha1.DlmLifecyclePolicy, err error) {
...
func (s dlmLifecyclePolicyNamespaceLister) Get(name string) (*v1alpha1.DlmLifecyclePolicy, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("dlmlifecyclepolicy"), name)
	}
	return obj.(*v1alpha1.DlmLifecyclePolicy), nil
}
