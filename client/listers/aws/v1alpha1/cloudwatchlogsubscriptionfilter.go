...
// cloudwatchLogSubscriptionFilterLister implements the CloudwatchLogSubscriptionFilterLister interface.
type cloudwatchLogSubscriptionFilterLister struct {
...
func NewCloudwatchLogSubscriptionFilterLister(indexer cache.Indexer) CloudwatchLogSubscriptionFilterLister {
	return &cloudwatchLogSubscriptionFilterLister{indexer: indexer}
}

// List lists all CloudwatchLogSubscriptionFilters in the indexer.
func (s *cloudwatchLogSubscriptionFilterLister) List(selector labels.Selector) (ret []*v1alpha1.CloudwatchLogSubscriptionFilter, err error) {
...
func (s cloudwatchLogSubscriptionFilterNamespaceLister) Get(name string) (*v1alpha1.CloudwatchLogSubscriptionFilter, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("cloudwatchlogsubscriptionfilter"), name)
	}
	return obj.(*v1alpha1.CloudwatchLogSubscriptionFilter), nil
}
