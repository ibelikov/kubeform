...
// pinpointAdmChannelLister implements the PinpointAdmChannelLister interface.
type pinpointAdmChannelLister struct {
...
func NewPinpointAdmChannelLister(indexer cache.Indexer) PinpointAdmChannelLister {
	return &pinpointAdmChannelLister{indexer: indexer}
}

// List lists all PinpointAdmChannels in the indexer.
func (s *pinpointAdmChannelLister) List(selector labels.Selector) (ret []*v1alpha1.PinpointAdmChannel, err error) {
...
func (s pinpointAdmChannelNamespaceLister) Get(name string) (*v1alpha1.PinpointAdmChannel, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("pinpointadmchannel"), name)
	}
	return obj.(*v1alpha1.PinpointAdmChannel), nil
}
