...
// dxGatewayAssociationProposalLister implements the DxGatewayAssociationProposalLister interface.
type dxGatewayAssociationProposalLister struct {
...
func NewDxGatewayAssociationProposalLister(indexer cache.Indexer) DxGatewayAssociationProposalLister {
	return &dxGatewayAssociationProposalLister{indexer: indexer}
}

// List lists all DxGatewayAssociationProposals in the indexer.
func (s *dxGatewayAssociationProposalLister) List(selector labels.Selector) (ret []*v1alpha1.DxGatewayAssociationProposal, err error) {
...
func (s dxGatewayAssociationProposalNamespaceLister) Get(name string) (*v1alpha1.DxGatewayAssociationProposal, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("dxgatewayassociationproposal"), name)
	}
	return obj.(*v1alpha1.DxGatewayAssociationProposal), nil
}
