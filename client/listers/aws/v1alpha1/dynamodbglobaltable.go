...
// dynamodbGlobalTableLister implements the DynamodbGlobalTableLister interface.
type dynamodbGlobalTableLister struct {
...
func NewDynamodbGlobalTableLister(indexer cache.Indexer) DynamodbGlobalTableLister {
	return &dynamodbGlobalTableLister{indexer: indexer}
}

// List lists all DynamodbGlobalTables in the indexer.
func (s *dynamodbGlobalTableLister) List(selector labels.Selector) (ret []*v1alpha1.DynamodbGlobalTable, err error) {
...
func (s dynamodbGlobalTableNamespaceLister) Get(name string) (*v1alpha1.DynamodbGlobalTable, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("dynamodbglobaltable"), name)
	}
	return obj.(*v1alpha1.DynamodbGlobalTable), nil
}
