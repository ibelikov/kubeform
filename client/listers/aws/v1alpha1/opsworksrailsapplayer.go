...
// opsworksRailsAppLayerLister implements the OpsworksRailsAppLayerLister interface.
type opsworksRailsAppLayerLister struct {
...
func NewOpsworksRailsAppLayerLister(indexer cache.Indexer) OpsworksRailsAppLayerLister {
	return &opsworksRailsAppLayerLister{indexer: indexer}
}

// List lists all OpsworksRailsAppLayers in the indexer.
func (s *opsworksRailsAppLayerLister) List(selector labels.Selector) (ret []*v1alpha1.OpsworksRailsAppLayer, err error) {
...
func (s opsworksRailsAppLayerNamespaceLister) Get(name string) (*v1alpha1.OpsworksRailsAppLayer, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("opsworksrailsapplayer"), name)
	}
	return obj.(*v1alpha1.OpsworksRailsAppLayer), nil
}
