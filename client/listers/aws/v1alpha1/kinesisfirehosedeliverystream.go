...
// kinesisFirehoseDeliveryStreamLister implements the KinesisFirehoseDeliveryStreamLister interface.
type kinesisFirehoseDeliveryStreamLister struct {
...
func NewKinesisFirehoseDeliveryStreamLister(indexer cache.Indexer) KinesisFirehoseDeliveryStreamLister {
	return &kinesisFirehoseDeliveryStreamLister{indexer: indexer}
}

// List lists all KinesisFirehoseDeliveryStreams in the indexer.
func (s *kinesisFirehoseDeliveryStreamLister) List(selector labels.Selector) (ret []*v1alpha1.KinesisFirehoseDeliveryStream, err error) {
...
func (s kinesisFirehoseDeliveryStreamNamespaceLister) Get(name string) (*v1alpha1.KinesisFirehoseDeliveryStream, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("kinesisfirehosedeliverystream"), name)
	}
	return obj.(*v1alpha1.KinesisFirehoseDeliveryStream), nil
}
