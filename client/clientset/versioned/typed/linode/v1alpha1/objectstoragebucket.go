...
func (c *objectStorageBuckets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ObjectStorageBucket, err error) {
...
func (c *objectStorageBuckets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ObjectStorageBucketList, err error) {
...
func (c *objectStorageBuckets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *objectStorageBuckets) Create(ctx context.Context, objectStorageBucket *v1alpha1.ObjectStorageBucket, opts v1.CreateOptions) (result *v1alpha1.ObjectStorageBucket, err error) {
	result = &v1alpha1.ObjectStorageBucket{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectstoragebuckets").
...
func (c *objectStorageBuckets) Update(ctx context.Context, objectStorageBucket *v1alpha1.ObjectStorageBucket, opts v1.UpdateOptions) (result *v1alpha1.ObjectStorageBucket, err error) {
	result = &v1alpha1.ObjectStorageBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectstoragebuckets").
...
func (c *objectStorageBuckets) UpdateStatus(ctx context.Context, objectStorageBucket *v1alpha1.ObjectStorageBucket, opts v1.UpdateOptions) (result *v1alpha1.ObjectStorageBucket, err error) {
	result = &v1alpha1.ObjectStorageBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectstoragebuckets").
...
func (c *objectStorageBuckets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *objectStorageBuckets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *objectStorageBuckets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ObjectStorageBucket, err error) {
	result = &v1alpha1.ObjectStorageBucket{}
