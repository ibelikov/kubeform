...
// LkeClustersGetter has a method to return a LkeClusterInterface.
...
// lkeClusters implements LkeClusterInterface
type lkeClusters struct {
	client rest.Interface
	ns     string
}

// newLkeClusters returns a LkeClusters
func newLkeClusters(c *LinodeV1alpha1Client, namespace string) *lkeClusters {
	return &lkeClusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *lkeClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LkeCluster, err error) {
	result = &v1alpha1.LkeCluster{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lkeclusters").
		Name(name).
...
func (c *lkeClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LkeClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LkeClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lkeclusters").
...
func (c *lkeClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lkeClusters) Create(ctx context.Context, lkeCluster *v1alpha1.LkeCluster, opts v1.CreateOptions) (result *v1alpha1.LkeCluster, err error) {
	result = &v1alpha1.LkeCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lkeclusters").
...
func (c *lkeClusters) Update(ctx context.Context, lkeCluster *v1alpha1.LkeCluster, opts v1.UpdateOptions) (result *v1alpha1.LkeCluster, err error) {
	result = &v1alpha1.LkeCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lkeclusters").
		Name(lkeCluster.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lkeCluster).
		Do(ctx).
		Into(result)
...
func (c *lkeClusters) UpdateStatus(ctx context.Context, lkeCluster *v1alpha1.LkeCluster, opts v1.UpdateOptions) (result *v1alpha1.LkeCluster, err error) {
	result = &v1alpha1.LkeCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lkeclusters").
...
func (c *lkeClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lkeClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lkeClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LkeCluster, err error) {
	result = &v1alpha1.LkeCluster{}
