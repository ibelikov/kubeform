...
type RDSInterface interface {
	...
	UpdateStatus(ctx context.Context, rDS *v1alpha1.RDS, opts v1.UpdateOptions) (*v1alpha1.RDS, error)
...
func (c *rDSs) UpdateStatus(ctx context.Context, rDS *v1alpha1.RDS, opts v1.UpdateOptions) (result *v1alpha1.RDS, err error) {
	result = &v1alpha1.RDS{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rdss").
