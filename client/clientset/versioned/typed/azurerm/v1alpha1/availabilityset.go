...
func (c *availabilitySets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AvailabilitySet, err error) {
...
func (c *availabilitySets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AvailabilitySetList, err error) {
...
func (c *availabilitySets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *availabilitySets) Create(ctx context.Context, availabilitySet *v1alpha1.AvailabilitySet, opts v1.CreateOptions) (result *v1alpha1.AvailabilitySet, err error) {
	result = &v1alpha1.AvailabilitySet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("availabilitysets").
...
func (c *availabilitySets) Update(ctx context.Context, availabilitySet *v1alpha1.AvailabilitySet, opts v1.UpdateOptions) (result *v1alpha1.AvailabilitySet, err error) {
	result = &v1alpha1.AvailabilitySet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("availabilitysets").
...
func (c *availabilitySets) UpdateStatus(ctx context.Context, availabilitySet *v1alpha1.AvailabilitySet, opts v1.UpdateOptions) (result *v1alpha1.AvailabilitySet, err error) {
	result = &v1alpha1.AvailabilitySet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("availabilitysets").
...
func (c *availabilitySets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *availabilitySets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *availabilitySets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AvailabilitySet, err error) {
	result = &v1alpha1.AvailabilitySet{}
