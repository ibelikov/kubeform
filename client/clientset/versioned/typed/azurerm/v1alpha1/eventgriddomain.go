...
func (c *eventgridDomains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EventgridDomain, err error) {
...
func (c *eventgridDomains) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EventgridDomainList, err error) {
...
func (c *eventgridDomains) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *eventgridDomains) Create(ctx context.Context, eventgridDomain *v1alpha1.EventgridDomain, opts v1.CreateOptions) (result *v1alpha1.EventgridDomain, err error) {
	result = &v1alpha1.EventgridDomain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("eventgriddomains").
...
func (c *eventgridDomains) Update(ctx context.Context, eventgridDomain *v1alpha1.EventgridDomain, opts v1.UpdateOptions) (result *v1alpha1.EventgridDomain, err error) {
	result = &v1alpha1.EventgridDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventgriddomains").
...
func (c *eventgridDomains) UpdateStatus(ctx context.Context, eventgridDomain *v1alpha1.EventgridDomain, opts v1.UpdateOptions) (result *v1alpha1.EventgridDomain, err error) {
	result = &v1alpha1.EventgridDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventgriddomains").
...
func (c *eventgridDomains) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *eventgridDomains) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *eventgridDomains) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EventgridDomain, err error) {
	result = &v1alpha1.EventgridDomain{}
