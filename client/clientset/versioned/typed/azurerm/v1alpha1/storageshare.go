...
func (c *storageShares) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageShare, err error) {
...
func (c *storageShares) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageShareList, err error) {
...
func (c *storageShares) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageShares) Create(ctx context.Context, storageShare *v1alpha1.StorageShare, opts v1.CreateOptions) (result *v1alpha1.StorageShare, err error) {
	result = &v1alpha1.StorageShare{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storageshares").
...
func (c *storageShares) Update(ctx context.Context, storageShare *v1alpha1.StorageShare, opts v1.UpdateOptions) (result *v1alpha1.StorageShare, err error) {
	result = &v1alpha1.StorageShare{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storageshares").
...
func (c *storageShares) UpdateStatus(ctx context.Context, storageShare *v1alpha1.StorageShare, opts v1.UpdateOptions) (result *v1alpha1.StorageShare, err error) {
	result = &v1alpha1.StorageShare{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storageshares").
...
func (c *storageShares) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageShares) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageShares) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageShare, err error) {
	result = &v1alpha1.StorageShare{}
