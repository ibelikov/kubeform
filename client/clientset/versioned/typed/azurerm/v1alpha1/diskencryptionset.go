...
func (c *diskEncryptionSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DiskEncryptionSet, err error) {
...
func (c *diskEncryptionSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DiskEncryptionSetList, err error) {
...
func (c *diskEncryptionSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *diskEncryptionSets) Create(ctx context.Context, diskEncryptionSet *v1alpha1.DiskEncryptionSet, opts v1.CreateOptions) (result *v1alpha1.DiskEncryptionSet, err error) {
	result = &v1alpha1.DiskEncryptionSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("diskencryptionsets").
...
func (c *diskEncryptionSets) Update(ctx context.Context, diskEncryptionSet *v1alpha1.DiskEncryptionSet, opts v1.UpdateOptions) (result *v1alpha1.DiskEncryptionSet, err error) {
	result = &v1alpha1.DiskEncryptionSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskencryptionsets").
...
func (c *diskEncryptionSets) UpdateStatus(ctx context.Context, diskEncryptionSet *v1alpha1.DiskEncryptionSet, opts v1.UpdateOptions) (result *v1alpha1.DiskEncryptionSet, err error) {
	result = &v1alpha1.DiskEncryptionSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskencryptionsets").
...
func (c *diskEncryptionSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *diskEncryptionSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *diskEncryptionSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DiskEncryptionSet, err error) {
	result = &v1alpha1.DiskEncryptionSet{}
