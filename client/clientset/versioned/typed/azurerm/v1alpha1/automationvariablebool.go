...
func (c *automationVariableBools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutomationVariableBool, err error) {
...
func (c *automationVariableBools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutomationVariableBoolList, err error) {
...
func (c *automationVariableBools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *automationVariableBools) Create(ctx context.Context, automationVariableBool *v1alpha1.AutomationVariableBool, opts v1.CreateOptions) (result *v1alpha1.AutomationVariableBool, err error) {
	result = &v1alpha1.AutomationVariableBool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("automationvariablebools").
...
func (c *automationVariableBools) Update(ctx context.Context, automationVariableBool *v1alpha1.AutomationVariableBool, opts v1.UpdateOptions) (result *v1alpha1.AutomationVariableBool, err error) {
	result = &v1alpha1.AutomationVariableBool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationvariablebools").
...
func (c *automationVariableBools) UpdateStatus(ctx context.Context, automationVariableBool *v1alpha1.AutomationVariableBool, opts v1.UpdateOptions) (result *v1alpha1.AutomationVariableBool, err error) {
	result = &v1alpha1.AutomationVariableBool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationvariablebools").
...
func (c *automationVariableBools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *automationVariableBools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *automationVariableBools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutomationVariableBool, err error) {
	result = &v1alpha1.AutomationVariableBool{}
