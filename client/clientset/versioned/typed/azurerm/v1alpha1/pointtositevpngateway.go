...
func (c *pointToSiteVPNGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PointToSiteVPNGateway, err error) {
...
func (c *pointToSiteVPNGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PointToSiteVPNGatewayList, err error) {
...
func (c *pointToSiteVPNGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pointToSiteVPNGateways) Create(ctx context.Context, pointToSiteVPNGateway *v1alpha1.PointToSiteVPNGateway, opts v1.CreateOptions) (result *v1alpha1.PointToSiteVPNGateway, err error) {
	result = &v1alpha1.PointToSiteVPNGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pointtositevpngateways").
...
func (c *pointToSiteVPNGateways) Update(ctx context.Context, pointToSiteVPNGateway *v1alpha1.PointToSiteVPNGateway, opts v1.UpdateOptions) (result *v1alpha1.PointToSiteVPNGateway, err error) {
	result = &v1alpha1.PointToSiteVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pointtositevpngateways").
...
func (c *pointToSiteVPNGateways) UpdateStatus(ctx context.Context, pointToSiteVPNGateway *v1alpha1.PointToSiteVPNGateway, opts v1.UpdateOptions) (result *v1alpha1.PointToSiteVPNGateway, err error) {
	result = &v1alpha1.PointToSiteVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pointtositevpngateways").
...
func (c *pointToSiteVPNGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pointToSiteVPNGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pointToSiteVPNGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PointToSiteVPNGateway, err error) {
	result = &v1alpha1.PointToSiteVPNGateway{}
