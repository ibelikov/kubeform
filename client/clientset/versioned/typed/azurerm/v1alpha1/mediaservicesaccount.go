...
type MediaServicesAccountInterface interface {
	Create(*v1alpha1.MediaServicesAccount) (*v1alpha1.MediaServicesAccount, error)
	Update(*v1alpha1.MediaServicesAccount) (*v1alpha1.MediaServicesAccount, error)
	UpdateStatus(*v1alpha1.MediaServicesAccount) (*v1alpha1.MediaServicesAccount, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MediaServicesAccount, error)
	List(opts v1.ListOptions) (*v1alpha1.MediaServicesAccountList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MediaServicesAccount, err error)
...
func (c *mediaServicesAccounts) List(opts v1.ListOptions) (result *v1alpha1.MediaServicesAccountList, err error) {
...
func (c *mediaServicesAccounts) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mediaServicesAccounts) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
