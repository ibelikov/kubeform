...
func (c *FakeFirewallNetworkRuleCollections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FirewallNetworkRuleCollection, err error) {
	obj, err := c.Fake.
...
func (c *FakeFirewallNetworkRuleCollections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirewallNetworkRuleCollectionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeFirewallNetworkRuleCollections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeFirewallNetworkRuleCollections) Create(ctx context.Context, firewallNetworkRuleCollection *v1alpha1.FirewallNetworkRuleCollection, opts v1.CreateOptions) (result *v1alpha1.FirewallNetworkRuleCollection, err error) {
	obj, err := c.Fake.
...
func (c *FakeFirewallNetworkRuleCollections) Update(ctx context.Context, firewallNetworkRuleCollection *v1alpha1.FirewallNetworkRuleCollection, opts v1.UpdateOptions) (result *v1alpha1.FirewallNetworkRuleCollection, err error) {
	obj, err := c.Fake.
...
func (c *FakeFirewallNetworkRuleCollections) UpdateStatus(ctx context.Context, firewallNetworkRuleCollection *v1alpha1.FirewallNetworkRuleCollection, opts v1.UpdateOptions) (*v1alpha1.FirewallNetworkRuleCollection, error) {
	obj, err := c.Fake.
...
func (c *FakeFirewallNetworkRuleCollections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeFirewallNetworkRuleCollections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(firewallnetworkrulecollectionsResource, c.ns, listOpts)
...
func (c *FakeFirewallNetworkRuleCollections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FirewallNetworkRuleCollection, err error) {
	obj, err := c.Fake.
