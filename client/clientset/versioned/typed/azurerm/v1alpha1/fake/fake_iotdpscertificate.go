...
func (c *FakeIotDpsCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IotDpsCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeIotDpsCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IotDpsCertificateList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIotDpsCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeIotDpsCertificates) Create(ctx context.Context, iotDpsCertificate *v1alpha1.IotDpsCertificate, opts v1.CreateOptions) (result *v1alpha1.IotDpsCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeIotDpsCertificates) Update(ctx context.Context, iotDpsCertificate *v1alpha1.IotDpsCertificate, opts v1.UpdateOptions) (result *v1alpha1.IotDpsCertificate, err error) {
	obj, err := c.Fake.
...
func (c *FakeIotDpsCertificates) UpdateStatus(ctx context.Context, iotDpsCertificate *v1alpha1.IotDpsCertificate, opts v1.UpdateOptions) (*v1alpha1.IotDpsCertificate, error) {
	obj, err := c.Fake.
...
func (c *FakeIotDpsCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeIotDpsCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(iotdpscertificatesResource, c.ns, listOpts)
...
func (c *FakeIotDpsCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IotDpsCertificate, err error) {
	obj, err := c.Fake.
