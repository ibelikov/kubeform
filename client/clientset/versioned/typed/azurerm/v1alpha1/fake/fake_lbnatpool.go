...
func (c *FakeLbNATPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LbNATPool, err error) {
	obj, err := c.Fake.
...
func (c *FakeLbNATPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LbNATPoolList, err error) {
	obj, err := c.Fake.
...
func (c *FakeLbNATPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeLbNATPools) Create(ctx context.Context, lbNATPool *v1alpha1.LbNATPool, opts v1.CreateOptions) (result *v1alpha1.LbNATPool, err error) {
	obj, err := c.Fake.
...
func (c *FakeLbNATPools) Update(ctx context.Context, lbNATPool *v1alpha1.LbNATPool, opts v1.UpdateOptions) (result *v1alpha1.LbNATPool, err error) {
	obj, err := c.Fake.
...
func (c *FakeLbNATPools) UpdateStatus(ctx context.Context, lbNATPool *v1alpha1.LbNATPool, opts v1.UpdateOptions) (*v1alpha1.LbNATPool, error) {
	obj, err := c.Fake.
...
func (c *FakeLbNATPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeLbNATPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(lbnatpoolsResource, c.ns, listOpts)
...
func (c *FakeLbNATPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LbNATPool, err error) {
	obj, err := c.Fake.
