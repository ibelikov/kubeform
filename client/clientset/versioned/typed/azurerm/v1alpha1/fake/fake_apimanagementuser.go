...
var apimanagementusersKind = schema.GroupVersionKind{Group: "azurerm.kubeform.com", Version: "v1alpha1", Kind: "ApiManagementUser"}
...
func (c *FakeApiManagementUsers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiManagementUser, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.ApiManagementUser), err
}

// List takes label and field selectors, and returns the list of ApiManagementUsers that match those selectors.
func (c *FakeApiManagementUsers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiManagementUserList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.ApiManagementUserList{ListMeta: obj.(*v1alpha1.ApiManagementUserList).ListMeta}
	for _, item := range obj.(*v1alpha1.ApiManagementUserList).Items {
...
func (c *FakeApiManagementUsers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeApiManagementUsers) Create(ctx context.Context, apiManagementUser *v1alpha1.ApiManagementUser, opts v1.CreateOptions) (result *v1alpha1.ApiManagementUser, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiManagementUsers) Update(ctx context.Context, apiManagementUser *v1alpha1.ApiManagementUser, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementUser, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiManagementUsers) UpdateStatus(ctx context.Context, apiManagementUser *v1alpha1.ApiManagementUser, opts v1.UpdateOptions) (*v1alpha1.ApiManagementUser, error) {
	obj, err := c.Fake.
...
func (c *FakeApiManagementUsers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeApiManagementUsers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(apimanagementusersResource, c.ns, listOpts)
...
func (c *FakeApiManagementUsers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiManagementUser, err error) {
	obj, err := c.Fake.
