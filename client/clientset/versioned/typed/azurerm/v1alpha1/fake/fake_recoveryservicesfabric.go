...
// FakeRecoveryServicesFabrics implements RecoveryServicesFabricInterface
type FakeRecoveryServicesFabrics struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var recoveryservicesfabricsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "recoveryservicesfabrics"}
...
func (c *FakeRecoveryServicesFabrics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RecoveryServicesFabric, err error) {
	...
	return obj.(*v1alpha1.RecoveryServicesFabric), err
}
...
func (c *FakeRecoveryServicesFabrics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RecoveryServicesFabricList, err error) {
	...
	list := &v1alpha1.RecoveryServicesFabricList{ListMeta: obj.(*v1alpha1.RecoveryServicesFabricList).ListMeta}
	for _, item := range obj.(*v1alpha1.RecoveryServicesFabricList).Items {
