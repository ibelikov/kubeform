...
var hdinsightinteractivequeryclustersKind = schema.GroupVersionKind{Group: "azurerm.kubeform.com", Version: "v1alpha1", Kind: "HdinsightInteractiveQueryCluster"}
...
func (c *FakeHdinsightInteractiveQueryClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HdinsightInteractiveQueryCluster, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.HdinsightInteractiveQueryCluster), err
}
...
func (c *FakeHdinsightInteractiveQueryClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HdinsightInteractiveQueryClusterList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.HdinsightInteractiveQueryClusterList{ListMeta: obj.(*v1alpha1.HdinsightInteractiveQueryClusterList).ListMeta}
	for _, item := range obj.(*v1alpha1.HdinsightInteractiveQueryClusterList).Items {
...
func (c *FakeHdinsightInteractiveQueryClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeHdinsightInteractiveQueryClusters) Create(ctx context.Context, hdinsightInteractiveQueryCluster *v1alpha1.HdinsightInteractiveQueryCluster, opts v1.CreateOptions) (result *v1alpha1.HdinsightInteractiveQueryCluster, err error) {
	obj, err := c.Fake.
...
func (c *FakeHdinsightInteractiveQueryClusters) Update(ctx context.Context, hdinsightInteractiveQueryCluster *v1alpha1.HdinsightInteractiveQueryCluster, opts v1.UpdateOptions) (result *v1alpha1.HdinsightInteractiveQueryCluster, err error) {
	obj, err := c.Fake.
...
func (c *FakeHdinsightInteractiveQueryClusters) UpdateStatus(ctx context.Context, hdinsightInteractiveQueryCluster *v1alpha1.HdinsightInteractiveQueryCluster, opts v1.UpdateOptions) (*v1alpha1.HdinsightInteractiveQueryCluster, error) {
	obj, err := c.Fake.
...
func (c *FakeHdinsightInteractiveQueryClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeHdinsightInteractiveQueryClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(hdinsightinteractivequeryclustersResource, c.ns, listOpts)
...
func (c *FakeHdinsightInteractiveQueryClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HdinsightInteractiveQueryCluster, err error) {
	obj, err := c.Fake.
