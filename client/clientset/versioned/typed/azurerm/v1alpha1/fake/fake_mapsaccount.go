...
// FakeMapsAccounts implements MapsAccountInterface
type FakeMapsAccounts struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var mapsaccountsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "mapsaccounts"}
...
func (c *FakeMapsAccounts) Get(name string, options v1.GetOptions) (result *v1alpha1.MapsAccount, err error) {
	...
	return obj.(*v1alpha1.MapsAccount), err
}
...
func (c *FakeMapsAccounts) List(opts v1.ListOptions) (result *v1alpha1.MapsAccountList, err error) {
	...
	list := &v1alpha1.MapsAccountList{ListMeta: obj.(*v1alpha1.MapsAccountList).ListMeta}
	for _, item := range obj.(*v1alpha1.MapsAccountList).Items {
