...
func (c *FakeStreamAnalyticsOutputServicebusQueues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StreamAnalyticsOutputServicebusQueue, err error) {
	obj, err := c.Fake.
...
func (c *FakeStreamAnalyticsOutputServicebusQueues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StreamAnalyticsOutputServicebusQueueList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStreamAnalyticsOutputServicebusQueues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeStreamAnalyticsOutputServicebusQueues) Create(ctx context.Context, streamAnalyticsOutputServicebusQueue *v1alpha1.StreamAnalyticsOutputServicebusQueue, opts v1.CreateOptions) (result *v1alpha1.StreamAnalyticsOutputServicebusQueue, err error) {
	obj, err := c.Fake.
...
func (c *FakeStreamAnalyticsOutputServicebusQueues) Update(ctx context.Context, streamAnalyticsOutputServicebusQueue *v1alpha1.StreamAnalyticsOutputServicebusQueue, opts v1.UpdateOptions) (result *v1alpha1.StreamAnalyticsOutputServicebusQueue, err error) {
	obj, err := c.Fake.
...
func (c *FakeStreamAnalyticsOutputServicebusQueues) UpdateStatus(ctx context.Context, streamAnalyticsOutputServicebusQueue *v1alpha1.StreamAnalyticsOutputServicebusQueue, opts v1.UpdateOptions) (*v1alpha1.StreamAnalyticsOutputServicebusQueue, error) {
	obj, err := c.Fake.
...
func (c *FakeStreamAnalyticsOutputServicebusQueues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeStreamAnalyticsOutputServicebusQueues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(streamanalyticsoutputservicebusqueuesResource, c.ns, listOpts)
...
func (c *FakeStreamAnalyticsOutputServicebusQueues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StreamAnalyticsOutputServicebusQueue, err error) {
	obj, err := c.Fake.
