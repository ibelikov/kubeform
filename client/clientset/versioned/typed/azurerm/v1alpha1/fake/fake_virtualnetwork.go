...
func (c *FakeVirtualNetworks) Get(name string, options v1.GetOptions) (result *v1alpha1.VirtualNetwork, err error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualNetworks) List(opts v1.ListOptions) (result *v1alpha1.VirtualNetworkList, err error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualNetworks) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeVirtualNetworks) Create(virtualNetwork *v1alpha1.VirtualNetwork) (result *v1alpha1.VirtualNetwork, err error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualNetworks) Update(virtualNetwork *v1alpha1.VirtualNetwork) (result *v1alpha1.VirtualNetwork, err error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualNetworks) UpdateStatus(virtualNetwork *v1alpha1.VirtualNetwork) (*v1alpha1.VirtualNetwork, error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualNetworks) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeVirtualNetworks) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(virtualnetworksResource, c.ns, listOptions)
...
func (c *FakeVirtualNetworks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VirtualNetwork, err error) {
	obj, err := c.Fake.
