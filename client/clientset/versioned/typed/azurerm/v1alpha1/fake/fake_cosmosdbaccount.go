...
func (c *FakeCosmosdbAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CosmosdbAccount, err error) {
	obj, err := c.Fake.
...
func (c *FakeCosmosdbAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CosmosdbAccountList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCosmosdbAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCosmosdbAccounts) Create(ctx context.Context, cosmosdbAccount *v1alpha1.CosmosdbAccount, opts v1.CreateOptions) (result *v1alpha1.CosmosdbAccount, err error) {
	obj, err := c.Fake.
...
func (c *FakeCosmosdbAccounts) Update(ctx context.Context, cosmosdbAccount *v1alpha1.CosmosdbAccount, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbAccount, err error) {
	obj, err := c.Fake.
...
func (c *FakeCosmosdbAccounts) UpdateStatus(ctx context.Context, cosmosdbAccount *v1alpha1.CosmosdbAccount, opts v1.UpdateOptions) (*v1alpha1.CosmosdbAccount, error) {
	obj, err := c.Fake.
...
func (c *FakeCosmosdbAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeCosmosdbAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(cosmosdbaccountsResource, c.ns, listOpts)
...
func (c *FakeCosmosdbAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CosmosdbAccount, err error) {
	obj, err := c.Fake.
