...
// FakeMonitorActionGroups implements MonitorActionGroupInterface
type FakeMonitorActionGroups struct {
	Fake *FakeAzurermV1alpha1
	ns   string
}

var monitoractiongroupsResource = schema.GroupVersionResource{Group: "azurerm.kubeform.com", Version: "v1alpha1", Resource: "monitoractiongroups"}
...
func (c *FakeMonitorActionGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.MonitorActionGroup, err error) {
	...
	return obj.(*v1alpha1.MonitorActionGroup), err
}
...
func (c *FakeMonitorActionGroups) List(opts v1.ListOptions) (result *v1alpha1.MonitorActionGroupList, err error) {
	...
	list := &v1alpha1.MonitorActionGroupList{ListMeta: obj.(*v1alpha1.MonitorActionGroupList).ListMeta}
	for _, item := range obj.(*v1alpha1.MonitorActionGroupList).Items {
