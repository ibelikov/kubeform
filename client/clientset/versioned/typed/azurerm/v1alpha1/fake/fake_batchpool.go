...
func (c *FakeBatchPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BatchPool, err error) {
	obj, err := c.Fake.
...
func (c *FakeBatchPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BatchPoolList, err error) {
	obj, err := c.Fake.
...
func (c *FakeBatchPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeBatchPools) Create(ctx context.Context, batchPool *v1alpha1.BatchPool, opts v1.CreateOptions) (result *v1alpha1.BatchPool, err error) {
	obj, err := c.Fake.
...
func (c *FakeBatchPools) Update(ctx context.Context, batchPool *v1alpha1.BatchPool, opts v1.UpdateOptions) (result *v1alpha1.BatchPool, err error) {
	obj, err := c.Fake.
...
func (c *FakeBatchPools) UpdateStatus(ctx context.Context, batchPool *v1alpha1.BatchPool, opts v1.UpdateOptions) (*v1alpha1.BatchPool, error) {
	obj, err := c.Fake.
...
func (c *FakeBatchPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeBatchPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(batchpoolsResource, c.ns, listOpts)
...
func (c *FakeBatchPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BatchPool, err error) {
	obj, err := c.Fake.
