...
type SqlVirtualNetworkRuleInterface interface {
	Create(*v1alpha1.SqlVirtualNetworkRule) (*v1alpha1.SqlVirtualNetworkRule, error)
	Update(*v1alpha1.SqlVirtualNetworkRule) (*v1alpha1.SqlVirtualNetworkRule, error)
	UpdateStatus(*v1alpha1.SqlVirtualNetworkRule) (*v1alpha1.SqlVirtualNetworkRule, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SqlVirtualNetworkRule, error)
	List(opts v1.ListOptions) (*v1alpha1.SqlVirtualNetworkRuleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SqlVirtualNetworkRule, err error)
...
func (c *sqlVirtualNetworkRules) List(opts v1.ListOptions) (result *v1alpha1.SqlVirtualNetworkRuleList, err error) {
...
func (c *sqlVirtualNetworkRules) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlVirtualNetworkRules) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
