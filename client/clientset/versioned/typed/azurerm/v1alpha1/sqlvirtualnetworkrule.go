...
func (c *sqlVirtualNetworkRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlVirtualNetworkRule, err error) {
...
func (c *sqlVirtualNetworkRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlVirtualNetworkRuleList, err error) {
...
func (c *sqlVirtualNetworkRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlVirtualNetworkRules) Create(ctx context.Context, sqlVirtualNetworkRule *v1alpha1.SqlVirtualNetworkRule, opts v1.CreateOptions) (result *v1alpha1.SqlVirtualNetworkRule, err error) {
	result = &v1alpha1.SqlVirtualNetworkRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqlvirtualnetworkrules").
...
func (c *sqlVirtualNetworkRules) Update(ctx context.Context, sqlVirtualNetworkRule *v1alpha1.SqlVirtualNetworkRule, opts v1.UpdateOptions) (result *v1alpha1.SqlVirtualNetworkRule, err error) {
	result = &v1alpha1.SqlVirtualNetworkRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlvirtualnetworkrules").
...
func (c *sqlVirtualNetworkRules) UpdateStatus(ctx context.Context, sqlVirtualNetworkRule *v1alpha1.SqlVirtualNetworkRule, opts v1.UpdateOptions) (result *v1alpha1.SqlVirtualNetworkRule, err error) {
	result = &v1alpha1.SqlVirtualNetworkRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlvirtualnetworkrules").
...
func (c *sqlVirtualNetworkRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlVirtualNetworkRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlVirtualNetworkRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlVirtualNetworkRule, err error) {
	result = &v1alpha1.SqlVirtualNetworkRule{}
