...
func newAppServices(c *AzurermV1alpha1Client, namespace string) *appServices {
	return &appServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *appServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppService, err error) {
...
func (c *appServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppServiceList, err error) {
...
func (c *appServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *appServices) Create(ctx context.Context, appService *v1alpha1.AppService, opts v1.CreateOptions) (result *v1alpha1.AppService, err error) {
	result = &v1alpha1.AppService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("appservices").
...
func (c *appServices) Update(ctx context.Context, appService *v1alpha1.AppService, opts v1.UpdateOptions) (result *v1alpha1.AppService, err error) {
	result = &v1alpha1.AppService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appservices").
...
func (c *appServices) UpdateStatus(ctx context.Context, appService *v1alpha1.AppService, opts v1.UpdateOptions) (result *v1alpha1.AppService, err error) {
	result = &v1alpha1.AppService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appservices").
...
func (c *appServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *appServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *appServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppService, err error) {
	result = &v1alpha1.AppService{}
