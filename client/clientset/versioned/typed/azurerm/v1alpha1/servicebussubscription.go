...
func (c *servicebusSubscriptions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicebusSubscription, err error) {
...
func (c *servicebusSubscriptions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicebusSubscriptionList, err error) {
...
func (c *servicebusSubscriptions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicebusSubscriptions) Create(ctx context.Context, servicebusSubscription *v1alpha1.ServicebusSubscription, opts v1.CreateOptions) (result *v1alpha1.ServicebusSubscription, err error) {
	result = &v1alpha1.ServicebusSubscription{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicebussubscriptions").
...
func (c *servicebusSubscriptions) Update(ctx context.Context, servicebusSubscription *v1alpha1.ServicebusSubscription, opts v1.UpdateOptions) (result *v1alpha1.ServicebusSubscription, err error) {
	result = &v1alpha1.ServicebusSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebussubscriptions").
...
func (c *servicebusSubscriptions) UpdateStatus(ctx context.Context, servicebusSubscription *v1alpha1.ServicebusSubscription, opts v1.UpdateOptions) (result *v1alpha1.ServicebusSubscription, err error) {
	result = &v1alpha1.ServicebusSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebussubscriptions").
...
func (c *servicebusSubscriptions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicebusSubscriptions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicebusSubscriptions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicebusSubscription, err error) {
	result = &v1alpha1.ServicebusSubscription{}
