...
func (c *hdinsightRserverClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HdinsightRserverCluster, err error) {
...
func (c *hdinsightRserverClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HdinsightRserverClusterList, err error) {
...
func (c *hdinsightRserverClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hdinsightRserverClusters) Create(ctx context.Context, hdinsightRserverCluster *v1alpha1.HdinsightRserverCluster, opts v1.CreateOptions) (result *v1alpha1.HdinsightRserverCluster, err error) {
	result = &v1alpha1.HdinsightRserverCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hdinsightrserverclusters").
...
func (c *hdinsightRserverClusters) Update(ctx context.Context, hdinsightRserverCluster *v1alpha1.HdinsightRserverCluster, opts v1.UpdateOptions) (result *v1alpha1.HdinsightRserverCluster, err error) {
	result = &v1alpha1.HdinsightRserverCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hdinsightrserverclusters").
...
func (c *hdinsightRserverClusters) UpdateStatus(ctx context.Context, hdinsightRserverCluster *v1alpha1.HdinsightRserverCluster, opts v1.UpdateOptions) (result *v1alpha1.HdinsightRserverCluster, err error) {
	result = &v1alpha1.HdinsightRserverCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hdinsightrserverclusters").
...
func (c *hdinsightRserverClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hdinsightRserverClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hdinsightRserverClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HdinsightRserverCluster, err error) {
	result = &v1alpha1.HdinsightRserverCluster{}
