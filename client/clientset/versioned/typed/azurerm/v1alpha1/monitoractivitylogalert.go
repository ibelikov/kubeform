...
func (c *monitorActivityLogAlerts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonitorActivityLogAlert, err error) {
...
func (c *monitorActivityLogAlerts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonitorActivityLogAlertList, err error) {
...
func (c *monitorActivityLogAlerts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitorActivityLogAlerts) Create(ctx context.Context, monitorActivityLogAlert *v1alpha1.MonitorActivityLogAlert, opts v1.CreateOptions) (result *v1alpha1.MonitorActivityLogAlert, err error) {
	result = &v1alpha1.MonitorActivityLogAlert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitoractivitylogalerts").
...
func (c *monitorActivityLogAlerts) Update(ctx context.Context, monitorActivityLogAlert *v1alpha1.MonitorActivityLogAlert, opts v1.UpdateOptions) (result *v1alpha1.MonitorActivityLogAlert, err error) {
	result = &v1alpha1.MonitorActivityLogAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoractivitylogalerts").
...
func (c *monitorActivityLogAlerts) UpdateStatus(ctx context.Context, monitorActivityLogAlert *v1alpha1.MonitorActivityLogAlert, opts v1.UpdateOptions) (result *v1alpha1.MonitorActivityLogAlert, err error) {
	result = &v1alpha1.MonitorActivityLogAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoractivitylogalerts").
...
func (c *monitorActivityLogAlerts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monitorActivityLogAlerts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monitorActivityLogAlerts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MonitorActivityLogAlert, err error) {
	result = &v1alpha1.MonitorActivityLogAlert{}
