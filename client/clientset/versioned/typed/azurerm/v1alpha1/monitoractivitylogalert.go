...
type MonitorActivityLogAlertInterface interface {
	Create(*v1alpha1.MonitorActivityLogAlert) (*v1alpha1.MonitorActivityLogAlert, error)
	Update(*v1alpha1.MonitorActivityLogAlert) (*v1alpha1.MonitorActivityLogAlert, error)
	UpdateStatus(*v1alpha1.MonitorActivityLogAlert) (*v1alpha1.MonitorActivityLogAlert, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MonitorActivityLogAlert, error)
	List(opts v1.ListOptions) (*v1alpha1.MonitorActivityLogAlertList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MonitorActivityLogAlert, err error)
...
func (c *monitorActivityLogAlerts) List(opts v1.ListOptions) (result *v1alpha1.MonitorActivityLogAlertList, err error) {
...
func (c *monitorActivityLogAlerts) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitorActivityLogAlerts) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
