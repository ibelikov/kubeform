...
func (c *automationCredentials) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutomationCredential, err error) {
...
func (c *automationCredentials) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutomationCredentialList, err error) {
...
func (c *automationCredentials) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *automationCredentials) Create(ctx context.Context, automationCredential *v1alpha1.AutomationCredential, opts v1.CreateOptions) (result *v1alpha1.AutomationCredential, err error) {
	result = &v1alpha1.AutomationCredential{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("automationcredentials").
...
func (c *automationCredentials) Update(ctx context.Context, automationCredential *v1alpha1.AutomationCredential, opts v1.UpdateOptions) (result *v1alpha1.AutomationCredential, err error) {
	result = &v1alpha1.AutomationCredential{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationcredentials").
...
func (c *automationCredentials) UpdateStatus(ctx context.Context, automationCredential *v1alpha1.AutomationCredential, opts v1.UpdateOptions) (result *v1alpha1.AutomationCredential, err error) {
	result = &v1alpha1.AutomationCredential{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationcredentials").
...
func (c *automationCredentials) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *automationCredentials) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *automationCredentials) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutomationCredential, err error) {
	result = &v1alpha1.AutomationCredential{}
