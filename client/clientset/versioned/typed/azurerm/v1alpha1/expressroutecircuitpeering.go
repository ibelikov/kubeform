...
func (c *expressRouteCircuitPeerings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ExpressRouteCircuitPeering, err error) {
...
func (c *expressRouteCircuitPeerings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ExpressRouteCircuitPeeringList, err error) {
...
func (c *expressRouteCircuitPeerings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *expressRouteCircuitPeerings) Create(ctx context.Context, expressRouteCircuitPeering *v1alpha1.ExpressRouteCircuitPeering, opts v1.CreateOptions) (result *v1alpha1.ExpressRouteCircuitPeering, err error) {
	result = &v1alpha1.ExpressRouteCircuitPeering{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("expressroutecircuitpeerings").
...
func (c *expressRouteCircuitPeerings) Update(ctx context.Context, expressRouteCircuitPeering *v1alpha1.ExpressRouteCircuitPeering, opts v1.UpdateOptions) (result *v1alpha1.ExpressRouteCircuitPeering, err error) {
	result = &v1alpha1.ExpressRouteCircuitPeering{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("expressroutecircuitpeerings").
...
func (c *expressRouteCircuitPeerings) UpdateStatus(ctx context.Context, expressRouteCircuitPeering *v1alpha1.ExpressRouteCircuitPeering, opts v1.UpdateOptions) (result *v1alpha1.ExpressRouteCircuitPeering, err error) {
	result = &v1alpha1.ExpressRouteCircuitPeering{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("expressroutecircuitpeerings").
...
func (c *expressRouteCircuitPeerings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *expressRouteCircuitPeerings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *expressRouteCircuitPeerings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ExpressRouteCircuitPeering, err error) {
	result = &v1alpha1.ExpressRouteCircuitPeering{}
