...
type SecurityCenterWorkspaceInterface interface {
	Create(*v1alpha1.SecurityCenterWorkspace) (*v1alpha1.SecurityCenterWorkspace, error)
	Update(*v1alpha1.SecurityCenterWorkspace) (*v1alpha1.SecurityCenterWorkspace, error)
	UpdateStatus(*v1alpha1.SecurityCenterWorkspace) (*v1alpha1.SecurityCenterWorkspace, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SecurityCenterWorkspace, error)
	List(opts v1.ListOptions) (*v1alpha1.SecurityCenterWorkspaceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SecurityCenterWorkspace, err error)
...
func (c *securityCenterWorkspaces) List(opts v1.ListOptions) (result *v1alpha1.SecurityCenterWorkspaceList, err error) {
...
func (c *securityCenterWorkspaces) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *securityCenterWorkspaces) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
