...
func (c *keyVaultKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KeyVaultKey, err error) {
...
func (c *keyVaultKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KeyVaultKeyList, err error) {
...
func (c *keyVaultKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *keyVaultKeys) Create(ctx context.Context, keyVaultKey *v1alpha1.KeyVaultKey, opts v1.CreateOptions) (result *v1alpha1.KeyVaultKey, err error) {
	result = &v1alpha1.KeyVaultKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("keyvaultkeys").
...
func (c *keyVaultKeys) Update(ctx context.Context, keyVaultKey *v1alpha1.KeyVaultKey, opts v1.UpdateOptions) (result *v1alpha1.KeyVaultKey, err error) {
	result = &v1alpha1.KeyVaultKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyvaultkeys").
...
func (c *keyVaultKeys) UpdateStatus(ctx context.Context, keyVaultKey *v1alpha1.KeyVaultKey, opts v1.UpdateOptions) (result *v1alpha1.KeyVaultKey, err error) {
	result = &v1alpha1.KeyVaultKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyvaultkeys").
...
func (c *keyVaultKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *keyVaultKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *keyVaultKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KeyVaultKey, err error) {
	result = &v1alpha1.KeyVaultKey{}
