...
func (c *notificationHubNamespace_s) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NotificationHubNamespace_, err error) {
...
func (c *notificationHubNamespace_s) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NotificationHubNamespace_List, err error) {
...
func (c *notificationHubNamespace_s) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *notificationHubNamespace_s) Create(ctx context.Context, notificationHubNamespace_ *v1alpha1.NotificationHubNamespace_, opts v1.CreateOptions) (result *v1alpha1.NotificationHubNamespace_, err error) {
	result = &v1alpha1.NotificationHubNamespace_{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("notificationhubnamespace_s").
...
func (c *notificationHubNamespace_s) Update(ctx context.Context, notificationHubNamespace_ *v1alpha1.NotificationHubNamespace_, opts v1.UpdateOptions) (result *v1alpha1.NotificationHubNamespace_, err error) {
	result = &v1alpha1.NotificationHubNamespace_{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("notificationhubnamespace_s").
...
func (c *notificationHubNamespace_s) UpdateStatus(ctx context.Context, notificationHubNamespace_ *v1alpha1.NotificationHubNamespace_, opts v1.UpdateOptions) (result *v1alpha1.NotificationHubNamespace_, err error) {
	result = &v1alpha1.NotificationHubNamespace_{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("notificationhubnamespace_s").
...
func (c *notificationHubNamespace_s) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *notificationHubNamespace_s) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *notificationHubNamespace_s) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NotificationHubNamespace_, err error) {
	result = &v1alpha1.NotificationHubNamespace_{}
