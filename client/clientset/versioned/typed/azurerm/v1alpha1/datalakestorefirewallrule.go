...
func (c *dataLakeStoreFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataLakeStoreFirewallRule, err error) {
...
func (c *dataLakeStoreFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataLakeStoreFirewallRuleList, err error) {
...
func (c *dataLakeStoreFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataLakeStoreFirewallRules) Create(ctx context.Context, dataLakeStoreFirewallRule *v1alpha1.DataLakeStoreFirewallRule, opts v1.CreateOptions) (result *v1alpha1.DataLakeStoreFirewallRule, err error) {
	result = &v1alpha1.DataLakeStoreFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datalakestorefirewallrules").
...
func (c *dataLakeStoreFirewallRules) Update(ctx context.Context, dataLakeStoreFirewallRule *v1alpha1.DataLakeStoreFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.DataLakeStoreFirewallRule, err error) {
	result = &v1alpha1.DataLakeStoreFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datalakestorefirewallrules").
...
func (c *dataLakeStoreFirewallRules) UpdateStatus(ctx context.Context, dataLakeStoreFirewallRule *v1alpha1.DataLakeStoreFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.DataLakeStoreFirewallRule, err error) {
	result = &v1alpha1.DataLakeStoreFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datalakestorefirewallrules").
...
func (c *dataLakeStoreFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataLakeStoreFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataLakeStoreFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataLakeStoreFirewallRule, err error) {
	result = &v1alpha1.DataLakeStoreFirewallRule{}
