...
func (c *storageDataLakeGen2Filesystems) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageDataLakeGen2Filesystem, err error) {
...
func (c *storageDataLakeGen2Filesystems) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageDataLakeGen2FilesystemList, err error) {
...
func (c *storageDataLakeGen2Filesystems) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageDataLakeGen2Filesystems) Create(ctx context.Context, storageDataLakeGen2Filesystem *v1alpha1.StorageDataLakeGen2Filesystem, opts v1.CreateOptions) (result *v1alpha1.StorageDataLakeGen2Filesystem, err error) {
	result = &v1alpha1.StorageDataLakeGen2Filesystem{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagedatalakegen2filesystems").
...
func (c *storageDataLakeGen2Filesystems) Update(ctx context.Context, storageDataLakeGen2Filesystem *v1alpha1.StorageDataLakeGen2Filesystem, opts v1.UpdateOptions) (result *v1alpha1.StorageDataLakeGen2Filesystem, err error) {
	result = &v1alpha1.StorageDataLakeGen2Filesystem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagedatalakegen2filesystems").
...
func (c *storageDataLakeGen2Filesystems) UpdateStatus(ctx context.Context, storageDataLakeGen2Filesystem *v1alpha1.StorageDataLakeGen2Filesystem, opts v1.UpdateOptions) (result *v1alpha1.StorageDataLakeGen2Filesystem, err error) {
	result = &v1alpha1.StorageDataLakeGen2Filesystem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagedatalakegen2filesystems").
...
func (c *storageDataLakeGen2Filesystems) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageDataLakeGen2Filesystems) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageDataLakeGen2Filesystems) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageDataLakeGen2Filesystem, err error) {
	result = &v1alpha1.StorageDataLakeGen2Filesystem{}
