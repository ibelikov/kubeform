...
type MysqlFirewallRuleInterface interface {
	Create(*v1alpha1.MysqlFirewallRule) (*v1alpha1.MysqlFirewallRule, error)
	Update(*v1alpha1.MysqlFirewallRule) (*v1alpha1.MysqlFirewallRule, error)
	UpdateStatus(*v1alpha1.MysqlFirewallRule) (*v1alpha1.MysqlFirewallRule, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MysqlFirewallRule, error)
	List(opts v1.ListOptions) (*v1alpha1.MysqlFirewallRuleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MysqlFirewallRule, err error)
...
func (c *mysqlFirewallRules) List(opts v1.ListOptions) (result *v1alpha1.MysqlFirewallRuleList, err error) {
...
func (c *mysqlFirewallRules) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mysqlFirewallRules) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
