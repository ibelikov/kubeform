...
func (c *mysqlFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MysqlFirewallRule, err error) {
...
func (c *mysqlFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MysqlFirewallRuleList, err error) {
...
func (c *mysqlFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mysqlFirewallRules) Create(ctx context.Context, mysqlFirewallRule *v1alpha1.MysqlFirewallRule, opts v1.CreateOptions) (result *v1alpha1.MysqlFirewallRule, err error) {
	result = &v1alpha1.MysqlFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mysqlfirewallrules").
...
func (c *mysqlFirewallRules) Update(ctx context.Context, mysqlFirewallRule *v1alpha1.MysqlFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.MysqlFirewallRule, err error) {
	result = &v1alpha1.MysqlFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqlfirewallrules").
...
func (c *mysqlFirewallRules) UpdateStatus(ctx context.Context, mysqlFirewallRule *v1alpha1.MysqlFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.MysqlFirewallRule, err error) {
	result = &v1alpha1.MysqlFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqlfirewallrules").
...
func (c *mysqlFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mysqlFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mysqlFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MysqlFirewallRule, err error) {
	result = &v1alpha1.MysqlFirewallRule{}
