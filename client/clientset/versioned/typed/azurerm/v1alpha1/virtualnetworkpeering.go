...
type VirtualNetworkPeeringInterface interface {
	Create(*v1alpha1.VirtualNetworkPeering) (*v1alpha1.VirtualNetworkPeering, error)
	Update(*v1alpha1.VirtualNetworkPeering) (*v1alpha1.VirtualNetworkPeering, error)
	UpdateStatus(*v1alpha1.VirtualNetworkPeering) (*v1alpha1.VirtualNetworkPeering, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.VirtualNetworkPeering, error)
	List(opts v1.ListOptions) (*v1alpha1.VirtualNetworkPeeringList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VirtualNetworkPeering, err error)
...
func (c *virtualNetworkPeerings) List(opts v1.ListOptions) (result *v1alpha1.VirtualNetworkPeeringList, err error) {
...
func (c *virtualNetworkPeerings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *virtualNetworkPeerings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
