...
func (c *privateEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PrivateEndpoint, err error) {
...
func (c *privateEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PrivateEndpointList, err error) {
...
func (c *privateEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *privateEndpoints) Create(ctx context.Context, privateEndpoint *v1alpha1.PrivateEndpoint, opts v1.CreateOptions) (result *v1alpha1.PrivateEndpoint, err error) {
	result = &v1alpha1.PrivateEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("privateendpoints").
...
func (c *privateEndpoints) Update(ctx context.Context, privateEndpoint *v1alpha1.PrivateEndpoint, opts v1.UpdateOptions) (result *v1alpha1.PrivateEndpoint, err error) {
	result = &v1alpha1.PrivateEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privateendpoints").
...
func (c *privateEndpoints) UpdateStatus(ctx context.Context, privateEndpoint *v1alpha1.PrivateEndpoint, opts v1.UpdateOptions) (result *v1alpha1.PrivateEndpoint, err error) {
	result = &v1alpha1.PrivateEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privateendpoints").
...
func (c *privateEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *privateEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *privateEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PrivateEndpoint, err error) {
	result = &v1alpha1.PrivateEndpoint{}
