...
func (c *dataLakeStores) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataLakeStore, err error) {
...
func (c *dataLakeStores) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataLakeStoreList, err error) {
...
func (c *dataLakeStores) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataLakeStores) Create(ctx context.Context, dataLakeStore *v1alpha1.DataLakeStore, opts v1.CreateOptions) (result *v1alpha1.DataLakeStore, err error) {
	result = &v1alpha1.DataLakeStore{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datalakestores").
...
func (c *dataLakeStores) Update(ctx context.Context, dataLakeStore *v1alpha1.DataLakeStore, opts v1.UpdateOptions) (result *v1alpha1.DataLakeStore, err error) {
	result = &v1alpha1.DataLakeStore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datalakestores").
...
func (c *dataLakeStores) UpdateStatus(ctx context.Context, dataLakeStore *v1alpha1.DataLakeStore, opts v1.UpdateOptions) (result *v1alpha1.DataLakeStore, err error) {
	result = &v1alpha1.DataLakeStore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datalakestores").
...
func (c *dataLakeStores) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataLakeStores) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataLakeStores) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataLakeStore, err error) {
	result = &v1alpha1.DataLakeStore{}
