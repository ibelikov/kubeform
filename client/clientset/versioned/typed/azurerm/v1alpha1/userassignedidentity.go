...
type UserAssignedIdentityInterface interface {
	Create(*v1alpha1.UserAssignedIdentity) (*v1alpha1.UserAssignedIdentity, error)
	Update(*v1alpha1.UserAssignedIdentity) (*v1alpha1.UserAssignedIdentity, error)
	UpdateStatus(*v1alpha1.UserAssignedIdentity) (*v1alpha1.UserAssignedIdentity, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.UserAssignedIdentity, error)
	List(opts v1.ListOptions) (*v1alpha1.UserAssignedIdentityList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.UserAssignedIdentity, err error)
...
func (c *userAssignedIdentities) List(opts v1.ListOptions) (result *v1alpha1.UserAssignedIdentityList, err error) {
...
func (c *userAssignedIdentities) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userAssignedIdentities) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
