...
func (c *userAssignedIdentities) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserAssignedIdentity, err error) {
...
func (c *userAssignedIdentities) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserAssignedIdentityList, err error) {
...
func (c *userAssignedIdentities) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userAssignedIdentities) Create(ctx context.Context, userAssignedIdentity *v1alpha1.UserAssignedIdentity, opts v1.CreateOptions) (result *v1alpha1.UserAssignedIdentity, err error) {
	result = &v1alpha1.UserAssignedIdentity{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("userassignedidentities").
...
func (c *userAssignedIdentities) Update(ctx context.Context, userAssignedIdentity *v1alpha1.UserAssignedIdentity, opts v1.UpdateOptions) (result *v1alpha1.UserAssignedIdentity, err error) {
	result = &v1alpha1.UserAssignedIdentity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userassignedidentities").
...
func (c *userAssignedIdentities) UpdateStatus(ctx context.Context, userAssignedIdentity *v1alpha1.UserAssignedIdentity, opts v1.UpdateOptions) (result *v1alpha1.UserAssignedIdentity, err error) {
	result = &v1alpha1.UserAssignedIdentity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userassignedidentities").
...
func (c *userAssignedIdentities) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userAssignedIdentities) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userAssignedIdentities) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserAssignedIdentity, err error) {
	result = &v1alpha1.UserAssignedIdentity{}
