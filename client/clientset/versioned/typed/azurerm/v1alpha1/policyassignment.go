...
func newPolicyAssignments(c *AzurermV1alpha1Client, namespace string) *policyAssignments {
...
func (c *policyAssignments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PolicyAssignment, err error) {
...
func (c *policyAssignments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PolicyAssignmentList, err error) {
...
func (c *policyAssignments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *policyAssignments) Create(ctx context.Context, policyAssignment *v1alpha1.PolicyAssignment, opts v1.CreateOptions) (result *v1alpha1.PolicyAssignment, err error) {
	result = &v1alpha1.PolicyAssignment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("policyassignments").
...
func (c *policyAssignments) Update(ctx context.Context, policyAssignment *v1alpha1.PolicyAssignment, opts v1.UpdateOptions) (result *v1alpha1.PolicyAssignment, err error) {
	result = &v1alpha1.PolicyAssignment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policyassignments").
...
func (c *policyAssignments) UpdateStatus(ctx context.Context, policyAssignment *v1alpha1.PolicyAssignment, opts v1.UpdateOptions) (result *v1alpha1.PolicyAssignment, err error) {
	result = &v1alpha1.PolicyAssignment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policyassignments").
...
func (c *policyAssignments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *policyAssignments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *policyAssignments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PolicyAssignment, err error) {
	result = &v1alpha1.PolicyAssignment{}
