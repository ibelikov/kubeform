...
func (c *devTestVirtualNetworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DevTestVirtualNetwork, err error) {
...
func (c *devTestVirtualNetworks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DevTestVirtualNetworkList, err error) {
...
func (c *devTestVirtualNetworks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *devTestVirtualNetworks) Create(ctx context.Context, devTestVirtualNetwork *v1alpha1.DevTestVirtualNetwork, opts v1.CreateOptions) (result *v1alpha1.DevTestVirtualNetwork, err error) {
	result = &v1alpha1.DevTestVirtualNetwork{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("devtestvirtualnetworks").
...
func (c *devTestVirtualNetworks) Update(ctx context.Context, devTestVirtualNetwork *v1alpha1.DevTestVirtualNetwork, opts v1.UpdateOptions) (result *v1alpha1.DevTestVirtualNetwork, err error) {
	result = &v1alpha1.DevTestVirtualNetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devtestvirtualnetworks").
...
func (c *devTestVirtualNetworks) UpdateStatus(ctx context.Context, devTestVirtualNetwork *v1alpha1.DevTestVirtualNetwork, opts v1.UpdateOptions) (result *v1alpha1.DevTestVirtualNetwork, err error) {
	result = &v1alpha1.DevTestVirtualNetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devtestvirtualnetworks").
...
func (c *devTestVirtualNetworks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *devTestVirtualNetworks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *devTestVirtualNetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DevTestVirtualNetwork, err error) {
	result = &v1alpha1.DevTestVirtualNetwork{}
