...
func (c *dataFactories) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataFactory, err error) {
...
func (c *dataFactories) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataFactoryList, err error) {
...
func (c *dataFactories) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataFactories) Create(ctx context.Context, dataFactory *v1alpha1.DataFactory, opts v1.CreateOptions) (result *v1alpha1.DataFactory, err error) {
	result = &v1alpha1.DataFactory{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datafactories").
...
func (c *dataFactories) Update(ctx context.Context, dataFactory *v1alpha1.DataFactory, opts v1.UpdateOptions) (result *v1alpha1.DataFactory, err error) {
	result = &v1alpha1.DataFactory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datafactories").
...
func (c *dataFactories) UpdateStatus(ctx context.Context, dataFactory *v1alpha1.DataFactory, opts v1.UpdateOptions) (result *v1alpha1.DataFactory, err error) {
	result = &v1alpha1.DataFactory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datafactories").
...
func (c *dataFactories) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataFactories) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataFactories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataFactory, err error) {
	result = &v1alpha1.DataFactory{}
