...
func (c *netappVolumes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetappVolume, err error) {
...
func (c *netappVolumes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetappVolumeList, err error) {
...
func (c *netappVolumes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *netappVolumes) Create(ctx context.Context, netappVolume *v1alpha1.NetappVolume, opts v1.CreateOptions) (result *v1alpha1.NetappVolume, err error) {
	result = &v1alpha1.NetappVolume{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("netappvolumes").
...
func (c *netappVolumes) Update(ctx context.Context, netappVolume *v1alpha1.NetappVolume, opts v1.UpdateOptions) (result *v1alpha1.NetappVolume, err error) {
	result = &v1alpha1.NetappVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("netappvolumes").
...
func (c *netappVolumes) UpdateStatus(ctx context.Context, netappVolume *v1alpha1.NetappVolume, opts v1.UpdateOptions) (result *v1alpha1.NetappVolume, err error) {
	result = &v1alpha1.NetappVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("netappvolumes").
...
func (c *netappVolumes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *netappVolumes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *netappVolumes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetappVolume, err error) {
	result = &v1alpha1.NetappVolume{}
