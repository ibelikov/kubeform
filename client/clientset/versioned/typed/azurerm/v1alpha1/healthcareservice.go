...
func (c *healthcareServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HealthcareService, err error) {
...
func (c *healthcareServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HealthcareServiceList, err error) {
...
func (c *healthcareServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *healthcareServices) Create(ctx context.Context, healthcareService *v1alpha1.HealthcareService, opts v1.CreateOptions) (result *v1alpha1.HealthcareService, err error) {
	result = &v1alpha1.HealthcareService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("healthcareservices").
...
func (c *healthcareServices) Update(ctx context.Context, healthcareService *v1alpha1.HealthcareService, opts v1.UpdateOptions) (result *v1alpha1.HealthcareService, err error) {
	result = &v1alpha1.HealthcareService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("healthcareservices").
...
func (c *healthcareServices) UpdateStatus(ctx context.Context, healthcareService *v1alpha1.HealthcareService, opts v1.UpdateOptions) (result *v1alpha1.HealthcareService, err error) {
	result = &v1alpha1.HealthcareService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("healthcareservices").
...
func (c *healthcareServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *healthcareServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *healthcareServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HealthcareService, err error) {
	result = &v1alpha1.HealthcareService{}
