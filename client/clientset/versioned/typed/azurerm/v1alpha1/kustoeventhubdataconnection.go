...
func (c *kustoEventhubDataConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KustoEventhubDataConnection, err error) {
...
func (c *kustoEventhubDataConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KustoEventhubDataConnectionList, err error) {
...
func (c *kustoEventhubDataConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kustoEventhubDataConnections) Create(ctx context.Context, kustoEventhubDataConnection *v1alpha1.KustoEventhubDataConnection, opts v1.CreateOptions) (result *v1alpha1.KustoEventhubDataConnection, err error) {
	result = &v1alpha1.KustoEventhubDataConnection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kustoeventhubdataconnections").
...
func (c *kustoEventhubDataConnections) Update(ctx context.Context, kustoEventhubDataConnection *v1alpha1.KustoEventhubDataConnection, opts v1.UpdateOptions) (result *v1alpha1.KustoEventhubDataConnection, err error) {
	result = &v1alpha1.KustoEventhubDataConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kustoeventhubdataconnections").
...
func (c *kustoEventhubDataConnections) UpdateStatus(ctx context.Context, kustoEventhubDataConnection *v1alpha1.KustoEventhubDataConnection, opts v1.UpdateOptions) (result *v1alpha1.KustoEventhubDataConnection, err error) {
	result = &v1alpha1.KustoEventhubDataConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kustoeventhubdataconnections").
...
func (c *kustoEventhubDataConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kustoEventhubDataConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kustoEventhubDataConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KustoEventhubDataConnection, err error) {
	result = &v1alpha1.KustoEventhubDataConnection{}
