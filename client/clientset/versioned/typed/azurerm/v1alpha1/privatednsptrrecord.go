...
func (c *privateDNSPtrRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PrivateDNSPtrRecord, err error) {
...
func (c *privateDNSPtrRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PrivateDNSPtrRecordList, err error) {
...
func (c *privateDNSPtrRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *privateDNSPtrRecords) Create(ctx context.Context, privateDNSPtrRecord *v1alpha1.PrivateDNSPtrRecord, opts v1.CreateOptions) (result *v1alpha1.PrivateDNSPtrRecord, err error) {
	result = &v1alpha1.PrivateDNSPtrRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("privatednsptrrecords").
...
func (c *privateDNSPtrRecords) Update(ctx context.Context, privateDNSPtrRecord *v1alpha1.PrivateDNSPtrRecord, opts v1.UpdateOptions) (result *v1alpha1.PrivateDNSPtrRecord, err error) {
	result = &v1alpha1.PrivateDNSPtrRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatednsptrrecords").
...
func (c *privateDNSPtrRecords) UpdateStatus(ctx context.Context, privateDNSPtrRecord *v1alpha1.PrivateDNSPtrRecord, opts v1.UpdateOptions) (result *v1alpha1.PrivateDNSPtrRecord, err error) {
	result = &v1alpha1.PrivateDNSPtrRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatednsptrrecords").
...
func (c *privateDNSPtrRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *privateDNSPtrRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *privateDNSPtrRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PrivateDNSPtrRecord, err error) {
	result = &v1alpha1.PrivateDNSPtrRecord{}
