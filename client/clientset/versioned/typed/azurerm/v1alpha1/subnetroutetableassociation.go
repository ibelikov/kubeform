...
func (c *subnetRouteTableAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SubnetRouteTableAssociation, err error) {
...
func (c *subnetRouteTableAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SubnetRouteTableAssociationList, err error) {
...
func (c *subnetRouteTableAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *subnetRouteTableAssociations) Create(ctx context.Context, subnetRouteTableAssociation *v1alpha1.SubnetRouteTableAssociation, opts v1.CreateOptions) (result *v1alpha1.SubnetRouteTableAssociation, err error) {
	result = &v1alpha1.SubnetRouteTableAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("subnetroutetableassociations").
...
func (c *subnetRouteTableAssociations) Update(ctx context.Context, subnetRouteTableAssociation *v1alpha1.SubnetRouteTableAssociation, opts v1.UpdateOptions) (result *v1alpha1.SubnetRouteTableAssociation, err error) {
	result = &v1alpha1.SubnetRouteTableAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subnetroutetableassociations").
...
func (c *subnetRouteTableAssociations) UpdateStatus(ctx context.Context, subnetRouteTableAssociation *v1alpha1.SubnetRouteTableAssociation, opts v1.UpdateOptions) (result *v1alpha1.SubnetRouteTableAssociation, err error) {
	result = &v1alpha1.SubnetRouteTableAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subnetroutetableassociations").
...
func (c *subnetRouteTableAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *subnetRouteTableAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *subnetRouteTableAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SubnetRouteTableAssociation, err error) {
	result = &v1alpha1.SubnetRouteTableAssociation{}
