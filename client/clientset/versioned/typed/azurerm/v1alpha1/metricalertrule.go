...
type MetricAlertruleInterface interface {
	Create(*v1alpha1.MetricAlertrule) (*v1alpha1.MetricAlertrule, error)
	Update(*v1alpha1.MetricAlertrule) (*v1alpha1.MetricAlertrule, error)
	UpdateStatus(*v1alpha1.MetricAlertrule) (*v1alpha1.MetricAlertrule, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MetricAlertrule, error)
	List(opts v1.ListOptions) (*v1alpha1.MetricAlertruleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MetricAlertrule, err error)
...
func (c *metricAlertrules) List(opts v1.ListOptions) (result *v1alpha1.MetricAlertruleList, err error) {
...
func (c *metricAlertrules) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *metricAlertrules) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
