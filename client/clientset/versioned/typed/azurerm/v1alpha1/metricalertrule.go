...
func (c *metricAlertrules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MetricAlertrule, err error) {
...
func (c *metricAlertrules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MetricAlertruleList, err error) {
...
func (c *metricAlertrules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *metricAlertrules) Create(ctx context.Context, metricAlertrule *v1alpha1.MetricAlertrule, opts v1.CreateOptions) (result *v1alpha1.MetricAlertrule, err error) {
	result = &v1alpha1.MetricAlertrule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("metricalertrules").
...
func (c *metricAlertrules) Update(ctx context.Context, metricAlertrule *v1alpha1.MetricAlertrule, opts v1.UpdateOptions) (result *v1alpha1.MetricAlertrule, err error) {
	result = &v1alpha1.MetricAlertrule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricalertrules").
...
func (c *metricAlertrules) UpdateStatus(ctx context.Context, metricAlertrule *v1alpha1.MetricAlertrule, opts v1.UpdateOptions) (result *v1alpha1.MetricAlertrule, err error) {
	result = &v1alpha1.MetricAlertrule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricalertrules").
...
func (c *metricAlertrules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *metricAlertrules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *metricAlertrules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MetricAlertrule, err error) {
	result = &v1alpha1.MetricAlertrule{}
