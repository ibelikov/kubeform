...
func (c *azureadApplications) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AzureadApplication, err error) {
...
func (c *azureadApplications) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AzureadApplicationList, err error) {
...
func (c *azureadApplications) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *azureadApplications) Create(ctx context.Context, azureadApplication *v1alpha1.AzureadApplication, opts v1.CreateOptions) (result *v1alpha1.AzureadApplication, err error) {
	result = &v1alpha1.AzureadApplication{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("azureadapplications").
...
func (c *azureadApplications) Update(ctx context.Context, azureadApplication *v1alpha1.AzureadApplication, opts v1.UpdateOptions) (result *v1alpha1.AzureadApplication, err error) {
	result = &v1alpha1.AzureadApplication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureadapplications").
...
func (c *azureadApplications) UpdateStatus(ctx context.Context, azureadApplication *v1alpha1.AzureadApplication, opts v1.UpdateOptions) (result *v1alpha1.AzureadApplication, err error) {
	result = &v1alpha1.AzureadApplication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureadapplications").
...
func (c *azureadApplications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *azureadApplications) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *azureadApplications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AzureadApplication, err error) {
	result = &v1alpha1.AzureadApplication{}
