...
func (c *netappPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetappPool, err error) {
...
func (c *netappPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetappPoolList, err error) {
...
func (c *netappPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *netappPools) Create(ctx context.Context, netappPool *v1alpha1.NetappPool, opts v1.CreateOptions) (result *v1alpha1.NetappPool, err error) {
	result = &v1alpha1.NetappPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("netapppools").
...
func (c *netappPools) Update(ctx context.Context, netappPool *v1alpha1.NetappPool, opts v1.UpdateOptions) (result *v1alpha1.NetappPool, err error) {
	result = &v1alpha1.NetappPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("netapppools").
...
func (c *netappPools) UpdateStatus(ctx context.Context, netappPool *v1alpha1.NetappPool, opts v1.UpdateOptions) (result *v1alpha1.NetappPool, err error) {
	result = &v1alpha1.NetappPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("netapppools").
...
func (c *netappPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *netappPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *netappPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetappPool, err error) {
	result = &v1alpha1.NetappPool{}
