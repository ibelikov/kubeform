...
type AzureadServicePrincipalPasswordInterface interface {
	Create(*v1alpha1.AzureadServicePrincipalPassword) (*v1alpha1.AzureadServicePrincipalPassword, error)
	Update(*v1alpha1.AzureadServicePrincipalPassword) (*v1alpha1.AzureadServicePrincipalPassword, error)
	UpdateStatus(*v1alpha1.AzureadServicePrincipalPassword) (*v1alpha1.AzureadServicePrincipalPassword, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.AzureadServicePrincipalPassword, error)
	List(opts v1.ListOptions) (*v1alpha1.AzureadServicePrincipalPasswordList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AzureadServicePrincipalPassword, err error)
...
func (c *azureadServicePrincipalPasswords) List(opts v1.ListOptions) (result *v1alpha1.AzureadServicePrincipalPasswordList, err error) {
...
func (c *azureadServicePrincipalPasswords) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *azureadServicePrincipalPasswords) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
