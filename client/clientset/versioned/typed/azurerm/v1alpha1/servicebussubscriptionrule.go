...
func (c *servicebusSubscriptionRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicebusSubscriptionRule, err error) {
...
func (c *servicebusSubscriptionRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicebusSubscriptionRuleList, err error) {
...
func (c *servicebusSubscriptionRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicebusSubscriptionRules) Create(ctx context.Context, servicebusSubscriptionRule *v1alpha1.ServicebusSubscriptionRule, opts v1.CreateOptions) (result *v1alpha1.ServicebusSubscriptionRule, err error) {
	result = &v1alpha1.ServicebusSubscriptionRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicebussubscriptionrules").
...
func (c *servicebusSubscriptionRules) Update(ctx context.Context, servicebusSubscriptionRule *v1alpha1.ServicebusSubscriptionRule, opts v1.UpdateOptions) (result *v1alpha1.ServicebusSubscriptionRule, err error) {
	result = &v1alpha1.ServicebusSubscriptionRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebussubscriptionrules").
...
func (c *servicebusSubscriptionRules) UpdateStatus(ctx context.Context, servicebusSubscriptionRule *v1alpha1.ServicebusSubscriptionRule, opts v1.UpdateOptions) (result *v1alpha1.ServicebusSubscriptionRule, err error) {
	result = &v1alpha1.ServicebusSubscriptionRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebussubscriptionrules").
...
func (c *servicebusSubscriptionRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicebusSubscriptionRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicebusSubscriptionRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicebusSubscriptionRule, err error) {
	result = &v1alpha1.ServicebusSubscriptionRule{}
