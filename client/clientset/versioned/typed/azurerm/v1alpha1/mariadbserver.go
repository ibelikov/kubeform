...
func (c *mariadbServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MariadbServer, err error) {
...
func (c *mariadbServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MariadbServerList, err error) {
...
func (c *mariadbServers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mariadbServers) Create(ctx context.Context, mariadbServer *v1alpha1.MariadbServer, opts v1.CreateOptions) (result *v1alpha1.MariadbServer, err error) {
	result = &v1alpha1.MariadbServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mariadbservers").
...
func (c *mariadbServers) Update(ctx context.Context, mariadbServer *v1alpha1.MariadbServer, opts v1.UpdateOptions) (result *v1alpha1.MariadbServer, err error) {
	result = &v1alpha1.MariadbServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mariadbservers").
...
func (c *mariadbServers) UpdateStatus(ctx context.Context, mariadbServer *v1alpha1.MariadbServer, opts v1.UpdateOptions) (result *v1alpha1.MariadbServer, err error) {
	result = &v1alpha1.MariadbServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mariadbservers").
...
func (c *mariadbServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mariadbServers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mariadbServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MariadbServer, err error) {
	result = &v1alpha1.MariadbServer{}
