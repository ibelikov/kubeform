...
type FirewallApplicationRuleCollectionInterface interface {
	Create(*v1alpha1.FirewallApplicationRuleCollection) (*v1alpha1.FirewallApplicationRuleCollection, error)
	Update(*v1alpha1.FirewallApplicationRuleCollection) (*v1alpha1.FirewallApplicationRuleCollection, error)
	UpdateStatus(*v1alpha1.FirewallApplicationRuleCollection) (*v1alpha1.FirewallApplicationRuleCollection, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.FirewallApplicationRuleCollection, error)
	List(opts v1.ListOptions) (*v1alpha1.FirewallApplicationRuleCollectionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FirewallApplicationRuleCollection, err error)
...
func (c *firewallApplicationRuleCollections) List(opts v1.ListOptions) (result *v1alpha1.FirewallApplicationRuleCollectionList, err error) {
...
func (c *firewallApplicationRuleCollections) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *firewallApplicationRuleCollections) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
