...
func (c *automationRunbooks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutomationRunbook, err error) {
...
func (c *automationRunbooks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutomationRunbookList, err error) {
...
func (c *automationRunbooks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *automationRunbooks) Create(ctx context.Context, automationRunbook *v1alpha1.AutomationRunbook, opts v1.CreateOptions) (result *v1alpha1.AutomationRunbook, err error) {
	result = &v1alpha1.AutomationRunbook{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("automationrunbooks").
...
func (c *automationRunbooks) Update(ctx context.Context, automationRunbook *v1alpha1.AutomationRunbook, opts v1.UpdateOptions) (result *v1alpha1.AutomationRunbook, err error) {
	result = &v1alpha1.AutomationRunbook{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationrunbooks").
...
func (c *automationRunbooks) UpdateStatus(ctx context.Context, automationRunbook *v1alpha1.AutomationRunbook, opts v1.UpdateOptions) (result *v1alpha1.AutomationRunbook, err error) {
	result = &v1alpha1.AutomationRunbook{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationrunbooks").
...
func (c *automationRunbooks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *automationRunbooks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *automationRunbooks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutomationRunbook, err error) {
	result = &v1alpha1.AutomationRunbook{}
