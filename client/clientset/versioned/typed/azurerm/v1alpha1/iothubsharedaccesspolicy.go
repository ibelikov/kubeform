...
type IothubSharedAccessPolicyInterface interface {
	Create(*v1alpha1.IothubSharedAccessPolicy) (*v1alpha1.IothubSharedAccessPolicy, error)
	Update(*v1alpha1.IothubSharedAccessPolicy) (*v1alpha1.IothubSharedAccessPolicy, error)
	UpdateStatus(*v1alpha1.IothubSharedAccessPolicy) (*v1alpha1.IothubSharedAccessPolicy, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.IothubSharedAccessPolicy, error)
	List(opts v1.ListOptions) (*v1alpha1.IothubSharedAccessPolicyList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IothubSharedAccessPolicy, err error)
...
func (c *iothubSharedAccessPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.IothubSharedAccessPolicy, err error) {
...
func (c *iothubSharedAccessPolicies) List(opts v1.ListOptions) (result *v1alpha1.IothubSharedAccessPolicyList, err error) {
...
func (c *iothubSharedAccessPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iothubSharedAccessPolicies) Create(iothubSharedAccessPolicy *v1alpha1.IothubSharedAccessPolicy) (result *v1alpha1.IothubSharedAccessPolicy, err error) {
	result = &v1alpha1.IothubSharedAccessPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iothubsharedaccesspolicies").
...
func (c *iothubSharedAccessPolicies) Update(iothubSharedAccessPolicy *v1alpha1.IothubSharedAccessPolicy) (result *v1alpha1.IothubSharedAccessPolicy, err error) {
	result = &v1alpha1.IothubSharedAccessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iothubsharedaccesspolicies").
...
func (c *iothubSharedAccessPolicies) UpdateStatus(iothubSharedAccessPolicy *v1alpha1.IothubSharedAccessPolicy) (result *v1alpha1.IothubSharedAccessPolicy, err error) {
	result = &v1alpha1.IothubSharedAccessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iothubsharedaccesspolicies").
...
func (c *iothubSharedAccessPolicies) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *iothubSharedAccessPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iothubSharedAccessPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IothubSharedAccessPolicy, err error) {
	result = &v1alpha1.IothubSharedAccessPolicy{}
