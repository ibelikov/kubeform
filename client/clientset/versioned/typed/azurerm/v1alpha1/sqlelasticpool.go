...
func (c *sqlElasticpools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlElasticpool, err error) {
...
func (c *sqlElasticpools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlElasticpoolList, err error) {
...
func (c *sqlElasticpools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlElasticpools) Create(ctx context.Context, sqlElasticpool *v1alpha1.SqlElasticpool, opts v1.CreateOptions) (result *v1alpha1.SqlElasticpool, err error) {
	result = &v1alpha1.SqlElasticpool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqlelasticpools").
...
func (c *sqlElasticpools) Update(ctx context.Context, sqlElasticpool *v1alpha1.SqlElasticpool, opts v1.UpdateOptions) (result *v1alpha1.SqlElasticpool, err error) {
	result = &v1alpha1.SqlElasticpool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlelasticpools").
...
func (c *sqlElasticpools) UpdateStatus(ctx context.Context, sqlElasticpool *v1alpha1.SqlElasticpool, opts v1.UpdateOptions) (result *v1alpha1.SqlElasticpool, err error) {
	result = &v1alpha1.SqlElasticpool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlelasticpools").
...
func (c *sqlElasticpools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlElasticpools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlElasticpools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlElasticpool, err error) {
	result = &v1alpha1.SqlElasticpool{}
