...
func (c *cosmosdbSQLContainers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CosmosdbSQLContainer, err error) {
...
func (c *cosmosdbSQLContainers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CosmosdbSQLContainerList, err error) {
...
func (c *cosmosdbSQLContainers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cosmosdbSQLContainers) Create(ctx context.Context, cosmosdbSQLContainer *v1alpha1.CosmosdbSQLContainer, opts v1.CreateOptions) (result *v1alpha1.CosmosdbSQLContainer, err error) {
	result = &v1alpha1.CosmosdbSQLContainer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cosmosdbsqlcontainers").
...
func (c *cosmosdbSQLContainers) Update(ctx context.Context, cosmosdbSQLContainer *v1alpha1.CosmosdbSQLContainer, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbSQLContainer, err error) {
	result = &v1alpha1.CosmosdbSQLContainer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbsqlcontainers").
...
func (c *cosmosdbSQLContainers) UpdateStatus(ctx context.Context, cosmosdbSQLContainer *v1alpha1.CosmosdbSQLContainer, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbSQLContainer, err error) {
	result = &v1alpha1.CosmosdbSQLContainer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbsqlcontainers").
...
func (c *cosmosdbSQLContainers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cosmosdbSQLContainers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cosmosdbSQLContainers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CosmosdbSQLContainer, err error) {
	result = &v1alpha1.CosmosdbSQLContainer{}
