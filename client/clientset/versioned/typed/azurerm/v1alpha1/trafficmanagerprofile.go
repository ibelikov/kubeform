...
func (c *trafficManagerProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TrafficManagerProfile, err error) {
...
func (c *trafficManagerProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TrafficManagerProfileList, err error) {
...
func (c *trafficManagerProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *trafficManagerProfiles) Create(ctx context.Context, trafficManagerProfile *v1alpha1.TrafficManagerProfile, opts v1.CreateOptions) (result *v1alpha1.TrafficManagerProfile, err error) {
	result = &v1alpha1.TrafficManagerProfile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("trafficmanagerprofiles").
...
func (c *trafficManagerProfiles) Update(ctx context.Context, trafficManagerProfile *v1alpha1.TrafficManagerProfile, opts v1.UpdateOptions) (result *v1alpha1.TrafficManagerProfile, err error) {
	result = &v1alpha1.TrafficManagerProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trafficmanagerprofiles").
...
func (c *trafficManagerProfiles) UpdateStatus(ctx context.Context, trafficManagerProfile *v1alpha1.TrafficManagerProfile, opts v1.UpdateOptions) (result *v1alpha1.TrafficManagerProfile, err error) {
	result = &v1alpha1.TrafficManagerProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trafficmanagerprofiles").
...
func (c *trafficManagerProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *trafficManagerProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *trafficManagerProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TrafficManagerProfile, err error) {
	result = &v1alpha1.TrafficManagerProfile{}
