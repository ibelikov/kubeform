...
type StreamAnalyticsOutputMssqlInterface interface {
	Create(*v1alpha1.StreamAnalyticsOutputMssql) (*v1alpha1.StreamAnalyticsOutputMssql, error)
	Update(*v1alpha1.StreamAnalyticsOutputMssql) (*v1alpha1.StreamAnalyticsOutputMssql, error)
	UpdateStatus(*v1alpha1.StreamAnalyticsOutputMssql) (*v1alpha1.StreamAnalyticsOutputMssql, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.StreamAnalyticsOutputMssql, error)
	List(opts v1.ListOptions) (*v1alpha1.StreamAnalyticsOutputMssqlList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StreamAnalyticsOutputMssql, err error)
...
func (c *streamAnalyticsOutputMssqls) List(opts v1.ListOptions) (result *v1alpha1.StreamAnalyticsOutputMssqlList, err error) {
...
func (c *streamAnalyticsOutputMssqls) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *streamAnalyticsOutputMssqls) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
