...
func (c *cosmosdbSQLDatabases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CosmosdbSQLDatabase, err error) {
...
func (c *cosmosdbSQLDatabases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CosmosdbSQLDatabaseList, err error) {
...
func (c *cosmosdbSQLDatabases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cosmosdbSQLDatabases) Create(ctx context.Context, cosmosdbSQLDatabase *v1alpha1.CosmosdbSQLDatabase, opts v1.CreateOptions) (result *v1alpha1.CosmosdbSQLDatabase, err error) {
	result = &v1alpha1.CosmosdbSQLDatabase{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cosmosdbsqldatabases").
...
func (c *cosmosdbSQLDatabases) Update(ctx context.Context, cosmosdbSQLDatabase *v1alpha1.CosmosdbSQLDatabase, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbSQLDatabase, err error) {
	result = &v1alpha1.CosmosdbSQLDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbsqldatabases").
...
func (c *cosmosdbSQLDatabases) UpdateStatus(ctx context.Context, cosmosdbSQLDatabase *v1alpha1.CosmosdbSQLDatabase, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbSQLDatabase, err error) {
	result = &v1alpha1.CosmosdbSQLDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbsqldatabases").
...
func (c *cosmosdbSQLDatabases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cosmosdbSQLDatabases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cosmosdbSQLDatabases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CosmosdbSQLDatabase, err error) {
	result = &v1alpha1.CosmosdbSQLDatabase{}
