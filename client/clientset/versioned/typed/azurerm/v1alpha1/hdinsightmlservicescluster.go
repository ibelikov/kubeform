...
func (c *hdinsightMlServicesClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HdinsightMlServicesCluster, err error) {
...
func (c *hdinsightMlServicesClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HdinsightMlServicesClusterList, err error) {
...
func (c *hdinsightMlServicesClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hdinsightMlServicesClusters) Create(ctx context.Context, hdinsightMlServicesCluster *v1alpha1.HdinsightMlServicesCluster, opts v1.CreateOptions) (result *v1alpha1.HdinsightMlServicesCluster, err error) {
	result = &v1alpha1.HdinsightMlServicesCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hdinsightmlservicesclusters").
...
func (c *hdinsightMlServicesClusters) Update(ctx context.Context, hdinsightMlServicesCluster *v1alpha1.HdinsightMlServicesCluster, opts v1.UpdateOptions) (result *v1alpha1.HdinsightMlServicesCluster, err error) {
	result = &v1alpha1.HdinsightMlServicesCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hdinsightmlservicesclusters").
...
func (c *hdinsightMlServicesClusters) UpdateStatus(ctx context.Context, hdinsightMlServicesCluster *v1alpha1.HdinsightMlServicesCluster, opts v1.UpdateOptions) (result *v1alpha1.HdinsightMlServicesCluster, err error) {
	result = &v1alpha1.HdinsightMlServicesCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hdinsightmlservicesclusters").
...
func (c *hdinsightMlServicesClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hdinsightMlServicesClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hdinsightMlServicesClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HdinsightMlServicesCluster, err error) {
	result = &v1alpha1.HdinsightMlServicesCluster{}
