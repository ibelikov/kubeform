...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation, err error) {
...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationList, err error) {
...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) Create(ctx context.Context, networkInterfaceApplicationGatewayBackendAddressPoolAssociation *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation, opts v1.CreateOptions) (result *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation, err error) {
	result = &v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkinterfaceapplicationgatewaybackendaddresspoolassociations").
...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) Update(ctx context.Context, networkInterfaceApplicationGatewayBackendAddressPoolAssociation *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation, opts v1.UpdateOptions) (result *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation, err error) {
	result = &v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkinterfaceapplicationgatewaybackendaddresspoolassociations").
...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) UpdateStatus(ctx context.Context, networkInterfaceApplicationGatewayBackendAddressPoolAssociation *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation, opts v1.UpdateOptions) (result *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation, err error) {
	result = &v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkinterfaceapplicationgatewaybackendaddresspoolassociations").
...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkInterfaceApplicationGatewayBackendAddressPoolAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation, err error) {
	result = &v1alpha1.NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation{}
