...
func (c *botChannelEmails) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BotChannelEmail, err error) {
...
func (c *botChannelEmails) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BotChannelEmailList, err error) {
...
func (c *botChannelEmails) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *botChannelEmails) Create(ctx context.Context, botChannelEmail *v1alpha1.BotChannelEmail, opts v1.CreateOptions) (result *v1alpha1.BotChannelEmail, err error) {
	result = &v1alpha1.BotChannelEmail{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("botchannelemails").
...
func (c *botChannelEmails) Update(ctx context.Context, botChannelEmail *v1alpha1.BotChannelEmail, opts v1.UpdateOptions) (result *v1alpha1.BotChannelEmail, err error) {
	result = &v1alpha1.BotChannelEmail{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("botchannelemails").
...
func (c *botChannelEmails) UpdateStatus(ctx context.Context, botChannelEmail *v1alpha1.BotChannelEmail, opts v1.UpdateOptions) (result *v1alpha1.BotChannelEmail, err error) {
	result = &v1alpha1.BotChannelEmail{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("botchannelemails").
...
func (c *botChannelEmails) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *botChannelEmails) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *botChannelEmails) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BotChannelEmail, err error) {
	result = &v1alpha1.BotChannelEmail{}
