...
func (c *postgresqlDatabases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PostgresqlDatabase, err error) {
...
func (c *postgresqlDatabases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PostgresqlDatabaseList, err error) {
...
func (c *postgresqlDatabases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *postgresqlDatabases) Create(ctx context.Context, postgresqlDatabase *v1alpha1.PostgresqlDatabase, opts v1.CreateOptions) (result *v1alpha1.PostgresqlDatabase, err error) {
	result = &v1alpha1.PostgresqlDatabase{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("postgresqldatabases").
...
func (c *postgresqlDatabases) Update(ctx context.Context, postgresqlDatabase *v1alpha1.PostgresqlDatabase, opts v1.UpdateOptions) (result *v1alpha1.PostgresqlDatabase, err error) {
	result = &v1alpha1.PostgresqlDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("postgresqldatabases").
...
func (c *postgresqlDatabases) UpdateStatus(ctx context.Context, postgresqlDatabase *v1alpha1.PostgresqlDatabase, opts v1.UpdateOptions) (result *v1alpha1.PostgresqlDatabase, err error) {
	result = &v1alpha1.PostgresqlDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("postgresqldatabases").
...
func (c *postgresqlDatabases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *postgresqlDatabases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *postgresqlDatabases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PostgresqlDatabase, err error) {
	result = &v1alpha1.PostgresqlDatabase{}
