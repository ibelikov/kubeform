...
func (c *monitorMetricAlertrules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonitorMetricAlertrule, err error) {
...
func (c *monitorMetricAlertrules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonitorMetricAlertruleList, err error) {
...
func (c *monitorMetricAlertrules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitorMetricAlertrules) Create(ctx context.Context, monitorMetricAlertrule *v1alpha1.MonitorMetricAlertrule, opts v1.CreateOptions) (result *v1alpha1.MonitorMetricAlertrule, err error) {
	result = &v1alpha1.MonitorMetricAlertrule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitormetricalertrules").
...
func (c *monitorMetricAlertrules) Update(ctx context.Context, monitorMetricAlertrule *v1alpha1.MonitorMetricAlertrule, opts v1.UpdateOptions) (result *v1alpha1.MonitorMetricAlertrule, err error) {
	result = &v1alpha1.MonitorMetricAlertrule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitormetricalertrules").
...
func (c *monitorMetricAlertrules) UpdateStatus(ctx context.Context, monitorMetricAlertrule *v1alpha1.MonitorMetricAlertrule, opts v1.UpdateOptions) (result *v1alpha1.MonitorMetricAlertrule, err error) {
	result = &v1alpha1.MonitorMetricAlertrule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitormetricalertrules").
...
func (c *monitorMetricAlertrules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monitorMetricAlertrules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monitorMetricAlertrules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MonitorMetricAlertrule, err error) {
	result = &v1alpha1.MonitorMetricAlertrule{}
