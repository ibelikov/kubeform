...
func (c *databricksWorkspaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabricksWorkspace, err error) {
...
func (c *databricksWorkspaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabricksWorkspaceList, err error) {
...
func (c *databricksWorkspaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databricksWorkspaces) Create(ctx context.Context, databricksWorkspace *v1alpha1.DatabricksWorkspace, opts v1.CreateOptions) (result *v1alpha1.DatabricksWorkspace, err error) {
	result = &v1alpha1.DatabricksWorkspace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("databricksworkspaces").
...
func (c *databricksWorkspaces) Update(ctx context.Context, databricksWorkspace *v1alpha1.DatabricksWorkspace, opts v1.UpdateOptions) (result *v1alpha1.DatabricksWorkspace, err error) {
	result = &v1alpha1.DatabricksWorkspace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databricksworkspaces").
...
func (c *databricksWorkspaces) UpdateStatus(ctx context.Context, databricksWorkspace *v1alpha1.DatabricksWorkspace, opts v1.UpdateOptions) (result *v1alpha1.DatabricksWorkspace, err error) {
	result = &v1alpha1.DatabricksWorkspace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databricksworkspaces").
...
func (c *databricksWorkspaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *databricksWorkspaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *databricksWorkspaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabricksWorkspace, err error) {
	result = &v1alpha1.DatabricksWorkspace{}
