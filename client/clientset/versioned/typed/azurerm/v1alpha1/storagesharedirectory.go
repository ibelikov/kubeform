...
func (c *storageShareDirectories) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageShareDirectory, err error) {
...
func (c *storageShareDirectories) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageShareDirectoryList, err error) {
...
func (c *storageShareDirectories) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageShareDirectories) Create(ctx context.Context, storageShareDirectory *v1alpha1.StorageShareDirectory, opts v1.CreateOptions) (result *v1alpha1.StorageShareDirectory, err error) {
	result = &v1alpha1.StorageShareDirectory{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagesharedirectories").
...
func (c *storageShareDirectories) Update(ctx context.Context, storageShareDirectory *v1alpha1.StorageShareDirectory, opts v1.UpdateOptions) (result *v1alpha1.StorageShareDirectory, err error) {
	result = &v1alpha1.StorageShareDirectory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagesharedirectories").
...
func (c *storageShareDirectories) UpdateStatus(ctx context.Context, storageShareDirectory *v1alpha1.StorageShareDirectory, opts v1.UpdateOptions) (result *v1alpha1.StorageShareDirectory, err error) {
	result = &v1alpha1.StorageShareDirectory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagesharedirectories").
...
func (c *storageShareDirectories) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageShareDirectories) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageShareDirectories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageShareDirectory, err error) {
	result = &v1alpha1.StorageShareDirectory{}
