...
func newServicebusQueues(c *AzurermV1alpha1Client, namespace string) *servicebusQueues {
...
func (c *servicebusQueues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicebusQueue, err error) {
...
func (c *servicebusQueues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicebusQueueList, err error) {
...
func (c *servicebusQueues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicebusQueues) Create(ctx context.Context, servicebusQueue *v1alpha1.ServicebusQueue, opts v1.CreateOptions) (result *v1alpha1.ServicebusQueue, err error) {
	result = &v1alpha1.ServicebusQueue{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicebusqueues").
...
func (c *servicebusQueues) Update(ctx context.Context, servicebusQueue *v1alpha1.ServicebusQueue, opts v1.UpdateOptions) (result *v1alpha1.ServicebusQueue, err error) {
	result = &v1alpha1.ServicebusQueue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebusqueues").
...
func (c *servicebusQueues) UpdateStatus(ctx context.Context, servicebusQueue *v1alpha1.ServicebusQueue, opts v1.UpdateOptions) (result *v1alpha1.ServicebusQueue, err error) {
	result = &v1alpha1.ServicebusQueue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebusqueues").
...
func (c *servicebusQueues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicebusQueues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicebusQueues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicebusQueue, err error) {
	result = &v1alpha1.ServicebusQueue{}
