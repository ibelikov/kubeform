...
func (c *dnsCaaRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DnsCaaRecord, err error) {
...
func (c *dnsCaaRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DnsCaaRecordList, err error) {
...
func (c *dnsCaaRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dnsCaaRecords) Create(ctx context.Context, dnsCaaRecord *v1alpha1.DnsCaaRecord, opts v1.CreateOptions) (result *v1alpha1.DnsCaaRecord, err error) {
	result = &v1alpha1.DnsCaaRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnscaarecords").
...
func (c *dnsCaaRecords) Update(ctx context.Context, dnsCaaRecord *v1alpha1.DnsCaaRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsCaaRecord, err error) {
	result = &v1alpha1.DnsCaaRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnscaarecords").
...
func (c *dnsCaaRecords) UpdateStatus(ctx context.Context, dnsCaaRecord *v1alpha1.DnsCaaRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsCaaRecord, err error) {
	result = &v1alpha1.DnsCaaRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnscaarecords").
...
func (c *dnsCaaRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dnsCaaRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dnsCaaRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DnsCaaRecord, err error) {
	result = &v1alpha1.DnsCaaRecord{}
