...
func (c *iothubFallbackRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IothubFallbackRoute, err error) {
...
func (c *iothubFallbackRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IothubFallbackRouteList, err error) {
...
func (c *iothubFallbackRoutes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iothubFallbackRoutes) Create(ctx context.Context, iothubFallbackRoute *v1alpha1.IothubFallbackRoute, opts v1.CreateOptions) (result *v1alpha1.IothubFallbackRoute, err error) {
	result = &v1alpha1.IothubFallbackRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iothubfallbackroutes").
...
func (c *iothubFallbackRoutes) Update(ctx context.Context, iothubFallbackRoute *v1alpha1.IothubFallbackRoute, opts v1.UpdateOptions) (result *v1alpha1.IothubFallbackRoute, err error) {
	result = &v1alpha1.IothubFallbackRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iothubfallbackroutes").
...
func (c *iothubFallbackRoutes) UpdateStatus(ctx context.Context, iothubFallbackRoute *v1alpha1.IothubFallbackRoute, opts v1.UpdateOptions) (result *v1alpha1.IothubFallbackRoute, err error) {
	result = &v1alpha1.IothubFallbackRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iothubfallbackroutes").
...
func (c *iothubFallbackRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iothubFallbackRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iothubFallbackRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IothubFallbackRoute, err error) {
	result = &v1alpha1.IothubFallbackRoute{}
