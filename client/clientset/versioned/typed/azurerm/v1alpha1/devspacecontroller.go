...
type DevspaceControllerInterface interface {
	Create(*v1alpha1.DevspaceController) (*v1alpha1.DevspaceController, error)
	Update(*v1alpha1.DevspaceController) (*v1alpha1.DevspaceController, error)
	UpdateStatus(*v1alpha1.DevspaceController) (*v1alpha1.DevspaceController, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DevspaceController, error)
	List(opts v1.ListOptions) (*v1alpha1.DevspaceControllerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DevspaceController, err error)
...
func (c *devspaceControllers) List(opts v1.ListOptions) (result *v1alpha1.DevspaceControllerList, err error) {
...
func (c *devspaceControllers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *devspaceControllers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
