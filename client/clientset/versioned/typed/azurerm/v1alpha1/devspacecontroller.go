...
func (c *devspaceControllers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DevspaceController, err error) {
...
func (c *devspaceControllers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DevspaceControllerList, err error) {
...
func (c *devspaceControllers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *devspaceControllers) Create(ctx context.Context, devspaceController *v1alpha1.DevspaceController, opts v1.CreateOptions) (result *v1alpha1.DevspaceController, err error) {
	result = &v1alpha1.DevspaceController{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("devspacecontrollers").
...
func (c *devspaceControllers) Update(ctx context.Context, devspaceController *v1alpha1.DevspaceController, opts v1.UpdateOptions) (result *v1alpha1.DevspaceController, err error) {
	result = &v1alpha1.DevspaceController{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devspacecontrollers").
...
func (c *devspaceControllers) UpdateStatus(ctx context.Context, devspaceController *v1alpha1.DevspaceController, opts v1.UpdateOptions) (result *v1alpha1.DevspaceController, err error) {
	result = &v1alpha1.DevspaceController{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devspacecontrollers").
...
func (c *devspaceControllers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *devspaceControllers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *devspaceControllers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DevspaceController, err error) {
	result = &v1alpha1.DevspaceController{}
