...
type ApiManagementProductGroupInterface interface {
	Create(*v1alpha1.ApiManagementProductGroup) (*v1alpha1.ApiManagementProductGroup, error)
	Update(*v1alpha1.ApiManagementProductGroup) (*v1alpha1.ApiManagementProductGroup, error)
	UpdateStatus(*v1alpha1.ApiManagementProductGroup) (*v1alpha1.ApiManagementProductGroup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ApiManagementProductGroup, error)
	List(opts v1.ListOptions) (*v1alpha1.ApiManagementProductGroupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiManagementProductGroup, err error)
...
func (c *apiManagementProductGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.ApiManagementProductGroup, err error) {
...
func (c *apiManagementProductGroups) List(opts v1.ListOptions) (result *v1alpha1.ApiManagementProductGroupList, err error) {
...
func (c *apiManagementProductGroups) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiManagementProductGroups) Create(apiManagementProductGroup *v1alpha1.ApiManagementProductGroup) (result *v1alpha1.ApiManagementProductGroup, err error) {
	result = &v1alpha1.ApiManagementProductGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apimanagementproductgroups").
...
func (c *apiManagementProductGroups) Update(apiManagementProductGroup *v1alpha1.ApiManagementProductGroup) (result *v1alpha1.ApiManagementProductGroup, err error) {
	result = &v1alpha1.ApiManagementProductGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementproductgroups").
...
func (c *apiManagementProductGroups) UpdateStatus(apiManagementProductGroup *v1alpha1.ApiManagementProductGroup) (result *v1alpha1.ApiManagementProductGroup, err error) {
	result = &v1alpha1.ApiManagementProductGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementproductgroups").
...
func (c *apiManagementProductGroups) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *apiManagementProductGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiManagementProductGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiManagementProductGroup, err error) {
	result = &v1alpha1.ApiManagementProductGroup{}
