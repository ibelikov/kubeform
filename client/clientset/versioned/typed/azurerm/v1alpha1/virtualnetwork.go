...
type VirtualNetworkInterface interface {
	Create(*v1alpha1.VirtualNetwork) (*v1alpha1.VirtualNetwork, error)
	Update(*v1alpha1.VirtualNetwork) (*v1alpha1.VirtualNetwork, error)
	UpdateStatus(*v1alpha1.VirtualNetwork) (*v1alpha1.VirtualNetwork, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.VirtualNetwork, error)
	List(opts v1.ListOptions) (*v1alpha1.VirtualNetworkList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VirtualNetwork, err error)
...
func (c *virtualNetworks) List(opts v1.ListOptions) (result *v1alpha1.VirtualNetworkList, err error) {
...
func (c *virtualNetworks) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *virtualNetworks) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
