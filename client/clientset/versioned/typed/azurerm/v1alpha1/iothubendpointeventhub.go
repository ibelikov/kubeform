...
func (c *iothubEndpointEventhubs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IothubEndpointEventhub, err error) {
...
func (c *iothubEndpointEventhubs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IothubEndpointEventhubList, err error) {
...
func (c *iothubEndpointEventhubs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iothubEndpointEventhubs) Create(ctx context.Context, iothubEndpointEventhub *v1alpha1.IothubEndpointEventhub, opts v1.CreateOptions) (result *v1alpha1.IothubEndpointEventhub, err error) {
	result = &v1alpha1.IothubEndpointEventhub{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iothubendpointeventhubs").
...
func (c *iothubEndpointEventhubs) Update(ctx context.Context, iothubEndpointEventhub *v1alpha1.IothubEndpointEventhub, opts v1.UpdateOptions) (result *v1alpha1.IothubEndpointEventhub, err error) {
	result = &v1alpha1.IothubEndpointEventhub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iothubendpointeventhubs").
...
func (c *iothubEndpointEventhubs) UpdateStatus(ctx context.Context, iothubEndpointEventhub *v1alpha1.IothubEndpointEventhub, opts v1.UpdateOptions) (result *v1alpha1.IothubEndpointEventhub, err error) {
	result = &v1alpha1.IothubEndpointEventhub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iothubendpointeventhubs").
...
func (c *iothubEndpointEventhubs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iothubEndpointEventhubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iothubEndpointEventhubs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IothubEndpointEventhub, err error) {
	result = &v1alpha1.IothubEndpointEventhub{}
