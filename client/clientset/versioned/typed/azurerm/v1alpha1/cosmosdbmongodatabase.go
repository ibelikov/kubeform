...
func (c *cosmosdbMongoDatabases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CosmosdbMongoDatabase, err error) {
...
func (c *cosmosdbMongoDatabases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CosmosdbMongoDatabaseList, err error) {
...
func (c *cosmosdbMongoDatabases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cosmosdbMongoDatabases) Create(ctx context.Context, cosmosdbMongoDatabase *v1alpha1.CosmosdbMongoDatabase, opts v1.CreateOptions) (result *v1alpha1.CosmosdbMongoDatabase, err error) {
	result = &v1alpha1.CosmosdbMongoDatabase{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cosmosdbmongodatabases").
...
func (c *cosmosdbMongoDatabases) Update(ctx context.Context, cosmosdbMongoDatabase *v1alpha1.CosmosdbMongoDatabase, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbMongoDatabase, err error) {
	result = &v1alpha1.CosmosdbMongoDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbmongodatabases").
...
func (c *cosmosdbMongoDatabases) UpdateStatus(ctx context.Context, cosmosdbMongoDatabase *v1alpha1.CosmosdbMongoDatabase, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbMongoDatabase, err error) {
	result = &v1alpha1.CosmosdbMongoDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbmongodatabases").
...
func (c *cosmosdbMongoDatabases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cosmosdbMongoDatabases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cosmosdbMongoDatabases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CosmosdbMongoDatabase, err error) {
	result = &v1alpha1.CosmosdbMongoDatabase{}
