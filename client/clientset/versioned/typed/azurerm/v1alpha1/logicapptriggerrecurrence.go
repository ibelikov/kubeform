...
type LogicAppTriggerRecurrenceInterface interface {
	Create(*v1alpha1.LogicAppTriggerRecurrence) (*v1alpha1.LogicAppTriggerRecurrence, error)
	Update(*v1alpha1.LogicAppTriggerRecurrence) (*v1alpha1.LogicAppTriggerRecurrence, error)
	UpdateStatus(*v1alpha1.LogicAppTriggerRecurrence) (*v1alpha1.LogicAppTriggerRecurrence, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.LogicAppTriggerRecurrence, error)
	List(opts v1.ListOptions) (*v1alpha1.LogicAppTriggerRecurrenceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.LogicAppTriggerRecurrence, err error)
...
func (c *logicAppTriggerRecurrences) List(opts v1.ListOptions) (result *v1alpha1.LogicAppTriggerRecurrenceList, err error) {
...
func (c *logicAppTriggerRecurrences) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logicAppTriggerRecurrences) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
