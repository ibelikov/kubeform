...
func newServicebusNamespaces(c *AzurermV1alpha1Client, namespace string) *servicebusNamespaces {
...
func (c *servicebusNamespaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicebusNamespace, err error) {
...
func (c *servicebusNamespaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicebusNamespaceList, err error) {
...
func (c *servicebusNamespaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicebusNamespaces) Create(ctx context.Context, servicebusNamespace *v1alpha1.ServicebusNamespace, opts v1.CreateOptions) (result *v1alpha1.ServicebusNamespace, err error) {
	result = &v1alpha1.ServicebusNamespace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicebusnamespaces").
...
func (c *servicebusNamespaces) Update(ctx context.Context, servicebusNamespace *v1alpha1.ServicebusNamespace, opts v1.UpdateOptions) (result *v1alpha1.ServicebusNamespace, err error) {
	result = &v1alpha1.ServicebusNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebusnamespaces").
...
func (c *servicebusNamespaces) UpdateStatus(ctx context.Context, servicebusNamespace *v1alpha1.ServicebusNamespace, opts v1.UpdateOptions) (result *v1alpha1.ServicebusNamespace, err error) {
	result = &v1alpha1.ServicebusNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebusnamespaces").
...
func (c *servicebusNamespaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicebusNamespaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicebusNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicebusNamespace, err error) {
	result = &v1alpha1.ServicebusNamespace{}
