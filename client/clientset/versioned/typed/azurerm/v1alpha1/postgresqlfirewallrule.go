...
func (c *postgresqlFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PostgresqlFirewallRule, err error) {
...
func (c *postgresqlFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PostgresqlFirewallRuleList, err error) {
...
func (c *postgresqlFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *postgresqlFirewallRules) Create(ctx context.Context, postgresqlFirewallRule *v1alpha1.PostgresqlFirewallRule, opts v1.CreateOptions) (result *v1alpha1.PostgresqlFirewallRule, err error) {
	result = &v1alpha1.PostgresqlFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("postgresqlfirewallrules").
...
func (c *postgresqlFirewallRules) Update(ctx context.Context, postgresqlFirewallRule *v1alpha1.PostgresqlFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.PostgresqlFirewallRule, err error) {
	result = &v1alpha1.PostgresqlFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("postgresqlfirewallrules").
...
func (c *postgresqlFirewallRules) UpdateStatus(ctx context.Context, postgresqlFirewallRule *v1alpha1.PostgresqlFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.PostgresqlFirewallRule, err error) {
	result = &v1alpha1.PostgresqlFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("postgresqlfirewallrules").
...
func (c *postgresqlFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *postgresqlFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *postgresqlFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PostgresqlFirewallRule, err error) {
	result = &v1alpha1.PostgresqlFirewallRule{}
