...
func (c *servicebusTopics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicebusTopic, err error) {
...
func (c *servicebusTopics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicebusTopicList, err error) {
...
func (c *servicebusTopics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicebusTopics) Create(ctx context.Context, servicebusTopic *v1alpha1.ServicebusTopic, opts v1.CreateOptions) (result *v1alpha1.ServicebusTopic, err error) {
	result = &v1alpha1.ServicebusTopic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicebustopics").
...
func (c *servicebusTopics) Update(ctx context.Context, servicebusTopic *v1alpha1.ServicebusTopic, opts v1.UpdateOptions) (result *v1alpha1.ServicebusTopic, err error) {
	result = &v1alpha1.ServicebusTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebustopics").
...
func (c *servicebusTopics) UpdateStatus(ctx context.Context, servicebusTopic *v1alpha1.ServicebusTopic, opts v1.UpdateOptions) (result *v1alpha1.ServicebusTopic, err error) {
	result = &v1alpha1.ServicebusTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebustopics").
...
func (c *servicebusTopics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicebusTopics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicebusTopics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicebusTopic, err error) {
	result = &v1alpha1.ServicebusTopic{}
