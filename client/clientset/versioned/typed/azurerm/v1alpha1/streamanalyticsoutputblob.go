...
func (c *streamAnalyticsOutputBlobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StreamAnalyticsOutputBlob, err error) {
...
func (c *streamAnalyticsOutputBlobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StreamAnalyticsOutputBlobList, err error) {
...
func (c *streamAnalyticsOutputBlobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *streamAnalyticsOutputBlobs) Create(ctx context.Context, streamAnalyticsOutputBlob *v1alpha1.StreamAnalyticsOutputBlob, opts v1.CreateOptions) (result *v1alpha1.StreamAnalyticsOutputBlob, err error) {
	result = &v1alpha1.StreamAnalyticsOutputBlob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("streamanalyticsoutputblobs").
...
func (c *streamAnalyticsOutputBlobs) Update(ctx context.Context, streamAnalyticsOutputBlob *v1alpha1.StreamAnalyticsOutputBlob, opts v1.UpdateOptions) (result *v1alpha1.StreamAnalyticsOutputBlob, err error) {
	result = &v1alpha1.StreamAnalyticsOutputBlob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("streamanalyticsoutputblobs").
...
func (c *streamAnalyticsOutputBlobs) UpdateStatus(ctx context.Context, streamAnalyticsOutputBlob *v1alpha1.StreamAnalyticsOutputBlob, opts v1.UpdateOptions) (result *v1alpha1.StreamAnalyticsOutputBlob, err error) {
	result = &v1alpha1.StreamAnalyticsOutputBlob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("streamanalyticsoutputblobs").
...
func (c *streamAnalyticsOutputBlobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *streamAnalyticsOutputBlobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *streamAnalyticsOutputBlobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StreamAnalyticsOutputBlob, err error) {
	result = &v1alpha1.StreamAnalyticsOutputBlob{}
