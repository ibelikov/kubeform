...
func (c *automationJobSchedules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutomationJobSchedule, err error) {
...
func (c *automationJobSchedules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutomationJobScheduleList, err error) {
...
func (c *automationJobSchedules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *automationJobSchedules) Create(ctx context.Context, automationJobSchedule *v1alpha1.AutomationJobSchedule, opts v1.CreateOptions) (result *v1alpha1.AutomationJobSchedule, err error) {
	result = &v1alpha1.AutomationJobSchedule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("automationjobschedules").
...
func (c *automationJobSchedules) Update(ctx context.Context, automationJobSchedule *v1alpha1.AutomationJobSchedule, opts v1.UpdateOptions) (result *v1alpha1.AutomationJobSchedule, err error) {
	result = &v1alpha1.AutomationJobSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationjobschedules").
...
func (c *automationJobSchedules) UpdateStatus(ctx context.Context, automationJobSchedule *v1alpha1.AutomationJobSchedule, opts v1.UpdateOptions) (result *v1alpha1.AutomationJobSchedule, err error) {
	result = &v1alpha1.AutomationJobSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationjobschedules").
...
func (c *automationJobSchedules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *automationJobSchedules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *automationJobSchedules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutomationJobSchedule, err error) {
	result = &v1alpha1.AutomationJobSchedule{}
