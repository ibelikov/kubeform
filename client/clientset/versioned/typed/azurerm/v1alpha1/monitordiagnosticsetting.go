...
func (c *monitorDiagnosticSettings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonitorDiagnosticSetting, err error) {
...
func (c *monitorDiagnosticSettings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonitorDiagnosticSettingList, err error) {
...
func (c *monitorDiagnosticSettings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitorDiagnosticSettings) Create(ctx context.Context, monitorDiagnosticSetting *v1alpha1.MonitorDiagnosticSetting, opts v1.CreateOptions) (result *v1alpha1.MonitorDiagnosticSetting, err error) {
	result = &v1alpha1.MonitorDiagnosticSetting{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitordiagnosticsettings").
...
func (c *monitorDiagnosticSettings) Update(ctx context.Context, monitorDiagnosticSetting *v1alpha1.MonitorDiagnosticSetting, opts v1.UpdateOptions) (result *v1alpha1.MonitorDiagnosticSetting, err error) {
	result = &v1alpha1.MonitorDiagnosticSetting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitordiagnosticsettings").
...
func (c *monitorDiagnosticSettings) UpdateStatus(ctx context.Context, monitorDiagnosticSetting *v1alpha1.MonitorDiagnosticSetting, opts v1.UpdateOptions) (result *v1alpha1.MonitorDiagnosticSetting, err error) {
	result = &v1alpha1.MonitorDiagnosticSetting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitordiagnosticsettings").
...
func (c *monitorDiagnosticSettings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monitorDiagnosticSettings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monitorDiagnosticSettings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MonitorDiagnosticSetting, err error) {
	result = &v1alpha1.MonitorDiagnosticSetting{}
