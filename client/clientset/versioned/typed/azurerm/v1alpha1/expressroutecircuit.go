...
func (c *expressRouteCircuits) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ExpressRouteCircuit, err error) {
...
func (c *expressRouteCircuits) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ExpressRouteCircuitList, err error) {
...
func (c *expressRouteCircuits) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *expressRouteCircuits) Create(ctx context.Context, expressRouteCircuit *v1alpha1.ExpressRouteCircuit, opts v1.CreateOptions) (result *v1alpha1.ExpressRouteCircuit, err error) {
	result = &v1alpha1.ExpressRouteCircuit{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("expressroutecircuits").
...
func (c *expressRouteCircuits) Update(ctx context.Context, expressRouteCircuit *v1alpha1.ExpressRouteCircuit, opts v1.UpdateOptions) (result *v1alpha1.ExpressRouteCircuit, err error) {
	result = &v1alpha1.ExpressRouteCircuit{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("expressroutecircuits").
...
func (c *expressRouteCircuits) UpdateStatus(ctx context.Context, expressRouteCircuit *v1alpha1.ExpressRouteCircuit, opts v1.UpdateOptions) (result *v1alpha1.ExpressRouteCircuit, err error) {
	result = &v1alpha1.ExpressRouteCircuit{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("expressroutecircuits").
...
func (c *expressRouteCircuits) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *expressRouteCircuits) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *expressRouteCircuits) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ExpressRouteCircuit, err error) {
	result = &v1alpha1.ExpressRouteCircuit{}
