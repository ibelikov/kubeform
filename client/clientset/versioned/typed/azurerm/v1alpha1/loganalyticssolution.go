...
func (c *logAnalyticsSolutions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogAnalyticsSolution, err error) {
...
func (c *logAnalyticsSolutions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogAnalyticsSolutionList, err error) {
...
func (c *logAnalyticsSolutions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logAnalyticsSolutions) Create(ctx context.Context, logAnalyticsSolution *v1alpha1.LogAnalyticsSolution, opts v1.CreateOptions) (result *v1alpha1.LogAnalyticsSolution, err error) {
	result = &v1alpha1.LogAnalyticsSolution{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loganalyticssolutions").
...
func (c *logAnalyticsSolutions) Update(ctx context.Context, logAnalyticsSolution *v1alpha1.LogAnalyticsSolution, opts v1.UpdateOptions) (result *v1alpha1.LogAnalyticsSolution, err error) {
	result = &v1alpha1.LogAnalyticsSolution{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loganalyticssolutions").
...
func (c *logAnalyticsSolutions) UpdateStatus(ctx context.Context, logAnalyticsSolution *v1alpha1.LogAnalyticsSolution, opts v1.UpdateOptions) (result *v1alpha1.LogAnalyticsSolution, err error) {
	result = &v1alpha1.LogAnalyticsSolution{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loganalyticssolutions").
...
func (c *logAnalyticsSolutions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logAnalyticsSolutions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logAnalyticsSolutions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogAnalyticsSolution, err error) {
	result = &v1alpha1.LogAnalyticsSolution{}
