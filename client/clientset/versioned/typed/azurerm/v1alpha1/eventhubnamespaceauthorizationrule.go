...
type EventhubNamespaceAuthorizationRuleInterface interface {
	Create(*v1alpha1.EventhubNamespaceAuthorizationRule) (*v1alpha1.EventhubNamespaceAuthorizationRule, error)
	Update(*v1alpha1.EventhubNamespaceAuthorizationRule) (*v1alpha1.EventhubNamespaceAuthorizationRule, error)
	UpdateStatus(*v1alpha1.EventhubNamespaceAuthorizationRule) (*v1alpha1.EventhubNamespaceAuthorizationRule, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.EventhubNamespaceAuthorizationRule, error)
	List(opts v1.ListOptions) (*v1alpha1.EventhubNamespaceAuthorizationRuleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.EventhubNamespaceAuthorizationRule, err error)
...
func (c *eventhubNamespaceAuthorizationRules) Get(name string, options v1.GetOptions) (result *v1alpha1.EventhubNamespaceAuthorizationRule, err error) {
...
func (c *eventhubNamespaceAuthorizationRules) List(opts v1.ListOptions) (result *v1alpha1.EventhubNamespaceAuthorizationRuleList, err error) {
...
func (c *eventhubNamespaceAuthorizationRules) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *eventhubNamespaceAuthorizationRules) Create(eventhubNamespaceAuthorizationRule *v1alpha1.EventhubNamespaceAuthorizationRule) (result *v1alpha1.EventhubNamespaceAuthorizationRule, err error) {
	result = &v1alpha1.EventhubNamespaceAuthorizationRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("eventhubnamespaceauthorizationrules").
...
func (c *eventhubNamespaceAuthorizationRules) Update(eventhubNamespaceAuthorizationRule *v1alpha1.EventhubNamespaceAuthorizationRule) (result *v1alpha1.EventhubNamespaceAuthorizationRule, err error) {
	result = &v1alpha1.EventhubNamespaceAuthorizationRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventhubnamespaceauthorizationrules").
...
func (c *eventhubNamespaceAuthorizationRules) UpdateStatus(eventhubNamespaceAuthorizationRule *v1alpha1.EventhubNamespaceAuthorizationRule) (result *v1alpha1.EventhubNamespaceAuthorizationRule, err error) {
	result = &v1alpha1.EventhubNamespaceAuthorizationRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventhubnamespaceauthorizationrules").
...
func (c *eventhubNamespaceAuthorizationRules) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *eventhubNamespaceAuthorizationRules) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *eventhubNamespaceAuthorizationRules) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.EventhubNamespaceAuthorizationRule, err error) {
	result = &v1alpha1.EventhubNamespaceAuthorizationRule{}
