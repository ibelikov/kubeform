...
func (c *logicAppActionCustoms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogicAppActionCustom, err error) {
...
func (c *logicAppActionCustoms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogicAppActionCustomList, err error) {
...
func (c *logicAppActionCustoms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logicAppActionCustoms) Create(ctx context.Context, logicAppActionCustom *v1alpha1.LogicAppActionCustom, opts v1.CreateOptions) (result *v1alpha1.LogicAppActionCustom, err error) {
	result = &v1alpha1.LogicAppActionCustom{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logicappactioncustoms").
...
func (c *logicAppActionCustoms) Update(ctx context.Context, logicAppActionCustom *v1alpha1.LogicAppActionCustom, opts v1.UpdateOptions) (result *v1alpha1.LogicAppActionCustom, err error) {
	result = &v1alpha1.LogicAppActionCustom{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logicappactioncustoms").
...
func (c *logicAppActionCustoms) UpdateStatus(ctx context.Context, logicAppActionCustom *v1alpha1.LogicAppActionCustom, opts v1.UpdateOptions) (result *v1alpha1.LogicAppActionCustom, err error) {
	result = &v1alpha1.LogicAppActionCustom{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logicappactioncustoms").
...
func (c *logicAppActionCustoms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logicAppActionCustoms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logicAppActionCustoms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogicAppActionCustom, err error) {
	result = &v1alpha1.LogicAppActionCustom{}
