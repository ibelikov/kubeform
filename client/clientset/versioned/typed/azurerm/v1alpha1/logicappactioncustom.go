...
type LogicAppActionCustomInterface interface {
	Create(*v1alpha1.LogicAppActionCustom) (*v1alpha1.LogicAppActionCustom, error)
	Update(*v1alpha1.LogicAppActionCustom) (*v1alpha1.LogicAppActionCustom, error)
	UpdateStatus(*v1alpha1.LogicAppActionCustom) (*v1alpha1.LogicAppActionCustom, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.LogicAppActionCustom, error)
	List(opts v1.ListOptions) (*v1alpha1.LogicAppActionCustomList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.LogicAppActionCustom, err error)
...
func (c *logicAppActionCustoms) List(opts v1.ListOptions) (result *v1alpha1.LogicAppActionCustomList, err error) {
...
func (c *logicAppActionCustoms) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logicAppActionCustoms) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
