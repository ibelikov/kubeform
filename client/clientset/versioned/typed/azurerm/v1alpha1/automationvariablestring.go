...
func (c *automationVariableStrings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutomationVariableString, err error) {
...
func (c *automationVariableStrings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutomationVariableStringList, err error) {
...
func (c *automationVariableStrings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *automationVariableStrings) Create(ctx context.Context, automationVariableString *v1alpha1.AutomationVariableString, opts v1.CreateOptions) (result *v1alpha1.AutomationVariableString, err error) {
	result = &v1alpha1.AutomationVariableString{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("automationvariablestrings").
...
func (c *automationVariableStrings) Update(ctx context.Context, automationVariableString *v1alpha1.AutomationVariableString, opts v1.UpdateOptions) (result *v1alpha1.AutomationVariableString, err error) {
	result = &v1alpha1.AutomationVariableString{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationvariablestrings").
...
func (c *automationVariableStrings) UpdateStatus(ctx context.Context, automationVariableString *v1alpha1.AutomationVariableString, opts v1.UpdateOptions) (result *v1alpha1.AutomationVariableString, err error) {
	result = &v1alpha1.AutomationVariableString{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationvariablestrings").
...
func (c *automationVariableStrings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *automationVariableStrings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *automationVariableStrings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutomationVariableString, err error) {
	result = &v1alpha1.AutomationVariableString{}
