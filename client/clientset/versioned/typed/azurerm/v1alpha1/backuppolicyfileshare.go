...
func (c *backupPolicyFileShares) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BackupPolicyFileShare, err error) {
...
func (c *backupPolicyFileShares) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BackupPolicyFileShareList, err error) {
...
func (c *backupPolicyFileShares) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *backupPolicyFileShares) Create(ctx context.Context, backupPolicyFileShare *v1alpha1.BackupPolicyFileShare, opts v1.CreateOptions) (result *v1alpha1.BackupPolicyFileShare, err error) {
	result = &v1alpha1.BackupPolicyFileShare{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backuppolicyfileshares").
...
func (c *backupPolicyFileShares) Update(ctx context.Context, backupPolicyFileShare *v1alpha1.BackupPolicyFileShare, opts v1.UpdateOptions) (result *v1alpha1.BackupPolicyFileShare, err error) {
	result = &v1alpha1.BackupPolicyFileShare{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backuppolicyfileshares").
...
func (c *backupPolicyFileShares) UpdateStatus(ctx context.Context, backupPolicyFileShare *v1alpha1.BackupPolicyFileShare, opts v1.UpdateOptions) (result *v1alpha1.BackupPolicyFileShare, err error) {
	result = &v1alpha1.BackupPolicyFileShare{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backuppolicyfileshares").
...
func (c *backupPolicyFileShares) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *backupPolicyFileShares) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *backupPolicyFileShares) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BackupPolicyFileShare, err error) {
	result = &v1alpha1.BackupPolicyFileShare{}
