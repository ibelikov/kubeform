...
type DevTestWindowsVirtualMachineInterface interface {
	Create(*v1alpha1.DevTestWindowsVirtualMachine) (*v1alpha1.DevTestWindowsVirtualMachine, error)
	Update(*v1alpha1.DevTestWindowsVirtualMachine) (*v1alpha1.DevTestWindowsVirtualMachine, error)
	UpdateStatus(*v1alpha1.DevTestWindowsVirtualMachine) (*v1alpha1.DevTestWindowsVirtualMachine, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DevTestWindowsVirtualMachine, error)
	List(opts v1.ListOptions) (*v1alpha1.DevTestWindowsVirtualMachineList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DevTestWindowsVirtualMachine, err error)
...
func (c *devTestWindowsVirtualMachines) Get(name string, options v1.GetOptions) (result *v1alpha1.DevTestWindowsVirtualMachine, err error) {
...
func (c *devTestWindowsVirtualMachines) List(opts v1.ListOptions) (result *v1alpha1.DevTestWindowsVirtualMachineList, err error) {
...
func (c *devTestWindowsVirtualMachines) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *devTestWindowsVirtualMachines) Create(devTestWindowsVirtualMachine *v1alpha1.DevTestWindowsVirtualMachine) (result *v1alpha1.DevTestWindowsVirtualMachine, err error) {
	result = &v1alpha1.DevTestWindowsVirtualMachine{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("devtestwindowsvirtualmachines").
...
func (c *devTestWindowsVirtualMachines) Update(devTestWindowsVirtualMachine *v1alpha1.DevTestWindowsVirtualMachine) (result *v1alpha1.DevTestWindowsVirtualMachine, err error) {
	result = &v1alpha1.DevTestWindowsVirtualMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devtestwindowsvirtualmachines").
...
func (c *devTestWindowsVirtualMachines) UpdateStatus(devTestWindowsVirtualMachine *v1alpha1.DevTestWindowsVirtualMachine) (result *v1alpha1.DevTestWindowsVirtualMachine, err error) {
	result = &v1alpha1.DevTestWindowsVirtualMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devtestwindowsvirtualmachines").
...
func (c *devTestWindowsVirtualMachines) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *devTestWindowsVirtualMachines) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *devTestWindowsVirtualMachines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DevTestWindowsVirtualMachine, err error) {
	result = &v1alpha1.DevTestWindowsVirtualMachine{}
