...
type PolicyDefinitionInterface interface {
	Create(*v1alpha1.PolicyDefinition) (*v1alpha1.PolicyDefinition, error)
	Update(*v1alpha1.PolicyDefinition) (*v1alpha1.PolicyDefinition, error)
	UpdateStatus(*v1alpha1.PolicyDefinition) (*v1alpha1.PolicyDefinition, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.PolicyDefinition, error)
	List(opts v1.ListOptions) (*v1alpha1.PolicyDefinitionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PolicyDefinition, err error)
...
func (c *policyDefinitions) Get(name string, options v1.GetOptions) (result *v1alpha1.PolicyDefinition, err error) {
...
func (c *policyDefinitions) List(opts v1.ListOptions) (result *v1alpha1.PolicyDefinitionList, err error) {
...
func (c *policyDefinitions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *policyDefinitions) Create(policyDefinition *v1alpha1.PolicyDefinition) (result *v1alpha1.PolicyDefinition, err error) {
	result = &v1alpha1.PolicyDefinition{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("policydefinitions").
...
func (c *policyDefinitions) Update(policyDefinition *v1alpha1.PolicyDefinition) (result *v1alpha1.PolicyDefinition, err error) {
	result = &v1alpha1.PolicyDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policydefinitions").
...
func (c *policyDefinitions) UpdateStatus(policyDefinition *v1alpha1.PolicyDefinition) (result *v1alpha1.PolicyDefinition, err error) {
	result = &v1alpha1.PolicyDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policydefinitions").
...
func (c *policyDefinitions) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *policyDefinitions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *policyDefinitions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PolicyDefinition, err error) {
	result = &v1alpha1.PolicyDefinition{}
