...
func (c *monitorLogProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonitorLogProfile, err error) {
...
func (c *monitorLogProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonitorLogProfileList, err error) {
...
func (c *monitorLogProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitorLogProfiles) Create(ctx context.Context, monitorLogProfile *v1alpha1.MonitorLogProfile, opts v1.CreateOptions) (result *v1alpha1.MonitorLogProfile, err error) {
	result = &v1alpha1.MonitorLogProfile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitorlogprofiles").
...
func (c *monitorLogProfiles) Update(ctx context.Context, monitorLogProfile *v1alpha1.MonitorLogProfile, opts v1.UpdateOptions) (result *v1alpha1.MonitorLogProfile, err error) {
	result = &v1alpha1.MonitorLogProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitorlogprofiles").
...
func (c *monitorLogProfiles) UpdateStatus(ctx context.Context, monitorLogProfile *v1alpha1.MonitorLogProfile, opts v1.UpdateOptions) (result *v1alpha1.MonitorLogProfile, err error) {
	result = &v1alpha1.MonitorLogProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitorlogprofiles").
...
func (c *monitorLogProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monitorLogProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monitorLogProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MonitorLogProfile, err error) {
	result = &v1alpha1.MonitorLogProfile{}
