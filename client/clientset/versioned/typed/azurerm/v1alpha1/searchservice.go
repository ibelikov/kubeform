...
func (c *searchServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SearchService, err error) {
...
func (c *searchServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SearchServiceList, err error) {
...
func (c *searchServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *searchServices) Create(ctx context.Context, searchService *v1alpha1.SearchService, opts v1.CreateOptions) (result *v1alpha1.SearchService, err error) {
	result = &v1alpha1.SearchService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("searchservices").
...
func (c *searchServices) Update(ctx context.Context, searchService *v1alpha1.SearchService, opts v1.UpdateOptions) (result *v1alpha1.SearchService, err error) {
	result = &v1alpha1.SearchService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("searchservices").
...
func (c *searchServices) UpdateStatus(ctx context.Context, searchService *v1alpha1.SearchService, opts v1.UpdateOptions) (result *v1alpha1.SearchService, err error) {
	result = &v1alpha1.SearchService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("searchservices").
...
func (c *searchServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *searchServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *searchServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SearchService, err error) {
	result = &v1alpha1.SearchService{}
