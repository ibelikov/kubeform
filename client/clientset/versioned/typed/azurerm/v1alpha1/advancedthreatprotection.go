...
func (c *advancedThreatProtections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AdvancedThreatProtection, err error) {
...
func (c *advancedThreatProtections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AdvancedThreatProtectionList, err error) {
...
func (c *advancedThreatProtections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *advancedThreatProtections) Create(ctx context.Context, advancedThreatProtection *v1alpha1.AdvancedThreatProtection, opts v1.CreateOptions) (result *v1alpha1.AdvancedThreatProtection, err error) {
	result = &v1alpha1.AdvancedThreatProtection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("advancedthreatprotections").
...
func (c *advancedThreatProtections) Update(ctx context.Context, advancedThreatProtection *v1alpha1.AdvancedThreatProtection, opts v1.UpdateOptions) (result *v1alpha1.AdvancedThreatProtection, err error) {
	result = &v1alpha1.AdvancedThreatProtection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("advancedthreatprotections").
...
func (c *advancedThreatProtections) UpdateStatus(ctx context.Context, advancedThreatProtection *v1alpha1.AdvancedThreatProtection, opts v1.UpdateOptions) (result *v1alpha1.AdvancedThreatProtection, err error) {
	result = &v1alpha1.AdvancedThreatProtection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("advancedthreatprotections").
...
func (c *advancedThreatProtections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *advancedThreatProtections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *advancedThreatProtections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AdvancedThreatProtection, err error) {
	result = &v1alpha1.AdvancedThreatProtection{}
