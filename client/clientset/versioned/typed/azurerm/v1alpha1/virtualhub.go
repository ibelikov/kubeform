...
func (c *virtualHubs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VirtualHub, err error) {
...
func (c *virtualHubs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VirtualHubList, err error) {
...
func (c *virtualHubs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *virtualHubs) Create(ctx context.Context, virtualHub *v1alpha1.VirtualHub, opts v1.CreateOptions) (result *v1alpha1.VirtualHub, err error) {
	result = &v1alpha1.VirtualHub{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualhubs").
...
func (c *virtualHubs) Update(ctx context.Context, virtualHub *v1alpha1.VirtualHub, opts v1.UpdateOptions) (result *v1alpha1.VirtualHub, err error) {
	result = &v1alpha1.VirtualHub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualhubs").
...
func (c *virtualHubs) UpdateStatus(ctx context.Context, virtualHub *v1alpha1.VirtualHub, opts v1.UpdateOptions) (result *v1alpha1.VirtualHub, err error) {
	result = &v1alpha1.VirtualHub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualhubs").
...
func (c *virtualHubs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *virtualHubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *virtualHubs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VirtualHub, err error) {
	result = &v1alpha1.VirtualHub{}
