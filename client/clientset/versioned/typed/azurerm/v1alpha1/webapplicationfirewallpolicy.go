...
func (c *webApplicationFirewallPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WebApplicationFirewallPolicy, err error) {
...
func (c *webApplicationFirewallPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WebApplicationFirewallPolicyList, err error) {
...
func (c *webApplicationFirewallPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *webApplicationFirewallPolicies) Create(ctx context.Context, webApplicationFirewallPolicy *v1alpha1.WebApplicationFirewallPolicy, opts v1.CreateOptions) (result *v1alpha1.WebApplicationFirewallPolicy, err error) {
	result = &v1alpha1.WebApplicationFirewallPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("webapplicationfirewallpolicies").
...
func (c *webApplicationFirewallPolicies) Update(ctx context.Context, webApplicationFirewallPolicy *v1alpha1.WebApplicationFirewallPolicy, opts v1.UpdateOptions) (result *v1alpha1.WebApplicationFirewallPolicy, err error) {
	result = &v1alpha1.WebApplicationFirewallPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("webapplicationfirewallpolicies").
...
func (c *webApplicationFirewallPolicies) UpdateStatus(ctx context.Context, webApplicationFirewallPolicy *v1alpha1.WebApplicationFirewallPolicy, opts v1.UpdateOptions) (result *v1alpha1.WebApplicationFirewallPolicy, err error) {
	result = &v1alpha1.WebApplicationFirewallPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("webapplicationfirewallpolicies").
...
func (c *webApplicationFirewallPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *webApplicationFirewallPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *webApplicationFirewallPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WebApplicationFirewallPolicy, err error) {
	result = &v1alpha1.WebApplicationFirewallPolicy{}
