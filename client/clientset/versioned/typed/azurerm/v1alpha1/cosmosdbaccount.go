...
func (c *cosmosdbAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CosmosdbAccount, err error) {
...
func (c *cosmosdbAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CosmosdbAccountList, err error) {
...
func (c *cosmosdbAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cosmosdbAccounts) Create(ctx context.Context, cosmosdbAccount *v1alpha1.CosmosdbAccount, opts v1.CreateOptions) (result *v1alpha1.CosmosdbAccount, err error) {
	result = &v1alpha1.CosmosdbAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cosmosdbaccounts").
...
func (c *cosmosdbAccounts) Update(ctx context.Context, cosmosdbAccount *v1alpha1.CosmosdbAccount, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbAccount, err error) {
	result = &v1alpha1.CosmosdbAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbaccounts").
...
func (c *cosmosdbAccounts) UpdateStatus(ctx context.Context, cosmosdbAccount *v1alpha1.CosmosdbAccount, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbAccount, err error) {
	result = &v1alpha1.CosmosdbAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbaccounts").
...
func (c *cosmosdbAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cosmosdbAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cosmosdbAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CosmosdbAccount, err error) {
	result = &v1alpha1.CosmosdbAccount{}
