...
func (c *schedulerJobCollections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SchedulerJobCollection, err error) {
...
func (c *schedulerJobCollections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SchedulerJobCollectionList, err error) {
...
func (c *schedulerJobCollections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *schedulerJobCollections) Create(ctx context.Context, schedulerJobCollection *v1alpha1.SchedulerJobCollection, opts v1.CreateOptions) (result *v1alpha1.SchedulerJobCollection, err error) {
	result = &v1alpha1.SchedulerJobCollection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("schedulerjobcollections").
...
func (c *schedulerJobCollections) Update(ctx context.Context, schedulerJobCollection *v1alpha1.SchedulerJobCollection, opts v1.UpdateOptions) (result *v1alpha1.SchedulerJobCollection, err error) {
	result = &v1alpha1.SchedulerJobCollection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("schedulerjobcollections").
...
func (c *schedulerJobCollections) UpdateStatus(ctx context.Context, schedulerJobCollection *v1alpha1.SchedulerJobCollection, opts v1.UpdateOptions) (result *v1alpha1.SchedulerJobCollection, err error) {
	result = &v1alpha1.SchedulerJobCollection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("schedulerjobcollections").
...
func (c *schedulerJobCollections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *schedulerJobCollections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *schedulerJobCollections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SchedulerJobCollection, err error) {
	result = &v1alpha1.SchedulerJobCollection{}
