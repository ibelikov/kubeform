...
type SharedImageVersionInterface interface {
	Create(*v1alpha1.SharedImageVersion) (*v1alpha1.SharedImageVersion, error)
	Update(*v1alpha1.SharedImageVersion) (*v1alpha1.SharedImageVersion, error)
	UpdateStatus(*v1alpha1.SharedImageVersion) (*v1alpha1.SharedImageVersion, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SharedImageVersion, error)
	List(opts v1.ListOptions) (*v1alpha1.SharedImageVersionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SharedImageVersion, err error)
...
func (c *sharedImageVersions) List(opts v1.ListOptions) (result *v1alpha1.SharedImageVersionList, err error) {
...
func (c *sharedImageVersions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sharedImageVersions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
