...
func (c *sharedImageVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SharedImageVersion, err error) {
...
func (c *sharedImageVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SharedImageVersionList, err error) {
...
func (c *sharedImageVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sharedImageVersions) Create(ctx context.Context, sharedImageVersion *v1alpha1.SharedImageVersion, opts v1.CreateOptions) (result *v1alpha1.SharedImageVersion, err error) {
	result = &v1alpha1.SharedImageVersion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sharedimageversions").
...
func (c *sharedImageVersions) Update(ctx context.Context, sharedImageVersion *v1alpha1.SharedImageVersion, opts v1.UpdateOptions) (result *v1alpha1.SharedImageVersion, err error) {
	result = &v1alpha1.SharedImageVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedimageversions").
...
func (c *sharedImageVersions) UpdateStatus(ctx context.Context, sharedImageVersion *v1alpha1.SharedImageVersion, opts v1.UpdateOptions) (result *v1alpha1.SharedImageVersion, err error) {
	result = &v1alpha1.SharedImageVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedimageversions").
...
func (c *sharedImageVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sharedImageVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sharedImageVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SharedImageVersion, err error) {
	result = &v1alpha1.SharedImageVersion{}
