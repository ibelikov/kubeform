...
func (c *dataLakeAnalyticsFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataLakeAnalyticsFirewallRule, err error) {
...
func (c *dataLakeAnalyticsFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataLakeAnalyticsFirewallRuleList, err error) {
...
func (c *dataLakeAnalyticsFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataLakeAnalyticsFirewallRules) Create(ctx context.Context, dataLakeAnalyticsFirewallRule *v1alpha1.DataLakeAnalyticsFirewallRule, opts v1.CreateOptions) (result *v1alpha1.DataLakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.DataLakeAnalyticsFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datalakeanalyticsfirewallrules").
...
func (c *dataLakeAnalyticsFirewallRules) Update(ctx context.Context, dataLakeAnalyticsFirewallRule *v1alpha1.DataLakeAnalyticsFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.DataLakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.DataLakeAnalyticsFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datalakeanalyticsfirewallrules").
...
func (c *dataLakeAnalyticsFirewallRules) UpdateStatus(ctx context.Context, dataLakeAnalyticsFirewallRule *v1alpha1.DataLakeAnalyticsFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.DataLakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.DataLakeAnalyticsFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datalakeanalyticsfirewallrules").
...
func (c *dataLakeAnalyticsFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataLakeAnalyticsFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataLakeAnalyticsFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataLakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.DataLakeAnalyticsFirewallRule{}
