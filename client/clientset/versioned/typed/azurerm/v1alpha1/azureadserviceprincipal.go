...
func (c *azureadServicePrincipals) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AzureadServicePrincipal, err error) {
...
func (c *azureadServicePrincipals) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AzureadServicePrincipalList, err error) {
...
func (c *azureadServicePrincipals) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *azureadServicePrincipals) Create(ctx context.Context, azureadServicePrincipal *v1alpha1.AzureadServicePrincipal, opts v1.CreateOptions) (result *v1alpha1.AzureadServicePrincipal, err error) {
	result = &v1alpha1.AzureadServicePrincipal{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("azureadserviceprincipals").
...
func (c *azureadServicePrincipals) Update(ctx context.Context, azureadServicePrincipal *v1alpha1.AzureadServicePrincipal, opts v1.UpdateOptions) (result *v1alpha1.AzureadServicePrincipal, err error) {
	result = &v1alpha1.AzureadServicePrincipal{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureadserviceprincipals").
...
func (c *azureadServicePrincipals) UpdateStatus(ctx context.Context, azureadServicePrincipal *v1alpha1.AzureadServicePrincipal, opts v1.UpdateOptions) (result *v1alpha1.AzureadServicePrincipal, err error) {
	result = &v1alpha1.AzureadServicePrincipal{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureadserviceprincipals").
...
func (c *azureadServicePrincipals) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *azureadServicePrincipals) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *azureadServicePrincipals) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AzureadServicePrincipal, err error) {
	result = &v1alpha1.AzureadServicePrincipal{}
