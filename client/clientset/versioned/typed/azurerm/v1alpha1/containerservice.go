...
type ContainerServiceInterface interface {
	Create(*v1alpha1.ContainerService) (*v1alpha1.ContainerService, error)
	Update(*v1alpha1.ContainerService) (*v1alpha1.ContainerService, error)
	UpdateStatus(*v1alpha1.ContainerService) (*v1alpha1.ContainerService, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ContainerService, error)
	List(opts v1.ListOptions) (*v1alpha1.ContainerServiceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ContainerService, err error)
...
func (c *containerServices) List(opts v1.ListOptions) (result *v1alpha1.ContainerServiceList, err error) {
...
func (c *containerServices) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *containerServices) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
