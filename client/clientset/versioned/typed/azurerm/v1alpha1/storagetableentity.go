...
func newStorageTableEntities(c *AzurermV1alpha1Client, namespace string) *storageTableEntities {
...
func (c *storageTableEntities) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageTableEntity, err error) {
...
func (c *storageTableEntities) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageTableEntityList, err error) {
...
func (c *storageTableEntities) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageTableEntities) Create(ctx context.Context, storageTableEntity *v1alpha1.StorageTableEntity, opts v1.CreateOptions) (result *v1alpha1.StorageTableEntity, err error) {
	result = &v1alpha1.StorageTableEntity{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagetableentities").
...
func (c *storageTableEntities) Update(ctx context.Context, storageTableEntity *v1alpha1.StorageTableEntity, opts v1.UpdateOptions) (result *v1alpha1.StorageTableEntity, err error) {
	result = &v1alpha1.StorageTableEntity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagetableentities").
...
func (c *storageTableEntities) UpdateStatus(ctx context.Context, storageTableEntity *v1alpha1.StorageTableEntity, opts v1.UpdateOptions) (result *v1alpha1.StorageTableEntity, err error) {
	result = &v1alpha1.StorageTableEntity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagetableentities").
...
func (c *storageTableEntities) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageTableEntities) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageTableEntities) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageTableEntity, err error) {
	result = &v1alpha1.StorageTableEntity{}
