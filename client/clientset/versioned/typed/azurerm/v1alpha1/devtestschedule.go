...
func (c *devTestSchedules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DevTestSchedule, err error) {
...
func (c *devTestSchedules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DevTestScheduleList, err error) {
...
func (c *devTestSchedules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *devTestSchedules) Create(ctx context.Context, devTestSchedule *v1alpha1.DevTestSchedule, opts v1.CreateOptions) (result *v1alpha1.DevTestSchedule, err error) {
	result = &v1alpha1.DevTestSchedule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("devtestschedules").
...
func (c *devTestSchedules) Update(ctx context.Context, devTestSchedule *v1alpha1.DevTestSchedule, opts v1.UpdateOptions) (result *v1alpha1.DevTestSchedule, err error) {
	result = &v1alpha1.DevTestSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devtestschedules").
...
func (c *devTestSchedules) UpdateStatus(ctx context.Context, devTestSchedule *v1alpha1.DevTestSchedule, opts v1.UpdateOptions) (result *v1alpha1.DevTestSchedule, err error) {
	result = &v1alpha1.DevTestSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devtestschedules").
...
func (c *devTestSchedules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *devTestSchedules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *devTestSchedules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DevTestSchedule, err error) {
	result = &v1alpha1.DevTestSchedule{}
