...
type LogicAppWorkflowInterface interface {
	Create(*v1alpha1.LogicAppWorkflow) (*v1alpha1.LogicAppWorkflow, error)
	Update(*v1alpha1.LogicAppWorkflow) (*v1alpha1.LogicAppWorkflow, error)
	UpdateStatus(*v1alpha1.LogicAppWorkflow) (*v1alpha1.LogicAppWorkflow, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.LogicAppWorkflow, error)
	List(opts v1.ListOptions) (*v1alpha1.LogicAppWorkflowList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.LogicAppWorkflow, err error)
...
func (c *logicAppWorkflows) List(opts v1.ListOptions) (result *v1alpha1.LogicAppWorkflowList, err error) {
...
func (c *logicAppWorkflows) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logicAppWorkflows) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
