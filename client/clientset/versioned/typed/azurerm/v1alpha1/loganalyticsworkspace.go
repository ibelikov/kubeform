...
func (c *logAnalyticsWorkspaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogAnalyticsWorkspace, err error) {
...
func (c *logAnalyticsWorkspaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogAnalyticsWorkspaceList, err error) {
...
func (c *logAnalyticsWorkspaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logAnalyticsWorkspaces) Create(ctx context.Context, logAnalyticsWorkspace *v1alpha1.LogAnalyticsWorkspace, opts v1.CreateOptions) (result *v1alpha1.LogAnalyticsWorkspace, err error) {
	result = &v1alpha1.LogAnalyticsWorkspace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loganalyticsworkspaces").
...
func (c *logAnalyticsWorkspaces) Update(ctx context.Context, logAnalyticsWorkspace *v1alpha1.LogAnalyticsWorkspace, opts v1.UpdateOptions) (result *v1alpha1.LogAnalyticsWorkspace, err error) {
	result = &v1alpha1.LogAnalyticsWorkspace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loganalyticsworkspaces").
...
func (c *logAnalyticsWorkspaces) UpdateStatus(ctx context.Context, logAnalyticsWorkspace *v1alpha1.LogAnalyticsWorkspace, opts v1.UpdateOptions) (result *v1alpha1.LogAnalyticsWorkspace, err error) {
	result = &v1alpha1.LogAnalyticsWorkspace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loganalyticsworkspaces").
...
func (c *logAnalyticsWorkspaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logAnalyticsWorkspaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logAnalyticsWorkspaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogAnalyticsWorkspace, err error) {
	result = &v1alpha1.LogAnalyticsWorkspace{}
