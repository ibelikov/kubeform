...
func (c *kustoDatabases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KustoDatabase, err error) {
...
func (c *kustoDatabases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KustoDatabaseList, err error) {
...
func (c *kustoDatabases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kustoDatabases) Create(ctx context.Context, kustoDatabase *v1alpha1.KustoDatabase, opts v1.CreateOptions) (result *v1alpha1.KustoDatabase, err error) {
	result = &v1alpha1.KustoDatabase{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kustodatabases").
...
func (c *kustoDatabases) Update(ctx context.Context, kustoDatabase *v1alpha1.KustoDatabase, opts v1.UpdateOptions) (result *v1alpha1.KustoDatabase, err error) {
	result = &v1alpha1.KustoDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kustodatabases").
...
func (c *kustoDatabases) UpdateStatus(ctx context.Context, kustoDatabase *v1alpha1.KustoDatabase, opts v1.UpdateOptions) (result *v1alpha1.KustoDatabase, err error) {
	result = &v1alpha1.KustoDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kustodatabases").
...
func (c *kustoDatabases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kustoDatabases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kustoDatabases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KustoDatabase, err error) {
	result = &v1alpha1.KustoDatabase{}
