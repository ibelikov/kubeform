...
func (c *relayNamespaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RelayNamespace, err error) {
...
func (c *relayNamespaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RelayNamespaceList, err error) {
...
func (c *relayNamespaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *relayNamespaces) Create(ctx context.Context, relayNamespace *v1alpha1.RelayNamespace, opts v1.CreateOptions) (result *v1alpha1.RelayNamespace, err error) {
	result = &v1alpha1.RelayNamespace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("relaynamespaces").
...
func (c *relayNamespaces) Update(ctx context.Context, relayNamespace *v1alpha1.RelayNamespace, opts v1.UpdateOptions) (result *v1alpha1.RelayNamespace, err error) {
	result = &v1alpha1.RelayNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("relaynamespaces").
...
func (c *relayNamespaces) UpdateStatus(ctx context.Context, relayNamespace *v1alpha1.RelayNamespace, opts v1.UpdateOptions) (result *v1alpha1.RelayNamespace, err error) {
	result = &v1alpha1.RelayNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("relaynamespaces").
...
func (c *relayNamespaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *relayNamespaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *relayNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RelayNamespace, err error) {
	result = &v1alpha1.RelayNamespace{}
