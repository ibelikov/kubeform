...
func (c *apiManagementLoggers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiManagementLogger, err error) {
...
func (c *apiManagementLoggers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiManagementLoggerList, err error) {
...
func (c *apiManagementLoggers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiManagementLoggers) Create(ctx context.Context, apiManagementLogger *v1alpha1.ApiManagementLogger, opts v1.CreateOptions) (result *v1alpha1.ApiManagementLogger, err error) {
	result = &v1alpha1.ApiManagementLogger{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apimanagementloggers").
...
func (c *apiManagementLoggers) Update(ctx context.Context, apiManagementLogger *v1alpha1.ApiManagementLogger, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementLogger, err error) {
	result = &v1alpha1.ApiManagementLogger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementloggers").
...
func (c *apiManagementLoggers) UpdateStatus(ctx context.Context, apiManagementLogger *v1alpha1.ApiManagementLogger, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementLogger, err error) {
	result = &v1alpha1.ApiManagementLogger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementloggers").
...
func (c *apiManagementLoggers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiManagementLoggers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiManagementLoggers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiManagementLogger, err error) {
	result = &v1alpha1.ApiManagementLogger{}
