...
type ApiManagementGroupInterface interface {
	Create(*v1alpha1.ApiManagementGroup) (*v1alpha1.ApiManagementGroup, error)
	Update(*v1alpha1.ApiManagementGroup) (*v1alpha1.ApiManagementGroup, error)
	UpdateStatus(*v1alpha1.ApiManagementGroup) (*v1alpha1.ApiManagementGroup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ApiManagementGroup, error)
	List(opts v1.ListOptions) (*v1alpha1.ApiManagementGroupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiManagementGroup, err error)
...
func (c *apiManagementGroups) List(opts v1.ListOptions) (result *v1alpha1.ApiManagementGroupList, err error) {
...
func (c *apiManagementGroups) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiManagementGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
