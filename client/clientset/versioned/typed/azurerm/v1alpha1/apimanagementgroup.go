...
func (c *apiManagementGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiManagementGroup, err error) {
...
func (c *apiManagementGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiManagementGroupList, err error) {
...
func (c *apiManagementGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiManagementGroups) Create(ctx context.Context, apiManagementGroup *v1alpha1.ApiManagementGroup, opts v1.CreateOptions) (result *v1alpha1.ApiManagementGroup, err error) {
	result = &v1alpha1.ApiManagementGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apimanagementgroups").
...
func (c *apiManagementGroups) Update(ctx context.Context, apiManagementGroup *v1alpha1.ApiManagementGroup, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementGroup, err error) {
	result = &v1alpha1.ApiManagementGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementgroups").
...
func (c *apiManagementGroups) UpdateStatus(ctx context.Context, apiManagementGroup *v1alpha1.ApiManagementGroup, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementGroup, err error) {
	result = &v1alpha1.ApiManagementGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementgroups").
...
func (c *apiManagementGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiManagementGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiManagementGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiManagementGroup, err error) {
	result = &v1alpha1.ApiManagementGroup{}
