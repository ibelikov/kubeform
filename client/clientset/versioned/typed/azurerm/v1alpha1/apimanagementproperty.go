...
func (c *apiManagementProperties) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiManagementProperty, err error) {
...
func (c *apiManagementProperties) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiManagementPropertyList, err error) {
...
func (c *apiManagementProperties) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiManagementProperties) Create(ctx context.Context, apiManagementProperty *v1alpha1.ApiManagementProperty, opts v1.CreateOptions) (result *v1alpha1.ApiManagementProperty, err error) {
	result = &v1alpha1.ApiManagementProperty{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apimanagementproperties").
...
func (c *apiManagementProperties) Update(ctx context.Context, apiManagementProperty *v1alpha1.ApiManagementProperty, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementProperty, err error) {
	result = &v1alpha1.ApiManagementProperty{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementproperties").
...
func (c *apiManagementProperties) UpdateStatus(ctx context.Context, apiManagementProperty *v1alpha1.ApiManagementProperty, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementProperty, err error) {
	result = &v1alpha1.ApiManagementProperty{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementproperties").
...
func (c *apiManagementProperties) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiManagementProperties) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiManagementProperties) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiManagementProperty, err error) {
	result = &v1alpha1.ApiManagementProperty{}
