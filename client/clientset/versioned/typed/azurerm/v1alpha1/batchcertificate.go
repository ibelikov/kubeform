...
func (c *batchCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BatchCertificate, err error) {
...
func (c *batchCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BatchCertificateList, err error) {
...
func (c *batchCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *batchCertificates) Create(ctx context.Context, batchCertificate *v1alpha1.BatchCertificate, opts v1.CreateOptions) (result *v1alpha1.BatchCertificate, err error) {
	result = &v1alpha1.BatchCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("batchcertificates").
...
func (c *batchCertificates) Update(ctx context.Context, batchCertificate *v1alpha1.BatchCertificate, opts v1.UpdateOptions) (result *v1alpha1.BatchCertificate, err error) {
	result = &v1alpha1.BatchCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("batchcertificates").
...
func (c *batchCertificates) UpdateStatus(ctx context.Context, batchCertificate *v1alpha1.BatchCertificate, opts v1.UpdateOptions) (result *v1alpha1.BatchCertificate, err error) {
	result = &v1alpha1.BatchCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("batchcertificates").
...
func (c *batchCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *batchCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *batchCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BatchCertificate, err error) {
	result = &v1alpha1.BatchCertificate{}
