...
type MariadbFirewallRuleInterface interface {
	Create(*v1alpha1.MariadbFirewallRule) (*v1alpha1.MariadbFirewallRule, error)
	Update(*v1alpha1.MariadbFirewallRule) (*v1alpha1.MariadbFirewallRule, error)
	UpdateStatus(*v1alpha1.MariadbFirewallRule) (*v1alpha1.MariadbFirewallRule, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MariadbFirewallRule, error)
	List(opts v1.ListOptions) (*v1alpha1.MariadbFirewallRuleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MariadbFirewallRule, err error)
...
func (c *mariadbFirewallRules) List(opts v1.ListOptions) (result *v1alpha1.MariadbFirewallRuleList, err error) {
...
func (c *mariadbFirewallRules) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mariadbFirewallRules) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
