...
func (c *mariadbFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MariadbFirewallRule, err error) {
...
func (c *mariadbFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MariadbFirewallRuleList, err error) {
...
func (c *mariadbFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mariadbFirewallRules) Create(ctx context.Context, mariadbFirewallRule *v1alpha1.MariadbFirewallRule, opts v1.CreateOptions) (result *v1alpha1.MariadbFirewallRule, err error) {
	result = &v1alpha1.MariadbFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mariadbfirewallrules").
...
func (c *mariadbFirewallRules) Update(ctx context.Context, mariadbFirewallRule *v1alpha1.MariadbFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.MariadbFirewallRule, err error) {
	result = &v1alpha1.MariadbFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mariadbfirewallrules").
...
func (c *mariadbFirewallRules) UpdateStatus(ctx context.Context, mariadbFirewallRule *v1alpha1.MariadbFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.MariadbFirewallRule, err error) {
	result = &v1alpha1.MariadbFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mariadbfirewallrules").
...
func (c *mariadbFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mariadbFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mariadbFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MariadbFirewallRule, err error) {
	result = &v1alpha1.MariadbFirewallRule{}
