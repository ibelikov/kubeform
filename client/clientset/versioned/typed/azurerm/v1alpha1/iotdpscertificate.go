...
func (c *iotDpsCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IotDpsCertificate, err error) {
...
func (c *iotDpsCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IotDpsCertificateList, err error) {
...
func (c *iotDpsCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iotDpsCertificates) Create(ctx context.Context, iotDpsCertificate *v1alpha1.IotDpsCertificate, opts v1.CreateOptions) (result *v1alpha1.IotDpsCertificate, err error) {
	result = &v1alpha1.IotDpsCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iotdpscertificates").
...
func (c *iotDpsCertificates) Update(ctx context.Context, iotDpsCertificate *v1alpha1.IotDpsCertificate, opts v1.UpdateOptions) (result *v1alpha1.IotDpsCertificate, err error) {
	result = &v1alpha1.IotDpsCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iotdpscertificates").
...
func (c *iotDpsCertificates) UpdateStatus(ctx context.Context, iotDpsCertificate *v1alpha1.IotDpsCertificate, opts v1.UpdateOptions) (result *v1alpha1.IotDpsCertificate, err error) {
	result = &v1alpha1.IotDpsCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iotdpscertificates").
...
func (c *iotDpsCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iotDpsCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iotDpsCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IotDpsCertificate, err error) {
	result = &v1alpha1.IotDpsCertificate{}
