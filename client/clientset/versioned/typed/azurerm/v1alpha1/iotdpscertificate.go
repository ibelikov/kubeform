...
type IotDpsCertificateInterface interface {
	Create(*v1alpha1.IotDpsCertificate) (*v1alpha1.IotDpsCertificate, error)
	Update(*v1alpha1.IotDpsCertificate) (*v1alpha1.IotDpsCertificate, error)
	UpdateStatus(*v1alpha1.IotDpsCertificate) (*v1alpha1.IotDpsCertificate, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.IotDpsCertificate, error)
	List(opts v1.ListOptions) (*v1alpha1.IotDpsCertificateList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IotDpsCertificate, err error)
...
func (c *iotDpsCertificates) List(opts v1.ListOptions) (result *v1alpha1.IotDpsCertificateList, err error) {
...
func (c *iotDpsCertificates) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iotDpsCertificates) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
