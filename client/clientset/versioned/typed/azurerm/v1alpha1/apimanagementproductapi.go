...
func (c *apiManagementProductAPIs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiManagementProductAPI, err error) {
...
func (c *apiManagementProductAPIs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiManagementProductAPIList, err error) {
...
func (c *apiManagementProductAPIs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiManagementProductAPIs) Create(ctx context.Context, apiManagementProductAPI *v1alpha1.ApiManagementProductAPI, opts v1.CreateOptions) (result *v1alpha1.ApiManagementProductAPI, err error) {
	result = &v1alpha1.ApiManagementProductAPI{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apimanagementproductapis").
...
func (c *apiManagementProductAPIs) Update(ctx context.Context, apiManagementProductAPI *v1alpha1.ApiManagementProductAPI, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementProductAPI, err error) {
	result = &v1alpha1.ApiManagementProductAPI{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementproductapis").
...
func (c *apiManagementProductAPIs) UpdateStatus(ctx context.Context, apiManagementProductAPI *v1alpha1.ApiManagementProductAPI, opts v1.UpdateOptions) (result *v1alpha1.ApiManagementProductAPI, err error) {
	result = &v1alpha1.ApiManagementProductAPI{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimanagementproductapis").
...
func (c *apiManagementProductAPIs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiManagementProductAPIs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiManagementProductAPIs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiManagementProductAPI, err error) {
	result = &v1alpha1.ApiManagementProductAPI{}
