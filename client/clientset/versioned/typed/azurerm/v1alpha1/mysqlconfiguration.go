...
func (c *mysqlConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MysqlConfiguration, err error) {
...
func (c *mysqlConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MysqlConfigurationList, err error) {
...
func (c *mysqlConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mysqlConfigurations) Create(ctx context.Context, mysqlConfiguration *v1alpha1.MysqlConfiguration, opts v1.CreateOptions) (result *v1alpha1.MysqlConfiguration, err error) {
	result = &v1alpha1.MysqlConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mysqlconfigurations").
...
func (c *mysqlConfigurations) Update(ctx context.Context, mysqlConfiguration *v1alpha1.MysqlConfiguration, opts v1.UpdateOptions) (result *v1alpha1.MysqlConfiguration, err error) {
	result = &v1alpha1.MysqlConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqlconfigurations").
...
func (c *mysqlConfigurations) UpdateStatus(ctx context.Context, mysqlConfiguration *v1alpha1.MysqlConfiguration, opts v1.UpdateOptions) (result *v1alpha1.MysqlConfiguration, err error) {
	result = &v1alpha1.MysqlConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqlconfigurations").
...
func (c *mysqlConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mysqlConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mysqlConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MysqlConfiguration, err error) {
	result = &v1alpha1.MysqlConfiguration{}
