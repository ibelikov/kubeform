...
func (c *automationVariableDatetimes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutomationVariableDatetime, err error) {
...
func (c *automationVariableDatetimes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutomationVariableDatetimeList, err error) {
...
func (c *automationVariableDatetimes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *automationVariableDatetimes) Create(ctx context.Context, automationVariableDatetime *v1alpha1.AutomationVariableDatetime, opts v1.CreateOptions) (result *v1alpha1.AutomationVariableDatetime, err error) {
	result = &v1alpha1.AutomationVariableDatetime{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("automationvariabledatetimes").
...
func (c *automationVariableDatetimes) Update(ctx context.Context, automationVariableDatetime *v1alpha1.AutomationVariableDatetime, opts v1.UpdateOptions) (result *v1alpha1.AutomationVariableDatetime, err error) {
	result = &v1alpha1.AutomationVariableDatetime{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationvariabledatetimes").
...
func (c *automationVariableDatetimes) UpdateStatus(ctx context.Context, automationVariableDatetime *v1alpha1.AutomationVariableDatetime, opts v1.UpdateOptions) (result *v1alpha1.AutomationVariableDatetime, err error) {
	result = &v1alpha1.AutomationVariableDatetime{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("automationvariabledatetimes").
...
func (c *automationVariableDatetimes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *automationVariableDatetimes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *automationVariableDatetimes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutomationVariableDatetime, err error) {
	result = &v1alpha1.AutomationVariableDatetime{}
