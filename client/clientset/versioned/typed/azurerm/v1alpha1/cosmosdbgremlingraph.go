...
func (c *cosmosdbGremlinGraphs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CosmosdbGremlinGraph, err error) {
...
func (c *cosmosdbGremlinGraphs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CosmosdbGremlinGraphList, err error) {
...
func (c *cosmosdbGremlinGraphs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cosmosdbGremlinGraphs) Create(ctx context.Context, cosmosdbGremlinGraph *v1alpha1.CosmosdbGremlinGraph, opts v1.CreateOptions) (result *v1alpha1.CosmosdbGremlinGraph, err error) {
	result = &v1alpha1.CosmosdbGremlinGraph{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cosmosdbgremlingraphs").
...
func (c *cosmosdbGremlinGraphs) Update(ctx context.Context, cosmosdbGremlinGraph *v1alpha1.CosmosdbGremlinGraph, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbGremlinGraph, err error) {
	result = &v1alpha1.CosmosdbGremlinGraph{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbgremlingraphs").
...
func (c *cosmosdbGremlinGraphs) UpdateStatus(ctx context.Context, cosmosdbGremlinGraph *v1alpha1.CosmosdbGremlinGraph, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbGremlinGraph, err error) {
	result = &v1alpha1.CosmosdbGremlinGraph{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbgremlingraphs").
...
func (c *cosmosdbGremlinGraphs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cosmosdbGremlinGraphs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cosmosdbGremlinGraphs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CosmosdbGremlinGraph, err error) {
	result = &v1alpha1.CosmosdbGremlinGraph{}
