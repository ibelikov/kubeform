...
type DataFactoryLinkedServicePostgresqlInterface interface {
	Create(*v1alpha1.DataFactoryLinkedServicePostgresql) (*v1alpha1.DataFactoryLinkedServicePostgresql, error)
	Update(*v1alpha1.DataFactoryLinkedServicePostgresql) (*v1alpha1.DataFactoryLinkedServicePostgresql, error)
	UpdateStatus(*v1alpha1.DataFactoryLinkedServicePostgresql) (*v1alpha1.DataFactoryLinkedServicePostgresql, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DataFactoryLinkedServicePostgresql, error)
	List(opts v1.ListOptions) (*v1alpha1.DataFactoryLinkedServicePostgresqlList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DataFactoryLinkedServicePostgresql, err error)
...
func (c *dataFactoryLinkedServicePostgresqls) List(opts v1.ListOptions) (result *v1alpha1.DataFactoryLinkedServicePostgresqlList, err error) {
...
func (c *dataFactoryLinkedServicePostgresqls) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataFactoryLinkedServicePostgresqls) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
