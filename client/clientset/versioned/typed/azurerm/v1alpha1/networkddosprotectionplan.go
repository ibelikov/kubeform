...
func (c *networkDdosProtectionPlans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkDdosProtectionPlan, err error) {
...
func (c *networkDdosProtectionPlans) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkDdosProtectionPlanList, err error) {
...
func (c *networkDdosProtectionPlans) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkDdosProtectionPlans) Create(ctx context.Context, networkDdosProtectionPlan *v1alpha1.NetworkDdosProtectionPlan, opts v1.CreateOptions) (result *v1alpha1.NetworkDdosProtectionPlan, err error) {
	result = &v1alpha1.NetworkDdosProtectionPlan{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkddosprotectionplans").
...
func (c *networkDdosProtectionPlans) Update(ctx context.Context, networkDdosProtectionPlan *v1alpha1.NetworkDdosProtectionPlan, opts v1.UpdateOptions) (result *v1alpha1.NetworkDdosProtectionPlan, err error) {
	result = &v1alpha1.NetworkDdosProtectionPlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkddosprotectionplans").
...
func (c *networkDdosProtectionPlans) UpdateStatus(ctx context.Context, networkDdosProtectionPlan *v1alpha1.NetworkDdosProtectionPlan, opts v1.UpdateOptions) (result *v1alpha1.NetworkDdosProtectionPlan, err error) {
	result = &v1alpha1.NetworkDdosProtectionPlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkddosprotectionplans").
...
func (c *networkDdosProtectionPlans) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkDdosProtectionPlans) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkDdosProtectionPlans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkDdosProtectionPlan, err error) {
	result = &v1alpha1.NetworkDdosProtectionPlan{}
