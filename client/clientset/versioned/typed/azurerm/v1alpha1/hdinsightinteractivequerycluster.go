...
type HdinsightInteractiveQueryClusterInterface interface {
	Create(*v1alpha1.HdinsightInteractiveQueryCluster) (*v1alpha1.HdinsightInteractiveQueryCluster, error)
	Update(*v1alpha1.HdinsightInteractiveQueryCluster) (*v1alpha1.HdinsightInteractiveQueryCluster, error)
	UpdateStatus(*v1alpha1.HdinsightInteractiveQueryCluster) (*v1alpha1.HdinsightInteractiveQueryCluster, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.HdinsightInteractiveQueryCluster, error)
	List(opts v1.ListOptions) (*v1alpha1.HdinsightInteractiveQueryClusterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.HdinsightInteractiveQueryCluster, err error)
...
func (c *hdinsightInteractiveQueryClusters) List(opts v1.ListOptions) (result *v1alpha1.HdinsightInteractiveQueryClusterList, err error) {
...
func (c *hdinsightInteractiveQueryClusters) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hdinsightInteractiveQueryClusters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
