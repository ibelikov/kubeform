...
func (c *streamAnalyticsJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StreamAnalyticsJob, err error) {
...
func (c *streamAnalyticsJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StreamAnalyticsJobList, err error) {
...
func (c *streamAnalyticsJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *streamAnalyticsJobs) Create(ctx context.Context, streamAnalyticsJob *v1alpha1.StreamAnalyticsJob, opts v1.CreateOptions) (result *v1alpha1.StreamAnalyticsJob, err error) {
	result = &v1alpha1.StreamAnalyticsJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("streamanalyticsjobs").
...
func (c *streamAnalyticsJobs) Update(ctx context.Context, streamAnalyticsJob *v1alpha1.StreamAnalyticsJob, opts v1.UpdateOptions) (result *v1alpha1.StreamAnalyticsJob, err error) {
	result = &v1alpha1.StreamAnalyticsJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("streamanalyticsjobs").
...
func (c *streamAnalyticsJobs) UpdateStatus(ctx context.Context, streamAnalyticsJob *v1alpha1.StreamAnalyticsJob, opts v1.UpdateOptions) (result *v1alpha1.StreamAnalyticsJob, err error) {
	result = &v1alpha1.StreamAnalyticsJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("streamanalyticsjobs").
...
func (c *streamAnalyticsJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *streamAnalyticsJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *streamAnalyticsJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StreamAnalyticsJob, err error) {
	result = &v1alpha1.StreamAnalyticsJob{}
