...
func (c *batchAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BatchAccount, err error) {
...
func (c *batchAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BatchAccountList, err error) {
...
func (c *batchAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *batchAccounts) Create(ctx context.Context, batchAccount *v1alpha1.BatchAccount, opts v1.CreateOptions) (result *v1alpha1.BatchAccount, err error) {
	result = &v1alpha1.BatchAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("batchaccounts").
...
func (c *batchAccounts) Update(ctx context.Context, batchAccount *v1alpha1.BatchAccount, opts v1.UpdateOptions) (result *v1alpha1.BatchAccount, err error) {
	result = &v1alpha1.BatchAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("batchaccounts").
...
func (c *batchAccounts) UpdateStatus(ctx context.Context, batchAccount *v1alpha1.BatchAccount, opts v1.UpdateOptions) (result *v1alpha1.BatchAccount, err error) {
	result = &v1alpha1.BatchAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("batchaccounts").
...
func (c *batchAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *batchAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *batchAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BatchAccount, err error) {
	result = &v1alpha1.BatchAccount{}
