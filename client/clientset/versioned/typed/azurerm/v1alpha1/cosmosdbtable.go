...
func (c *cosmosdbTables) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CosmosdbTable, err error) {
...
func (c *cosmosdbTables) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CosmosdbTableList, err error) {
...
func (c *cosmosdbTables) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cosmosdbTables) Create(ctx context.Context, cosmosdbTable *v1alpha1.CosmosdbTable, opts v1.CreateOptions) (result *v1alpha1.CosmosdbTable, err error) {
	result = &v1alpha1.CosmosdbTable{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cosmosdbtables").
...
func (c *cosmosdbTables) Update(ctx context.Context, cosmosdbTable *v1alpha1.CosmosdbTable, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbTable, err error) {
	result = &v1alpha1.CosmosdbTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbtables").
...
func (c *cosmosdbTables) UpdateStatus(ctx context.Context, cosmosdbTable *v1alpha1.CosmosdbTable, opts v1.UpdateOptions) (result *v1alpha1.CosmosdbTable, err error) {
	result = &v1alpha1.CosmosdbTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cosmosdbtables").
...
func (c *cosmosdbTables) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cosmosdbTables) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cosmosdbTables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CosmosdbTable, err error) {
	result = &v1alpha1.CosmosdbTable{}
