...
type CosmosdbTableInterface interface {
	Create(*v1alpha1.CosmosdbTable) (*v1alpha1.CosmosdbTable, error)
	Update(*v1alpha1.CosmosdbTable) (*v1alpha1.CosmosdbTable, error)
	UpdateStatus(*v1alpha1.CosmosdbTable) (*v1alpha1.CosmosdbTable, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.CosmosdbTable, error)
	List(opts v1.ListOptions) (*v1alpha1.CosmosdbTableList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CosmosdbTable, err error)
...
func (c *cosmosdbTables) List(opts v1.ListOptions) (result *v1alpha1.CosmosdbTableList, err error) {
...
func (c *cosmosdbTables) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cosmosdbTables) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
