...
func (c *monitorMetricAlerts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonitorMetricAlert, err error) {
...
func (c *monitorMetricAlerts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonitorMetricAlertList, err error) {
...
func (c *monitorMetricAlerts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitorMetricAlerts) Create(ctx context.Context, monitorMetricAlert *v1alpha1.MonitorMetricAlert, opts v1.CreateOptions) (result *v1alpha1.MonitorMetricAlert, err error) {
	result = &v1alpha1.MonitorMetricAlert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitormetricalerts").
...
func (c *monitorMetricAlerts) Update(ctx context.Context, monitorMetricAlert *v1alpha1.MonitorMetricAlert, opts v1.UpdateOptions) (result *v1alpha1.MonitorMetricAlert, err error) {
	result = &v1alpha1.MonitorMetricAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitormetricalerts").
...
func (c *monitorMetricAlerts) UpdateStatus(ctx context.Context, monitorMetricAlert *v1alpha1.MonitorMetricAlert, opts v1.UpdateOptions) (result *v1alpha1.MonitorMetricAlert, err error) {
	result = &v1alpha1.MonitorMetricAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitormetricalerts").
...
func (c *monitorMetricAlerts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monitorMetricAlerts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monitorMetricAlerts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MonitorMetricAlert, err error) {
	result = &v1alpha1.MonitorMetricAlert{}
