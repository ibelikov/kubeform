...
func (c *hdinsightStormClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HdinsightStormCluster, err error) {
...
func (c *hdinsightStormClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HdinsightStormClusterList, err error) {
...
func (c *hdinsightStormClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hdinsightStormClusters) Create(ctx context.Context, hdinsightStormCluster *v1alpha1.HdinsightStormCluster, opts v1.CreateOptions) (result *v1alpha1.HdinsightStormCluster, err error) {
	result = &v1alpha1.HdinsightStormCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hdinsightstormclusters").
...
func (c *hdinsightStormClusters) Update(ctx context.Context, hdinsightStormCluster *v1alpha1.HdinsightStormCluster, opts v1.UpdateOptions) (result *v1alpha1.HdinsightStormCluster, err error) {
	result = &v1alpha1.HdinsightStormCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hdinsightstormclusters").
...
func (c *hdinsightStormClusters) UpdateStatus(ctx context.Context, hdinsightStormCluster *v1alpha1.HdinsightStormCluster, opts v1.UpdateOptions) (result *v1alpha1.HdinsightStormCluster, err error) {
	result = &v1alpha1.HdinsightStormCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hdinsightstormclusters").
...
func (c *hdinsightStormClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hdinsightStormClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hdinsightStormClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HdinsightStormCluster, err error) {
	result = &v1alpha1.HdinsightStormCluster{}
