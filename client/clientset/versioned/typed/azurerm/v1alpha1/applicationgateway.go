...
func (c *applicationGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApplicationGateway, err error) {
...
func (c *applicationGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApplicationGatewayList, err error) {
...
func (c *applicationGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *applicationGateways) Create(ctx context.Context, applicationGateway *v1alpha1.ApplicationGateway, opts v1.CreateOptions) (result *v1alpha1.ApplicationGateway, err error) {
	result = &v1alpha1.ApplicationGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("applicationgateways").
...
func (c *applicationGateways) Update(ctx context.Context, applicationGateway *v1alpha1.ApplicationGateway, opts v1.UpdateOptions) (result *v1alpha1.ApplicationGateway, err error) {
	result = &v1alpha1.ApplicationGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationgateways").
...
func (c *applicationGateways) UpdateStatus(ctx context.Context, applicationGateway *v1alpha1.ApplicationGateway, opts v1.UpdateOptions) (result *v1alpha1.ApplicationGateway, err error) {
	result = &v1alpha1.ApplicationGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationgateways").
...
func (c *applicationGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *applicationGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *applicationGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApplicationGateway, err error) {
	result = &v1alpha1.ApplicationGateway{}
