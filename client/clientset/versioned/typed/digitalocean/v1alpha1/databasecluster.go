...
func (c *databaseClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabaseCluster, err error) {
...
func (c *databaseClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabaseClusterList, err error) {
...
func (c *databaseClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databaseClusters) Create(ctx context.Context, databaseCluster *v1alpha1.DatabaseCluster, opts v1.CreateOptions) (result *v1alpha1.DatabaseCluster, err error) {
	result = &v1alpha1.DatabaseCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("databaseclusters").
...
func (c *databaseClusters) Update(ctx context.Context, databaseCluster *v1alpha1.DatabaseCluster, opts v1.UpdateOptions) (result *v1alpha1.DatabaseCluster, err error) {
	result = &v1alpha1.DatabaseCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseclusters").
...
func (c *databaseClusters) UpdateStatus(ctx context.Context, databaseCluster *v1alpha1.DatabaseCluster, opts v1.UpdateOptions) (result *v1alpha1.DatabaseCluster, err error) {
	result = &v1alpha1.DatabaseCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseclusters").
...
func (c *databaseClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *databaseClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *databaseClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabaseCluster, err error) {
	result = &v1alpha1.DatabaseCluster{}
