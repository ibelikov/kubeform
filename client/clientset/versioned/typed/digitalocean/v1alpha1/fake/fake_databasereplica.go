...
// FakeDatabaseReplicas implements DatabaseReplicaInterface
type FakeDatabaseReplicas struct {
	Fake *FakeDigitaloceanV1alpha1
	ns   string
}

var databasereplicasResource = schema.GroupVersionResource{Group: "digitalocean.kubeform.com", Version: "v1alpha1", Resource: "databasereplicas"}
...
func (c *FakeDatabaseReplicas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabaseReplica, err error) {
	...
	return obj.(*v1alpha1.DatabaseReplica), err
}
...
func (c *FakeDatabaseReplicas) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabaseReplicaList, err error) {
	...
	list := &v1alpha1.DatabaseReplicaList{ListMeta: obj.(*v1alpha1.DatabaseReplicaList).ListMeta}
	for _, item := range obj.(*v1alpha1.DatabaseReplicaList).Items {
