...
type RecordInterface interface {
	Create(*v1alpha1.Record) (*v1alpha1.Record, error)
	Update(*v1alpha1.Record) (*v1alpha1.Record, error)
	UpdateStatus(*v1alpha1.Record) (*v1alpha1.Record, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Record, error)
	List(opts v1.ListOptions) (*v1alpha1.RecordList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Record, err error)
	RecordExpansion
}
...
func (c *records) List(opts v1.ListOptions) (result *v1alpha1.RecordList, err error) {
...
func (c *records) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *records) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
