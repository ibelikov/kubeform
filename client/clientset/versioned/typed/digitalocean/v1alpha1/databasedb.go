...
// DatabaseDbsGetter has a method to return a DatabaseDbInterface.
...
// databaseDbs implements DatabaseDbInterface
type databaseDbs struct {
	client rest.Interface
	ns     string
}

// newDatabaseDbs returns a DatabaseDbs
func newDatabaseDbs(c *DigitaloceanV1alpha1Client, namespace string) *databaseDbs {
	return &databaseDbs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *databaseDbs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabaseDb, err error) {
	result = &v1alpha1.DatabaseDb{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("databasedbs").
		Name(name).
...
func (c *databaseDbs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabaseDbList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DatabaseDbList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("databasedbs").
...
func (c *databaseDbs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databaseDbs) Create(ctx context.Context, databaseDb *v1alpha1.DatabaseDb, opts v1.CreateOptions) (result *v1alpha1.DatabaseDb, err error) {
	result = &v1alpha1.DatabaseDb{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("databasedbs").
...
func (c *databaseDbs) Update(ctx context.Context, databaseDb *v1alpha1.DatabaseDb, opts v1.UpdateOptions) (result *v1alpha1.DatabaseDb, err error) {
	result = &v1alpha1.DatabaseDb{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databasedbs").
		Name(databaseDb.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databaseDb).
		Do(ctx).
		Into(result)
...
func (c *databaseDbs) UpdateStatus(ctx context.Context, databaseDb *v1alpha1.DatabaseDb, opts v1.UpdateOptions) (result *v1alpha1.DatabaseDb, err error) {
	result = &v1alpha1.DatabaseDb{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databasedbs").
...
func (c *databaseDbs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *databaseDbs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *databaseDbs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabaseDb, err error) {
	result = &v1alpha1.DatabaseDb{}
