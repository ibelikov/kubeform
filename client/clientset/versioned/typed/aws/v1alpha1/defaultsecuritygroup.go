...
func (c *defaultSecurityGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DefaultSecurityGroup, err error) {
...
func (c *defaultSecurityGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DefaultSecurityGroupList, err error) {
...
func (c *defaultSecurityGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *defaultSecurityGroups) Create(ctx context.Context, defaultSecurityGroup *v1alpha1.DefaultSecurityGroup, opts v1.CreateOptions) (result *v1alpha1.DefaultSecurityGroup, err error) {
	result = &v1alpha1.DefaultSecurityGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("defaultsecuritygroups").
...
func (c *defaultSecurityGroups) Update(ctx context.Context, defaultSecurityGroup *v1alpha1.DefaultSecurityGroup, opts v1.UpdateOptions) (result *v1alpha1.DefaultSecurityGroup, err error) {
	result = &v1alpha1.DefaultSecurityGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("defaultsecuritygroups").
...
func (c *defaultSecurityGroups) UpdateStatus(ctx context.Context, defaultSecurityGroup *v1alpha1.DefaultSecurityGroup, opts v1.UpdateOptions) (result *v1alpha1.DefaultSecurityGroup, err error) {
	result = &v1alpha1.DefaultSecurityGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("defaultsecuritygroups").
...
func (c *defaultSecurityGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *defaultSecurityGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *defaultSecurityGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DefaultSecurityGroup, err error) {
	result = &v1alpha1.DefaultSecurityGroup{}
