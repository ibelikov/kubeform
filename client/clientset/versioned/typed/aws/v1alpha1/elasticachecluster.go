...
type ElasticacheClusterInterface interface {
	Create(*v1alpha1.ElasticacheCluster) (*v1alpha1.ElasticacheCluster, error)
	Update(*v1alpha1.ElasticacheCluster) (*v1alpha1.ElasticacheCluster, error)
	UpdateStatus(*v1alpha1.ElasticacheCluster) (*v1alpha1.ElasticacheCluster, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ElasticacheCluster, error)
	List(opts v1.ListOptions) (*v1alpha1.ElasticacheClusterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ElasticacheCluster, err error)
...
func (c *elasticacheClusters) List(opts v1.ListOptions) (result *v1alpha1.ElasticacheClusterList, err error) {
...
func (c *elasticacheClusters) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *elasticacheClusters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
