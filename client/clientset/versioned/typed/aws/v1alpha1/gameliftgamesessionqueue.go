...
func (c *gameliftGameSessionQueues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GameliftGameSessionQueue, err error) {
...
func (c *gameliftGameSessionQueues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GameliftGameSessionQueueList, err error) {
...
func (c *gameliftGameSessionQueues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *gameliftGameSessionQueues) Create(ctx context.Context, gameliftGameSessionQueue *v1alpha1.GameliftGameSessionQueue, opts v1.CreateOptions) (result *v1alpha1.GameliftGameSessionQueue, err error) {
	result = &v1alpha1.GameliftGameSessionQueue{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gameliftgamesessionqueues").
...
func (c *gameliftGameSessionQueues) Update(ctx context.Context, gameliftGameSessionQueue *v1alpha1.GameliftGameSessionQueue, opts v1.UpdateOptions) (result *v1alpha1.GameliftGameSessionQueue, err error) {
	result = &v1alpha1.GameliftGameSessionQueue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gameliftgamesessionqueues").
...
func (c *gameliftGameSessionQueues) UpdateStatus(ctx context.Context, gameliftGameSessionQueue *v1alpha1.GameliftGameSessionQueue, opts v1.UpdateOptions) (result *v1alpha1.GameliftGameSessionQueue, err error) {
	result = &v1alpha1.GameliftGameSessionQueue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gameliftgamesessionqueues").
...
func (c *gameliftGameSessionQueues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *gameliftGameSessionQueues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *gameliftGameSessionQueues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GameliftGameSessionQueue, err error) {
	result = &v1alpha1.GameliftGameSessionQueue{}
