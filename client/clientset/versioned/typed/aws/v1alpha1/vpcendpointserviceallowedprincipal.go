...
type VpcEndpointServiceAllowedPrincipalInterface interface {
	Create(*v1alpha1.VpcEndpointServiceAllowedPrincipal) (*v1alpha1.VpcEndpointServiceAllowedPrincipal, error)
	Update(*v1alpha1.VpcEndpointServiceAllowedPrincipal) (*v1alpha1.VpcEndpointServiceAllowedPrincipal, error)
	UpdateStatus(*v1alpha1.VpcEndpointServiceAllowedPrincipal) (*v1alpha1.VpcEndpointServiceAllowedPrincipal, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.VpcEndpointServiceAllowedPrincipal, error)
	List(opts v1.ListOptions) (*v1alpha1.VpcEndpointServiceAllowedPrincipalList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error)
...
func (c *vpcEndpointServiceAllowedPrincipals) Get(name string, options v1.GetOptions) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
...
func (c *vpcEndpointServiceAllowedPrincipals) List(opts v1.ListOptions) (result *v1alpha1.VpcEndpointServiceAllowedPrincipalList, err error) {
...
func (c *vpcEndpointServiceAllowedPrincipals) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vpcEndpointServiceAllowedPrincipals) Create(vpcEndpointServiceAllowedPrincipal *v1alpha1.VpcEndpointServiceAllowedPrincipal) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
	result = &v1alpha1.VpcEndpointServiceAllowedPrincipal{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpcendpointserviceallowedprincipals").
...
func (c *vpcEndpointServiceAllowedPrincipals) Update(vpcEndpointServiceAllowedPrincipal *v1alpha1.VpcEndpointServiceAllowedPrincipal) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
	result = &v1alpha1.VpcEndpointServiceAllowedPrincipal{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcendpointserviceallowedprincipals").
...
func (c *vpcEndpointServiceAllowedPrincipals) UpdateStatus(vpcEndpointServiceAllowedPrincipal *v1alpha1.VpcEndpointServiceAllowedPrincipal) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
	result = &v1alpha1.VpcEndpointServiceAllowedPrincipal{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcendpointserviceallowedprincipals").
...
func (c *vpcEndpointServiceAllowedPrincipals) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *vpcEndpointServiceAllowedPrincipals) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vpcEndpointServiceAllowedPrincipals) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
	result = &v1alpha1.VpcEndpointServiceAllowedPrincipal{}
