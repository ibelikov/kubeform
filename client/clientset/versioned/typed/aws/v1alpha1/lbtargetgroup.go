...
func (c *lbTargetGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LbTargetGroup, err error) {
...
func (c *lbTargetGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LbTargetGroupList, err error) {
...
func (c *lbTargetGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lbTargetGroups) Create(ctx context.Context, lbTargetGroup *v1alpha1.LbTargetGroup, opts v1.CreateOptions) (result *v1alpha1.LbTargetGroup, err error) {
	result = &v1alpha1.LbTargetGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lbtargetgroups").
...
func (c *lbTargetGroups) Update(ctx context.Context, lbTargetGroup *v1alpha1.LbTargetGroup, opts v1.UpdateOptions) (result *v1alpha1.LbTargetGroup, err error) {
	result = &v1alpha1.LbTargetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lbtargetgroups").
...
func (c *lbTargetGroups) UpdateStatus(ctx context.Context, lbTargetGroup *v1alpha1.LbTargetGroup, opts v1.UpdateOptions) (result *v1alpha1.LbTargetGroup, err error) {
	result = &v1alpha1.LbTargetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lbtargetgroups").
...
func (c *lbTargetGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lbTargetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lbTargetGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LbTargetGroup, err error) {
	result = &v1alpha1.LbTargetGroup{}
