...
func (c *apiGatewayDomainNames) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayDomainName, err error) {
...
func (c *apiGatewayDomainNames) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayDomainNameList, err error) {
...
func (c *apiGatewayDomainNames) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiGatewayDomainNames) Create(ctx context.Context, apiGatewayDomainName *v1alpha1.ApiGatewayDomainName, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayDomainName, err error) {
	result = &v1alpha1.ApiGatewayDomainName{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigatewaydomainnames").
...
func (c *apiGatewayDomainNames) Update(ctx context.Context, apiGatewayDomainName *v1alpha1.ApiGatewayDomainName, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayDomainName, err error) {
	result = &v1alpha1.ApiGatewayDomainName{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewaydomainnames").
...
func (c *apiGatewayDomainNames) UpdateStatus(ctx context.Context, apiGatewayDomainName *v1alpha1.ApiGatewayDomainName, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayDomainName, err error) {
	result = &v1alpha1.ApiGatewayDomainName{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewaydomainnames").
...
func (c *apiGatewayDomainNames) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiGatewayDomainNames) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiGatewayDomainNames) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayDomainName, err error) {
	result = &v1alpha1.ApiGatewayDomainName{}
