...
func (c *serviceDiscoveryHTTPNamespaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceDiscoveryHTTPNamespace, err error) {
...
func (c *serviceDiscoveryHTTPNamespaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceDiscoveryHTTPNamespaceList, err error) {
...
func (c *serviceDiscoveryHTTPNamespaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceDiscoveryHTTPNamespaces) Create(ctx context.Context, serviceDiscoveryHTTPNamespace *v1alpha1.ServiceDiscoveryHTTPNamespace, opts v1.CreateOptions) (result *v1alpha1.ServiceDiscoveryHTTPNamespace, err error) {
	result = &v1alpha1.ServiceDiscoveryHTTPNamespace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicediscoveryhttpnamespaces").
...
func (c *serviceDiscoveryHTTPNamespaces) Update(ctx context.Context, serviceDiscoveryHTTPNamespace *v1alpha1.ServiceDiscoveryHTTPNamespace, opts v1.UpdateOptions) (result *v1alpha1.ServiceDiscoveryHTTPNamespace, err error) {
	result = &v1alpha1.ServiceDiscoveryHTTPNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicediscoveryhttpnamespaces").
...
func (c *serviceDiscoveryHTTPNamespaces) UpdateStatus(ctx context.Context, serviceDiscoveryHTTPNamespace *v1alpha1.ServiceDiscoveryHTTPNamespace, opts v1.UpdateOptions) (result *v1alpha1.ServiceDiscoveryHTTPNamespace, err error) {
	result = &v1alpha1.ServiceDiscoveryHTTPNamespace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicediscoveryhttpnamespaces").
...
func (c *serviceDiscoveryHTTPNamespaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *serviceDiscoveryHTTPNamespaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *serviceDiscoveryHTTPNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceDiscoveryHTTPNamespace, err error) {
	result = &v1alpha1.ServiceDiscoveryHTTPNamespace{}
