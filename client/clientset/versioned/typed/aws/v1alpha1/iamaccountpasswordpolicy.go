...
func (c *iamAccountPasswordPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
...
func (c *iamAccountPasswordPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamAccountPasswordPolicyList, err error) {
...
func (c *iamAccountPasswordPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamAccountPasswordPolicies) Create(ctx context.Context, iamAccountPasswordPolicy *v1alpha1.IamAccountPasswordPolicy, opts v1.CreateOptions) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
	result = &v1alpha1.IamAccountPasswordPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamaccountpasswordpolicies").
...
func (c *iamAccountPasswordPolicies) Update(ctx context.Context, iamAccountPasswordPolicy *v1alpha1.IamAccountPasswordPolicy, opts v1.UpdateOptions) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
	result = &v1alpha1.IamAccountPasswordPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamaccountpasswordpolicies").
...
func (c *iamAccountPasswordPolicies) UpdateStatus(ctx context.Context, iamAccountPasswordPolicy *v1alpha1.IamAccountPasswordPolicy, opts v1.UpdateOptions) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
	result = &v1alpha1.IamAccountPasswordPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamaccountpasswordpolicies").
...
func (c *iamAccountPasswordPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamAccountPasswordPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamAccountPasswordPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
	result = &v1alpha1.IamAccountPasswordPolicy{}
