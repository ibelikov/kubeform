...
func (c *iamAccountAliases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamAccountAlias, err error) {
...
func (c *iamAccountAliases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamAccountAliasList, err error) {
...
func (c *iamAccountAliases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamAccountAliases) Create(ctx context.Context, iamAccountAlias *v1alpha1.IamAccountAlias, opts v1.CreateOptions) (result *v1alpha1.IamAccountAlias, err error) {
	result = &v1alpha1.IamAccountAlias{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamaccountaliases").
...
func (c *iamAccountAliases) Update(ctx context.Context, iamAccountAlias *v1alpha1.IamAccountAlias, opts v1.UpdateOptions) (result *v1alpha1.IamAccountAlias, err error) {
	result = &v1alpha1.IamAccountAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamaccountaliases").
...
func (c *iamAccountAliases) UpdateStatus(ctx context.Context, iamAccountAlias *v1alpha1.IamAccountAlias, opts v1.UpdateOptions) (result *v1alpha1.IamAccountAlias, err error) {
	result = &v1alpha1.IamAccountAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamaccountaliases").
...
func (c *iamAccountAliases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamAccountAliases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamAccountAliases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamAccountAlias, err error) {
	result = &v1alpha1.IamAccountAlias{}
