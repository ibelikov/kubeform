...
func (c *elasticBeanstalkApplications) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ElasticBeanstalkApplication, err error) {
...
func (c *elasticBeanstalkApplications) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElasticBeanstalkApplicationList, err error) {
...
func (c *elasticBeanstalkApplications) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *elasticBeanstalkApplications) Create(ctx context.Context, elasticBeanstalkApplication *v1alpha1.ElasticBeanstalkApplication, opts v1.CreateOptions) (result *v1alpha1.ElasticBeanstalkApplication, err error) {
	result = &v1alpha1.ElasticBeanstalkApplication{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("elasticbeanstalkapplications").
...
func (c *elasticBeanstalkApplications) Update(ctx context.Context, elasticBeanstalkApplication *v1alpha1.ElasticBeanstalkApplication, opts v1.UpdateOptions) (result *v1alpha1.ElasticBeanstalkApplication, err error) {
	result = &v1alpha1.ElasticBeanstalkApplication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticbeanstalkapplications").
...
func (c *elasticBeanstalkApplications) UpdateStatus(ctx context.Context, elasticBeanstalkApplication *v1alpha1.ElasticBeanstalkApplication, opts v1.UpdateOptions) (result *v1alpha1.ElasticBeanstalkApplication, err error) {
	result = &v1alpha1.ElasticBeanstalkApplication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticbeanstalkapplications").
...
func (c *elasticBeanstalkApplications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *elasticBeanstalkApplications) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *elasticBeanstalkApplications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ElasticBeanstalkApplication, err error) {
	result = &v1alpha1.ElasticBeanstalkApplication{}
