...
func (c *snsSmsPreferenceses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SnsSmsPreferences, err error) {
...
func (c *snsSmsPreferenceses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SnsSmsPreferencesList, err error) {
...
func (c *snsSmsPreferenceses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *snsSmsPreferenceses) Create(ctx context.Context, snsSmsPreferences *v1alpha1.SnsSmsPreferences, opts v1.CreateOptions) (result *v1alpha1.SnsSmsPreferences, err error) {
	result = &v1alpha1.SnsSmsPreferences{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("snssmspreferenceses").
...
func (c *snsSmsPreferenceses) Update(ctx context.Context, snsSmsPreferences *v1alpha1.SnsSmsPreferences, opts v1.UpdateOptions) (result *v1alpha1.SnsSmsPreferences, err error) {
	result = &v1alpha1.SnsSmsPreferences{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snssmspreferenceses").
...
func (c *snsSmsPreferenceses) UpdateStatus(ctx context.Context, snsSmsPreferences *v1alpha1.SnsSmsPreferences, opts v1.UpdateOptions) (result *v1alpha1.SnsSmsPreferences, err error) {
	result = &v1alpha1.SnsSmsPreferences{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snssmspreferenceses").
...
func (c *snsSmsPreferenceses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *snsSmsPreferenceses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *snsSmsPreferenceses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SnsSmsPreferences, err error) {
	result = &v1alpha1.SnsSmsPreferences{}
