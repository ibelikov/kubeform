...
func (c *lightsailStaticIPAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LightsailStaticIPAttachment, err error) {
...
func (c *lightsailStaticIPAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LightsailStaticIPAttachmentList, err error) {
...
func (c *lightsailStaticIPAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lightsailStaticIPAttachments) Create(ctx context.Context, lightsailStaticIPAttachment *v1alpha1.LightsailStaticIPAttachment, opts v1.CreateOptions) (result *v1alpha1.LightsailStaticIPAttachment, err error) {
	result = &v1alpha1.LightsailStaticIPAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lightsailstaticipattachments").
...
func (c *lightsailStaticIPAttachments) Update(ctx context.Context, lightsailStaticIPAttachment *v1alpha1.LightsailStaticIPAttachment, opts v1.UpdateOptions) (result *v1alpha1.LightsailStaticIPAttachment, err error) {
	result = &v1alpha1.LightsailStaticIPAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lightsailstaticipattachments").
...
func (c *lightsailStaticIPAttachments) UpdateStatus(ctx context.Context, lightsailStaticIPAttachment *v1alpha1.LightsailStaticIPAttachment, opts v1.UpdateOptions) (result *v1alpha1.LightsailStaticIPAttachment, err error) {
	result = &v1alpha1.LightsailStaticIPAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lightsailstaticipattachments").
...
func (c *lightsailStaticIPAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lightsailStaticIPAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lightsailStaticIPAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LightsailStaticIPAttachment, err error) {
	result = &v1alpha1.LightsailStaticIPAttachment{}
