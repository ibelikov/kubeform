...
func (c *vpnGatewayRoutePropagations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpnGatewayRoutePropagation, err error) {
...
func (c *vpnGatewayRoutePropagations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpnGatewayRoutePropagationList, err error) {
...
func (c *vpnGatewayRoutePropagations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vpnGatewayRoutePropagations) Create(ctx context.Context, vpnGatewayRoutePropagation *v1alpha1.VpnGatewayRoutePropagation, opts v1.CreateOptions) (result *v1alpha1.VpnGatewayRoutePropagation, err error) {
	result = &v1alpha1.VpnGatewayRoutePropagation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpngatewayroutepropagations").
...
func (c *vpnGatewayRoutePropagations) Update(ctx context.Context, vpnGatewayRoutePropagation *v1alpha1.VpnGatewayRoutePropagation, opts v1.UpdateOptions) (result *v1alpha1.VpnGatewayRoutePropagation, err error) {
	result = &v1alpha1.VpnGatewayRoutePropagation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpngatewayroutepropagations").
...
func (c *vpnGatewayRoutePropagations) UpdateStatus(ctx context.Context, vpnGatewayRoutePropagation *v1alpha1.VpnGatewayRoutePropagation, opts v1.UpdateOptions) (result *v1alpha1.VpnGatewayRoutePropagation, err error) {
	result = &v1alpha1.VpnGatewayRoutePropagation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpngatewayroutepropagations").
...
func (c *vpnGatewayRoutePropagations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vpnGatewayRoutePropagations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vpnGatewayRoutePropagations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpnGatewayRoutePropagation, err error) {
	result = &v1alpha1.VpnGatewayRoutePropagation{}
