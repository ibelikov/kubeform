...
func (c *kmsKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KmsKey, err error) {
...
func (c *kmsKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KmsKeyList, err error) {
...
func (c *kmsKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kmsKeys) Create(ctx context.Context, kmsKey *v1alpha1.KmsKey, opts v1.CreateOptions) (result *v1alpha1.KmsKey, err error) {
	result = &v1alpha1.KmsKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kmskeys").
...
func (c *kmsKeys) Update(ctx context.Context, kmsKey *v1alpha1.KmsKey, opts v1.UpdateOptions) (result *v1alpha1.KmsKey, err error) {
	result = &v1alpha1.KmsKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmskeys").
...
func (c *kmsKeys) UpdateStatus(ctx context.Context, kmsKey *v1alpha1.KmsKey, opts v1.UpdateOptions) (result *v1alpha1.KmsKey, err error) {
	result = &v1alpha1.KmsKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmskeys").
...
func (c *kmsKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kmsKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kmsKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KmsKey, err error) {
	result = &v1alpha1.KmsKey{}
