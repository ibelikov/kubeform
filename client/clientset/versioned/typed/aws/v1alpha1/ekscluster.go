...
func (c *eksClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EksCluster, err error) {
...
func (c *eksClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EksClusterList, err error) {
...
func (c *eksClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *eksClusters) Create(ctx context.Context, eksCluster *v1alpha1.EksCluster, opts v1.CreateOptions) (result *v1alpha1.EksCluster, err error) {
	result = &v1alpha1.EksCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("eksclusters").
...
func (c *eksClusters) Update(ctx context.Context, eksCluster *v1alpha1.EksCluster, opts v1.UpdateOptions) (result *v1alpha1.EksCluster, err error) {
	result = &v1alpha1.EksCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eksclusters").
...
func (c *eksClusters) UpdateStatus(ctx context.Context, eksCluster *v1alpha1.EksCluster, opts v1.UpdateOptions) (result *v1alpha1.EksCluster, err error) {
	result = &v1alpha1.EksCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eksclusters").
...
func (c *eksClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *eksClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *eksClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EksCluster, err error) {
	result = &v1alpha1.EksCluster{}
