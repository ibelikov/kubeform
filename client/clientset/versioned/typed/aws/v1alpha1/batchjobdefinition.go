...
func (c *batchJobDefinitions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BatchJobDefinition, err error) {
...
func (c *batchJobDefinitions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BatchJobDefinitionList, err error) {
...
func (c *batchJobDefinitions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *batchJobDefinitions) Create(ctx context.Context, batchJobDefinition *v1alpha1.BatchJobDefinition, opts v1.CreateOptions) (result *v1alpha1.BatchJobDefinition, err error) {
	result = &v1alpha1.BatchJobDefinition{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("batchjobdefinitions").
...
func (c *batchJobDefinitions) Update(ctx context.Context, batchJobDefinition *v1alpha1.BatchJobDefinition, opts v1.UpdateOptions) (result *v1alpha1.BatchJobDefinition, err error) {
	result = &v1alpha1.BatchJobDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("batchjobdefinitions").
...
func (c *batchJobDefinitions) UpdateStatus(ctx context.Context, batchJobDefinition *v1alpha1.BatchJobDefinition, opts v1.UpdateOptions) (result *v1alpha1.BatchJobDefinition, err error) {
	result = &v1alpha1.BatchJobDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("batchjobdefinitions").
...
func (c *batchJobDefinitions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *batchJobDefinitions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *batchJobDefinitions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BatchJobDefinition, err error) {
	result = &v1alpha1.BatchJobDefinition{}
