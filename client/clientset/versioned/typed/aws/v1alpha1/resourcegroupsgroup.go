...
func (c *resourcegroupsGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourcegroupsGroup, err error) {
...
func (c *resourcegroupsGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourcegroupsGroupList, err error) {
...
func (c *resourcegroupsGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resourcegroupsGroups) Create(ctx context.Context, resourcegroupsGroup *v1alpha1.ResourcegroupsGroup, opts v1.CreateOptions) (result *v1alpha1.ResourcegroupsGroup, err error) {
	result = &v1alpha1.ResourcegroupsGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourcegroupsgroups").
...
func (c *resourcegroupsGroups) Update(ctx context.Context, resourcegroupsGroup *v1alpha1.ResourcegroupsGroup, opts v1.UpdateOptions) (result *v1alpha1.ResourcegroupsGroup, err error) {
	result = &v1alpha1.ResourcegroupsGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcegroupsgroups").
...
func (c *resourcegroupsGroups) UpdateStatus(ctx context.Context, resourcegroupsGroup *v1alpha1.ResourcegroupsGroup, opts v1.UpdateOptions) (result *v1alpha1.ResourcegroupsGroup, err error) {
	result = &v1alpha1.ResourcegroupsGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcegroupsgroups").
...
func (c *resourcegroupsGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *resourcegroupsGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *resourcegroupsGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourcegroupsGroup, err error) {
	result = &v1alpha1.ResourcegroupsGroup{}
