...
func (c *cloudwatchLogGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudwatchLogGroup, err error) {
...
func (c *cloudwatchLogGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudwatchLogGroupList, err error) {
...
func (c *cloudwatchLogGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudwatchLogGroups) Create(ctx context.Context, cloudwatchLogGroup *v1alpha1.CloudwatchLogGroup, opts v1.CreateOptions) (result *v1alpha1.CloudwatchLogGroup, err error) {
	result = &v1alpha1.CloudwatchLogGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudwatchloggroups").
...
func (c *cloudwatchLogGroups) Update(ctx context.Context, cloudwatchLogGroup *v1alpha1.CloudwatchLogGroup, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogGroup, err error) {
	result = &v1alpha1.CloudwatchLogGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudwatchloggroups").
...
func (c *cloudwatchLogGroups) UpdateStatus(ctx context.Context, cloudwatchLogGroup *v1alpha1.CloudwatchLogGroup, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogGroup, err error) {
	result = &v1alpha1.CloudwatchLogGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudwatchloggroups").
...
func (c *cloudwatchLogGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudwatchLogGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudwatchLogGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudwatchLogGroup, err error) {
	result = &v1alpha1.CloudwatchLogGroup{}
