...
func (c *autoscalingAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoscalingAttachment, err error) {
...
func (c *autoscalingAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoscalingAttachmentList, err error) {
...
func (c *autoscalingAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *autoscalingAttachments) Create(ctx context.Context, autoscalingAttachment *v1alpha1.AutoscalingAttachment, opts v1.CreateOptions) (result *v1alpha1.AutoscalingAttachment, err error) {
	result = &v1alpha1.AutoscalingAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("autoscalingattachments").
...
func (c *autoscalingAttachments) Update(ctx context.Context, autoscalingAttachment *v1alpha1.AutoscalingAttachment, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingAttachment, err error) {
	result = &v1alpha1.AutoscalingAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autoscalingattachments").
...
func (c *autoscalingAttachments) UpdateStatus(ctx context.Context, autoscalingAttachment *v1alpha1.AutoscalingAttachment, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingAttachment, err error) {
	result = &v1alpha1.AutoscalingAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autoscalingattachments").
...
func (c *autoscalingAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *autoscalingAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *autoscalingAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoscalingAttachment, err error) {
	result = &v1alpha1.AutoscalingAttachment{}
