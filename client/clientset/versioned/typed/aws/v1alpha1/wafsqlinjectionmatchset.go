...
func (c *wafSQLInjectionMatchSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafSQLInjectionMatchSet, err error) {
...
func (c *wafSQLInjectionMatchSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafSQLInjectionMatchSetList, err error) {
...
func (c *wafSQLInjectionMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafSQLInjectionMatchSets) Create(ctx context.Context, wafSQLInjectionMatchSet *v1alpha1.WafSQLInjectionMatchSet, opts v1.CreateOptions) (result *v1alpha1.WafSQLInjectionMatchSet, err error) {
	result = &v1alpha1.WafSQLInjectionMatchSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafsqlinjectionmatchsets").
...
func (c *wafSQLInjectionMatchSets) Update(ctx context.Context, wafSQLInjectionMatchSet *v1alpha1.WafSQLInjectionMatchSet, opts v1.UpdateOptions) (result *v1alpha1.WafSQLInjectionMatchSet, err error) {
	result = &v1alpha1.WafSQLInjectionMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafsqlinjectionmatchsets").
...
func (c *wafSQLInjectionMatchSets) UpdateStatus(ctx context.Context, wafSQLInjectionMatchSet *v1alpha1.WafSQLInjectionMatchSet, opts v1.UpdateOptions) (result *v1alpha1.WafSQLInjectionMatchSet, err error) {
	result = &v1alpha1.WafSQLInjectionMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafsqlinjectionmatchsets").
...
func (c *wafSQLInjectionMatchSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafSQLInjectionMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafSQLInjectionMatchSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafSQLInjectionMatchSet, err error) {
	result = &v1alpha1.WafSQLInjectionMatchSet{}
