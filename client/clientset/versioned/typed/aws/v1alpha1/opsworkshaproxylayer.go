...
type OpsworksHaproxyLayerInterface interface {
	Create(*v1alpha1.OpsworksHaproxyLayer) (*v1alpha1.OpsworksHaproxyLayer, error)
	Update(*v1alpha1.OpsworksHaproxyLayer) (*v1alpha1.OpsworksHaproxyLayer, error)
	UpdateStatus(*v1alpha1.OpsworksHaproxyLayer) (*v1alpha1.OpsworksHaproxyLayer, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.OpsworksHaproxyLayer, error)
	List(opts v1.ListOptions) (*v1alpha1.OpsworksHaproxyLayerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OpsworksHaproxyLayer, err error)
...
func (c *opsworksHaproxyLayers) List(opts v1.ListOptions) (result *v1alpha1.OpsworksHaproxyLayerList, err error) {
...
func (c *opsworksHaproxyLayers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksHaproxyLayers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
