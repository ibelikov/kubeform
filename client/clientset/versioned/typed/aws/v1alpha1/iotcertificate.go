...
func (c *iotCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IotCertificate, err error) {
...
func (c *iotCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IotCertificateList, err error) {
...
func (c *iotCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iotCertificates) Create(ctx context.Context, iotCertificate *v1alpha1.IotCertificate, opts v1.CreateOptions) (result *v1alpha1.IotCertificate, err error) {
	result = &v1alpha1.IotCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iotcertificates").
...
func (c *iotCertificates) Update(ctx context.Context, iotCertificate *v1alpha1.IotCertificate, opts v1.UpdateOptions) (result *v1alpha1.IotCertificate, err error) {
	result = &v1alpha1.IotCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iotcertificates").
...
func (c *iotCertificates) UpdateStatus(ctx context.Context, iotCertificate *v1alpha1.IotCertificate, opts v1.UpdateOptions) (result *v1alpha1.IotCertificate, err error) {
	result = &v1alpha1.IotCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iotcertificates").
...
func (c *iotCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iotCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iotCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IotCertificate, err error) {
	result = &v1alpha1.IotCertificate{}
