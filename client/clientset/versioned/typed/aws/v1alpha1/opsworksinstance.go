...
func (c *opsworksInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksInstance, err error) {
...
func (c *opsworksInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksInstanceList, err error) {
...
func (c *opsworksInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksInstances) Create(ctx context.Context, opsworksInstance *v1alpha1.OpsworksInstance, opts v1.CreateOptions) (result *v1alpha1.OpsworksInstance, err error) {
	result = &v1alpha1.OpsworksInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("opsworksinstances").
...
func (c *opsworksInstances) Update(ctx context.Context, opsworksInstance *v1alpha1.OpsworksInstance, opts v1.UpdateOptions) (result *v1alpha1.OpsworksInstance, err error) {
	result = &v1alpha1.OpsworksInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworksinstances").
...
func (c *opsworksInstances) UpdateStatus(ctx context.Context, opsworksInstance *v1alpha1.OpsworksInstance, opts v1.UpdateOptions) (result *v1alpha1.OpsworksInstance, err error) {
	result = &v1alpha1.OpsworksInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworksinstances").
...
func (c *opsworksInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *opsworksInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *opsworksInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksInstance, err error) {
	result = &v1alpha1.OpsworksInstance{}
