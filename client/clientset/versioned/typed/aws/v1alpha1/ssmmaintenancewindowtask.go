...
func (c *ssmMaintenanceWindowTasks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SsmMaintenanceWindowTask, err error) {
...
func (c *ssmMaintenanceWindowTasks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SsmMaintenanceWindowTaskList, err error) {
...
func (c *ssmMaintenanceWindowTasks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssmMaintenanceWindowTasks) Create(ctx context.Context, ssmMaintenanceWindowTask *v1alpha1.SsmMaintenanceWindowTask, opts v1.CreateOptions) (result *v1alpha1.SsmMaintenanceWindowTask, err error) {
	result = &v1alpha1.SsmMaintenanceWindowTask{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ssmmaintenancewindowtasks").
...
func (c *ssmMaintenanceWindowTasks) Update(ctx context.Context, ssmMaintenanceWindowTask *v1alpha1.SsmMaintenanceWindowTask, opts v1.UpdateOptions) (result *v1alpha1.SsmMaintenanceWindowTask, err error) {
	result = &v1alpha1.SsmMaintenanceWindowTask{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmmaintenancewindowtasks").
...
func (c *ssmMaintenanceWindowTasks) UpdateStatus(ctx context.Context, ssmMaintenanceWindowTask *v1alpha1.SsmMaintenanceWindowTask, opts v1.UpdateOptions) (result *v1alpha1.SsmMaintenanceWindowTask, err error) {
	result = &v1alpha1.SsmMaintenanceWindowTask{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmmaintenancewindowtasks").
...
func (c *ssmMaintenanceWindowTasks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ssmMaintenanceWindowTasks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ssmMaintenanceWindowTasks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SsmMaintenanceWindowTask, err error) {
	result = &v1alpha1.SsmMaintenanceWindowTask{}
