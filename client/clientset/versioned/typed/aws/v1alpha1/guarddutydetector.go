...
func (c *guarddutyDetectors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GuarddutyDetector, err error) {
...
func (c *guarddutyDetectors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GuarddutyDetectorList, err error) {
...
func (c *guarddutyDetectors) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *guarddutyDetectors) Create(ctx context.Context, guarddutyDetector *v1alpha1.GuarddutyDetector, opts v1.CreateOptions) (result *v1alpha1.GuarddutyDetector, err error) {
	result = &v1alpha1.GuarddutyDetector{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("guarddutydetectors").
...
func (c *guarddutyDetectors) Update(ctx context.Context, guarddutyDetector *v1alpha1.GuarddutyDetector, opts v1.UpdateOptions) (result *v1alpha1.GuarddutyDetector, err error) {
	result = &v1alpha1.GuarddutyDetector{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("guarddutydetectors").
...
func (c *guarddutyDetectors) UpdateStatus(ctx context.Context, guarddutyDetector *v1alpha1.GuarddutyDetector, opts v1.UpdateOptions) (result *v1alpha1.GuarddutyDetector, err error) {
	result = &v1alpha1.GuarddutyDetector{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("guarddutydetectors").
...
func (c *guarddutyDetectors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *guarddutyDetectors) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *guarddutyDetectors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GuarddutyDetector, err error) {
	result = &v1alpha1.GuarddutyDetector{}
