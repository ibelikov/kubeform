...
func (c *globalacceleratorListeners) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlobalacceleratorListener, err error) {
...
func (c *globalacceleratorListeners) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlobalacceleratorListenerList, err error) {
...
func (c *globalacceleratorListeners) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *globalacceleratorListeners) Create(ctx context.Context, globalacceleratorListener *v1alpha1.GlobalacceleratorListener, opts v1.CreateOptions) (result *v1alpha1.GlobalacceleratorListener, err error) {
	result = &v1alpha1.GlobalacceleratorListener{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("globalacceleratorlisteners").
...
func (c *globalacceleratorListeners) Update(ctx context.Context, globalacceleratorListener *v1alpha1.GlobalacceleratorListener, opts v1.UpdateOptions) (result *v1alpha1.GlobalacceleratorListener, err error) {
	result = &v1alpha1.GlobalacceleratorListener{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("globalacceleratorlisteners").
...
func (c *globalacceleratorListeners) UpdateStatus(ctx context.Context, globalacceleratorListener *v1alpha1.GlobalacceleratorListener, opts v1.UpdateOptions) (result *v1alpha1.GlobalacceleratorListener, err error) {
	result = &v1alpha1.GlobalacceleratorListener{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("globalacceleratorlisteners").
...
func (c *globalacceleratorListeners) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *globalacceleratorListeners) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *globalacceleratorListeners) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlobalacceleratorListener, err error) {
	result = &v1alpha1.GlobalacceleratorListener{}
