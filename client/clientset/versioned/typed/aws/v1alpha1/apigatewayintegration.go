...
type ApiGatewayIntegrationInterface interface {
	Create(*v1alpha1.ApiGatewayIntegration) (*v1alpha1.ApiGatewayIntegration, error)
	Update(*v1alpha1.ApiGatewayIntegration) (*v1alpha1.ApiGatewayIntegration, error)
	UpdateStatus(*v1alpha1.ApiGatewayIntegration) (*v1alpha1.ApiGatewayIntegration, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ApiGatewayIntegration, error)
	List(opts v1.ListOptions) (*v1alpha1.ApiGatewayIntegrationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiGatewayIntegration, err error)
...
func (c *apiGatewayIntegrations) List(opts v1.ListOptions) (result *v1alpha1.ApiGatewayIntegrationList, err error) {
...
func (c *apiGatewayIntegrations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiGatewayIntegrations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
