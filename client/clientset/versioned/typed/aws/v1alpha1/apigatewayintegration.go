...
func (c *apiGatewayIntegrations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayIntegration, err error) {
...
func (c *apiGatewayIntegrations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayIntegrationList, err error) {
...
func (c *apiGatewayIntegrations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiGatewayIntegrations) Create(ctx context.Context, apiGatewayIntegration *v1alpha1.ApiGatewayIntegration, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayIntegration, err error) {
	result = &v1alpha1.ApiGatewayIntegration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigatewayintegrations").
...
func (c *apiGatewayIntegrations) Update(ctx context.Context, apiGatewayIntegration *v1alpha1.ApiGatewayIntegration, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayIntegration, err error) {
	result = &v1alpha1.ApiGatewayIntegration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewayintegrations").
...
func (c *apiGatewayIntegrations) UpdateStatus(ctx context.Context, apiGatewayIntegration *v1alpha1.ApiGatewayIntegration, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayIntegration, err error) {
	result = &v1alpha1.ApiGatewayIntegration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewayintegrations").
...
func (c *apiGatewayIntegrations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiGatewayIntegrations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiGatewayIntegrations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayIntegration, err error) {
	result = &v1alpha1.ApiGatewayIntegration{}
