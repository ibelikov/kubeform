...
type RedshiftParameterGroupInterface interface {
	Create(*v1alpha1.RedshiftParameterGroup) (*v1alpha1.RedshiftParameterGroup, error)
	Update(*v1alpha1.RedshiftParameterGroup) (*v1alpha1.RedshiftParameterGroup, error)
	UpdateStatus(*v1alpha1.RedshiftParameterGroup) (*v1alpha1.RedshiftParameterGroup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.RedshiftParameterGroup, error)
	List(opts v1.ListOptions) (*v1alpha1.RedshiftParameterGroupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.RedshiftParameterGroup, err error)
...
func (c *redshiftParameterGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.RedshiftParameterGroup, err error) {
...
func (c *redshiftParameterGroups) List(opts v1.ListOptions) (result *v1alpha1.RedshiftParameterGroupList, err error) {
...
func (c *redshiftParameterGroups) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *redshiftParameterGroups) Create(redshiftParameterGroup *v1alpha1.RedshiftParameterGroup) (result *v1alpha1.RedshiftParameterGroup, err error) {
	result = &v1alpha1.RedshiftParameterGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("redshiftparametergroups").
...
func (c *redshiftParameterGroups) Update(redshiftParameterGroup *v1alpha1.RedshiftParameterGroup) (result *v1alpha1.RedshiftParameterGroup, err error) {
	result = &v1alpha1.RedshiftParameterGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redshiftparametergroups").
...
func (c *redshiftParameterGroups) UpdateStatus(redshiftParameterGroup *v1alpha1.RedshiftParameterGroup) (result *v1alpha1.RedshiftParameterGroup, err error) {
	result = &v1alpha1.RedshiftParameterGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redshiftparametergroups").
...
func (c *redshiftParameterGroups) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *redshiftParameterGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *redshiftParameterGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.RedshiftParameterGroup, err error) {
	result = &v1alpha1.RedshiftParameterGroup{}
