...
func (c *spotDatafeedSubscriptions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpotDatafeedSubscription, err error) {
...
func (c *spotDatafeedSubscriptions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpotDatafeedSubscriptionList, err error) {
...
func (c *spotDatafeedSubscriptions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *spotDatafeedSubscriptions) Create(ctx context.Context, spotDatafeedSubscription *v1alpha1.SpotDatafeedSubscription, opts v1.CreateOptions) (result *v1alpha1.SpotDatafeedSubscription, err error) {
	result = &v1alpha1.SpotDatafeedSubscription{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spotdatafeedsubscriptions").
...
func (c *spotDatafeedSubscriptions) Update(ctx context.Context, spotDatafeedSubscription *v1alpha1.SpotDatafeedSubscription, opts v1.UpdateOptions) (result *v1alpha1.SpotDatafeedSubscription, err error) {
	result = &v1alpha1.SpotDatafeedSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spotdatafeedsubscriptions").
...
func (c *spotDatafeedSubscriptions) UpdateStatus(ctx context.Context, spotDatafeedSubscription *v1alpha1.SpotDatafeedSubscription, opts v1.UpdateOptions) (result *v1alpha1.SpotDatafeedSubscription, err error) {
	result = &v1alpha1.SpotDatafeedSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spotdatafeedsubscriptions").
...
func (c *spotDatafeedSubscriptions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *spotDatafeedSubscriptions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *spotDatafeedSubscriptions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SpotDatafeedSubscription, err error) {
	result = &v1alpha1.SpotDatafeedSubscription{}
