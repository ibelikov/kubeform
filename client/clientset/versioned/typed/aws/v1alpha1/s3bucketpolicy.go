...
func (c *s3BucketPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.S3BucketPolicy, err error) {
...
func (c *s3BucketPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.S3BucketPolicyList, err error) {
...
func (c *s3BucketPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *s3BucketPolicies) Create(ctx context.Context, s3BucketPolicy *v1alpha1.S3BucketPolicy, opts v1.CreateOptions) (result *v1alpha1.S3BucketPolicy, err error) {
	result = &v1alpha1.S3BucketPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("s3bucketpolicies").
...
func (c *s3BucketPolicies) Update(ctx context.Context, s3BucketPolicy *v1alpha1.S3BucketPolicy, opts v1.UpdateOptions) (result *v1alpha1.S3BucketPolicy, err error) {
	result = &v1alpha1.S3BucketPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("s3bucketpolicies").
...
func (c *s3BucketPolicies) UpdateStatus(ctx context.Context, s3BucketPolicy *v1alpha1.S3BucketPolicy, opts v1.UpdateOptions) (result *v1alpha1.S3BucketPolicy, err error) {
	result = &v1alpha1.S3BucketPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("s3bucketpolicies").
...
func (c *s3BucketPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *s3BucketPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *s3BucketPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.S3BucketPolicy, err error) {
	result = &v1alpha1.S3BucketPolicy{}
