...
func (c *ecrRepositoryPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EcrRepositoryPolicy, err error) {
...
func (c *ecrRepositoryPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EcrRepositoryPolicyList, err error) {
...
func (c *ecrRepositoryPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ecrRepositoryPolicies) Create(ctx context.Context, ecrRepositoryPolicy *v1alpha1.EcrRepositoryPolicy, opts v1.CreateOptions) (result *v1alpha1.EcrRepositoryPolicy, err error) {
	result = &v1alpha1.EcrRepositoryPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ecrrepositorypolicies").
...
func (c *ecrRepositoryPolicies) Update(ctx context.Context, ecrRepositoryPolicy *v1alpha1.EcrRepositoryPolicy, opts v1.UpdateOptions) (result *v1alpha1.EcrRepositoryPolicy, err error) {
	result = &v1alpha1.EcrRepositoryPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ecrrepositorypolicies").
...
func (c *ecrRepositoryPolicies) UpdateStatus(ctx context.Context, ecrRepositoryPolicy *v1alpha1.EcrRepositoryPolicy, opts v1.UpdateOptions) (result *v1alpha1.EcrRepositoryPolicy, err error) {
	result = &v1alpha1.EcrRepositoryPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ecrrepositorypolicies").
...
func (c *ecrRepositoryPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ecrRepositoryPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ecrRepositoryPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EcrRepositoryPolicy, err error) {
	result = &v1alpha1.EcrRepositoryPolicy{}
