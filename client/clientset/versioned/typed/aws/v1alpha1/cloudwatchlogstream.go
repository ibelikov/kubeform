...
func (c *cloudwatchLogStreams) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudwatchLogStream, err error) {
...
func (c *cloudwatchLogStreams) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudwatchLogStreamList, err error) {
...
func (c *cloudwatchLogStreams) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudwatchLogStreams) Create(ctx context.Context, cloudwatchLogStream *v1alpha1.CloudwatchLogStream, opts v1.CreateOptions) (result *v1alpha1.CloudwatchLogStream, err error) {
	result = &v1alpha1.CloudwatchLogStream{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudwatchlogstreams").
...
func (c *cloudwatchLogStreams) Update(ctx context.Context, cloudwatchLogStream *v1alpha1.CloudwatchLogStream, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogStream, err error) {
	result = &v1alpha1.CloudwatchLogStream{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudwatchlogstreams").
...
func (c *cloudwatchLogStreams) UpdateStatus(ctx context.Context, cloudwatchLogStream *v1alpha1.CloudwatchLogStream, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogStream, err error) {
	result = &v1alpha1.CloudwatchLogStream{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudwatchlogstreams").
...
func (c *cloudwatchLogStreams) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudwatchLogStreams) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudwatchLogStreams) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudwatchLogStream, err error) {
	result = &v1alpha1.CloudwatchLogStream{}
