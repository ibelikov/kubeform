...
func (c *lightsailDomains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LightsailDomain, err error) {
...
func (c *lightsailDomains) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LightsailDomainList, err error) {
...
func (c *lightsailDomains) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lightsailDomains) Create(ctx context.Context, lightsailDomain *v1alpha1.LightsailDomain, opts v1.CreateOptions) (result *v1alpha1.LightsailDomain, err error) {
	result = &v1alpha1.LightsailDomain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lightsaildomains").
...
func (c *lightsailDomains) Update(ctx context.Context, lightsailDomain *v1alpha1.LightsailDomain, opts v1.UpdateOptions) (result *v1alpha1.LightsailDomain, err error) {
	result = &v1alpha1.LightsailDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lightsaildomains").
...
func (c *lightsailDomains) UpdateStatus(ctx context.Context, lightsailDomain *v1alpha1.LightsailDomain, opts v1.UpdateOptions) (result *v1alpha1.LightsailDomain, err error) {
	result = &v1alpha1.LightsailDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lightsaildomains").
...
func (c *lightsailDomains) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lightsailDomains) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lightsailDomains) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LightsailDomain, err error) {
	result = &v1alpha1.LightsailDomain{}
