...
func (c *ssmActivations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SsmActivation, err error) {
...
func (c *ssmActivations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SsmActivationList, err error) {
...
func (c *ssmActivations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssmActivations) Create(ctx context.Context, ssmActivation *v1alpha1.SsmActivation, opts v1.CreateOptions) (result *v1alpha1.SsmActivation, err error) {
	result = &v1alpha1.SsmActivation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ssmactivations").
...
func (c *ssmActivations) Update(ctx context.Context, ssmActivation *v1alpha1.SsmActivation, opts v1.UpdateOptions) (result *v1alpha1.SsmActivation, err error) {
	result = &v1alpha1.SsmActivation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmactivations").
...
func (c *ssmActivations) UpdateStatus(ctx context.Context, ssmActivation *v1alpha1.SsmActivation, opts v1.UpdateOptions) (result *v1alpha1.SsmActivation, err error) {
	result = &v1alpha1.SsmActivation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmactivations").
...
func (c *ssmActivations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ssmActivations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ssmActivations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SsmActivation, err error) {
	result = &v1alpha1.SsmActivation{}
