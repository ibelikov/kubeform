...
func (c *wafRuleGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafRuleGroup, err error) {
...
func (c *wafRuleGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafRuleGroupList, err error) {
...
func (c *wafRuleGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafRuleGroups) Create(ctx context.Context, wafRuleGroup *v1alpha1.WafRuleGroup, opts v1.CreateOptions) (result *v1alpha1.WafRuleGroup, err error) {
	result = &v1alpha1.WafRuleGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafrulegroups").
...
func (c *wafRuleGroups) Update(ctx context.Context, wafRuleGroup *v1alpha1.WafRuleGroup, opts v1.UpdateOptions) (result *v1alpha1.WafRuleGroup, err error) {
	result = &v1alpha1.WafRuleGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafrulegroups").
...
func (c *wafRuleGroups) UpdateStatus(ctx context.Context, wafRuleGroup *v1alpha1.WafRuleGroup, opts v1.UpdateOptions) (result *v1alpha1.WafRuleGroup, err error) {
	result = &v1alpha1.WafRuleGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafrulegroups").
...
func (c *wafRuleGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafRuleGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafRuleGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafRuleGroup, err error) {
	result = &v1alpha1.WafRuleGroup{}
