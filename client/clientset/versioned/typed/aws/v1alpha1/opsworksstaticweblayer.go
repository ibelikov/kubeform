...
func newOpsworksStaticWebLayers(c *AwsV1alpha1Client, namespace string) *opsworksStaticWebLayers {
...
func (c *opsworksStaticWebLayers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksStaticWebLayer, err error) {
...
func (c *opsworksStaticWebLayers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksStaticWebLayerList, err error) {
...
func (c *opsworksStaticWebLayers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksStaticWebLayers) Create(ctx context.Context, opsworksStaticWebLayer *v1alpha1.OpsworksStaticWebLayer, opts v1.CreateOptions) (result *v1alpha1.OpsworksStaticWebLayer, err error) {
	result = &v1alpha1.OpsworksStaticWebLayer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("opsworksstaticweblayers").
...
func (c *opsworksStaticWebLayers) Update(ctx context.Context, opsworksStaticWebLayer *v1alpha1.OpsworksStaticWebLayer, opts v1.UpdateOptions) (result *v1alpha1.OpsworksStaticWebLayer, err error) {
	result = &v1alpha1.OpsworksStaticWebLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworksstaticweblayers").
...
func (c *opsworksStaticWebLayers) UpdateStatus(ctx context.Context, opsworksStaticWebLayer *v1alpha1.OpsworksStaticWebLayer, opts v1.UpdateOptions) (result *v1alpha1.OpsworksStaticWebLayer, err error) {
	result = &v1alpha1.OpsworksStaticWebLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworksstaticweblayers").
...
func (c *opsworksStaticWebLayers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *opsworksStaticWebLayers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *opsworksStaticWebLayers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksStaticWebLayer, err error) {
	result = &v1alpha1.OpsworksStaticWebLayer{}
