...
func (c *ebsDefaultKmsKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EbsDefaultKmsKey, err error) {
...
func (c *ebsDefaultKmsKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EbsDefaultKmsKeyList, err error) {
...
func (c *ebsDefaultKmsKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ebsDefaultKmsKeys) Create(ctx context.Context, ebsDefaultKmsKey *v1alpha1.EbsDefaultKmsKey, opts v1.CreateOptions) (result *v1alpha1.EbsDefaultKmsKey, err error) {
	result = &v1alpha1.EbsDefaultKmsKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ebsdefaultkmskeys").
...
func (c *ebsDefaultKmsKeys) Update(ctx context.Context, ebsDefaultKmsKey *v1alpha1.EbsDefaultKmsKey, opts v1.UpdateOptions) (result *v1alpha1.EbsDefaultKmsKey, err error) {
	result = &v1alpha1.EbsDefaultKmsKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ebsdefaultkmskeys").
...
func (c *ebsDefaultKmsKeys) UpdateStatus(ctx context.Context, ebsDefaultKmsKey *v1alpha1.EbsDefaultKmsKey, opts v1.UpdateOptions) (result *v1alpha1.EbsDefaultKmsKey, err error) {
	result = &v1alpha1.EbsDefaultKmsKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ebsdefaultkmskeys").
...
func (c *ebsDefaultKmsKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ebsDefaultKmsKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ebsDefaultKmsKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EbsDefaultKmsKey, err error) {
	result = &v1alpha1.EbsDefaultKmsKey{}
