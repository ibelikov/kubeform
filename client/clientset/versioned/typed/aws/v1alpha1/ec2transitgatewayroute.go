...
func (c *ec2TransitGatewayRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ec2TransitGatewayRoute, err error) {
...
func (c *ec2TransitGatewayRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.Ec2TransitGatewayRouteList, err error) {
...
func (c *ec2TransitGatewayRoutes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ec2TransitGatewayRoutes) Create(ctx context.Context, ec2TransitGatewayRoute *v1alpha1.Ec2TransitGatewayRoute, opts v1.CreateOptions) (result *v1alpha1.Ec2TransitGatewayRoute, err error) {
	result = &v1alpha1.Ec2TransitGatewayRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ec2transitgatewayroutes").
...
func (c *ec2TransitGatewayRoutes) Update(ctx context.Context, ec2TransitGatewayRoute *v1alpha1.Ec2TransitGatewayRoute, opts v1.UpdateOptions) (result *v1alpha1.Ec2TransitGatewayRoute, err error) {
	result = &v1alpha1.Ec2TransitGatewayRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ec2transitgatewayroutes").
...
func (c *ec2TransitGatewayRoutes) UpdateStatus(ctx context.Context, ec2TransitGatewayRoute *v1alpha1.Ec2TransitGatewayRoute, opts v1.UpdateOptions) (result *v1alpha1.Ec2TransitGatewayRoute, err error) {
	result = &v1alpha1.Ec2TransitGatewayRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ec2transitgatewayroutes").
...
func (c *ec2TransitGatewayRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ec2TransitGatewayRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ec2TransitGatewayRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ec2TransitGatewayRoute, err error) {
	result = &v1alpha1.Ec2TransitGatewayRoute{}
