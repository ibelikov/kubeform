...
func (c *docdbClusterInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DocdbClusterInstance, err error) {
...
func (c *docdbClusterInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DocdbClusterInstanceList, err error) {
...
func (c *docdbClusterInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *docdbClusterInstances) Create(ctx context.Context, docdbClusterInstance *v1alpha1.DocdbClusterInstance, opts v1.CreateOptions) (result *v1alpha1.DocdbClusterInstance, err error) {
	result = &v1alpha1.DocdbClusterInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("docdbclusterinstances").
...
func (c *docdbClusterInstances) Update(ctx context.Context, docdbClusterInstance *v1alpha1.DocdbClusterInstance, opts v1.UpdateOptions) (result *v1alpha1.DocdbClusterInstance, err error) {
	result = &v1alpha1.DocdbClusterInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("docdbclusterinstances").
...
func (c *docdbClusterInstances) UpdateStatus(ctx context.Context, docdbClusterInstance *v1alpha1.DocdbClusterInstance, opts v1.UpdateOptions) (result *v1alpha1.DocdbClusterInstance, err error) {
	result = &v1alpha1.DocdbClusterInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("docdbclusterinstances").
...
func (c *docdbClusterInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *docdbClusterInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *docdbClusterInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DocdbClusterInstance, err error) {
	result = &v1alpha1.DocdbClusterInstance{}
