...
func (c *iamRolePolicyAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamRolePolicyAttachment, err error) {
...
func (c *iamRolePolicyAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamRolePolicyAttachmentList, err error) {
...
func (c *iamRolePolicyAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamRolePolicyAttachments) Create(ctx context.Context, iamRolePolicyAttachment *v1alpha1.IamRolePolicyAttachment, opts v1.CreateOptions) (result *v1alpha1.IamRolePolicyAttachment, err error) {
	result = &v1alpha1.IamRolePolicyAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamrolepolicyattachments").
...
func (c *iamRolePolicyAttachments) Update(ctx context.Context, iamRolePolicyAttachment *v1alpha1.IamRolePolicyAttachment, opts v1.UpdateOptions) (result *v1alpha1.IamRolePolicyAttachment, err error) {
	result = &v1alpha1.IamRolePolicyAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamrolepolicyattachments").
...
func (c *iamRolePolicyAttachments) UpdateStatus(ctx context.Context, iamRolePolicyAttachment *v1alpha1.IamRolePolicyAttachment, opts v1.UpdateOptions) (result *v1alpha1.IamRolePolicyAttachment, err error) {
	result = &v1alpha1.IamRolePolicyAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamrolepolicyattachments").
...
func (c *iamRolePolicyAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamRolePolicyAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamRolePolicyAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamRolePolicyAttachment, err error) {
	result = &v1alpha1.IamRolePolicyAttachment{}
