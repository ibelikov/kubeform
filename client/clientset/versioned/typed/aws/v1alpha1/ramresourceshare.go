...
func (c *ramResourceShares) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RamResourceShare, err error) {
...
func (c *ramResourceShares) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RamResourceShareList, err error) {
...
func (c *ramResourceShares) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ramResourceShares) Create(ctx context.Context, ramResourceShare *v1alpha1.RamResourceShare, opts v1.CreateOptions) (result *v1alpha1.RamResourceShare, err error) {
	result = &v1alpha1.RamResourceShare{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ramresourceshares").
...
func (c *ramResourceShares) Update(ctx context.Context, ramResourceShare *v1alpha1.RamResourceShare, opts v1.UpdateOptions) (result *v1alpha1.RamResourceShare, err error) {
	result = &v1alpha1.RamResourceShare{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ramresourceshares").
...
func (c *ramResourceShares) UpdateStatus(ctx context.Context, ramResourceShare *v1alpha1.RamResourceShare, opts v1.UpdateOptions) (result *v1alpha1.RamResourceShare, err error) {
	result = &v1alpha1.RamResourceShare{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ramresourceshares").
...
func (c *ramResourceShares) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ramResourceShares) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ramResourceShares) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RamResourceShare, err error) {
	result = &v1alpha1.RamResourceShare{}
