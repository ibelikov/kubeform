...
type RamResourceShareInterface interface {
	Create(*v1alpha1.RamResourceShare) (*v1alpha1.RamResourceShare, error)
	Update(*v1alpha1.RamResourceShare) (*v1alpha1.RamResourceShare, error)
	UpdateStatus(*v1alpha1.RamResourceShare) (*v1alpha1.RamResourceShare, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.RamResourceShare, error)
	List(opts v1.ListOptions) (*v1alpha1.RamResourceShareList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.RamResourceShare, err error)
...
func (c *ramResourceShares) List(opts v1.ListOptions) (result *v1alpha1.RamResourceShareList, err error) {
...
func (c *ramResourceShares) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ramResourceShares) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
