...
func newKmsCiphertexts(c *AwsV1alpha1Client, namespace string) *kmsCiphertexts {
...
func (c *kmsCiphertexts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KmsCiphertext, err error) {
...
func (c *kmsCiphertexts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KmsCiphertextList, err error) {
...
func (c *kmsCiphertexts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kmsCiphertexts) Create(ctx context.Context, kmsCiphertext *v1alpha1.KmsCiphertext, opts v1.CreateOptions) (result *v1alpha1.KmsCiphertext, err error) {
	result = &v1alpha1.KmsCiphertext{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kmsciphertexts").
...
func (c *kmsCiphertexts) Update(ctx context.Context, kmsCiphertext *v1alpha1.KmsCiphertext, opts v1.UpdateOptions) (result *v1alpha1.KmsCiphertext, err error) {
	result = &v1alpha1.KmsCiphertext{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmsciphertexts").
...
func (c *kmsCiphertexts) UpdateStatus(ctx context.Context, kmsCiphertext *v1alpha1.KmsCiphertext, opts v1.UpdateOptions) (result *v1alpha1.KmsCiphertext, err error) {
	result = &v1alpha1.KmsCiphertext{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmsciphertexts").
...
func (c *kmsCiphertexts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kmsCiphertexts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kmsCiphertexts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KmsCiphertext, err error) {
	result = &v1alpha1.KmsCiphertext{}
