...
func (c *transferServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TransferServer, err error) {
...
func (c *transferServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TransferServerList, err error) {
...
func (c *transferServers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *transferServers) Create(ctx context.Context, transferServer *v1alpha1.TransferServer, opts v1.CreateOptions) (result *v1alpha1.TransferServer, err error) {
	result = &v1alpha1.TransferServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("transferservers").
...
func (c *transferServers) Update(ctx context.Context, transferServer *v1alpha1.TransferServer, opts v1.UpdateOptions) (result *v1alpha1.TransferServer, err error) {
	result = &v1alpha1.TransferServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transferservers").
...
func (c *transferServers) UpdateStatus(ctx context.Context, transferServer *v1alpha1.TransferServer, opts v1.UpdateOptions) (result *v1alpha1.TransferServer, err error) {
	result = &v1alpha1.TransferServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transferservers").
...
func (c *transferServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *transferServers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *transferServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TransferServer, err error) {
	result = &v1alpha1.TransferServer{}
