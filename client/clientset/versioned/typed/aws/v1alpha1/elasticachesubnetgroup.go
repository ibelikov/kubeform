...
func (c *elasticacheSubnetGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ElasticacheSubnetGroup, err error) {
...
func (c *elasticacheSubnetGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElasticacheSubnetGroupList, err error) {
...
func (c *elasticacheSubnetGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *elasticacheSubnetGroups) Create(ctx context.Context, elasticacheSubnetGroup *v1alpha1.ElasticacheSubnetGroup, opts v1.CreateOptions) (result *v1alpha1.ElasticacheSubnetGroup, err error) {
	result = &v1alpha1.ElasticacheSubnetGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("elasticachesubnetgroups").
...
func (c *elasticacheSubnetGroups) Update(ctx context.Context, elasticacheSubnetGroup *v1alpha1.ElasticacheSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.ElasticacheSubnetGroup, err error) {
	result = &v1alpha1.ElasticacheSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticachesubnetgroups").
...
func (c *elasticacheSubnetGroups) UpdateStatus(ctx context.Context, elasticacheSubnetGroup *v1alpha1.ElasticacheSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.ElasticacheSubnetGroup, err error) {
	result = &v1alpha1.ElasticacheSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticachesubnetgroups").
...
func (c *elasticacheSubnetGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *elasticacheSubnetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *elasticacheSubnetGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ElasticacheSubnetGroup, err error) {
	result = &v1alpha1.ElasticacheSubnetGroup{}
