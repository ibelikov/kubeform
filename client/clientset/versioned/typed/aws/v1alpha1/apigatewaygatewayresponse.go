...
type ApiGatewayGatewayResponseInterface interface {
	Create(*v1alpha1.ApiGatewayGatewayResponse) (*v1alpha1.ApiGatewayGatewayResponse, error)
	Update(*v1alpha1.ApiGatewayGatewayResponse) (*v1alpha1.ApiGatewayGatewayResponse, error)
	UpdateStatus(*v1alpha1.ApiGatewayGatewayResponse) (*v1alpha1.ApiGatewayGatewayResponse, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ApiGatewayGatewayResponse, error)
	List(opts v1.ListOptions) (*v1alpha1.ApiGatewayGatewayResponseList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiGatewayGatewayResponse, err error)
...
func (c *apiGatewayGatewayResponses) List(opts v1.ListOptions) (result *v1alpha1.ApiGatewayGatewayResponseList, err error) {
...
func (c *apiGatewayGatewayResponses) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiGatewayGatewayResponses) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
