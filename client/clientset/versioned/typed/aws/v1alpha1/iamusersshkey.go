...
func (c *iamUserSSHKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamUserSSHKey, err error) {
...
func (c *iamUserSSHKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamUserSSHKeyList, err error) {
...
func (c *iamUserSSHKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamUserSSHKeys) Create(ctx context.Context, iamUserSSHKey *v1alpha1.IamUserSSHKey, opts v1.CreateOptions) (result *v1alpha1.IamUserSSHKey, err error) {
	result = &v1alpha1.IamUserSSHKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamusersshkeys").
...
func (c *iamUserSSHKeys) Update(ctx context.Context, iamUserSSHKey *v1alpha1.IamUserSSHKey, opts v1.UpdateOptions) (result *v1alpha1.IamUserSSHKey, err error) {
	result = &v1alpha1.IamUserSSHKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamusersshkeys").
...
func (c *iamUserSSHKeys) UpdateStatus(ctx context.Context, iamUserSSHKey *v1alpha1.IamUserSSHKey, opts v1.UpdateOptions) (result *v1alpha1.IamUserSSHKey, err error) {
	result = &v1alpha1.IamUserSSHKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamusersshkeys").
...
func (c *iamUserSSHKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamUserSSHKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamUserSSHKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamUserSSHKey, err error) {
	result = &v1alpha1.IamUserSSHKey{}
