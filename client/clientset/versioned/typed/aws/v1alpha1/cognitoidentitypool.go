...
func (c *cognitoIdentityPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CognitoIdentityPool, err error) {
...
func (c *cognitoIdentityPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CognitoIdentityPoolList, err error) {
...
func (c *cognitoIdentityPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cognitoIdentityPools) Create(ctx context.Context, cognitoIdentityPool *v1alpha1.CognitoIdentityPool, opts v1.CreateOptions) (result *v1alpha1.CognitoIdentityPool, err error) {
	result = &v1alpha1.CognitoIdentityPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cognitoidentitypools").
...
func (c *cognitoIdentityPools) Update(ctx context.Context, cognitoIdentityPool *v1alpha1.CognitoIdentityPool, opts v1.UpdateOptions) (result *v1alpha1.CognitoIdentityPool, err error) {
	result = &v1alpha1.CognitoIdentityPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cognitoidentitypools").
...
func (c *cognitoIdentityPools) UpdateStatus(ctx context.Context, cognitoIdentityPool *v1alpha1.CognitoIdentityPool, opts v1.UpdateOptions) (result *v1alpha1.CognitoIdentityPool, err error) {
	result = &v1alpha1.CognitoIdentityPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cognitoidentitypools").
...
func (c *cognitoIdentityPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cognitoIdentityPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cognitoIdentityPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CognitoIdentityPool, err error) {
	result = &v1alpha1.CognitoIdentityPool{}
