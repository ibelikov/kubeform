...
type CognitoUserPoolDomainInterface interface {
	Create(*v1alpha1.CognitoUserPoolDomain) (*v1alpha1.CognitoUserPoolDomain, error)
	Update(*v1alpha1.CognitoUserPoolDomain) (*v1alpha1.CognitoUserPoolDomain, error)
	UpdateStatus(*v1alpha1.CognitoUserPoolDomain) (*v1alpha1.CognitoUserPoolDomain, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.CognitoUserPoolDomain, error)
	List(opts v1.ListOptions) (*v1alpha1.CognitoUserPoolDomainList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CognitoUserPoolDomain, err error)
...
func (c *cognitoUserPoolDomains) Get(name string, options v1.GetOptions) (result *v1alpha1.CognitoUserPoolDomain, err error) {
...
func (c *cognitoUserPoolDomains) List(opts v1.ListOptions) (result *v1alpha1.CognitoUserPoolDomainList, err error) {
...
func (c *cognitoUserPoolDomains) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cognitoUserPoolDomains) Create(cognitoUserPoolDomain *v1alpha1.CognitoUserPoolDomain) (result *v1alpha1.CognitoUserPoolDomain, err error) {
	result = &v1alpha1.CognitoUserPoolDomain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cognitouserpooldomains").
...
func (c *cognitoUserPoolDomains) Update(cognitoUserPoolDomain *v1alpha1.CognitoUserPoolDomain) (result *v1alpha1.CognitoUserPoolDomain, err error) {
	result = &v1alpha1.CognitoUserPoolDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cognitouserpooldomains").
...
func (c *cognitoUserPoolDomains) UpdateStatus(cognitoUserPoolDomain *v1alpha1.CognitoUserPoolDomain) (result *v1alpha1.CognitoUserPoolDomain, err error) {
	result = &v1alpha1.CognitoUserPoolDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cognitouserpooldomains").
...
func (c *cognitoUserPoolDomains) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *cognitoUserPoolDomains) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cognitoUserPoolDomains) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CognitoUserPoolDomain, err error) {
	result = &v1alpha1.CognitoUserPoolDomain{}
