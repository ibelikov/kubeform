...
func newSnsTopics(c *AwsV1alpha1Client, namespace string) *snsTopics {
	return &snsTopics{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *snsTopics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SnsTopic, err error) {
...
func (c *snsTopics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SnsTopicList, err error) {
...
func (c *snsTopics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *snsTopics) Create(ctx context.Context, snsTopic *v1alpha1.SnsTopic, opts v1.CreateOptions) (result *v1alpha1.SnsTopic, err error) {
	result = &v1alpha1.SnsTopic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("snstopics").
...
func (c *snsTopics) Update(ctx context.Context, snsTopic *v1alpha1.SnsTopic, opts v1.UpdateOptions) (result *v1alpha1.SnsTopic, err error) {
	result = &v1alpha1.SnsTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snstopics").
...
func (c *snsTopics) UpdateStatus(ctx context.Context, snsTopic *v1alpha1.SnsTopic, opts v1.UpdateOptions) (result *v1alpha1.SnsTopic, err error) {
	result = &v1alpha1.SnsTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snstopics").
...
func (c *snsTopics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *snsTopics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *snsTopics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SnsTopic, err error) {
	result = &v1alpha1.SnsTopic{}
