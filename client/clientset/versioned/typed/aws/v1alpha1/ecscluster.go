...
func (c *ecsClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EcsCluster, err error) {
...
func (c *ecsClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EcsClusterList, err error) {
...
func (c *ecsClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ecsClusters) Create(ctx context.Context, ecsCluster *v1alpha1.EcsCluster, opts v1.CreateOptions) (result *v1alpha1.EcsCluster, err error) {
	result = &v1alpha1.EcsCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ecsclusters").
...
func (c *ecsClusters) Update(ctx context.Context, ecsCluster *v1alpha1.EcsCluster, opts v1.UpdateOptions) (result *v1alpha1.EcsCluster, err error) {
	result = &v1alpha1.EcsCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ecsclusters").
...
func (c *ecsClusters) UpdateStatus(ctx context.Context, ecsCluster *v1alpha1.EcsCluster, opts v1.UpdateOptions) (result *v1alpha1.EcsCluster, err error) {
	result = &v1alpha1.EcsCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ecsclusters").
...
func (c *ecsClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ecsClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ecsClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EcsCluster, err error) {
	result = &v1alpha1.EcsCluster{}
