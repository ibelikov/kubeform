...
func (c *iamPolicyAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamPolicyAttachment, err error) {
...
func (c *iamPolicyAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamPolicyAttachmentList, err error) {
...
func (c *iamPolicyAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamPolicyAttachments) Create(ctx context.Context, iamPolicyAttachment *v1alpha1.IamPolicyAttachment, opts v1.CreateOptions) (result *v1alpha1.IamPolicyAttachment, err error) {
	result = &v1alpha1.IamPolicyAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iampolicyattachments").
...
func (c *iamPolicyAttachments) Update(ctx context.Context, iamPolicyAttachment *v1alpha1.IamPolicyAttachment, opts v1.UpdateOptions) (result *v1alpha1.IamPolicyAttachment, err error) {
	result = &v1alpha1.IamPolicyAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iampolicyattachments").
...
func (c *iamPolicyAttachments) UpdateStatus(ctx context.Context, iamPolicyAttachment *v1alpha1.IamPolicyAttachment, opts v1.UpdateOptions) (result *v1alpha1.IamPolicyAttachment, err error) {
	result = &v1alpha1.IamPolicyAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iampolicyattachments").
...
func (c *iamPolicyAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamPolicyAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamPolicyAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamPolicyAttachment, err error) {
	result = &v1alpha1.IamPolicyAttachment{}
