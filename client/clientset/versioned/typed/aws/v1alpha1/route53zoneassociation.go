...
func (c *route53ZoneAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Route53ZoneAssociation, err error) {
...
func (c *route53ZoneAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.Route53ZoneAssociationList, err error) {
...
func (c *route53ZoneAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *route53ZoneAssociations) Create(ctx context.Context, route53ZoneAssociation *v1alpha1.Route53ZoneAssociation, opts v1.CreateOptions) (result *v1alpha1.Route53ZoneAssociation, err error) {
	result = &v1alpha1.Route53ZoneAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("route53zoneassociations").
...
func (c *route53ZoneAssociations) Update(ctx context.Context, route53ZoneAssociation *v1alpha1.Route53ZoneAssociation, opts v1.UpdateOptions) (result *v1alpha1.Route53ZoneAssociation, err error) {
	result = &v1alpha1.Route53ZoneAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("route53zoneassociations").
...
func (c *route53ZoneAssociations) UpdateStatus(ctx context.Context, route53ZoneAssociation *v1alpha1.Route53ZoneAssociation, opts v1.UpdateOptions) (result *v1alpha1.Route53ZoneAssociation, err error) {
	result = &v1alpha1.Route53ZoneAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("route53zoneassociations").
...
func (c *route53ZoneAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *route53ZoneAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *route53ZoneAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Route53ZoneAssociation, err error) {
	result = &v1alpha1.Route53ZoneAssociation{}
