...
func (c *wafregionalRuleGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafregionalRuleGroup, err error) {
...
func (c *wafregionalRuleGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafregionalRuleGroupList, err error) {
...
func (c *wafregionalRuleGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafregionalRuleGroups) Create(ctx context.Context, wafregionalRuleGroup *v1alpha1.WafregionalRuleGroup, opts v1.CreateOptions) (result *v1alpha1.WafregionalRuleGroup, err error) {
	result = &v1alpha1.WafregionalRuleGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafregionalrulegroups").
...
func (c *wafregionalRuleGroups) Update(ctx context.Context, wafregionalRuleGroup *v1alpha1.WafregionalRuleGroup, opts v1.UpdateOptions) (result *v1alpha1.WafregionalRuleGroup, err error) {
	result = &v1alpha1.WafregionalRuleGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalrulegroups").
...
func (c *wafregionalRuleGroups) UpdateStatus(ctx context.Context, wafregionalRuleGroup *v1alpha1.WafregionalRuleGroup, opts v1.UpdateOptions) (result *v1alpha1.WafregionalRuleGroup, err error) {
	result = &v1alpha1.WafregionalRuleGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalrulegroups").
...
func (c *wafregionalRuleGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafregionalRuleGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafregionalRuleGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafregionalRuleGroup, err error) {
	result = &v1alpha1.WafregionalRuleGroup{}
