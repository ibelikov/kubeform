...
func (c *glacierVaultLocks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlacierVaultLock, err error) {
...
func (c *glacierVaultLocks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlacierVaultLockList, err error) {
...
func (c *glacierVaultLocks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *glacierVaultLocks) Create(ctx context.Context, glacierVaultLock *v1alpha1.GlacierVaultLock, opts v1.CreateOptions) (result *v1alpha1.GlacierVaultLock, err error) {
	result = &v1alpha1.GlacierVaultLock{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("glaciervaultlocks").
...
func (c *glacierVaultLocks) Update(ctx context.Context, glacierVaultLock *v1alpha1.GlacierVaultLock, opts v1.UpdateOptions) (result *v1alpha1.GlacierVaultLock, err error) {
	result = &v1alpha1.GlacierVaultLock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("glaciervaultlocks").
...
func (c *glacierVaultLocks) UpdateStatus(ctx context.Context, glacierVaultLock *v1alpha1.GlacierVaultLock, opts v1.UpdateOptions) (result *v1alpha1.GlacierVaultLock, err error) {
	result = &v1alpha1.GlacierVaultLock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("glaciervaultlocks").
...
func (c *glacierVaultLocks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *glacierVaultLocks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *glacierVaultLocks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlacierVaultLock, err error) {
	result = &v1alpha1.GlacierVaultLock{}
