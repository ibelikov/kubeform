...
func (c *vpcDHCPOptionsAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
...
func (c *vpcDHCPOptionsAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpcDHCPOptionsAssociationList, err error) {
...
func (c *vpcDHCPOptionsAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vpcDHCPOptionsAssociations) Create(ctx context.Context, vpcDHCPOptionsAssociation *v1alpha1.VpcDHCPOptionsAssociation, opts v1.CreateOptions) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
	result = &v1alpha1.VpcDHCPOptionsAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpcdhcpoptionsassociations").
...
func (c *vpcDHCPOptionsAssociations) Update(ctx context.Context, vpcDHCPOptionsAssociation *v1alpha1.VpcDHCPOptionsAssociation, opts v1.UpdateOptions) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
	result = &v1alpha1.VpcDHCPOptionsAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcdhcpoptionsassociations").
...
func (c *vpcDHCPOptionsAssociations) UpdateStatus(ctx context.Context, vpcDHCPOptionsAssociation *v1alpha1.VpcDHCPOptionsAssociation, opts v1.UpdateOptions) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
	result = &v1alpha1.VpcDHCPOptionsAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcdhcpoptionsassociations").
...
func (c *vpcDHCPOptionsAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vpcDHCPOptionsAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vpcDHCPOptionsAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
	result = &v1alpha1.VpcDHCPOptionsAssociation{}
