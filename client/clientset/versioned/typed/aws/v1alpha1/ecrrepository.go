...
func (c *ecrRepositories) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EcrRepository, err error) {
...
func (c *ecrRepositories) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EcrRepositoryList, err error) {
...
func (c *ecrRepositories) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ecrRepositories) Create(ctx context.Context, ecrRepository *v1alpha1.EcrRepository, opts v1.CreateOptions) (result *v1alpha1.EcrRepository, err error) {
	result = &v1alpha1.EcrRepository{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ecrrepositories").
...
func (c *ecrRepositories) Update(ctx context.Context, ecrRepository *v1alpha1.EcrRepository, opts v1.UpdateOptions) (result *v1alpha1.EcrRepository, err error) {
	result = &v1alpha1.EcrRepository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ecrrepositories").
...
func (c *ecrRepositories) UpdateStatus(ctx context.Context, ecrRepository *v1alpha1.EcrRepository, opts v1.UpdateOptions) (result *v1alpha1.EcrRepository, err error) {
	result = &v1alpha1.EcrRepository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ecrrepositories").
...
func (c *ecrRepositories) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ecrRepositories) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ecrRepositories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EcrRepository, err error) {
	result = &v1alpha1.EcrRepository{}
