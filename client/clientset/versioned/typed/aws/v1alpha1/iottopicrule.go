...
func (c *iotTopicRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IotTopicRule, err error) {
...
func (c *iotTopicRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IotTopicRuleList, err error) {
...
func (c *iotTopicRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iotTopicRules) Create(ctx context.Context, iotTopicRule *v1alpha1.IotTopicRule, opts v1.CreateOptions) (result *v1alpha1.IotTopicRule, err error) {
	result = &v1alpha1.IotTopicRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iottopicrules").
...
func (c *iotTopicRules) Update(ctx context.Context, iotTopicRule *v1alpha1.IotTopicRule, opts v1.UpdateOptions) (result *v1alpha1.IotTopicRule, err error) {
	result = &v1alpha1.IotTopicRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iottopicrules").
...
func (c *iotTopicRules) UpdateStatus(ctx context.Context, iotTopicRule *v1alpha1.IotTopicRule, opts v1.UpdateOptions) (result *v1alpha1.IotTopicRule, err error) {
	result = &v1alpha1.IotTopicRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iottopicrules").
...
func (c *iotTopicRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iotTopicRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iotTopicRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IotTopicRule, err error) {
	result = &v1alpha1.IotTopicRule{}
