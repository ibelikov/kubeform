...
type CloudwatchLogMetricFilterInterface interface {
	Create(*v1alpha1.CloudwatchLogMetricFilter) (*v1alpha1.CloudwatchLogMetricFilter, error)
	Update(*v1alpha1.CloudwatchLogMetricFilter) (*v1alpha1.CloudwatchLogMetricFilter, error)
	UpdateStatus(*v1alpha1.CloudwatchLogMetricFilter) (*v1alpha1.CloudwatchLogMetricFilter, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.CloudwatchLogMetricFilter, error)
	List(opts v1.ListOptions) (*v1alpha1.CloudwatchLogMetricFilterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CloudwatchLogMetricFilter, err error)
...
func (c *cloudwatchLogMetricFilters) List(opts v1.ListOptions) (result *v1alpha1.CloudwatchLogMetricFilterList, err error) {
...
func (c *cloudwatchLogMetricFilters) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudwatchLogMetricFilters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
