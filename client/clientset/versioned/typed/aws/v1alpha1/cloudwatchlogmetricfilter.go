...
func (c *cloudwatchLogMetricFilters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
...
func (c *cloudwatchLogMetricFilters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudwatchLogMetricFilterList, err error) {
...
func (c *cloudwatchLogMetricFilters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudwatchLogMetricFilters) Create(ctx context.Context, cloudwatchLogMetricFilter *v1alpha1.CloudwatchLogMetricFilter, opts v1.CreateOptions) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
	result = &v1alpha1.CloudwatchLogMetricFilter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudwatchlogmetricfilters").
...
func (c *cloudwatchLogMetricFilters) Update(ctx context.Context, cloudwatchLogMetricFilter *v1alpha1.CloudwatchLogMetricFilter, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
	result = &v1alpha1.CloudwatchLogMetricFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudwatchlogmetricfilters").
...
func (c *cloudwatchLogMetricFilters) UpdateStatus(ctx context.Context, cloudwatchLogMetricFilter *v1alpha1.CloudwatchLogMetricFilter, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
	result = &v1alpha1.CloudwatchLogMetricFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudwatchlogmetricfilters").
...
func (c *cloudwatchLogMetricFilters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudwatchLogMetricFilters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudwatchLogMetricFilters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
	result = &v1alpha1.CloudwatchLogMetricFilter{}
