...
func (c *dbParameterGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DbParameterGroup, err error) {
...
func (c *dbParameterGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DbParameterGroupList, err error) {
...
func (c *dbParameterGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dbParameterGroups) Create(ctx context.Context, dbParameterGroup *v1alpha1.DbParameterGroup, opts v1.CreateOptions) (result *v1alpha1.DbParameterGroup, err error) {
	result = &v1alpha1.DbParameterGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dbparametergroups").
...
func (c *dbParameterGroups) Update(ctx context.Context, dbParameterGroup *v1alpha1.DbParameterGroup, opts v1.UpdateOptions) (result *v1alpha1.DbParameterGroup, err error) {
	result = &v1alpha1.DbParameterGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbparametergroups").
...
func (c *dbParameterGroups) UpdateStatus(ctx context.Context, dbParameterGroup *v1alpha1.DbParameterGroup, opts v1.UpdateOptions) (result *v1alpha1.DbParameterGroup, err error) {
	result = &v1alpha1.DbParameterGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbparametergroups").
...
func (c *dbParameterGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dbParameterGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dbParameterGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DbParameterGroup, err error) {
	result = &v1alpha1.DbParameterGroup{}
