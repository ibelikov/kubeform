...
func (c *dbInstanceRoleAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DbInstanceRoleAssociation, err error) {
...
func (c *dbInstanceRoleAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DbInstanceRoleAssociationList, err error) {
...
func (c *dbInstanceRoleAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dbInstanceRoleAssociations) Create(ctx context.Context, dbInstanceRoleAssociation *v1alpha1.DbInstanceRoleAssociation, opts v1.CreateOptions) (result *v1alpha1.DbInstanceRoleAssociation, err error) {
	result = &v1alpha1.DbInstanceRoleAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dbinstanceroleassociations").
...
func (c *dbInstanceRoleAssociations) Update(ctx context.Context, dbInstanceRoleAssociation *v1alpha1.DbInstanceRoleAssociation, opts v1.UpdateOptions) (result *v1alpha1.DbInstanceRoleAssociation, err error) {
	result = &v1alpha1.DbInstanceRoleAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbinstanceroleassociations").
...
func (c *dbInstanceRoleAssociations) UpdateStatus(ctx context.Context, dbInstanceRoleAssociation *v1alpha1.DbInstanceRoleAssociation, opts v1.UpdateOptions) (result *v1alpha1.DbInstanceRoleAssociation, err error) {
	result = &v1alpha1.DbInstanceRoleAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbinstanceroleassociations").
...
func (c *dbInstanceRoleAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dbInstanceRoleAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dbInstanceRoleAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DbInstanceRoleAssociation, err error) {
	result = &v1alpha1.DbInstanceRoleAssociation{}
