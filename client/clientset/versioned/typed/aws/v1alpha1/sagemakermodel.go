...
type SagemakerModelInterface interface {
	Create(*v1alpha1.SagemakerModel) (*v1alpha1.SagemakerModel, error)
	Update(*v1alpha1.SagemakerModel) (*v1alpha1.SagemakerModel, error)
	UpdateStatus(*v1alpha1.SagemakerModel) (*v1alpha1.SagemakerModel, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SagemakerModel, error)
	List(opts v1.ListOptions) (*v1alpha1.SagemakerModelList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SagemakerModel, err error)
...
func (c *sagemakerModels) List(opts v1.ListOptions) (result *v1alpha1.SagemakerModelList, err error) {
...
func (c *sagemakerModels) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sagemakerModels) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
