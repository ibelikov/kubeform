...
func (c *sagemakerModels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SagemakerModel, err error) {
...
func (c *sagemakerModels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SagemakerModelList, err error) {
...
func (c *sagemakerModels) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sagemakerModels) Create(ctx context.Context, sagemakerModel *v1alpha1.SagemakerModel, opts v1.CreateOptions) (result *v1alpha1.SagemakerModel, err error) {
	result = &v1alpha1.SagemakerModel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sagemakermodels").
...
func (c *sagemakerModels) Update(ctx context.Context, sagemakerModel *v1alpha1.SagemakerModel, opts v1.UpdateOptions) (result *v1alpha1.SagemakerModel, err error) {
	result = &v1alpha1.SagemakerModel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sagemakermodels").
...
func (c *sagemakerModels) UpdateStatus(ctx context.Context, sagemakerModel *v1alpha1.SagemakerModel, opts v1.UpdateOptions) (result *v1alpha1.SagemakerModel, err error) {
	result = &v1alpha1.SagemakerModel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sagemakermodels").
...
func (c *sagemakerModels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sagemakerModels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sagemakerModels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SagemakerModel, err error) {
	result = &v1alpha1.SagemakerModel{}
