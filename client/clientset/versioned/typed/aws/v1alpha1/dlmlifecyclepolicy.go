...
type DlmLifecyclePolicyInterface interface {
	Create(*v1alpha1.DlmLifecyclePolicy) (*v1alpha1.DlmLifecyclePolicy, error)
	Update(*v1alpha1.DlmLifecyclePolicy) (*v1alpha1.DlmLifecyclePolicy, error)
	UpdateStatus(*v1alpha1.DlmLifecyclePolicy) (*v1alpha1.DlmLifecyclePolicy, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DlmLifecyclePolicy, error)
	List(opts v1.ListOptions) (*v1alpha1.DlmLifecyclePolicyList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DlmLifecyclePolicy, err error)
...
func (c *dlmLifecyclePolicies) List(opts v1.ListOptions) (result *v1alpha1.DlmLifecyclePolicyList, err error) {
...
func (c *dlmLifecyclePolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dlmLifecyclePolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
