...
func (c *dlmLifecyclePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DlmLifecyclePolicy, err error) {
...
func (c *dlmLifecyclePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DlmLifecyclePolicyList, err error) {
...
func (c *dlmLifecyclePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dlmLifecyclePolicies) Create(ctx context.Context, dlmLifecyclePolicy *v1alpha1.DlmLifecyclePolicy, opts v1.CreateOptions) (result *v1alpha1.DlmLifecyclePolicy, err error) {
	result = &v1alpha1.DlmLifecyclePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dlmlifecyclepolicies").
...
func (c *dlmLifecyclePolicies) Update(ctx context.Context, dlmLifecyclePolicy *v1alpha1.DlmLifecyclePolicy, opts v1.UpdateOptions) (result *v1alpha1.DlmLifecyclePolicy, err error) {
	result = &v1alpha1.DlmLifecyclePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dlmlifecyclepolicies").
...
func (c *dlmLifecyclePolicies) UpdateStatus(ctx context.Context, dlmLifecyclePolicy *v1alpha1.DlmLifecyclePolicy, opts v1.UpdateOptions) (result *v1alpha1.DlmLifecyclePolicy, err error) {
	result = &v1alpha1.DlmLifecyclePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dlmlifecyclepolicies").
...
func (c *dlmLifecyclePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dlmLifecyclePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dlmLifecyclePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DlmLifecyclePolicy, err error) {
	result = &v1alpha1.DlmLifecyclePolicy{}
