...
type GlueCatalogTableInterface interface {
	Create(*v1alpha1.GlueCatalogTable) (*v1alpha1.GlueCatalogTable, error)
	Update(*v1alpha1.GlueCatalogTable) (*v1alpha1.GlueCatalogTable, error)
	UpdateStatus(*v1alpha1.GlueCatalogTable) (*v1alpha1.GlueCatalogTable, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.GlueCatalogTable, error)
	List(opts v1.ListOptions) (*v1alpha1.GlueCatalogTableList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.GlueCatalogTable, err error)
...
func (c *glueCatalogTables) List(opts v1.ListOptions) (result *v1alpha1.GlueCatalogTableList, err error) {
...
func (c *glueCatalogTables) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *glueCatalogTables) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
