...
func (c *glueCatalogTables) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlueCatalogTable, err error) {
...
func (c *glueCatalogTables) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlueCatalogTableList, err error) {
...
func (c *glueCatalogTables) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *glueCatalogTables) Create(ctx context.Context, glueCatalogTable *v1alpha1.GlueCatalogTable, opts v1.CreateOptions) (result *v1alpha1.GlueCatalogTable, err error) {
	result = &v1alpha1.GlueCatalogTable{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gluecatalogtables").
...
func (c *glueCatalogTables) Update(ctx context.Context, glueCatalogTable *v1alpha1.GlueCatalogTable, opts v1.UpdateOptions) (result *v1alpha1.GlueCatalogTable, err error) {
	result = &v1alpha1.GlueCatalogTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gluecatalogtables").
...
func (c *glueCatalogTables) UpdateStatus(ctx context.Context, glueCatalogTable *v1alpha1.GlueCatalogTable, opts v1.UpdateOptions) (result *v1alpha1.GlueCatalogTable, err error) {
	result = &v1alpha1.GlueCatalogTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gluecatalogtables").
...
func (c *glueCatalogTables) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *glueCatalogTables) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *glueCatalogTables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlueCatalogTable, err error) {
	result = &v1alpha1.GlueCatalogTable{}
