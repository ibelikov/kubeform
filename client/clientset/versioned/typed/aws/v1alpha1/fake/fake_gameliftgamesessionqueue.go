...
func (c *FakeGameliftGameSessionQueues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GameliftGameSessionQueue, err error) {
	obj, err := c.Fake.
...
func (c *FakeGameliftGameSessionQueues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GameliftGameSessionQueueList, err error) {
	obj, err := c.Fake.
...
func (c *FakeGameliftGameSessionQueues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeGameliftGameSessionQueues) Create(ctx context.Context, gameliftGameSessionQueue *v1alpha1.GameliftGameSessionQueue, opts v1.CreateOptions) (result *v1alpha1.GameliftGameSessionQueue, err error) {
	obj, err := c.Fake.
...
func (c *FakeGameliftGameSessionQueues) Update(ctx context.Context, gameliftGameSessionQueue *v1alpha1.GameliftGameSessionQueue, opts v1.UpdateOptions) (result *v1alpha1.GameliftGameSessionQueue, err error) {
	obj, err := c.Fake.
...
func (c *FakeGameliftGameSessionQueues) UpdateStatus(ctx context.Context, gameliftGameSessionQueue *v1alpha1.GameliftGameSessionQueue, opts v1.UpdateOptions) (*v1alpha1.GameliftGameSessionQueue, error) {
	obj, err := c.Fake.
...
func (c *FakeGameliftGameSessionQueues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeGameliftGameSessionQueues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(gameliftgamesessionqueuesResource, c.ns, listOpts)
...
func (c *FakeGameliftGameSessionQueues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GameliftGameSessionQueue, err error) {
	obj, err := c.Fake.
