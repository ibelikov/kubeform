...
func (c *FakeAppsyncGraphqlAPIs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppsyncGraphqlAPIs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppsyncGraphqlAPIList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppsyncGraphqlAPIs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAppsyncGraphqlAPIs) Create(ctx context.Context, appsyncGraphqlAPI *v1alpha1.AppsyncGraphqlAPI, opts v1.CreateOptions) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppsyncGraphqlAPIs) Update(ctx context.Context, appsyncGraphqlAPI *v1alpha1.AppsyncGraphqlAPI, opts v1.UpdateOptions) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppsyncGraphqlAPIs) UpdateStatus(ctx context.Context, appsyncGraphqlAPI *v1alpha1.AppsyncGraphqlAPI, opts v1.UpdateOptions) (*v1alpha1.AppsyncGraphqlAPI, error) {
	obj, err := c.Fake.
...
func (c *FakeAppsyncGraphqlAPIs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAppsyncGraphqlAPIs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(appsyncgraphqlapisResource, c.ns, listOpts)
...
func (c *FakeAppsyncGraphqlAPIs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
	obj, err := c.Fake.
