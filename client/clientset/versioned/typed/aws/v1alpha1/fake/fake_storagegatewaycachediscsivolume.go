...
func (c *FakeStoragegatewayCachedIscsiVolumes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StoragegatewayCachedIscsiVolume, err error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayCachedIscsiVolumes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StoragegatewayCachedIscsiVolumeList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayCachedIscsiVolumes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeStoragegatewayCachedIscsiVolumes) Create(ctx context.Context, storagegatewayCachedIscsiVolume *v1alpha1.StoragegatewayCachedIscsiVolume, opts v1.CreateOptions) (result *v1alpha1.StoragegatewayCachedIscsiVolume, err error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayCachedIscsiVolumes) Update(ctx context.Context, storagegatewayCachedIscsiVolume *v1alpha1.StoragegatewayCachedIscsiVolume, opts v1.UpdateOptions) (result *v1alpha1.StoragegatewayCachedIscsiVolume, err error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayCachedIscsiVolumes) UpdateStatus(ctx context.Context, storagegatewayCachedIscsiVolume *v1alpha1.StoragegatewayCachedIscsiVolume, opts v1.UpdateOptions) (*v1alpha1.StoragegatewayCachedIscsiVolume, error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayCachedIscsiVolumes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeStoragegatewayCachedIscsiVolumes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(storagegatewaycachediscsivolumesResource, c.ns, listOpts)
...
func (c *FakeStoragegatewayCachedIscsiVolumes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StoragegatewayCachedIscsiVolume, err error) {
	obj, err := c.Fake.
