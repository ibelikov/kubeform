...
func (c *FakeDatasyncTasks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatasyncTask, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatasyncTasks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatasyncTaskList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatasyncTasks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeDatasyncTasks) Create(ctx context.Context, datasyncTask *v1alpha1.DatasyncTask, opts v1.CreateOptions) (result *v1alpha1.DatasyncTask, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatasyncTasks) Update(ctx context.Context, datasyncTask *v1alpha1.DatasyncTask, opts v1.UpdateOptions) (result *v1alpha1.DatasyncTask, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatasyncTasks) UpdateStatus(ctx context.Context, datasyncTask *v1alpha1.DatasyncTask, opts v1.UpdateOptions) (*v1alpha1.DatasyncTask, error) {
	obj, err := c.Fake.
...
func (c *FakeDatasyncTasks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeDatasyncTasks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(datasynctasksResource, c.ns, listOpts)
...
func (c *FakeDatasyncTasks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatasyncTask, err error) {
	obj, err := c.Fake.
