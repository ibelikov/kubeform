...
func (c *FakeSesConfigurationSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SesConfigurationSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeSesConfigurationSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SesConfigurationSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSesConfigurationSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSesConfigurationSets) Create(ctx context.Context, sesConfigurationSet *v1alpha1.SesConfigurationSet, opts v1.CreateOptions) (result *v1alpha1.SesConfigurationSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeSesConfigurationSets) Update(ctx context.Context, sesConfigurationSet *v1alpha1.SesConfigurationSet, opts v1.UpdateOptions) (result *v1alpha1.SesConfigurationSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeSesConfigurationSets) UpdateStatus(ctx context.Context, sesConfigurationSet *v1alpha1.SesConfigurationSet, opts v1.UpdateOptions) (*v1alpha1.SesConfigurationSet, error) {
	obj, err := c.Fake.
...
func (c *FakeSesConfigurationSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeSesConfigurationSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sesconfigurationsetsResource, c.ns, listOpts)
...
func (c *FakeSesConfigurationSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SesConfigurationSet, err error) {
	obj, err := c.Fake.
