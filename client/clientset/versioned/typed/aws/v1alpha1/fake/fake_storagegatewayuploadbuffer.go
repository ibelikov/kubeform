...
func (c *FakeStoragegatewayUploadBuffers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StoragegatewayUploadBuffer, err error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayUploadBuffers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StoragegatewayUploadBufferList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayUploadBuffers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeStoragegatewayUploadBuffers) Create(ctx context.Context, storagegatewayUploadBuffer *v1alpha1.StoragegatewayUploadBuffer, opts v1.CreateOptions) (result *v1alpha1.StoragegatewayUploadBuffer, err error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayUploadBuffers) Update(ctx context.Context, storagegatewayUploadBuffer *v1alpha1.StoragegatewayUploadBuffer, opts v1.UpdateOptions) (result *v1alpha1.StoragegatewayUploadBuffer, err error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayUploadBuffers) UpdateStatus(ctx context.Context, storagegatewayUploadBuffer *v1alpha1.StoragegatewayUploadBuffer, opts v1.UpdateOptions) (*v1alpha1.StoragegatewayUploadBuffer, error) {
	obj, err := c.Fake.
...
func (c *FakeStoragegatewayUploadBuffers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeStoragegatewayUploadBuffers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(storagegatewayuploadbuffersResource, c.ns, listOpts)
...
func (c *FakeStoragegatewayUploadBuffers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StoragegatewayUploadBuffer, err error) {
	obj, err := c.Fake.
