...
func (c *FakeOpsworksMemcachedLayers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksMemcachedLayers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksMemcachedLayerList, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksMemcachedLayers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeOpsworksMemcachedLayers) Create(ctx context.Context, opsworksMemcachedLayer *v1alpha1.OpsworksMemcachedLayer, opts v1.CreateOptions) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksMemcachedLayers) Update(ctx context.Context, opsworksMemcachedLayer *v1alpha1.OpsworksMemcachedLayer, opts v1.UpdateOptions) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksMemcachedLayers) UpdateStatus(ctx context.Context, opsworksMemcachedLayer *v1alpha1.OpsworksMemcachedLayer, opts v1.UpdateOptions) (*v1alpha1.OpsworksMemcachedLayer, error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksMemcachedLayers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeOpsworksMemcachedLayers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(opsworksmemcachedlayersResource, c.ns, listOpts)
...
func (c *FakeOpsworksMemcachedLayers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
	obj, err := c.Fake.
