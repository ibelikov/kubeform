...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, err error) {
	obj, err := c.Fake.
...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DxHostedPrivateVirtualInterfaceAccepterList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) Create(ctx context.Context, dxHostedPrivateVirtualInterfaceAccepter *v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, opts v1.CreateOptions) (result *v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, err error) {
	obj, err := c.Fake.
...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) Update(ctx context.Context, dxHostedPrivateVirtualInterfaceAccepter *v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, opts v1.UpdateOptions) (result *v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, err error) {
	obj, err := c.Fake.
...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) UpdateStatus(ctx context.Context, dxHostedPrivateVirtualInterfaceAccepter *v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, opts v1.UpdateOptions) (*v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, error) {
	obj, err := c.Fake.
...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(dxhostedprivatevirtualinterfaceacceptersResource, c.ns, listOpts)
...
func (c *FakeDxHostedPrivateVirtualInterfaceAccepters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, err error) {
	obj, err := c.Fake.
