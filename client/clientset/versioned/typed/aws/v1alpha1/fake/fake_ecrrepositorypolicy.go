...
func (c *FakeEcrRepositoryPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EcrRepositoryPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeEcrRepositoryPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EcrRepositoryPolicyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeEcrRepositoryPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeEcrRepositoryPolicies) Create(ctx context.Context, ecrRepositoryPolicy *v1alpha1.EcrRepositoryPolicy, opts v1.CreateOptions) (result *v1alpha1.EcrRepositoryPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeEcrRepositoryPolicies) Update(ctx context.Context, ecrRepositoryPolicy *v1alpha1.EcrRepositoryPolicy, opts v1.UpdateOptions) (result *v1alpha1.EcrRepositoryPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeEcrRepositoryPolicies) UpdateStatus(ctx context.Context, ecrRepositoryPolicy *v1alpha1.EcrRepositoryPolicy, opts v1.UpdateOptions) (*v1alpha1.EcrRepositoryPolicy, error) {
	obj, err := c.Fake.
...
func (c *FakeEcrRepositoryPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeEcrRepositoryPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(ecrrepositorypoliciesResource, c.ns, listOpts)
...
func (c *FakeEcrRepositoryPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EcrRepositoryPolicy, err error) {
	obj, err := c.Fake.
