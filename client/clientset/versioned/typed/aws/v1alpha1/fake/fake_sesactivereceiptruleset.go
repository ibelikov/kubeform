...
func (c *FakeSesActiveReceiptRuleSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SesActiveReceiptRuleSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeSesActiveReceiptRuleSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SesActiveReceiptRuleSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSesActiveReceiptRuleSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSesActiveReceiptRuleSets) Create(ctx context.Context, sesActiveReceiptRuleSet *v1alpha1.SesActiveReceiptRuleSet, opts v1.CreateOptions) (result *v1alpha1.SesActiveReceiptRuleSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeSesActiveReceiptRuleSets) Update(ctx context.Context, sesActiveReceiptRuleSet *v1alpha1.SesActiveReceiptRuleSet, opts v1.UpdateOptions) (result *v1alpha1.SesActiveReceiptRuleSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeSesActiveReceiptRuleSets) UpdateStatus(ctx context.Context, sesActiveReceiptRuleSet *v1alpha1.SesActiveReceiptRuleSet, opts v1.UpdateOptions) (*v1alpha1.SesActiveReceiptRuleSet, error) {
	obj, err := c.Fake.
...
func (c *FakeSesActiveReceiptRuleSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeSesActiveReceiptRuleSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sesactivereceiptrulesetsResource, c.ns, listOpts)
...
func (c *FakeSesActiveReceiptRuleSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SesActiveReceiptRuleSet, err error) {
	obj, err := c.Fake.
