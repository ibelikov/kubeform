...
var gluesecurityconfigurationsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "GlueSecurityConfiguration"}
...
func (c *FakeGlueSecurityConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlueSecurityConfiguration, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.GlueSecurityConfiguration), err
}

// List takes label and field selectors, and returns the list of GlueSecurityConfigurations that match those selectors.
func (c *FakeGlueSecurityConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlueSecurityConfigurationList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.GlueSecurityConfigurationList{ListMeta: obj.(*v1alpha1.GlueSecurityConfigurationList).ListMeta}
	for _, item := range obj.(*v1alpha1.GlueSecurityConfigurationList).Items {
...
func (c *FakeGlueSecurityConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeGlueSecurityConfigurations) Create(ctx context.Context, glueSecurityConfiguration *v1alpha1.GlueSecurityConfiguration, opts v1.CreateOptions) (result *v1alpha1.GlueSecurityConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlueSecurityConfigurations) Update(ctx context.Context, glueSecurityConfiguration *v1alpha1.GlueSecurityConfiguration, opts v1.UpdateOptions) (result *v1alpha1.GlueSecurityConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlueSecurityConfigurations) UpdateStatus(ctx context.Context, glueSecurityConfiguration *v1alpha1.GlueSecurityConfiguration, opts v1.UpdateOptions) (*v1alpha1.GlueSecurityConfiguration, error) {
	obj, err := c.Fake.
...
func (c *FakeGlueSecurityConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeGlueSecurityConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(gluesecurityconfigurationsResource, c.ns, listOpts)
...
func (c *FakeGlueSecurityConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlueSecurityConfiguration, err error) {
	obj, err := c.Fake.
