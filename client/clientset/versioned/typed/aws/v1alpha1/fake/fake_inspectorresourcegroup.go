...
func (c *FakeInspectorResourceGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InspectorResourceGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeInspectorResourceGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InspectorResourceGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeInspectorResourceGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeInspectorResourceGroups) Create(ctx context.Context, inspectorResourceGroup *v1alpha1.InspectorResourceGroup, opts v1.CreateOptions) (result *v1alpha1.InspectorResourceGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeInspectorResourceGroups) Update(ctx context.Context, inspectorResourceGroup *v1alpha1.InspectorResourceGroup, opts v1.UpdateOptions) (result *v1alpha1.InspectorResourceGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeInspectorResourceGroups) UpdateStatus(ctx context.Context, inspectorResourceGroup *v1alpha1.InspectorResourceGroup, opts v1.UpdateOptions) (*v1alpha1.InspectorResourceGroup, error) {
	obj, err := c.Fake.
...
func (c *FakeInspectorResourceGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeInspectorResourceGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(inspectorresourcegroupsResource, c.ns, listOpts)
...
func (c *FakeInspectorResourceGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InspectorResourceGroup, err error) {
	obj, err := c.Fake.
