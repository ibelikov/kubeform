...
func (c *FakeDocdbSubnetGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DocdbSubnetGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeDocdbSubnetGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DocdbSubnetGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDocdbSubnetGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeDocdbSubnetGroups) Create(ctx context.Context, docdbSubnetGroup *v1alpha1.DocdbSubnetGroup, opts v1.CreateOptions) (result *v1alpha1.DocdbSubnetGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeDocdbSubnetGroups) Update(ctx context.Context, docdbSubnetGroup *v1alpha1.DocdbSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.DocdbSubnetGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeDocdbSubnetGroups) UpdateStatus(ctx context.Context, docdbSubnetGroup *v1alpha1.DocdbSubnetGroup, opts v1.UpdateOptions) (*v1alpha1.DocdbSubnetGroup, error) {
	obj, err := c.Fake.
...
func (c *FakeDocdbSubnetGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeDocdbSubnetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(docdbsubnetgroupsResource, c.ns, listOpts)
...
func (c *FakeDocdbSubnetGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DocdbSubnetGroup, err error) {
	obj, err := c.Fake.
