...
// FakeEcrLifecyclePolicies implements EcrLifecyclePolicyInterface
type FakeEcrLifecyclePolicies struct {
	Fake *FakeAwsV1alpha1
	ns   string
}

var ecrlifecyclepoliciesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "ecrlifecyclepolicies"}
...
func (c *FakeEcrLifecyclePolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.EcrLifecyclePolicy, err error) {
	...
	return obj.(*v1alpha1.EcrLifecyclePolicy), err
}
...
func (c *FakeEcrLifecyclePolicies) List(opts v1.ListOptions) (result *v1alpha1.EcrLifecyclePolicyList, err error) {
	...
	list := &v1alpha1.EcrLifecyclePolicyList{ListMeta: obj.(*v1alpha1.EcrLifecyclePolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.EcrLifecyclePolicyList).Items {
