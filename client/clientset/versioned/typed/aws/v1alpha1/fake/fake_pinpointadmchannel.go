...
var pinpointadmchannelsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "PinpointAdmChannel"}
...
func (c *FakePinpointAdmChannels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PinpointAdmChannel, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.PinpointAdmChannel), err
}

// List takes label and field selectors, and returns the list of PinpointAdmChannels that match those selectors.
func (c *FakePinpointAdmChannels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PinpointAdmChannelList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.PinpointAdmChannelList{ListMeta: obj.(*v1alpha1.PinpointAdmChannelList).ListMeta}
	for _, item := range obj.(*v1alpha1.PinpointAdmChannelList).Items {
...
func (c *FakePinpointAdmChannels) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakePinpointAdmChannels) Create(ctx context.Context, pinpointAdmChannel *v1alpha1.PinpointAdmChannel, opts v1.CreateOptions) (result *v1alpha1.PinpointAdmChannel, err error) {
	obj, err := c.Fake.
...
func (c *FakePinpointAdmChannels) Update(ctx context.Context, pinpointAdmChannel *v1alpha1.PinpointAdmChannel, opts v1.UpdateOptions) (result *v1alpha1.PinpointAdmChannel, err error) {
	obj, err := c.Fake.
...
func (c *FakePinpointAdmChannels) UpdateStatus(ctx context.Context, pinpointAdmChannel *v1alpha1.PinpointAdmChannel, opts v1.UpdateOptions) (*v1alpha1.PinpointAdmChannel, error) {
	obj, err := c.Fake.
...
func (c *FakePinpointAdmChannels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakePinpointAdmChannels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(pinpointadmchannelsResource, c.ns, listOpts)
...
func (c *FakePinpointAdmChannels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PinpointAdmChannel, err error) {
	obj, err := c.Fake.
