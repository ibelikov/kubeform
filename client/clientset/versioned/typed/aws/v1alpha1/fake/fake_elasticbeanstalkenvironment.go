...
// FakeElasticBeanstalkEnvironments implements ElasticBeanstalkEnvironmentInterface
type FakeElasticBeanstalkEnvironments struct {
	Fake *FakeAwsV1alpha1
	ns   string
}

var elasticbeanstalkenvironmentsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "elasticbeanstalkenvironments"}
...
func (c *FakeElasticBeanstalkEnvironments) Get(name string, options v1.GetOptions) (result *v1alpha1.ElasticBeanstalkEnvironment, err error) {
	...
	return obj.(*v1alpha1.ElasticBeanstalkEnvironment), err
}
...
func (c *FakeElasticBeanstalkEnvironments) List(opts v1.ListOptions) (result *v1alpha1.ElasticBeanstalkEnvironmentList, err error) {
	...
	list := &v1alpha1.ElasticBeanstalkEnvironmentList{ListMeta: obj.(*v1alpha1.ElasticBeanstalkEnvironmentList).ListMeta}
	for _, item := range obj.(*v1alpha1.ElasticBeanstalkEnvironmentList).Items {
