...
// FakeVpcPeeringConnectionAccepters implements VpcPeeringConnectionAccepterInterface
type FakeVpcPeeringConnectionAccepters struct {
	Fake *FakeAwsV1alpha1
	ns   string
}

var vpcpeeringconnectionacceptersResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "vpcpeeringconnectionaccepters"}
...
func (c *FakeVpcPeeringConnectionAccepters) Get(name string, options v1.GetOptions) (result *v1alpha1.VpcPeeringConnectionAccepter, err error) {
	...
	return obj.(*v1alpha1.VpcPeeringConnectionAccepter), err
}
...
func (c *FakeVpcPeeringConnectionAccepters) List(opts v1.ListOptions) (result *v1alpha1.VpcPeeringConnectionAccepterList, err error) {
	...
	list := &v1alpha1.VpcPeeringConnectionAccepterList{ListMeta: obj.(*v1alpha1.VpcPeeringConnectionAccepterList).ListMeta}
	for _, item := range obj.(*v1alpha1.VpcPeeringConnectionAccepterList).Items {
