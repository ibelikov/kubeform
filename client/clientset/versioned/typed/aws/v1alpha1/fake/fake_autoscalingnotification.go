...
func (c *FakeAutoscalingNotifications) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoscalingNotification, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingNotifications) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoscalingNotificationList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingNotifications) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAutoscalingNotifications) Create(ctx context.Context, autoscalingNotification *v1alpha1.AutoscalingNotification, opts v1.CreateOptions) (result *v1alpha1.AutoscalingNotification, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingNotifications) Update(ctx context.Context, autoscalingNotification *v1alpha1.AutoscalingNotification, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingNotification, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingNotifications) UpdateStatus(ctx context.Context, autoscalingNotification *v1alpha1.AutoscalingNotification, opts v1.UpdateOptions) (*v1alpha1.AutoscalingNotification, error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingNotifications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAutoscalingNotifications) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(autoscalingnotificationsResource, c.ns, listOpts)
...
func (c *FakeAutoscalingNotifications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoscalingNotification, err error) {
	obj, err := c.Fake.
