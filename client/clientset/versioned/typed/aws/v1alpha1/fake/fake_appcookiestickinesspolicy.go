...
func (c *FakeAppCookieStickinessPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppCookieStickinessPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppCookieStickinessPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppCookieStickinessPolicyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppCookieStickinessPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAppCookieStickinessPolicies) Create(ctx context.Context, appCookieStickinessPolicy *v1alpha1.AppCookieStickinessPolicy, opts v1.CreateOptions) (result *v1alpha1.AppCookieStickinessPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppCookieStickinessPolicies) Update(ctx context.Context, appCookieStickinessPolicy *v1alpha1.AppCookieStickinessPolicy, opts v1.UpdateOptions) (result *v1alpha1.AppCookieStickinessPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppCookieStickinessPolicies) UpdateStatus(ctx context.Context, appCookieStickinessPolicy *v1alpha1.AppCookieStickinessPolicy, opts v1.UpdateOptions) (*v1alpha1.AppCookieStickinessPolicy, error) {
	obj, err := c.Fake.
...
func (c *FakeAppCookieStickinessPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAppCookieStickinessPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(appcookiestickinesspoliciesResource, c.ns, listOpts)
...
func (c *FakeAppCookieStickinessPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppCookieStickinessPolicy, err error) {
	obj, err := c.Fake.
