...
var iamaccountpasswordpoliciesKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "IamAccountPasswordPolicy"}
...
func (c *FakeIamAccountPasswordPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.IamAccountPasswordPolicy), err
}

// List takes label and field selectors, and returns the list of IamAccountPasswordPolicies that match those selectors.
func (c *FakeIamAccountPasswordPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamAccountPasswordPolicyList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.IamAccountPasswordPolicyList{ListMeta: obj.(*v1alpha1.IamAccountPasswordPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.IamAccountPasswordPolicyList).Items {
...
func (c *FakeIamAccountPasswordPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeIamAccountPasswordPolicies) Create(ctx context.Context, iamAccountPasswordPolicy *v1alpha1.IamAccountPasswordPolicy, opts v1.CreateOptions) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamAccountPasswordPolicies) Update(ctx context.Context, iamAccountPasswordPolicy *v1alpha1.IamAccountPasswordPolicy, opts v1.UpdateOptions) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamAccountPasswordPolicies) UpdateStatus(ctx context.Context, iamAccountPasswordPolicy *v1alpha1.IamAccountPasswordPolicy, opts v1.UpdateOptions) (*v1alpha1.IamAccountPasswordPolicy, error) {
	obj, err := c.Fake.
...
func (c *FakeIamAccountPasswordPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeIamAccountPasswordPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(iamaccountpasswordpoliciesResource, c.ns, listOpts)
...
func (c *FakeIamAccountPasswordPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamAccountPasswordPolicy, err error) {
	obj, err := c.Fake.
