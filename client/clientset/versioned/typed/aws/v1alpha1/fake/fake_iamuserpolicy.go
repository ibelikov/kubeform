...
func (c *FakeIamUserPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamUserPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamUserPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamUserPolicyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamUserPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeIamUserPolicies) Create(ctx context.Context, iamUserPolicy *v1alpha1.IamUserPolicy, opts v1.CreateOptions) (result *v1alpha1.IamUserPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamUserPolicies) Update(ctx context.Context, iamUserPolicy *v1alpha1.IamUserPolicy, opts v1.UpdateOptions) (result *v1alpha1.IamUserPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamUserPolicies) UpdateStatus(ctx context.Context, iamUserPolicy *v1alpha1.IamUserPolicy, opts v1.UpdateOptions) (*v1alpha1.IamUserPolicy, error) {
	obj, err := c.Fake.
...
func (c *FakeIamUserPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeIamUserPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(iamuserpoliciesResource, c.ns, listOpts)
...
func (c *FakeIamUserPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamUserPolicy, err error) {
	obj, err := c.Fake.
