...
func (c *FakeCodedeployDeploymentGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeCodedeployDeploymentGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CodedeployDeploymentGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCodedeployDeploymentGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCodedeployDeploymentGroups) Create(ctx context.Context, codedeployDeploymentGroup *v1alpha1.CodedeployDeploymentGroup, opts v1.CreateOptions) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeCodedeployDeploymentGroups) Update(ctx context.Context, codedeployDeploymentGroup *v1alpha1.CodedeployDeploymentGroup, opts v1.UpdateOptions) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeCodedeployDeploymentGroups) UpdateStatus(ctx context.Context, codedeployDeploymentGroup *v1alpha1.CodedeployDeploymentGroup, opts v1.UpdateOptions) (*v1alpha1.CodedeployDeploymentGroup, error) {
	obj, err := c.Fake.
...
func (c *FakeCodedeployDeploymentGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeCodedeployDeploymentGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(codedeploydeploymentgroupsResource, c.ns, listOpts)
...
func (c *FakeCodedeployDeploymentGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
	obj, err := c.Fake.
