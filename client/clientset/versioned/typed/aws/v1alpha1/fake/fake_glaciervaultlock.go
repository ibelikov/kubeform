...
func (c *FakeGlacierVaultLocks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlacierVaultLock, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlacierVaultLocks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlacierVaultLockList, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlacierVaultLocks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeGlacierVaultLocks) Create(ctx context.Context, glacierVaultLock *v1alpha1.GlacierVaultLock, opts v1.CreateOptions) (result *v1alpha1.GlacierVaultLock, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlacierVaultLocks) Update(ctx context.Context, glacierVaultLock *v1alpha1.GlacierVaultLock, opts v1.UpdateOptions) (result *v1alpha1.GlacierVaultLock, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlacierVaultLocks) UpdateStatus(ctx context.Context, glacierVaultLock *v1alpha1.GlacierVaultLock, opts v1.UpdateOptions) (*v1alpha1.GlacierVaultLock, error) {
	obj, err := c.Fake.
...
func (c *FakeGlacierVaultLocks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeGlacierVaultLocks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(glaciervaultlocksResource, c.ns, listOpts)
...
func (c *FakeGlacierVaultLocks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlacierVaultLock, err error) {
	obj, err := c.Fake.
