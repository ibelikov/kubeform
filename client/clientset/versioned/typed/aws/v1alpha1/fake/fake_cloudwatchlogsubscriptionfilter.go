...
func (c *FakeCloudwatchLogSubscriptionFilters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudwatchLogSubscriptionFilter, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogSubscriptionFilters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudwatchLogSubscriptionFilterList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogSubscriptionFilters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCloudwatchLogSubscriptionFilters) Create(ctx context.Context, cloudwatchLogSubscriptionFilter *v1alpha1.CloudwatchLogSubscriptionFilter, opts v1.CreateOptions) (result *v1alpha1.CloudwatchLogSubscriptionFilter, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogSubscriptionFilters) Update(ctx context.Context, cloudwatchLogSubscriptionFilter *v1alpha1.CloudwatchLogSubscriptionFilter, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogSubscriptionFilter, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogSubscriptionFilters) UpdateStatus(ctx context.Context, cloudwatchLogSubscriptionFilter *v1alpha1.CloudwatchLogSubscriptionFilter, opts v1.UpdateOptions) (*v1alpha1.CloudwatchLogSubscriptionFilter, error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogSubscriptionFilters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeCloudwatchLogSubscriptionFilters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(cloudwatchlogsubscriptionfiltersResource, c.ns, listOpts)
...
func (c *FakeCloudwatchLogSubscriptionFilters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudwatchLogSubscriptionFilter, err error) {
	obj, err := c.Fake.
