...
func (c *FakeOpsworksUserProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksUserProfile, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksUserProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksUserProfileList, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksUserProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeOpsworksUserProfiles) Create(ctx context.Context, opsworksUserProfile *v1alpha1.OpsworksUserProfile, opts v1.CreateOptions) (result *v1alpha1.OpsworksUserProfile, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksUserProfiles) Update(ctx context.Context, opsworksUserProfile *v1alpha1.OpsworksUserProfile, opts v1.UpdateOptions) (result *v1alpha1.OpsworksUserProfile, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksUserProfiles) UpdateStatus(ctx context.Context, opsworksUserProfile *v1alpha1.OpsworksUserProfile, opts v1.UpdateOptions) (*v1alpha1.OpsworksUserProfile, error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksUserProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeOpsworksUserProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(opsworksuserprofilesResource, c.ns, listOpts)
...
func (c *FakeOpsworksUserProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksUserProfile, err error) {
	obj, err := c.Fake.
