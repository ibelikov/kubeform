...
func (c *FakeCurReportDefinitions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CurReportDefinition, err error) {
	obj, err := c.Fake.
...
func (c *FakeCurReportDefinitions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CurReportDefinitionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCurReportDefinitions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCurReportDefinitions) Create(ctx context.Context, curReportDefinition *v1alpha1.CurReportDefinition, opts v1.CreateOptions) (result *v1alpha1.CurReportDefinition, err error) {
	obj, err := c.Fake.
...
func (c *FakeCurReportDefinitions) Update(ctx context.Context, curReportDefinition *v1alpha1.CurReportDefinition, opts v1.UpdateOptions) (result *v1alpha1.CurReportDefinition, err error) {
	obj, err := c.Fake.
...
func (c *FakeCurReportDefinitions) UpdateStatus(ctx context.Context, curReportDefinition *v1alpha1.CurReportDefinition, opts v1.UpdateOptions) (*v1alpha1.CurReportDefinition, error) {
	obj, err := c.Fake.
...
func (c *FakeCurReportDefinitions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeCurReportDefinitions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(curreportdefinitionsResource, c.ns, listOpts)
...
func (c *FakeCurReportDefinitions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CurReportDefinition, err error) {
	obj, err := c.Fake.
