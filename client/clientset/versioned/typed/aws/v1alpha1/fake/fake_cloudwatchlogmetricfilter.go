...
func (c *FakeCloudwatchLogMetricFilters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogMetricFilters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudwatchLogMetricFilterList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogMetricFilters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCloudwatchLogMetricFilters) Create(ctx context.Context, cloudwatchLogMetricFilter *v1alpha1.CloudwatchLogMetricFilter, opts v1.CreateOptions) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogMetricFilters) Update(ctx context.Context, cloudwatchLogMetricFilter *v1alpha1.CloudwatchLogMetricFilter, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogMetricFilters) UpdateStatus(ctx context.Context, cloudwatchLogMetricFilter *v1alpha1.CloudwatchLogMetricFilter, opts v1.UpdateOptions) (*v1alpha1.CloudwatchLogMetricFilter, error) {
	obj, err := c.Fake.
...
func (c *FakeCloudwatchLogMetricFilters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeCloudwatchLogMetricFilters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(cloudwatchlogmetricfiltersResource, c.ns, listOpts)
...
func (c *FakeCloudwatchLogMetricFilters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudwatchLogMetricFilter, err error) {
	obj, err := c.Fake.
