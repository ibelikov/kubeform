...
func (c *FakeApiGatewayRestAPIs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayRestAPI, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayRestAPIs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayRestAPIList, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayRestAPIs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeApiGatewayRestAPIs) Create(ctx context.Context, apiGatewayRestAPI *v1alpha1.ApiGatewayRestAPI, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayRestAPI, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayRestAPIs) Update(ctx context.Context, apiGatewayRestAPI *v1alpha1.ApiGatewayRestAPI, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayRestAPI, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayRestAPIs) UpdateStatus(ctx context.Context, apiGatewayRestAPI *v1alpha1.ApiGatewayRestAPI, opts v1.UpdateOptions) (*v1alpha1.ApiGatewayRestAPI, error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayRestAPIs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeApiGatewayRestAPIs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(apigatewayrestapisResource, c.ns, listOpts)
...
func (c *FakeApiGatewayRestAPIs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayRestAPI, err error) {
	obj, err := c.Fake.
