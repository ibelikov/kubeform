...
func (c *FakeVpcEndpointServiceAllowedPrincipals) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
	obj, err := c.Fake.
...
func (c *FakeVpcEndpointServiceAllowedPrincipals) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpcEndpointServiceAllowedPrincipalList, err error) {
	obj, err := c.Fake.
...
func (c *FakeVpcEndpointServiceAllowedPrincipals) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeVpcEndpointServiceAllowedPrincipals) Create(ctx context.Context, vpcEndpointServiceAllowedPrincipal *v1alpha1.VpcEndpointServiceAllowedPrincipal, opts v1.CreateOptions) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
	obj, err := c.Fake.
...
func (c *FakeVpcEndpointServiceAllowedPrincipals) Update(ctx context.Context, vpcEndpointServiceAllowedPrincipal *v1alpha1.VpcEndpointServiceAllowedPrincipal, opts v1.UpdateOptions) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
	obj, err := c.Fake.
...
func (c *FakeVpcEndpointServiceAllowedPrincipals) UpdateStatus(ctx context.Context, vpcEndpointServiceAllowedPrincipal *v1alpha1.VpcEndpointServiceAllowedPrincipal, opts v1.UpdateOptions) (*v1alpha1.VpcEndpointServiceAllowedPrincipal, error) {
	obj, err := c.Fake.
...
func (c *FakeVpcEndpointServiceAllowedPrincipals) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeVpcEndpointServiceAllowedPrincipals) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(vpcendpointserviceallowedprincipalsResource, c.ns, listOpts)
...
func (c *FakeVpcEndpointServiceAllowedPrincipals) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpcEndpointServiceAllowedPrincipal, err error) {
	obj, err := c.Fake.
