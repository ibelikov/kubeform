...
var opsworkspermissionsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "OpsworksPermission"}
...
func (c *FakeOpsworksPermissions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksPermission, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.OpsworksPermission), err
}

// List takes label and field selectors, and returns the list of OpsworksPermissions that match those selectors.
func (c *FakeOpsworksPermissions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksPermissionList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.OpsworksPermissionList{ListMeta: obj.(*v1alpha1.OpsworksPermissionList).ListMeta}
	for _, item := range obj.(*v1alpha1.OpsworksPermissionList).Items {
...
func (c *FakeOpsworksPermissions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeOpsworksPermissions) Create(ctx context.Context, opsworksPermission *v1alpha1.OpsworksPermission, opts v1.CreateOptions) (result *v1alpha1.OpsworksPermission, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksPermissions) Update(ctx context.Context, opsworksPermission *v1alpha1.OpsworksPermission, opts v1.UpdateOptions) (result *v1alpha1.OpsworksPermission, err error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksPermissions) UpdateStatus(ctx context.Context, opsworksPermission *v1alpha1.OpsworksPermission, opts v1.UpdateOptions) (*v1alpha1.OpsworksPermission, error) {
	obj, err := c.Fake.
...
func (c *FakeOpsworksPermissions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeOpsworksPermissions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(opsworkspermissionsResource, c.ns, listOpts)
...
func (c *FakeOpsworksPermissions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksPermission, err error) {
	obj, err := c.Fake.
