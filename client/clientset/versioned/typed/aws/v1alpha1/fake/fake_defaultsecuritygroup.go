...
func (c *FakeDefaultSecurityGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DefaultSecurityGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeDefaultSecurityGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DefaultSecurityGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDefaultSecurityGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeDefaultSecurityGroups) Create(ctx context.Context, defaultSecurityGroup *v1alpha1.DefaultSecurityGroup, opts v1.CreateOptions) (result *v1alpha1.DefaultSecurityGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeDefaultSecurityGroups) Update(ctx context.Context, defaultSecurityGroup *v1alpha1.DefaultSecurityGroup, opts v1.UpdateOptions) (result *v1alpha1.DefaultSecurityGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeDefaultSecurityGroups) UpdateStatus(ctx context.Context, defaultSecurityGroup *v1alpha1.DefaultSecurityGroup, opts v1.UpdateOptions) (*v1alpha1.DefaultSecurityGroup, error) {
	obj, err := c.Fake.
...
func (c *FakeDefaultSecurityGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeDefaultSecurityGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(defaultsecuritygroupsResource, c.ns, listOpts)
...
func (c *FakeDefaultSecurityGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DefaultSecurityGroup, err error) {
	obj, err := c.Fake.
