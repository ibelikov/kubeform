...
var appsyncdatasourcesKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AppsyncDatasource"}
...
func (c *FakeAppsyncDatasources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppsyncDatasource, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.AppsyncDatasource), err
}

// List takes label and field selectors, and returns the list of AppsyncDatasources that match those selectors.
func (c *FakeAppsyncDatasources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppsyncDatasourceList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.AppsyncDatasourceList{ListMeta: obj.(*v1alpha1.AppsyncDatasourceList).ListMeta}
	for _, item := range obj.(*v1alpha1.AppsyncDatasourceList).Items {
...
func (c *FakeAppsyncDatasources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAppsyncDatasources) Create(ctx context.Context, appsyncDatasource *v1alpha1.AppsyncDatasource, opts v1.CreateOptions) (result *v1alpha1.AppsyncDatasource, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppsyncDatasources) Update(ctx context.Context, appsyncDatasource *v1alpha1.AppsyncDatasource, opts v1.UpdateOptions) (result *v1alpha1.AppsyncDatasource, err error) {
	obj, err := c.Fake.
...
func (c *FakeAppsyncDatasources) UpdateStatus(ctx context.Context, appsyncDatasource *v1alpha1.AppsyncDatasource, opts v1.UpdateOptions) (*v1alpha1.AppsyncDatasource, error) {
	obj, err := c.Fake.
...
func (c *FakeAppsyncDatasources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAppsyncDatasources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(appsyncdatasourcesResource, c.ns, listOpts)
...
func (c *FakeAppsyncDatasources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppsyncDatasource, err error) {
	obj, err := c.Fake.
