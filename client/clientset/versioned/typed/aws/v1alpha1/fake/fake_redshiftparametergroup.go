...
func (c *FakeRedshiftParameterGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RedshiftParameterGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeRedshiftParameterGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RedshiftParameterGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRedshiftParameterGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeRedshiftParameterGroups) Create(ctx context.Context, redshiftParameterGroup *v1alpha1.RedshiftParameterGroup, opts v1.CreateOptions) (result *v1alpha1.RedshiftParameterGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeRedshiftParameterGroups) Update(ctx context.Context, redshiftParameterGroup *v1alpha1.RedshiftParameterGroup, opts v1.UpdateOptions) (result *v1alpha1.RedshiftParameterGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeRedshiftParameterGroups) UpdateStatus(ctx context.Context, redshiftParameterGroup *v1alpha1.RedshiftParameterGroup, opts v1.UpdateOptions) (*v1alpha1.RedshiftParameterGroup, error) {
	obj, err := c.Fake.
...
func (c *FakeRedshiftParameterGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeRedshiftParameterGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(redshiftparametergroupsResource, c.ns, listOpts)
...
func (c *FakeRedshiftParameterGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RedshiftParameterGroup, err error) {
	obj, err := c.Fake.
