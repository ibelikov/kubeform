...
// FakeConfigOrganizationCustomRules implements ConfigOrganizationCustomRuleInterface
type FakeConfigOrganizationCustomRules struct {
	Fake *FakeAwsV1alpha1
	ns   string
}

var configorganizationcustomrulesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "configorganizationcustomrules"}
...
func (c *FakeConfigOrganizationCustomRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ConfigOrganizationCustomRule, err error) {
	...
	return obj.(*v1alpha1.ConfigOrganizationCustomRule), err
}
...
func (c *FakeConfigOrganizationCustomRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConfigOrganizationCustomRuleList, err error) {
	...
	list := &v1alpha1.ConfigOrganizationCustomRuleList{ListMeta: obj.(*v1alpha1.ConfigOrganizationCustomRuleList).ListMeta}
	for _, item := range obj.(*v1alpha1.ConfigOrganizationCustomRuleList).Items {
