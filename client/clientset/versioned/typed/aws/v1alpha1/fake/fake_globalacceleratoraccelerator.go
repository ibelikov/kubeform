...
func (c *FakeGlobalacceleratorAccelerators) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlobalacceleratorAccelerator, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlobalacceleratorAccelerators) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlobalacceleratorAcceleratorList, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlobalacceleratorAccelerators) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeGlobalacceleratorAccelerators) Create(ctx context.Context, globalacceleratorAccelerator *v1alpha1.GlobalacceleratorAccelerator, opts v1.CreateOptions) (result *v1alpha1.GlobalacceleratorAccelerator, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlobalacceleratorAccelerators) Update(ctx context.Context, globalacceleratorAccelerator *v1alpha1.GlobalacceleratorAccelerator, opts v1.UpdateOptions) (result *v1alpha1.GlobalacceleratorAccelerator, err error) {
	obj, err := c.Fake.
...
func (c *FakeGlobalacceleratorAccelerators) UpdateStatus(ctx context.Context, globalacceleratorAccelerator *v1alpha1.GlobalacceleratorAccelerator, opts v1.UpdateOptions) (*v1alpha1.GlobalacceleratorAccelerator, error) {
	obj, err := c.Fake.
...
func (c *FakeGlobalacceleratorAccelerators) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeGlobalacceleratorAccelerators) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(globalacceleratoracceleratorsResource, c.ns, listOpts)
...
func (c *FakeGlobalacceleratorAccelerators) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlobalacceleratorAccelerator, err error) {
	obj, err := c.Fake.
