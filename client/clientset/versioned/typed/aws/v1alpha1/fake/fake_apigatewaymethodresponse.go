...
// FakeApiGatewayMethodResponses implements ApiGatewayMethodResponseInterface
type FakeApiGatewayMethodResponses struct {
	Fake *FakeAwsV1alpha1
	ns   string
}

var apigatewaymethodresponsesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "apigatewaymethodresponses"}
...
func (c *FakeApiGatewayMethodResponses) Get(name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayMethodResponse, err error) {
	...
	return obj.(*v1alpha1.ApiGatewayMethodResponse), err
}
...
func (c *FakeApiGatewayMethodResponses) List(opts v1.ListOptions) (result *v1alpha1.ApiGatewayMethodResponseList, err error) {
	...
	list := &v1alpha1.ApiGatewayMethodResponseList{ListMeta: obj.(*v1alpha1.ApiGatewayMethodResponseList).ListMeta}
	for _, item := range obj.(*v1alpha1.ApiGatewayMethodResponseList).Items {
