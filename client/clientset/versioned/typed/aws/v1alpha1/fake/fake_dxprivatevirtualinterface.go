...
func (c *FakeDxPrivateVirtualInterfaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DxPrivateVirtualInterface, err error) {
	obj, err := c.Fake.
...
func (c *FakeDxPrivateVirtualInterfaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DxPrivateVirtualInterfaceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDxPrivateVirtualInterfaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeDxPrivateVirtualInterfaces) Create(ctx context.Context, dxPrivateVirtualInterface *v1alpha1.DxPrivateVirtualInterface, opts v1.CreateOptions) (result *v1alpha1.DxPrivateVirtualInterface, err error) {
	obj, err := c.Fake.
...
func (c *FakeDxPrivateVirtualInterfaces) Update(ctx context.Context, dxPrivateVirtualInterface *v1alpha1.DxPrivateVirtualInterface, opts v1.UpdateOptions) (result *v1alpha1.DxPrivateVirtualInterface, err error) {
	obj, err := c.Fake.
...
func (c *FakeDxPrivateVirtualInterfaces) UpdateStatus(ctx context.Context, dxPrivateVirtualInterface *v1alpha1.DxPrivateVirtualInterface, opts v1.UpdateOptions) (*v1alpha1.DxPrivateVirtualInterface, error) {
	obj, err := c.Fake.
...
func (c *FakeDxPrivateVirtualInterfaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeDxPrivateVirtualInterfaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(dxprivatevirtualinterfacesResource, c.ns, listOpts)
...
func (c *FakeDxPrivateVirtualInterfaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DxPrivateVirtualInterface, err error) {
	obj, err := c.Fake.
