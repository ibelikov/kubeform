...
func (c *FakeRoute53DelegationSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Route53DelegationSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoute53DelegationSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.Route53DelegationSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoute53DelegationSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeRoute53DelegationSets) Create(ctx context.Context, route53DelegationSet *v1alpha1.Route53DelegationSet, opts v1.CreateOptions) (result *v1alpha1.Route53DelegationSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoute53DelegationSets) Update(ctx context.Context, route53DelegationSet *v1alpha1.Route53DelegationSet, opts v1.UpdateOptions) (result *v1alpha1.Route53DelegationSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeRoute53DelegationSets) UpdateStatus(ctx context.Context, route53DelegationSet *v1alpha1.Route53DelegationSet, opts v1.UpdateOptions) (*v1alpha1.Route53DelegationSet, error) {
	obj, err := c.Fake.
...
func (c *FakeRoute53DelegationSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeRoute53DelegationSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(route53delegationsetsResource, c.ns, listOpts)
...
func (c *FakeRoute53DelegationSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Route53DelegationSet, err error) {
	obj, err := c.Fake.
