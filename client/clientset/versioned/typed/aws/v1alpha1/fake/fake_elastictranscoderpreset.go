...
func (c *FakeElastictranscoderPresets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ElastictranscoderPreset, err error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPresets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElastictranscoderPresetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPresets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeElastictranscoderPresets) Create(ctx context.Context, elastictranscoderPreset *v1alpha1.ElastictranscoderPreset, opts v1.CreateOptions) (result *v1alpha1.ElastictranscoderPreset, err error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPresets) Update(ctx context.Context, elastictranscoderPreset *v1alpha1.ElastictranscoderPreset, opts v1.UpdateOptions) (result *v1alpha1.ElastictranscoderPreset, err error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPresets) UpdateStatus(ctx context.Context, elastictranscoderPreset *v1alpha1.ElastictranscoderPreset, opts v1.UpdateOptions) (*v1alpha1.ElastictranscoderPreset, error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPresets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeElastictranscoderPresets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(elastictranscoderpresetsResource, c.ns, listOpts)
...
func (c *FakeElastictranscoderPresets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ElastictranscoderPreset, err error) {
	obj, err := c.Fake.
