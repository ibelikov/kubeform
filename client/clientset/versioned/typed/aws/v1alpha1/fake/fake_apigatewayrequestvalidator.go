...
var apigatewayrequestvalidatorsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "ApiGatewayRequestValidator"}
...
func (c *FakeApiGatewayRequestValidators) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayRequestValidator, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.ApiGatewayRequestValidator), err
}

// List takes label and field selectors, and returns the list of ApiGatewayRequestValidators that match those selectors.
func (c *FakeApiGatewayRequestValidators) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayRequestValidatorList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.ApiGatewayRequestValidatorList{ListMeta: obj.(*v1alpha1.ApiGatewayRequestValidatorList).ListMeta}
	for _, item := range obj.(*v1alpha1.ApiGatewayRequestValidatorList).Items {
...
func (c *FakeApiGatewayRequestValidators) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeApiGatewayRequestValidators) Create(ctx context.Context, apiGatewayRequestValidator *v1alpha1.ApiGatewayRequestValidator, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayRequestValidator, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayRequestValidators) Update(ctx context.Context, apiGatewayRequestValidator *v1alpha1.ApiGatewayRequestValidator, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayRequestValidator, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayRequestValidators) UpdateStatus(ctx context.Context, apiGatewayRequestValidator *v1alpha1.ApiGatewayRequestValidator, opts v1.UpdateOptions) (*v1alpha1.ApiGatewayRequestValidator, error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayRequestValidators) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeApiGatewayRequestValidators) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(apigatewayrequestvalidatorsResource, c.ns, listOpts)
...
func (c *FakeApiGatewayRequestValidators) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayRequestValidator, err error) {
	obj, err := c.Fake.
