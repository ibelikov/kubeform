...
// FakeMediaPackageChannels implements MediaPackageChannelInterface
type FakeMediaPackageChannels struct {
	Fake *FakeAwsV1alpha1
	ns   string
}

var mediapackagechannelsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "mediapackagechannels"}
...
func (c *FakeMediaPackageChannels) Get(name string, options v1.GetOptions) (result *v1alpha1.MediaPackageChannel, err error) {
	...
	return obj.(*v1alpha1.MediaPackageChannel), err
}
...
func (c *FakeMediaPackageChannels) List(opts v1.ListOptions) (result *v1alpha1.MediaPackageChannelList, err error) {
	...
	list := &v1alpha1.MediaPackageChannelList{ListMeta: obj.(*v1alpha1.MediaPackageChannelList).ListMeta}
	for _, item := range obj.(*v1alpha1.MediaPackageChannelList).Items {
