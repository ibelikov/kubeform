...
func (c *FakeEcsTaskDefinitions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EcsTaskDefinition, err error) {
	obj, err := c.Fake.
...
func (c *FakeEcsTaskDefinitions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EcsTaskDefinitionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeEcsTaskDefinitions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeEcsTaskDefinitions) Create(ctx context.Context, ecsTaskDefinition *v1alpha1.EcsTaskDefinition, opts v1.CreateOptions) (result *v1alpha1.EcsTaskDefinition, err error) {
	obj, err := c.Fake.
...
func (c *FakeEcsTaskDefinitions) Update(ctx context.Context, ecsTaskDefinition *v1alpha1.EcsTaskDefinition, opts v1.UpdateOptions) (result *v1alpha1.EcsTaskDefinition, err error) {
	obj, err := c.Fake.
...
func (c *FakeEcsTaskDefinitions) UpdateStatus(ctx context.Context, ecsTaskDefinition *v1alpha1.EcsTaskDefinition, opts v1.UpdateOptions) (*v1alpha1.EcsTaskDefinition, error) {
	obj, err := c.Fake.
...
func (c *FakeEcsTaskDefinitions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeEcsTaskDefinitions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(ecstaskdefinitionsResource, c.ns, listOpts)
...
func (c *FakeEcsTaskDefinitions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EcsTaskDefinition, err error) {
	obj, err := c.Fake.
