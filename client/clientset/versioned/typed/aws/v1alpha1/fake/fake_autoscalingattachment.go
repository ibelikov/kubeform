...
func (c *FakeAutoscalingAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoscalingAttachment, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoscalingAttachmentList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAutoscalingAttachments) Create(ctx context.Context, autoscalingAttachment *v1alpha1.AutoscalingAttachment, opts v1.CreateOptions) (result *v1alpha1.AutoscalingAttachment, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingAttachments) Update(ctx context.Context, autoscalingAttachment *v1alpha1.AutoscalingAttachment, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingAttachment, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingAttachments) UpdateStatus(ctx context.Context, autoscalingAttachment *v1alpha1.AutoscalingAttachment, opts v1.UpdateOptions) (*v1alpha1.AutoscalingAttachment, error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAutoscalingAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(autoscalingattachmentsResource, c.ns, listOpts)
...
func (c *FakeAutoscalingAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoscalingAttachment, err error) {
	obj, err := c.Fake.
