...
func (c *FakeIamRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamRoleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamRoles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeIamRoles) Create(ctx context.Context, iamRole *v1alpha1.IamRole, opts v1.CreateOptions) (result *v1alpha1.IamRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamRoles) Update(ctx context.Context, iamRole *v1alpha1.IamRole, opts v1.UpdateOptions) (result *v1alpha1.IamRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeIamRoles) UpdateStatus(ctx context.Context, iamRole *v1alpha1.IamRole, opts v1.UpdateOptions) (*v1alpha1.IamRole, error) {
	obj, err := c.Fake.
...
func (c *FakeIamRoles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeIamRoles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(iamrolesResource, c.ns, listOpts)
...
func (c *FakeIamRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamRole, err error) {
	obj, err := c.Fake.
