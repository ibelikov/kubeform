...
func (c *FakeApiGatewayUsagePlanKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayUsagePlanKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayUsagePlanKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayUsagePlanKeyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayUsagePlanKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeApiGatewayUsagePlanKeys) Create(ctx context.Context, apiGatewayUsagePlanKey *v1alpha1.ApiGatewayUsagePlanKey, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayUsagePlanKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayUsagePlanKeys) Update(ctx context.Context, apiGatewayUsagePlanKey *v1alpha1.ApiGatewayUsagePlanKey, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayUsagePlanKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayUsagePlanKeys) UpdateStatus(ctx context.Context, apiGatewayUsagePlanKey *v1alpha1.ApiGatewayUsagePlanKey, opts v1.UpdateOptions) (*v1alpha1.ApiGatewayUsagePlanKey, error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayUsagePlanKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeApiGatewayUsagePlanKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(apigatewayusageplankeysResource, c.ns, listOpts)
...
func (c *FakeApiGatewayUsagePlanKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayUsagePlanKey, err error) {
	obj, err := c.Fake.
