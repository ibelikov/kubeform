...
func (c *FakeAutoscalingSchedules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoscalingSchedule, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingSchedules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoscalingScheduleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingSchedules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAutoscalingSchedules) Create(ctx context.Context, autoscalingSchedule *v1alpha1.AutoscalingSchedule, opts v1.CreateOptions) (result *v1alpha1.AutoscalingSchedule, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingSchedules) Update(ctx context.Context, autoscalingSchedule *v1alpha1.AutoscalingSchedule, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingSchedule, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingSchedules) UpdateStatus(ctx context.Context, autoscalingSchedule *v1alpha1.AutoscalingSchedule, opts v1.UpdateOptions) (*v1alpha1.AutoscalingSchedule, error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalingSchedules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAutoscalingSchedules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(autoscalingschedulesResource, c.ns, listOpts)
...
func (c *FakeAutoscalingSchedules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoscalingSchedule, err error) {
	obj, err := c.Fake.
