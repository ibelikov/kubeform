...
// FakeCloudwatchEventRules implements CloudwatchEventRuleInterface
type FakeCloudwatchEventRules struct {
	Fake *FakeAwsV1alpha1
	ns   string
}

var cloudwatcheventrulesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "cloudwatcheventrules"}
...
func (c *FakeCloudwatchEventRules) Get(name string, options v1.GetOptions) (result *v1alpha1.CloudwatchEventRule, err error) {
	...
	return obj.(*v1alpha1.CloudwatchEventRule), err
}
...
func (c *FakeCloudwatchEventRules) List(opts v1.ListOptions) (result *v1alpha1.CloudwatchEventRuleList, err error) {
	...
	list := &v1alpha1.CloudwatchEventRuleList{ListMeta: obj.(*v1alpha1.CloudwatchEventRuleList).ListMeta}
	for _, item := range obj.(*v1alpha1.CloudwatchEventRuleList).Items {
