...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceDiscoveryPrivateDNSNamespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceDiscoveryPrivateDNSNamespaceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) Create(ctx context.Context, serviceDiscoveryPrivateDNSNamespace *v1alpha1.ServiceDiscoveryPrivateDNSNamespace, opts v1.CreateOptions) (result *v1alpha1.ServiceDiscoveryPrivateDNSNamespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) Update(ctx context.Context, serviceDiscoveryPrivateDNSNamespace *v1alpha1.ServiceDiscoveryPrivateDNSNamespace, opts v1.UpdateOptions) (result *v1alpha1.ServiceDiscoveryPrivateDNSNamespace, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) UpdateStatus(ctx context.Context, serviceDiscoveryPrivateDNSNamespace *v1alpha1.ServiceDiscoveryPrivateDNSNamespace, opts v1.UpdateOptions) (*v1alpha1.ServiceDiscoveryPrivateDNSNamespace, error) {
	obj, err := c.Fake.
...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(servicediscoveryprivatednsnamespacesResource, c.ns, listOpts)
...
func (c *FakeServiceDiscoveryPrivateDNSNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceDiscoveryPrivateDNSNamespace, err error) {
	obj, err := c.Fake.
