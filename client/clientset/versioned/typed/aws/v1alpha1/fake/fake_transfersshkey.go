...
func (c *FakeTransferSSHKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TransferSSHKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransferSSHKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TransferSSHKeyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransferSSHKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeTransferSSHKeys) Create(ctx context.Context, transferSSHKey *v1alpha1.TransferSSHKey, opts v1.CreateOptions) (result *v1alpha1.TransferSSHKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransferSSHKeys) Update(ctx context.Context, transferSSHKey *v1alpha1.TransferSSHKey, opts v1.UpdateOptions) (result *v1alpha1.TransferSSHKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeTransferSSHKeys) UpdateStatus(ctx context.Context, transferSSHKey *v1alpha1.TransferSSHKey, opts v1.UpdateOptions) (*v1alpha1.TransferSSHKey, error) {
	obj, err := c.Fake.
...
func (c *FakeTransferSSHKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeTransferSSHKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(transfersshkeysResource, c.ns, listOpts)
...
func (c *FakeTransferSSHKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TransferSSHKey, err error) {
	obj, err := c.Fake.
