...
var codecommitrepositoriesKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "CodecommitRepository"}
...
func (c *FakeCodecommitRepositories) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CodecommitRepository, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.CodecommitRepository), err
}

// List takes label and field selectors, and returns the list of CodecommitRepositories that match those selectors.
func (c *FakeCodecommitRepositories) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CodecommitRepositoryList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.CodecommitRepositoryList{ListMeta: obj.(*v1alpha1.CodecommitRepositoryList).ListMeta}
	for _, item := range obj.(*v1alpha1.CodecommitRepositoryList).Items {
...
func (c *FakeCodecommitRepositories) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCodecommitRepositories) Create(ctx context.Context, codecommitRepository *v1alpha1.CodecommitRepository, opts v1.CreateOptions) (result *v1alpha1.CodecommitRepository, err error) {
	obj, err := c.Fake.
...
func (c *FakeCodecommitRepositories) Update(ctx context.Context, codecommitRepository *v1alpha1.CodecommitRepository, opts v1.UpdateOptions) (result *v1alpha1.CodecommitRepository, err error) {
	obj, err := c.Fake.
...
func (c *FakeCodecommitRepositories) UpdateStatus(ctx context.Context, codecommitRepository *v1alpha1.CodecommitRepository, opts v1.UpdateOptions) (*v1alpha1.CodecommitRepository, error) {
	obj, err := c.Fake.
...
func (c *FakeCodecommitRepositories) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeCodecommitRepositories) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(codecommitrepositoriesResource, c.ns, listOpts)
...
func (c *FakeCodecommitRepositories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CodecommitRepository, err error) {
	obj, err := c.Fake.
