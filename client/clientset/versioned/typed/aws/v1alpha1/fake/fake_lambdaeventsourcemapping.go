...
var lambdaeventsourcemappingsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "LambdaEventSourceMapping"}
...
func (c *FakeLambdaEventSourceMappings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LambdaEventSourceMapping, err error) {
	obj, err := c.Fake.
	...
	return obj.(*v1alpha1.LambdaEventSourceMapping), err
}

// List takes label and field selectors, and returns the list of LambdaEventSourceMappings that match those selectors.
func (c *FakeLambdaEventSourceMappings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LambdaEventSourceMappingList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.LambdaEventSourceMappingList{ListMeta: obj.(*v1alpha1.LambdaEventSourceMappingList).ListMeta}
	for _, item := range obj.(*v1alpha1.LambdaEventSourceMappingList).Items {
...
func (c *FakeLambdaEventSourceMappings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeLambdaEventSourceMappings) Create(ctx context.Context, lambdaEventSourceMapping *v1alpha1.LambdaEventSourceMapping, opts v1.CreateOptions) (result *v1alpha1.LambdaEventSourceMapping, err error) {
	obj, err := c.Fake.
...
func (c *FakeLambdaEventSourceMappings) Update(ctx context.Context, lambdaEventSourceMapping *v1alpha1.LambdaEventSourceMapping, opts v1.UpdateOptions) (result *v1alpha1.LambdaEventSourceMapping, err error) {
	obj, err := c.Fake.
...
func (c *FakeLambdaEventSourceMappings) UpdateStatus(ctx context.Context, lambdaEventSourceMapping *v1alpha1.LambdaEventSourceMapping, opts v1.UpdateOptions) (*v1alpha1.LambdaEventSourceMapping, error) {
	obj, err := c.Fake.
...
func (c *FakeLambdaEventSourceMappings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeLambdaEventSourceMappings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(lambdaeventsourcemappingsResource, c.ns, listOpts)
...
func (c *FakeLambdaEventSourceMappings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LambdaEventSourceMapping, err error) {
	obj, err := c.Fake.
