...
func (c *FakeApiGatewayAPIKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayAPIKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayAPIKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayAPIKeyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayAPIKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeApiGatewayAPIKeys) Create(ctx context.Context, apiGatewayAPIKey *v1alpha1.ApiGatewayAPIKey, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayAPIKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayAPIKeys) Update(ctx context.Context, apiGatewayAPIKey *v1alpha1.ApiGatewayAPIKey, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayAPIKey, err error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayAPIKeys) UpdateStatus(ctx context.Context, apiGatewayAPIKey *v1alpha1.ApiGatewayAPIKey, opts v1.UpdateOptions) (*v1alpha1.ApiGatewayAPIKey, error) {
	obj, err := c.Fake.
...
func (c *FakeApiGatewayAPIKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeApiGatewayAPIKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(apigatewayapikeysResource, c.ns, listOpts)
...
func (c *FakeApiGatewayAPIKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayAPIKey, err error) {
	obj, err := c.Fake.
