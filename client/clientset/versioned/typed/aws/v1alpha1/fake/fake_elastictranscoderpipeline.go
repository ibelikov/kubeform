...
func (c *FakeElastictranscoderPipelines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ElastictranscoderPipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPipelines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElastictranscoderPipelineList, err error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPipelines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeElastictranscoderPipelines) Create(ctx context.Context, elastictranscoderPipeline *v1alpha1.ElastictranscoderPipeline, opts v1.CreateOptions) (result *v1alpha1.ElastictranscoderPipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPipelines) Update(ctx context.Context, elastictranscoderPipeline *v1alpha1.ElastictranscoderPipeline, opts v1.UpdateOptions) (result *v1alpha1.ElastictranscoderPipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPipelines) UpdateStatus(ctx context.Context, elastictranscoderPipeline *v1alpha1.ElastictranscoderPipeline, opts v1.UpdateOptions) (*v1alpha1.ElastictranscoderPipeline, error) {
	obj, err := c.Fake.
...
func (c *FakeElastictranscoderPipelines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeElastictranscoderPipelines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(elastictranscoderpipelinesResource, c.ns, listOpts)
...
func (c *FakeElastictranscoderPipelines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ElastictranscoderPipeline, err error) {
	obj, err := c.Fake.
