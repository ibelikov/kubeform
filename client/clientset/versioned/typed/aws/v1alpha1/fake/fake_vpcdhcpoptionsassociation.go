...
func (c *FakeVpcDHCPOptionsAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
	obj, err := c.Fake.
...
func (c *FakeVpcDHCPOptionsAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpcDHCPOptionsAssociationList, err error) {
	obj, err := c.Fake.
...
func (c *FakeVpcDHCPOptionsAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeVpcDHCPOptionsAssociations) Create(ctx context.Context, vpcDHCPOptionsAssociation *v1alpha1.VpcDHCPOptionsAssociation, opts v1.CreateOptions) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
	obj, err := c.Fake.
...
func (c *FakeVpcDHCPOptionsAssociations) Update(ctx context.Context, vpcDHCPOptionsAssociation *v1alpha1.VpcDHCPOptionsAssociation, opts v1.UpdateOptions) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
	obj, err := c.Fake.
...
func (c *FakeVpcDHCPOptionsAssociations) UpdateStatus(ctx context.Context, vpcDHCPOptionsAssociation *v1alpha1.VpcDHCPOptionsAssociation, opts v1.UpdateOptions) (*v1alpha1.VpcDHCPOptionsAssociation, error) {
	obj, err := c.Fake.
...
func (c *FakeVpcDHCPOptionsAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeVpcDHCPOptionsAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(vpcdhcpoptionsassociationsResource, c.ns, listOpts)
...
func (c *FakeVpcDHCPOptionsAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpcDHCPOptionsAssociation, err error) {
	obj, err := c.Fake.
