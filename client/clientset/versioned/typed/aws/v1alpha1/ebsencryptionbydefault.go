...
func (c *ebsEncryptionByDefaults) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EbsEncryptionByDefault, err error) {
...
func (c *ebsEncryptionByDefaults) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EbsEncryptionByDefaultList, err error) {
...
func (c *ebsEncryptionByDefaults) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ebsEncryptionByDefaults) Create(ctx context.Context, ebsEncryptionByDefault *v1alpha1.EbsEncryptionByDefault, opts v1.CreateOptions) (result *v1alpha1.EbsEncryptionByDefault, err error) {
	result = &v1alpha1.EbsEncryptionByDefault{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ebsencryptionbydefaults").
...
func (c *ebsEncryptionByDefaults) Update(ctx context.Context, ebsEncryptionByDefault *v1alpha1.EbsEncryptionByDefault, opts v1.UpdateOptions) (result *v1alpha1.EbsEncryptionByDefault, err error) {
	result = &v1alpha1.EbsEncryptionByDefault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ebsencryptionbydefaults").
...
func (c *ebsEncryptionByDefaults) UpdateStatus(ctx context.Context, ebsEncryptionByDefault *v1alpha1.EbsEncryptionByDefault, opts v1.UpdateOptions) (result *v1alpha1.EbsEncryptionByDefault, err error) {
	result = &v1alpha1.EbsEncryptionByDefault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ebsencryptionbydefaults").
...
func (c *ebsEncryptionByDefaults) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ebsEncryptionByDefaults) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ebsEncryptionByDefaults) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EbsEncryptionByDefault, err error) {
	result = &v1alpha1.EbsEncryptionByDefault{}
