...
func (c *ec2TransitGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ec2TransitGateway, err error) {
...
func (c *ec2TransitGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.Ec2TransitGatewayList, err error) {
...
func (c *ec2TransitGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ec2TransitGateways) Create(ctx context.Context, ec2TransitGateway *v1alpha1.Ec2TransitGateway, opts v1.CreateOptions) (result *v1alpha1.Ec2TransitGateway, err error) {
	result = &v1alpha1.Ec2TransitGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ec2transitgateways").
...
func (c *ec2TransitGateways) Update(ctx context.Context, ec2TransitGateway *v1alpha1.Ec2TransitGateway, opts v1.UpdateOptions) (result *v1alpha1.Ec2TransitGateway, err error) {
	result = &v1alpha1.Ec2TransitGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ec2transitgateways").
...
func (c *ec2TransitGateways) UpdateStatus(ctx context.Context, ec2TransitGateway *v1alpha1.Ec2TransitGateway, opts v1.UpdateOptions) (result *v1alpha1.Ec2TransitGateway, err error) {
	result = &v1alpha1.Ec2TransitGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ec2transitgateways").
...
func (c *ec2TransitGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ec2TransitGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ec2TransitGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ec2TransitGateway, err error) {
	result = &v1alpha1.Ec2TransitGateway{}
