...
func (c *wafregionalGeoMatchSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafregionalGeoMatchSet, err error) {
...
func (c *wafregionalGeoMatchSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafregionalGeoMatchSetList, err error) {
...
func (c *wafregionalGeoMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafregionalGeoMatchSets) Create(ctx context.Context, wafregionalGeoMatchSet *v1alpha1.WafregionalGeoMatchSet, opts v1.CreateOptions) (result *v1alpha1.WafregionalGeoMatchSet, err error) {
	result = &v1alpha1.WafregionalGeoMatchSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafregionalgeomatchsets").
...
func (c *wafregionalGeoMatchSets) Update(ctx context.Context, wafregionalGeoMatchSet *v1alpha1.WafregionalGeoMatchSet, opts v1.UpdateOptions) (result *v1alpha1.WafregionalGeoMatchSet, err error) {
	result = &v1alpha1.WafregionalGeoMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalgeomatchsets").
...
func (c *wafregionalGeoMatchSets) UpdateStatus(ctx context.Context, wafregionalGeoMatchSet *v1alpha1.WafregionalGeoMatchSet, opts v1.UpdateOptions) (result *v1alpha1.WafregionalGeoMatchSet, err error) {
	result = &v1alpha1.WafregionalGeoMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalgeomatchsets").
...
func (c *wafregionalGeoMatchSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafregionalGeoMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafregionalGeoMatchSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafregionalGeoMatchSet, err error) {
	result = &v1alpha1.WafregionalGeoMatchSet{}
