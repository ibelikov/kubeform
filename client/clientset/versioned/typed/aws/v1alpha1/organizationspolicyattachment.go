...
type OrganizationsPolicyAttachmentInterface interface {
	Create(*v1alpha1.OrganizationsPolicyAttachment) (*v1alpha1.OrganizationsPolicyAttachment, error)
	Update(*v1alpha1.OrganizationsPolicyAttachment) (*v1alpha1.OrganizationsPolicyAttachment, error)
	UpdateStatus(*v1alpha1.OrganizationsPolicyAttachment) (*v1alpha1.OrganizationsPolicyAttachment, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.OrganizationsPolicyAttachment, error)
	List(opts v1.ListOptions) (*v1alpha1.OrganizationsPolicyAttachmentList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OrganizationsPolicyAttachment, err error)
...
func (c *organizationsPolicyAttachments) List(opts v1.ListOptions) (result *v1alpha1.OrganizationsPolicyAttachmentList, err error) {
...
func (c *organizationsPolicyAttachments) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *organizationsPolicyAttachments) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
