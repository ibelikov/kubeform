...
func (c *iamGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamGroup, err error) {
...
func (c *iamGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamGroupList, err error) {
...
func (c *iamGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamGroups) Create(ctx context.Context, iamGroup *v1alpha1.IamGroup, opts v1.CreateOptions) (result *v1alpha1.IamGroup, err error) {
	result = &v1alpha1.IamGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamgroups").
...
func (c *iamGroups) Update(ctx context.Context, iamGroup *v1alpha1.IamGroup, opts v1.UpdateOptions) (result *v1alpha1.IamGroup, err error) {
	result = &v1alpha1.IamGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamgroups").
...
func (c *iamGroups) UpdateStatus(ctx context.Context, iamGroup *v1alpha1.IamGroup, opts v1.UpdateOptions) (result *v1alpha1.IamGroup, err error) {
	result = &v1alpha1.IamGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamgroups").
...
func (c *iamGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamGroup, err error) {
	result = &v1alpha1.IamGroup{}
