...
func (c *albListenerCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AlbListenerCertificate, err error) {
...
func (c *albListenerCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AlbListenerCertificateList, err error) {
...
func (c *albListenerCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *albListenerCertificates) Create(ctx context.Context, albListenerCertificate *v1alpha1.AlbListenerCertificate, opts v1.CreateOptions) (result *v1alpha1.AlbListenerCertificate, err error) {
	result = &v1alpha1.AlbListenerCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alblistenercertificates").
...
func (c *albListenerCertificates) Update(ctx context.Context, albListenerCertificate *v1alpha1.AlbListenerCertificate, opts v1.UpdateOptions) (result *v1alpha1.AlbListenerCertificate, err error) {
	result = &v1alpha1.AlbListenerCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alblistenercertificates").
...
func (c *albListenerCertificates) UpdateStatus(ctx context.Context, albListenerCertificate *v1alpha1.AlbListenerCertificate, opts v1.UpdateOptions) (result *v1alpha1.AlbListenerCertificate, err error) {
	result = &v1alpha1.AlbListenerCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alblistenercertificates").
...
func (c *albListenerCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *albListenerCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *albListenerCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AlbListenerCertificate, err error) {
	result = &v1alpha1.AlbListenerCertificate{}
