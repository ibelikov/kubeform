...
func (c *ssmPatchBaselines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SsmPatchBaseline, err error) {
...
func (c *ssmPatchBaselines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SsmPatchBaselineList, err error) {
...
func (c *ssmPatchBaselines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssmPatchBaselines) Create(ctx context.Context, ssmPatchBaseline *v1alpha1.SsmPatchBaseline, opts v1.CreateOptions) (result *v1alpha1.SsmPatchBaseline, err error) {
	result = &v1alpha1.SsmPatchBaseline{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ssmpatchbaselines").
...
func (c *ssmPatchBaselines) Update(ctx context.Context, ssmPatchBaseline *v1alpha1.SsmPatchBaseline, opts v1.UpdateOptions) (result *v1alpha1.SsmPatchBaseline, err error) {
	result = &v1alpha1.SsmPatchBaseline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmpatchbaselines").
...
func (c *ssmPatchBaselines) UpdateStatus(ctx context.Context, ssmPatchBaseline *v1alpha1.SsmPatchBaseline, opts v1.UpdateOptions) (result *v1alpha1.SsmPatchBaseline, err error) {
	result = &v1alpha1.SsmPatchBaseline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmpatchbaselines").
...
func (c *ssmPatchBaselines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ssmPatchBaselines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ssmPatchBaselines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SsmPatchBaseline, err error) {
	result = &v1alpha1.SsmPatchBaseline{}
