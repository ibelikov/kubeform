...
func (c *ssmMaintenanceWindows) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SsmMaintenanceWindow, err error) {
...
func (c *ssmMaintenanceWindows) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SsmMaintenanceWindowList, err error) {
...
func (c *ssmMaintenanceWindows) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssmMaintenanceWindows) Create(ctx context.Context, ssmMaintenanceWindow *v1alpha1.SsmMaintenanceWindow, opts v1.CreateOptions) (result *v1alpha1.SsmMaintenanceWindow, err error) {
	result = &v1alpha1.SsmMaintenanceWindow{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ssmmaintenancewindows").
...
func (c *ssmMaintenanceWindows) Update(ctx context.Context, ssmMaintenanceWindow *v1alpha1.SsmMaintenanceWindow, opts v1.UpdateOptions) (result *v1alpha1.SsmMaintenanceWindow, err error) {
	result = &v1alpha1.SsmMaintenanceWindow{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmmaintenancewindows").
...
func (c *ssmMaintenanceWindows) UpdateStatus(ctx context.Context, ssmMaintenanceWindow *v1alpha1.SsmMaintenanceWindow, opts v1.UpdateOptions) (result *v1alpha1.SsmMaintenanceWindow, err error) {
	result = &v1alpha1.SsmMaintenanceWindow{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmmaintenancewindows").
...
func (c *ssmMaintenanceWindows) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ssmMaintenanceWindows) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ssmMaintenanceWindows) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SsmMaintenanceWindow, err error) {
	result = &v1alpha1.SsmMaintenanceWindow{}
