...
type SsmMaintenanceWindowInterface interface {
	Create(*v1alpha1.SsmMaintenanceWindow) (*v1alpha1.SsmMaintenanceWindow, error)
	Update(*v1alpha1.SsmMaintenanceWindow) (*v1alpha1.SsmMaintenanceWindow, error)
	UpdateStatus(*v1alpha1.SsmMaintenanceWindow) (*v1alpha1.SsmMaintenanceWindow, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SsmMaintenanceWindow, error)
	List(opts v1.ListOptions) (*v1alpha1.SsmMaintenanceWindowList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SsmMaintenanceWindow, err error)
...
func (c *ssmMaintenanceWindows) List(opts v1.ListOptions) (result *v1alpha1.SsmMaintenanceWindowList, err error) {
...
func (c *ssmMaintenanceWindows) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssmMaintenanceWindows) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
