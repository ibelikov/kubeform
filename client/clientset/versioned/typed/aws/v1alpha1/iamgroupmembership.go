...
func (c *iamGroupMemberships) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamGroupMembership, err error) {
...
func (c *iamGroupMemberships) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamGroupMembershipList, err error) {
...
func (c *iamGroupMemberships) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamGroupMemberships) Create(ctx context.Context, iamGroupMembership *v1alpha1.IamGroupMembership, opts v1.CreateOptions) (result *v1alpha1.IamGroupMembership, err error) {
	result = &v1alpha1.IamGroupMembership{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamgroupmemberships").
...
func (c *iamGroupMemberships) Update(ctx context.Context, iamGroupMembership *v1alpha1.IamGroupMembership, opts v1.UpdateOptions) (result *v1alpha1.IamGroupMembership, err error) {
	result = &v1alpha1.IamGroupMembership{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamgroupmemberships").
...
func (c *iamGroupMemberships) UpdateStatus(ctx context.Context, iamGroupMembership *v1alpha1.IamGroupMembership, opts v1.UpdateOptions) (result *v1alpha1.IamGroupMembership, err error) {
	result = &v1alpha1.IamGroupMembership{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamgroupmemberships").
...
func (c *iamGroupMemberships) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamGroupMemberships) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamGroupMemberships) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamGroupMembership, err error) {
	result = &v1alpha1.IamGroupMembership{}
