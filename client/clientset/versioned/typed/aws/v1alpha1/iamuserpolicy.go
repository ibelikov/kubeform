...
func (c *iamUserPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamUserPolicy, err error) {
...
func (c *iamUserPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamUserPolicyList, err error) {
...
func (c *iamUserPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamUserPolicies) Create(ctx context.Context, iamUserPolicy *v1alpha1.IamUserPolicy, opts v1.CreateOptions) (result *v1alpha1.IamUserPolicy, err error) {
	result = &v1alpha1.IamUserPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamuserpolicies").
...
func (c *iamUserPolicies) Update(ctx context.Context, iamUserPolicy *v1alpha1.IamUserPolicy, opts v1.UpdateOptions) (result *v1alpha1.IamUserPolicy, err error) {
	result = &v1alpha1.IamUserPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamuserpolicies").
...
func (c *iamUserPolicies) UpdateStatus(ctx context.Context, iamUserPolicy *v1alpha1.IamUserPolicy, opts v1.UpdateOptions) (result *v1alpha1.IamUserPolicy, err error) {
	result = &v1alpha1.IamUserPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamuserpolicies").
...
func (c *iamUserPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamUserPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamUserPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamUserPolicy, err error) {
	result = &v1alpha1.IamUserPolicy{}
