...
func (c *inspectorResourceGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InspectorResourceGroup, err error) {
...
func (c *inspectorResourceGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InspectorResourceGroupList, err error) {
...
func (c *inspectorResourceGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *inspectorResourceGroups) Create(ctx context.Context, inspectorResourceGroup *v1alpha1.InspectorResourceGroup, opts v1.CreateOptions) (result *v1alpha1.InspectorResourceGroup, err error) {
	result = &v1alpha1.InspectorResourceGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("inspectorresourcegroups").
...
func (c *inspectorResourceGroups) Update(ctx context.Context, inspectorResourceGroup *v1alpha1.InspectorResourceGroup, opts v1.UpdateOptions) (result *v1alpha1.InspectorResourceGroup, err error) {
	result = &v1alpha1.InspectorResourceGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("inspectorresourcegroups").
...
func (c *inspectorResourceGroups) UpdateStatus(ctx context.Context, inspectorResourceGroup *v1alpha1.InspectorResourceGroup, opts v1.UpdateOptions) (result *v1alpha1.InspectorResourceGroup, err error) {
	result = &v1alpha1.InspectorResourceGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("inspectorresourcegroups").
...
func (c *inspectorResourceGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *inspectorResourceGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *inspectorResourceGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InspectorResourceGroup, err error) {
	result = &v1alpha1.InspectorResourceGroup{}
