...
func (c *wafregionalIpsets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafregionalIpset, err error) {
...
func (c *wafregionalIpsets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafregionalIpsetList, err error) {
...
func (c *wafregionalIpsets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafregionalIpsets) Create(ctx context.Context, wafregionalIpset *v1alpha1.WafregionalIpset, opts v1.CreateOptions) (result *v1alpha1.WafregionalIpset, err error) {
	result = &v1alpha1.WafregionalIpset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafregionalipsets").
...
func (c *wafregionalIpsets) Update(ctx context.Context, wafregionalIpset *v1alpha1.WafregionalIpset, opts v1.UpdateOptions) (result *v1alpha1.WafregionalIpset, err error) {
	result = &v1alpha1.WafregionalIpset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalipsets").
...
func (c *wafregionalIpsets) UpdateStatus(ctx context.Context, wafregionalIpset *v1alpha1.WafregionalIpset, opts v1.UpdateOptions) (result *v1alpha1.WafregionalIpset, err error) {
	result = &v1alpha1.WafregionalIpset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalipsets").
...
func (c *wafregionalIpsets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafregionalIpsets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafregionalIpsets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafregionalIpset, err error) {
	result = &v1alpha1.WafregionalIpset{}
