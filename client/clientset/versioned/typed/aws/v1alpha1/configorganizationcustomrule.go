...
func (c *configOrganizationCustomRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ConfigOrganizationCustomRule, err error) {
...
func (c *configOrganizationCustomRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConfigOrganizationCustomRuleList, err error) {
...
func (c *configOrganizationCustomRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *configOrganizationCustomRules) Create(ctx context.Context, configOrganizationCustomRule *v1alpha1.ConfigOrganizationCustomRule, opts v1.CreateOptions) (result *v1alpha1.ConfigOrganizationCustomRule, err error) {
	result = &v1alpha1.ConfigOrganizationCustomRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("configorganizationcustomrules").
...
func (c *configOrganizationCustomRules) Update(ctx context.Context, configOrganizationCustomRule *v1alpha1.ConfigOrganizationCustomRule, opts v1.UpdateOptions) (result *v1alpha1.ConfigOrganizationCustomRule, err error) {
	result = &v1alpha1.ConfigOrganizationCustomRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configorganizationcustomrules").
...
func (c *configOrganizationCustomRules) UpdateStatus(ctx context.Context, configOrganizationCustomRule *v1alpha1.ConfigOrganizationCustomRule, opts v1.UpdateOptions) (result *v1alpha1.ConfigOrganizationCustomRule, err error) {
	result = &v1alpha1.ConfigOrganizationCustomRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configorganizationcustomrules").
...
func (c *configOrganizationCustomRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *configOrganizationCustomRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *configOrganizationCustomRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ConfigOrganizationCustomRule, err error) {
	result = &v1alpha1.ConfigOrganizationCustomRule{}
