...
func (c *networkInterfaceSgAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkInterfaceSgAttachment, err error) {
...
func (c *networkInterfaceSgAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkInterfaceSgAttachmentList, err error) {
...
func (c *networkInterfaceSgAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkInterfaceSgAttachments) Create(ctx context.Context, networkInterfaceSgAttachment *v1alpha1.NetworkInterfaceSgAttachment, opts v1.CreateOptions) (result *v1alpha1.NetworkInterfaceSgAttachment, err error) {
	result = &v1alpha1.NetworkInterfaceSgAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkinterfacesgattachments").
...
func (c *networkInterfaceSgAttachments) Update(ctx context.Context, networkInterfaceSgAttachment *v1alpha1.NetworkInterfaceSgAttachment, opts v1.UpdateOptions) (result *v1alpha1.NetworkInterfaceSgAttachment, err error) {
	result = &v1alpha1.NetworkInterfaceSgAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkinterfacesgattachments").
...
func (c *networkInterfaceSgAttachments) UpdateStatus(ctx context.Context, networkInterfaceSgAttachment *v1alpha1.NetworkInterfaceSgAttachment, opts v1.UpdateOptions) (result *v1alpha1.NetworkInterfaceSgAttachment, err error) {
	result = &v1alpha1.NetworkInterfaceSgAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkinterfacesgattachments").
...
func (c *networkInterfaceSgAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkInterfaceSgAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkInterfaceSgAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkInterfaceSgAttachment, err error) {
	result = &v1alpha1.NetworkInterfaceSgAttachment{}
