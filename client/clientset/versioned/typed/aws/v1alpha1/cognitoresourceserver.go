...
func (c *cognitoResourceServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CognitoResourceServer, err error) {
...
func (c *cognitoResourceServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CognitoResourceServerList, err error) {
...
func (c *cognitoResourceServers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cognitoResourceServers) Create(ctx context.Context, cognitoResourceServer *v1alpha1.CognitoResourceServer, opts v1.CreateOptions) (result *v1alpha1.CognitoResourceServer, err error) {
	result = &v1alpha1.CognitoResourceServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cognitoresourceservers").
...
func (c *cognitoResourceServers) Update(ctx context.Context, cognitoResourceServer *v1alpha1.CognitoResourceServer, opts v1.UpdateOptions) (result *v1alpha1.CognitoResourceServer, err error) {
	result = &v1alpha1.CognitoResourceServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cognitoresourceservers").
...
func (c *cognitoResourceServers) UpdateStatus(ctx context.Context, cognitoResourceServer *v1alpha1.CognitoResourceServer, opts v1.UpdateOptions) (result *v1alpha1.CognitoResourceServer, err error) {
	result = &v1alpha1.CognitoResourceServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cognitoresourceservers").
...
func (c *cognitoResourceServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cognitoResourceServers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cognitoResourceServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CognitoResourceServer, err error) {
	result = &v1alpha1.CognitoResourceServer{}
