...
func (c *elbAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ElbAttachment, err error) {
...
func (c *elbAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElbAttachmentList, err error) {
...
func (c *elbAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *elbAttachments) Create(ctx context.Context, elbAttachment *v1alpha1.ElbAttachment, opts v1.CreateOptions) (result *v1alpha1.ElbAttachment, err error) {
	result = &v1alpha1.ElbAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("elbattachments").
...
func (c *elbAttachments) Update(ctx context.Context, elbAttachment *v1alpha1.ElbAttachment, opts v1.UpdateOptions) (result *v1alpha1.ElbAttachment, err error) {
	result = &v1alpha1.ElbAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elbattachments").
...
func (c *elbAttachments) UpdateStatus(ctx context.Context, elbAttachment *v1alpha1.ElbAttachment, opts v1.UpdateOptions) (result *v1alpha1.ElbAttachment, err error) {
	result = &v1alpha1.ElbAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elbattachments").
...
func (c *elbAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *elbAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *elbAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ElbAttachment, err error) {
	result = &v1alpha1.ElbAttachment{}
