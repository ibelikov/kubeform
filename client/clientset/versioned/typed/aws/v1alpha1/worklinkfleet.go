...
func (c *worklinkFleets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WorklinkFleet, err error) {
...
func (c *worklinkFleets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WorklinkFleetList, err error) {
...
func (c *worklinkFleets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *worklinkFleets) Create(ctx context.Context, worklinkFleet *v1alpha1.WorklinkFleet, opts v1.CreateOptions) (result *v1alpha1.WorklinkFleet, err error) {
	result = &v1alpha1.WorklinkFleet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("worklinkfleets").
...
func (c *worklinkFleets) Update(ctx context.Context, worklinkFleet *v1alpha1.WorklinkFleet, opts v1.UpdateOptions) (result *v1alpha1.WorklinkFleet, err error) {
	result = &v1alpha1.WorklinkFleet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("worklinkfleets").
...
func (c *worklinkFleets) UpdateStatus(ctx context.Context, worklinkFleet *v1alpha1.WorklinkFleet, opts v1.UpdateOptions) (result *v1alpha1.WorklinkFleet, err error) {
	result = &v1alpha1.WorklinkFleet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("worklinkfleets").
...
func (c *worklinkFleets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *worklinkFleets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *worklinkFleets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WorklinkFleet, err error) {
	result = &v1alpha1.WorklinkFleet{}
