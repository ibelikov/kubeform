...
type WorklinkFleetInterface interface {
	Create(*v1alpha1.WorklinkFleet) (*v1alpha1.WorklinkFleet, error)
	Update(*v1alpha1.WorklinkFleet) (*v1alpha1.WorklinkFleet, error)
	UpdateStatus(*v1alpha1.WorklinkFleet) (*v1alpha1.WorklinkFleet, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.WorklinkFleet, error)
	List(opts v1.ListOptions) (*v1alpha1.WorklinkFleetList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.WorklinkFleet, err error)
...
func (c *worklinkFleets) List(opts v1.ListOptions) (result *v1alpha1.WorklinkFleetList, err error) {
...
func (c *worklinkFleets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *worklinkFleets) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
