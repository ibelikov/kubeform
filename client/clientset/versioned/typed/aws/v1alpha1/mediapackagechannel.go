...
func (c *mediaPackageChannels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MediaPackageChannel, err error) {
...
func (c *mediaPackageChannels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MediaPackageChannelList, err error) {
...
func (c *mediaPackageChannels) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mediaPackageChannels) Create(ctx context.Context, mediaPackageChannel *v1alpha1.MediaPackageChannel, opts v1.CreateOptions) (result *v1alpha1.MediaPackageChannel, err error) {
	result = &v1alpha1.MediaPackageChannel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mediapackagechannels").
...
func (c *mediaPackageChannels) Update(ctx context.Context, mediaPackageChannel *v1alpha1.MediaPackageChannel, opts v1.UpdateOptions) (result *v1alpha1.MediaPackageChannel, err error) {
	result = &v1alpha1.MediaPackageChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mediapackagechannels").
...
func (c *mediaPackageChannels) UpdateStatus(ctx context.Context, mediaPackageChannel *v1alpha1.MediaPackageChannel, opts v1.UpdateOptions) (result *v1alpha1.MediaPackageChannel, err error) {
	result = &v1alpha1.MediaPackageChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mediapackagechannels").
...
func (c *mediaPackageChannels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mediaPackageChannels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mediaPackageChannels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MediaPackageChannel, err error) {
	result = &v1alpha1.MediaPackageChannel{}
