...
func (c *athenaWorkgroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AthenaWorkgroup, err error) {
...
func (c *athenaWorkgroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AthenaWorkgroupList, err error) {
...
func (c *athenaWorkgroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *athenaWorkgroups) Create(ctx context.Context, athenaWorkgroup *v1alpha1.AthenaWorkgroup, opts v1.CreateOptions) (result *v1alpha1.AthenaWorkgroup, err error) {
	result = &v1alpha1.AthenaWorkgroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("athenaworkgroups").
...
func (c *athenaWorkgroups) Update(ctx context.Context, athenaWorkgroup *v1alpha1.AthenaWorkgroup, opts v1.UpdateOptions) (result *v1alpha1.AthenaWorkgroup, err error) {
	result = &v1alpha1.AthenaWorkgroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("athenaworkgroups").
...
func (c *athenaWorkgroups) UpdateStatus(ctx context.Context, athenaWorkgroup *v1alpha1.AthenaWorkgroup, opts v1.UpdateOptions) (result *v1alpha1.AthenaWorkgroup, err error) {
	result = &v1alpha1.AthenaWorkgroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("athenaworkgroups").
...
func (c *athenaWorkgroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *athenaWorkgroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *athenaWorkgroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AthenaWorkgroup, err error) {
	result = &v1alpha1.AthenaWorkgroup{}
