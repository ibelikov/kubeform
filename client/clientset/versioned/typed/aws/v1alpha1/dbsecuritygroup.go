...
func (c *dbSecurityGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DbSecurityGroup, err error) {
...
func (c *dbSecurityGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DbSecurityGroupList, err error) {
...
func (c *dbSecurityGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dbSecurityGroups) Create(ctx context.Context, dbSecurityGroup *v1alpha1.DbSecurityGroup, opts v1.CreateOptions) (result *v1alpha1.DbSecurityGroup, err error) {
	result = &v1alpha1.DbSecurityGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dbsecuritygroups").
...
func (c *dbSecurityGroups) Update(ctx context.Context, dbSecurityGroup *v1alpha1.DbSecurityGroup, opts v1.UpdateOptions) (result *v1alpha1.DbSecurityGroup, err error) {
	result = &v1alpha1.DbSecurityGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbsecuritygroups").
...
func (c *dbSecurityGroups) UpdateStatus(ctx context.Context, dbSecurityGroup *v1alpha1.DbSecurityGroup, opts v1.UpdateOptions) (result *v1alpha1.DbSecurityGroup, err error) {
	result = &v1alpha1.DbSecurityGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbsecuritygroups").
...
func (c *dbSecurityGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dbSecurityGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dbSecurityGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DbSecurityGroup, err error) {
	result = &v1alpha1.DbSecurityGroup{}
