...
type AppmeshVirtualRouterInterface interface {
	Create(*v1alpha1.AppmeshVirtualRouter) (*v1alpha1.AppmeshVirtualRouter, error)
	Update(*v1alpha1.AppmeshVirtualRouter) (*v1alpha1.AppmeshVirtualRouter, error)
	UpdateStatus(*v1alpha1.AppmeshVirtualRouter) (*v1alpha1.AppmeshVirtualRouter, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.AppmeshVirtualRouter, error)
	List(opts v1.ListOptions) (*v1alpha1.AppmeshVirtualRouterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AppmeshVirtualRouter, err error)
...
func (c *appmeshVirtualRouters) List(opts v1.ListOptions) (result *v1alpha1.AppmeshVirtualRouterList, err error) {
...
func (c *appmeshVirtualRouters) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *appmeshVirtualRouters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
