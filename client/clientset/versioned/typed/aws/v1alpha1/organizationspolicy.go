...
type OrganizationsPolicyInterface interface {
	Create(*v1alpha1.OrganizationsPolicy) (*v1alpha1.OrganizationsPolicy, error)
	Update(*v1alpha1.OrganizationsPolicy) (*v1alpha1.OrganizationsPolicy, error)
	UpdateStatus(*v1alpha1.OrganizationsPolicy) (*v1alpha1.OrganizationsPolicy, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.OrganizationsPolicy, error)
	List(opts v1.ListOptions) (*v1alpha1.OrganizationsPolicyList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OrganizationsPolicy, err error)
...
func (c *organizationsPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.OrganizationsPolicy, err error) {
...
func (c *organizationsPolicies) List(opts v1.ListOptions) (result *v1alpha1.OrganizationsPolicyList, err error) {
...
func (c *organizationsPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *organizationsPolicies) Create(organizationsPolicy *v1alpha1.OrganizationsPolicy) (result *v1alpha1.OrganizationsPolicy, err error) {
	result = &v1alpha1.OrganizationsPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("organizationspolicies").
...
func (c *organizationsPolicies) Update(organizationsPolicy *v1alpha1.OrganizationsPolicy) (result *v1alpha1.OrganizationsPolicy, err error) {
	result = &v1alpha1.OrganizationsPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationspolicies").
...
func (c *organizationsPolicies) UpdateStatus(organizationsPolicy *v1alpha1.OrganizationsPolicy) (result *v1alpha1.OrganizationsPolicy, err error) {
	result = &v1alpha1.OrganizationsPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationspolicies").
...
func (c *organizationsPolicies) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *organizationsPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *organizationsPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OrganizationsPolicy, err error) {
	result = &v1alpha1.OrganizationsPolicy{}
