...
func (c *athenaNamedQueries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AthenaNamedQuery, err error) {
...
func (c *athenaNamedQueries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AthenaNamedQueryList, err error) {
...
func (c *athenaNamedQueries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *athenaNamedQueries) Create(ctx context.Context, athenaNamedQuery *v1alpha1.AthenaNamedQuery, opts v1.CreateOptions) (result *v1alpha1.AthenaNamedQuery, err error) {
	result = &v1alpha1.AthenaNamedQuery{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("athenanamedqueries").
...
func (c *athenaNamedQueries) Update(ctx context.Context, athenaNamedQuery *v1alpha1.AthenaNamedQuery, opts v1.UpdateOptions) (result *v1alpha1.AthenaNamedQuery, err error) {
	result = &v1alpha1.AthenaNamedQuery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("athenanamedqueries").
...
func (c *athenaNamedQueries) UpdateStatus(ctx context.Context, athenaNamedQuery *v1alpha1.AthenaNamedQuery, opts v1.UpdateOptions) (result *v1alpha1.AthenaNamedQuery, err error) {
	result = &v1alpha1.AthenaNamedQuery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("athenanamedqueries").
...
func (c *athenaNamedQueries) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *athenaNamedQueries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *athenaNamedQueries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AthenaNamedQuery, err error) {
	result = &v1alpha1.AthenaNamedQuery{}
