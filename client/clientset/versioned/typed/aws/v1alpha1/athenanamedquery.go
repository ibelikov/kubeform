...
type AthenaNamedQueryInterface interface {
	Create(*v1alpha1.AthenaNamedQuery) (*v1alpha1.AthenaNamedQuery, error)
	Update(*v1alpha1.AthenaNamedQuery) (*v1alpha1.AthenaNamedQuery, error)
	UpdateStatus(*v1alpha1.AthenaNamedQuery) (*v1alpha1.AthenaNamedQuery, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.AthenaNamedQuery, error)
	List(opts v1.ListOptions) (*v1alpha1.AthenaNamedQueryList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AthenaNamedQuery, err error)
...
func (c *athenaNamedQueries) List(opts v1.ListOptions) (result *v1alpha1.AthenaNamedQueryList, err error) {
...
func (c *athenaNamedQueries) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *athenaNamedQueries) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
