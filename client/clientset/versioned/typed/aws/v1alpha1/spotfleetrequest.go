...
func (c *spotFleetRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpotFleetRequest, err error) {
...
func (c *spotFleetRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpotFleetRequestList, err error) {
...
func (c *spotFleetRequests) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *spotFleetRequests) Create(ctx context.Context, spotFleetRequest *v1alpha1.SpotFleetRequest, opts v1.CreateOptions) (result *v1alpha1.SpotFleetRequest, err error) {
	result = &v1alpha1.SpotFleetRequest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spotfleetrequests").
...
func (c *spotFleetRequests) Update(ctx context.Context, spotFleetRequest *v1alpha1.SpotFleetRequest, opts v1.UpdateOptions) (result *v1alpha1.SpotFleetRequest, err error) {
	result = &v1alpha1.SpotFleetRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spotfleetrequests").
...
func (c *spotFleetRequests) UpdateStatus(ctx context.Context, spotFleetRequest *v1alpha1.SpotFleetRequest, opts v1.UpdateOptions) (result *v1alpha1.SpotFleetRequest, err error) {
	result = &v1alpha1.SpotFleetRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spotfleetrequests").
...
func (c *spotFleetRequests) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *spotFleetRequests) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *spotFleetRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SpotFleetRequest, err error) {
	result = &v1alpha1.SpotFleetRequest{}
