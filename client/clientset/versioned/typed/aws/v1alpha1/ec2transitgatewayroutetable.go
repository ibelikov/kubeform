...
func (c *ec2TransitGatewayRouteTables) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ec2TransitGatewayRouteTable, err error) {
...
func (c *ec2TransitGatewayRouteTables) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.Ec2TransitGatewayRouteTableList, err error) {
...
func (c *ec2TransitGatewayRouteTables) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ec2TransitGatewayRouteTables) Create(ctx context.Context, ec2TransitGatewayRouteTable *v1alpha1.Ec2TransitGatewayRouteTable, opts v1.CreateOptions) (result *v1alpha1.Ec2TransitGatewayRouteTable, err error) {
	result = &v1alpha1.Ec2TransitGatewayRouteTable{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ec2transitgatewayroutetables").
...
func (c *ec2TransitGatewayRouteTables) Update(ctx context.Context, ec2TransitGatewayRouteTable *v1alpha1.Ec2TransitGatewayRouteTable, opts v1.UpdateOptions) (result *v1alpha1.Ec2TransitGatewayRouteTable, err error) {
	result = &v1alpha1.Ec2TransitGatewayRouteTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ec2transitgatewayroutetables").
...
func (c *ec2TransitGatewayRouteTables) UpdateStatus(ctx context.Context, ec2TransitGatewayRouteTable *v1alpha1.Ec2TransitGatewayRouteTable, opts v1.UpdateOptions) (result *v1alpha1.Ec2TransitGatewayRouteTable, err error) {
	result = &v1alpha1.Ec2TransitGatewayRouteTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ec2transitgatewayroutetables").
...
func (c *ec2TransitGatewayRouteTables) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ec2TransitGatewayRouteTables) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ec2TransitGatewayRouteTables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ec2TransitGatewayRouteTable, err error) {
	result = &v1alpha1.Ec2TransitGatewayRouteTable{}
