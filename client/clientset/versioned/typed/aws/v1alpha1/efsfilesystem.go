...
func (c *efsFileSystems) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EfsFileSystem, err error) {
...
func (c *efsFileSystems) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EfsFileSystemList, err error) {
...
func (c *efsFileSystems) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *efsFileSystems) Create(ctx context.Context, efsFileSystem *v1alpha1.EfsFileSystem, opts v1.CreateOptions) (result *v1alpha1.EfsFileSystem, err error) {
	result = &v1alpha1.EfsFileSystem{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("efsfilesystems").
...
func (c *efsFileSystems) Update(ctx context.Context, efsFileSystem *v1alpha1.EfsFileSystem, opts v1.UpdateOptions) (result *v1alpha1.EfsFileSystem, err error) {
	result = &v1alpha1.EfsFileSystem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("efsfilesystems").
...
func (c *efsFileSystems) UpdateStatus(ctx context.Context, efsFileSystem *v1alpha1.EfsFileSystem, opts v1.UpdateOptions) (result *v1alpha1.EfsFileSystem, err error) {
	result = &v1alpha1.EfsFileSystem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("efsfilesystems").
...
func (c *efsFileSystems) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *efsFileSystems) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *efsFileSystems) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EfsFileSystem, err error) {
	result = &v1alpha1.EfsFileSystem{}
