...
type IamInstanceProfileInterface interface {
	Create(*v1alpha1.IamInstanceProfile) (*v1alpha1.IamInstanceProfile, error)
	Update(*v1alpha1.IamInstanceProfile) (*v1alpha1.IamInstanceProfile, error)
	UpdateStatus(*v1alpha1.IamInstanceProfile) (*v1alpha1.IamInstanceProfile, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.IamInstanceProfile, error)
	List(opts v1.ListOptions) (*v1alpha1.IamInstanceProfileList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IamInstanceProfile, err error)
...
func (c *iamInstanceProfiles) List(opts v1.ListOptions) (result *v1alpha1.IamInstanceProfileList, err error) {
...
func (c *iamInstanceProfiles) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamInstanceProfiles) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
