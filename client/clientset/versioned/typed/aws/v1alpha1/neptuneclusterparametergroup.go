...
func (c *neptuneClusterParameterGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NeptuneClusterParameterGroup, err error) {
...
func (c *neptuneClusterParameterGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NeptuneClusterParameterGroupList, err error) {
...
func (c *neptuneClusterParameterGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *neptuneClusterParameterGroups) Create(ctx context.Context, neptuneClusterParameterGroup *v1alpha1.NeptuneClusterParameterGroup, opts v1.CreateOptions) (result *v1alpha1.NeptuneClusterParameterGroup, err error) {
	result = &v1alpha1.NeptuneClusterParameterGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("neptuneclusterparametergroups").
...
func (c *neptuneClusterParameterGroups) Update(ctx context.Context, neptuneClusterParameterGroup *v1alpha1.NeptuneClusterParameterGroup, opts v1.UpdateOptions) (result *v1alpha1.NeptuneClusterParameterGroup, err error) {
	result = &v1alpha1.NeptuneClusterParameterGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("neptuneclusterparametergroups").
...
func (c *neptuneClusterParameterGroups) UpdateStatus(ctx context.Context, neptuneClusterParameterGroup *v1alpha1.NeptuneClusterParameterGroup, opts v1.UpdateOptions) (result *v1alpha1.NeptuneClusterParameterGroup, err error) {
	result = &v1alpha1.NeptuneClusterParameterGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("neptuneclusterparametergroups").
...
func (c *neptuneClusterParameterGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *neptuneClusterParameterGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *neptuneClusterParameterGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NeptuneClusterParameterGroup, err error) {
	result = &v1alpha1.NeptuneClusterParameterGroup{}
