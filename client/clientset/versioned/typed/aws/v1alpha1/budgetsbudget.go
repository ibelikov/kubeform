...
func (c *budgetsBudgets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BudgetsBudget, err error) {
...
func (c *budgetsBudgets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BudgetsBudgetList, err error) {
...
func (c *budgetsBudgets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *budgetsBudgets) Create(ctx context.Context, budgetsBudget *v1alpha1.BudgetsBudget, opts v1.CreateOptions) (result *v1alpha1.BudgetsBudget, err error) {
	result = &v1alpha1.BudgetsBudget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("budgetsbudgets").
...
func (c *budgetsBudgets) Update(ctx context.Context, budgetsBudget *v1alpha1.BudgetsBudget, opts v1.UpdateOptions) (result *v1alpha1.BudgetsBudget, err error) {
	result = &v1alpha1.BudgetsBudget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("budgetsbudgets").
...
func (c *budgetsBudgets) UpdateStatus(ctx context.Context, budgetsBudget *v1alpha1.BudgetsBudget, opts v1.UpdateOptions) (result *v1alpha1.BudgetsBudget, err error) {
	result = &v1alpha1.BudgetsBudget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("budgetsbudgets").
...
func (c *budgetsBudgets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *budgetsBudgets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *budgetsBudgets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BudgetsBudget, err error) {
	result = &v1alpha1.BudgetsBudget{}
