...
func (c *cognitoUserGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CognitoUserGroup, err error) {
...
func (c *cognitoUserGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CognitoUserGroupList, err error) {
...
func (c *cognitoUserGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cognitoUserGroups) Create(ctx context.Context, cognitoUserGroup *v1alpha1.CognitoUserGroup, opts v1.CreateOptions) (result *v1alpha1.CognitoUserGroup, err error) {
	result = &v1alpha1.CognitoUserGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cognitousergroups").
...
func (c *cognitoUserGroups) Update(ctx context.Context, cognitoUserGroup *v1alpha1.CognitoUserGroup, opts v1.UpdateOptions) (result *v1alpha1.CognitoUserGroup, err error) {
	result = &v1alpha1.CognitoUserGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cognitousergroups").
...
func (c *cognitoUserGroups) UpdateStatus(ctx context.Context, cognitoUserGroup *v1alpha1.CognitoUserGroup, opts v1.UpdateOptions) (result *v1alpha1.CognitoUserGroup, err error) {
	result = &v1alpha1.CognitoUserGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cognitousergroups").
...
func (c *cognitoUserGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cognitoUserGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cognitoUserGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CognitoUserGroup, err error) {
	result = &v1alpha1.CognitoUserGroup{}
