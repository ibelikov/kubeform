...
func (c *codecommitTriggers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CodecommitTrigger, err error) {
...
func (c *codecommitTriggers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CodecommitTriggerList, err error) {
...
func (c *codecommitTriggers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *codecommitTriggers) Create(ctx context.Context, codecommitTrigger *v1alpha1.CodecommitTrigger, opts v1.CreateOptions) (result *v1alpha1.CodecommitTrigger, err error) {
	result = &v1alpha1.CodecommitTrigger{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("codecommittriggers").
...
func (c *codecommitTriggers) Update(ctx context.Context, codecommitTrigger *v1alpha1.CodecommitTrigger, opts v1.UpdateOptions) (result *v1alpha1.CodecommitTrigger, err error) {
	result = &v1alpha1.CodecommitTrigger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("codecommittriggers").
...
func (c *codecommitTriggers) UpdateStatus(ctx context.Context, codecommitTrigger *v1alpha1.CodecommitTrigger, opts v1.UpdateOptions) (result *v1alpha1.CodecommitTrigger, err error) {
	result = &v1alpha1.CodecommitTrigger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("codecommittriggers").
...
func (c *codecommitTriggers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *codecommitTriggers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *codecommitTriggers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CodecommitTrigger, err error) {
	result = &v1alpha1.CodecommitTrigger{}
