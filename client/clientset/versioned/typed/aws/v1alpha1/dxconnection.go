...
func (c *dxConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DxConnection, err error) {
...
func (c *dxConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DxConnectionList, err error) {
...
func (c *dxConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dxConnections) Create(ctx context.Context, dxConnection *v1alpha1.DxConnection, opts v1.CreateOptions) (result *v1alpha1.DxConnection, err error) {
	result = &v1alpha1.DxConnection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dxconnections").
...
func (c *dxConnections) Update(ctx context.Context, dxConnection *v1alpha1.DxConnection, opts v1.UpdateOptions) (result *v1alpha1.DxConnection, err error) {
	result = &v1alpha1.DxConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dxconnections").
...
func (c *dxConnections) UpdateStatus(ctx context.Context, dxConnection *v1alpha1.DxConnection, opts v1.UpdateOptions) (result *v1alpha1.DxConnection, err error) {
	result = &v1alpha1.DxConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dxconnections").
...
func (c *dxConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dxConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dxConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DxConnection, err error) {
	result = &v1alpha1.DxConnection{}
