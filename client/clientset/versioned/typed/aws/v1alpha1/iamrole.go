...
func (c *iamRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamRole, err error) {
...
func (c *iamRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamRoleList, err error) {
...
func (c *iamRoles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamRoles) Create(ctx context.Context, iamRole *v1alpha1.IamRole, opts v1.CreateOptions) (result *v1alpha1.IamRole, err error) {
	result = &v1alpha1.IamRole{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamroles").
...
func (c *iamRoles) Update(ctx context.Context, iamRole *v1alpha1.IamRole, opts v1.UpdateOptions) (result *v1alpha1.IamRole, err error) {
	result = &v1alpha1.IamRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamroles").
...
func (c *iamRoles) UpdateStatus(ctx context.Context, iamRole *v1alpha1.IamRole, opts v1.UpdateOptions) (result *v1alpha1.IamRole, err error) {
	result = &v1alpha1.IamRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamroles").
...
func (c *iamRoles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamRoles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamRole, err error) {
	result = &v1alpha1.IamRole{}
