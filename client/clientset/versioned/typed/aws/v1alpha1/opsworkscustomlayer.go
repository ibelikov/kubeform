...
func (c *opsworksCustomLayers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksCustomLayer, err error) {
...
func (c *opsworksCustomLayers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksCustomLayerList, err error) {
...
func (c *opsworksCustomLayers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksCustomLayers) Create(ctx context.Context, opsworksCustomLayer *v1alpha1.OpsworksCustomLayer, opts v1.CreateOptions) (result *v1alpha1.OpsworksCustomLayer, err error) {
	result = &v1alpha1.OpsworksCustomLayer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("opsworkscustomlayers").
...
func (c *opsworksCustomLayers) Update(ctx context.Context, opsworksCustomLayer *v1alpha1.OpsworksCustomLayer, opts v1.UpdateOptions) (result *v1alpha1.OpsworksCustomLayer, err error) {
	result = &v1alpha1.OpsworksCustomLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworkscustomlayers").
...
func (c *opsworksCustomLayers) UpdateStatus(ctx context.Context, opsworksCustomLayer *v1alpha1.OpsworksCustomLayer, opts v1.UpdateOptions) (result *v1alpha1.OpsworksCustomLayer, err error) {
	result = &v1alpha1.OpsworksCustomLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworkscustomlayers").
...
func (c *opsworksCustomLayers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *opsworksCustomLayers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *opsworksCustomLayers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksCustomLayer, err error) {
	result = &v1alpha1.OpsworksCustomLayer{}
