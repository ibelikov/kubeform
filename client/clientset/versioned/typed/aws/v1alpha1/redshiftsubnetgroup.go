...
func (c *redshiftSubnetGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RedshiftSubnetGroup, err error) {
...
func (c *redshiftSubnetGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RedshiftSubnetGroupList, err error) {
...
func (c *redshiftSubnetGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *redshiftSubnetGroups) Create(ctx context.Context, redshiftSubnetGroup *v1alpha1.RedshiftSubnetGroup, opts v1.CreateOptions) (result *v1alpha1.RedshiftSubnetGroup, err error) {
	result = &v1alpha1.RedshiftSubnetGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("redshiftsubnetgroups").
...
func (c *redshiftSubnetGroups) Update(ctx context.Context, redshiftSubnetGroup *v1alpha1.RedshiftSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.RedshiftSubnetGroup, err error) {
	result = &v1alpha1.RedshiftSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redshiftsubnetgroups").
...
func (c *redshiftSubnetGroups) UpdateStatus(ctx context.Context, redshiftSubnetGroup *v1alpha1.RedshiftSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.RedshiftSubnetGroup, err error) {
	result = &v1alpha1.RedshiftSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redshiftsubnetgroups").
...
func (c *redshiftSubnetGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *redshiftSubnetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *redshiftSubnetGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RedshiftSubnetGroup, err error) {
	result = &v1alpha1.RedshiftSubnetGroup{}
