...
func (c *secretsmanagerSecrets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SecretsmanagerSecret, err error) {
...
func (c *secretsmanagerSecrets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SecretsmanagerSecretList, err error) {
...
func (c *secretsmanagerSecrets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *secretsmanagerSecrets) Create(ctx context.Context, secretsmanagerSecret *v1alpha1.SecretsmanagerSecret, opts v1.CreateOptions) (result *v1alpha1.SecretsmanagerSecret, err error) {
	result = &v1alpha1.SecretsmanagerSecret{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("secretsmanagersecrets").
...
func (c *secretsmanagerSecrets) Update(ctx context.Context, secretsmanagerSecret *v1alpha1.SecretsmanagerSecret, opts v1.UpdateOptions) (result *v1alpha1.SecretsmanagerSecret, err error) {
	result = &v1alpha1.SecretsmanagerSecret{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("secretsmanagersecrets").
...
func (c *secretsmanagerSecrets) UpdateStatus(ctx context.Context, secretsmanagerSecret *v1alpha1.SecretsmanagerSecret, opts v1.UpdateOptions) (result *v1alpha1.SecretsmanagerSecret, err error) {
	result = &v1alpha1.SecretsmanagerSecret{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("secretsmanagersecrets").
...
func (c *secretsmanagerSecrets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *secretsmanagerSecrets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *secretsmanagerSecrets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SecretsmanagerSecret, err error) {
	result = &v1alpha1.SecretsmanagerSecret{}
