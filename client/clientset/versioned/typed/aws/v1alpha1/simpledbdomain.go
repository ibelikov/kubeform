...
func (c *simpledbDomains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SimpledbDomain, err error) {
...
func (c *simpledbDomains) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SimpledbDomainList, err error) {
...
func (c *simpledbDomains) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *simpledbDomains) Create(ctx context.Context, simpledbDomain *v1alpha1.SimpledbDomain, opts v1.CreateOptions) (result *v1alpha1.SimpledbDomain, err error) {
	result = &v1alpha1.SimpledbDomain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("simpledbdomains").
...
func (c *simpledbDomains) Update(ctx context.Context, simpledbDomain *v1alpha1.SimpledbDomain, opts v1.UpdateOptions) (result *v1alpha1.SimpledbDomain, err error) {
	result = &v1alpha1.SimpledbDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("simpledbdomains").
...
func (c *simpledbDomains) UpdateStatus(ctx context.Context, simpledbDomain *v1alpha1.SimpledbDomain, opts v1.UpdateOptions) (result *v1alpha1.SimpledbDomain, err error) {
	result = &v1alpha1.SimpledbDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("simpledbdomains").
...
func (c *simpledbDomains) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *simpledbDomains) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *simpledbDomains) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SimpledbDomain, err error) {
	result = &v1alpha1.SimpledbDomain{}
