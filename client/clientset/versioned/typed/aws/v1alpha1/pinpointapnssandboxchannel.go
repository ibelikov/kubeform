...
func (c *pinpointApnsSandboxChannels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PinpointApnsSandboxChannel, err error) {
...
func (c *pinpointApnsSandboxChannels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PinpointApnsSandboxChannelList, err error) {
...
func (c *pinpointApnsSandboxChannels) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pinpointApnsSandboxChannels) Create(ctx context.Context, pinpointApnsSandboxChannel *v1alpha1.PinpointApnsSandboxChannel, opts v1.CreateOptions) (result *v1alpha1.PinpointApnsSandboxChannel, err error) {
	result = &v1alpha1.PinpointApnsSandboxChannel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pinpointapnssandboxchannels").
...
func (c *pinpointApnsSandboxChannels) Update(ctx context.Context, pinpointApnsSandboxChannel *v1alpha1.PinpointApnsSandboxChannel, opts v1.UpdateOptions) (result *v1alpha1.PinpointApnsSandboxChannel, err error) {
	result = &v1alpha1.PinpointApnsSandboxChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pinpointapnssandboxchannels").
...
func (c *pinpointApnsSandboxChannels) UpdateStatus(ctx context.Context, pinpointApnsSandboxChannel *v1alpha1.PinpointApnsSandboxChannel, opts v1.UpdateOptions) (result *v1alpha1.PinpointApnsSandboxChannel, err error) {
	result = &v1alpha1.PinpointApnsSandboxChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pinpointapnssandboxchannels").
...
func (c *pinpointApnsSandboxChannels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pinpointApnsSandboxChannels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pinpointApnsSandboxChannels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PinpointApnsSandboxChannel, err error) {
	result = &v1alpha1.PinpointApnsSandboxChannel{}
