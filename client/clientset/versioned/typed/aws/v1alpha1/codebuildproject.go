...
func (c *codebuildProjects) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CodebuildProject, err error) {
...
func (c *codebuildProjects) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CodebuildProjectList, err error) {
...
func (c *codebuildProjects) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *codebuildProjects) Create(ctx context.Context, codebuildProject *v1alpha1.CodebuildProject, opts v1.CreateOptions) (result *v1alpha1.CodebuildProject, err error) {
	result = &v1alpha1.CodebuildProject{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("codebuildprojects").
...
func (c *codebuildProjects) Update(ctx context.Context, codebuildProject *v1alpha1.CodebuildProject, opts v1.UpdateOptions) (result *v1alpha1.CodebuildProject, err error) {
	result = &v1alpha1.CodebuildProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("codebuildprojects").
...
func (c *codebuildProjects) UpdateStatus(ctx context.Context, codebuildProject *v1alpha1.CodebuildProject, opts v1.UpdateOptions) (result *v1alpha1.CodebuildProject, err error) {
	result = &v1alpha1.CodebuildProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("codebuildprojects").
...
func (c *codebuildProjects) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *codebuildProjects) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *codebuildProjects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CodebuildProject, err error) {
	result = &v1alpha1.CodebuildProject{}
