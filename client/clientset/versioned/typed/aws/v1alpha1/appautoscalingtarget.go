...
func (c *appautoscalingTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppautoscalingTarget, err error) {
...
func (c *appautoscalingTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppautoscalingTargetList, err error) {
...
func (c *appautoscalingTargets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *appautoscalingTargets) Create(ctx context.Context, appautoscalingTarget *v1alpha1.AppautoscalingTarget, opts v1.CreateOptions) (result *v1alpha1.AppautoscalingTarget, err error) {
	result = &v1alpha1.AppautoscalingTarget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("appautoscalingtargets").
...
func (c *appautoscalingTargets) Update(ctx context.Context, appautoscalingTarget *v1alpha1.AppautoscalingTarget, opts v1.UpdateOptions) (result *v1alpha1.AppautoscalingTarget, err error) {
	result = &v1alpha1.AppautoscalingTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appautoscalingtargets").
...
func (c *appautoscalingTargets) UpdateStatus(ctx context.Context, appautoscalingTarget *v1alpha1.AppautoscalingTarget, opts v1.UpdateOptions) (result *v1alpha1.AppautoscalingTarget, err error) {
	result = &v1alpha1.AppautoscalingTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appautoscalingtargets").
...
func (c *appautoscalingTargets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *appautoscalingTargets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *appautoscalingTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppautoscalingTarget, err error) {
	result = &v1alpha1.AppautoscalingTarget{}
