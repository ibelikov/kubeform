...
func (c *mediaStoreContainers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MediaStoreContainer, err error) {
...
func (c *mediaStoreContainers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MediaStoreContainerList, err error) {
...
func (c *mediaStoreContainers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mediaStoreContainers) Create(ctx context.Context, mediaStoreContainer *v1alpha1.MediaStoreContainer, opts v1.CreateOptions) (result *v1alpha1.MediaStoreContainer, err error) {
	result = &v1alpha1.MediaStoreContainer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mediastorecontainers").
...
func (c *mediaStoreContainers) Update(ctx context.Context, mediaStoreContainer *v1alpha1.MediaStoreContainer, opts v1.UpdateOptions) (result *v1alpha1.MediaStoreContainer, err error) {
	result = &v1alpha1.MediaStoreContainer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mediastorecontainers").
...
func (c *mediaStoreContainers) UpdateStatus(ctx context.Context, mediaStoreContainer *v1alpha1.MediaStoreContainer, opts v1.UpdateOptions) (result *v1alpha1.MediaStoreContainer, err error) {
	result = &v1alpha1.MediaStoreContainer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mediastorecontainers").
...
func (c *mediaStoreContainers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mediaStoreContainers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mediaStoreContainers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MediaStoreContainer, err error) {
	result = &v1alpha1.MediaStoreContainer{}
