...
type SnapshotCreateVolumePermissionInterface interface {
	Create(*v1alpha1.SnapshotCreateVolumePermission) (*v1alpha1.SnapshotCreateVolumePermission, error)
	Update(*v1alpha1.SnapshotCreateVolumePermission) (*v1alpha1.SnapshotCreateVolumePermission, error)
	UpdateStatus(*v1alpha1.SnapshotCreateVolumePermission) (*v1alpha1.SnapshotCreateVolumePermission, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SnapshotCreateVolumePermission, error)
	List(opts v1.ListOptions) (*v1alpha1.SnapshotCreateVolumePermissionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SnapshotCreateVolumePermission, err error)
...
func (c *snapshotCreateVolumePermissions) Get(name string, options v1.GetOptions) (result *v1alpha1.SnapshotCreateVolumePermission, err error) {
...
func (c *snapshotCreateVolumePermissions) List(opts v1.ListOptions) (result *v1alpha1.SnapshotCreateVolumePermissionList, err error) {
...
func (c *snapshotCreateVolumePermissions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *snapshotCreateVolumePermissions) Create(snapshotCreateVolumePermission *v1alpha1.SnapshotCreateVolumePermission) (result *v1alpha1.SnapshotCreateVolumePermission, err error) {
	result = &v1alpha1.SnapshotCreateVolumePermission{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("snapshotcreatevolumepermissions").
...
func (c *snapshotCreateVolumePermissions) Update(snapshotCreateVolumePermission *v1alpha1.SnapshotCreateVolumePermission) (result *v1alpha1.SnapshotCreateVolumePermission, err error) {
	result = &v1alpha1.SnapshotCreateVolumePermission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snapshotcreatevolumepermissions").
...
func (c *snapshotCreateVolumePermissions) UpdateStatus(snapshotCreateVolumePermission *v1alpha1.SnapshotCreateVolumePermission) (result *v1alpha1.SnapshotCreateVolumePermission, err error) {
	result = &v1alpha1.SnapshotCreateVolumePermission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snapshotcreatevolumepermissions").
...
func (c *snapshotCreateVolumePermissions) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *snapshotCreateVolumePermissions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *snapshotCreateVolumePermissions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SnapshotCreateVolumePermission, err error) {
	result = &v1alpha1.SnapshotCreateVolumePermission{}
