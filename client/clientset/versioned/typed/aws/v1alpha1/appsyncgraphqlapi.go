...
func (c *appsyncGraphqlAPIs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
...
func (c *appsyncGraphqlAPIs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppsyncGraphqlAPIList, err error) {
...
func (c *appsyncGraphqlAPIs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *appsyncGraphqlAPIs) Create(ctx context.Context, appsyncGraphqlAPI *v1alpha1.AppsyncGraphqlAPI, opts v1.CreateOptions) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
	result = &v1alpha1.AppsyncGraphqlAPI{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("appsyncgraphqlapis").
...
func (c *appsyncGraphqlAPIs) Update(ctx context.Context, appsyncGraphqlAPI *v1alpha1.AppsyncGraphqlAPI, opts v1.UpdateOptions) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
	result = &v1alpha1.AppsyncGraphqlAPI{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appsyncgraphqlapis").
...
func (c *appsyncGraphqlAPIs) UpdateStatus(ctx context.Context, appsyncGraphqlAPI *v1alpha1.AppsyncGraphqlAPI, opts v1.UpdateOptions) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
	result = &v1alpha1.AppsyncGraphqlAPI{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appsyncgraphqlapis").
...
func (c *appsyncGraphqlAPIs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *appsyncGraphqlAPIs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *appsyncGraphqlAPIs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppsyncGraphqlAPI, err error) {
	result = &v1alpha1.AppsyncGraphqlAPI{}
