...
type SagemakerEndpointConfigurationInterface interface {
	Create(*v1alpha1.SagemakerEndpointConfiguration) (*v1alpha1.SagemakerEndpointConfiguration, error)
	Update(*v1alpha1.SagemakerEndpointConfiguration) (*v1alpha1.SagemakerEndpointConfiguration, error)
	UpdateStatus(*v1alpha1.SagemakerEndpointConfiguration) (*v1alpha1.SagemakerEndpointConfiguration, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SagemakerEndpointConfiguration, error)
	List(opts v1.ListOptions) (*v1alpha1.SagemakerEndpointConfigurationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SagemakerEndpointConfiguration, err error)
...
func (c *sagemakerEndpointConfigurations) List(opts v1.ListOptions) (result *v1alpha1.SagemakerEndpointConfigurationList, err error) {
...
func (c *sagemakerEndpointConfigurations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sagemakerEndpointConfigurations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
