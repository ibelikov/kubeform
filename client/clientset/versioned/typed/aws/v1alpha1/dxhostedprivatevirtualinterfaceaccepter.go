...
type DxHostedPrivateVirtualInterfaceAccepterInterface interface {
	Create(*v1alpha1.DxHostedPrivateVirtualInterfaceAccepter) (*v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, error)
	Update(*v1alpha1.DxHostedPrivateVirtualInterfaceAccepter) (*v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, error)
	UpdateStatus(*v1alpha1.DxHostedPrivateVirtualInterfaceAccepter) (*v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, error)
	List(opts v1.ListOptions) (*v1alpha1.DxHostedPrivateVirtualInterfaceAccepterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DxHostedPrivateVirtualInterfaceAccepter, err error)
...
func (c *dxHostedPrivateVirtualInterfaceAccepters) List(opts v1.ListOptions) (result *v1alpha1.DxHostedPrivateVirtualInterfaceAccepterList, err error) {
...
func (c *dxHostedPrivateVirtualInterfaceAccepters) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dxHostedPrivateVirtualInterfaceAccepters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
