...
func newWafregionalXssMatchSets(c *AwsV1alpha1Client, namespace string) *wafregionalXssMatchSets {
...
func (c *wafregionalXssMatchSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafregionalXssMatchSet, err error) {
...
func (c *wafregionalXssMatchSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafregionalXssMatchSetList, err error) {
...
func (c *wafregionalXssMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafregionalXssMatchSets) Create(ctx context.Context, wafregionalXssMatchSet *v1alpha1.WafregionalXssMatchSet, opts v1.CreateOptions) (result *v1alpha1.WafregionalXssMatchSet, err error) {
	result = &v1alpha1.WafregionalXssMatchSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafregionalxssmatchsets").
...
func (c *wafregionalXssMatchSets) Update(ctx context.Context, wafregionalXssMatchSet *v1alpha1.WafregionalXssMatchSet, opts v1.UpdateOptions) (result *v1alpha1.WafregionalXssMatchSet, err error) {
	result = &v1alpha1.WafregionalXssMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalxssmatchsets").
...
func (c *wafregionalXssMatchSets) UpdateStatus(ctx context.Context, wafregionalXssMatchSet *v1alpha1.WafregionalXssMatchSet, opts v1.UpdateOptions) (result *v1alpha1.WafregionalXssMatchSet, err error) {
	result = &v1alpha1.WafregionalXssMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalxssmatchsets").
...
func (c *wafregionalXssMatchSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafregionalXssMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafregionalXssMatchSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafregionalXssMatchSet, err error) {
	result = &v1alpha1.WafregionalXssMatchSet{}
