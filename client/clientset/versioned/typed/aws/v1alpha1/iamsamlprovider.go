...
func newIamSamlProviders(c *AwsV1alpha1Client, namespace string) *iamSamlProviders {
...
func (c *iamSamlProviders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamSamlProvider, err error) {
...
func (c *iamSamlProviders) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamSamlProviderList, err error) {
...
func (c *iamSamlProviders) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamSamlProviders) Create(ctx context.Context, iamSamlProvider *v1alpha1.IamSamlProvider, opts v1.CreateOptions) (result *v1alpha1.IamSamlProvider, err error) {
	result = &v1alpha1.IamSamlProvider{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamsamlproviders").
...
func (c *iamSamlProviders) Update(ctx context.Context, iamSamlProvider *v1alpha1.IamSamlProvider, opts v1.UpdateOptions) (result *v1alpha1.IamSamlProvider, err error) {
	result = &v1alpha1.IamSamlProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamsamlproviders").
...
func (c *iamSamlProviders) UpdateStatus(ctx context.Context, iamSamlProvider *v1alpha1.IamSamlProvider, opts v1.UpdateOptions) (result *v1alpha1.IamSamlProvider, err error) {
	result = &v1alpha1.IamSamlProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamsamlproviders").
...
func (c *iamSamlProviders) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamSamlProviders) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamSamlProviders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamSamlProvider, err error) {
	result = &v1alpha1.IamSamlProvider{}
