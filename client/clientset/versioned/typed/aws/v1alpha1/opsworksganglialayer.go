...
type OpsworksGangliaLayerInterface interface {
	Create(*v1alpha1.OpsworksGangliaLayer) (*v1alpha1.OpsworksGangliaLayer, error)
	Update(*v1alpha1.OpsworksGangliaLayer) (*v1alpha1.OpsworksGangliaLayer, error)
	UpdateStatus(*v1alpha1.OpsworksGangliaLayer) (*v1alpha1.OpsworksGangliaLayer, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.OpsworksGangliaLayer, error)
	List(opts v1.ListOptions) (*v1alpha1.OpsworksGangliaLayerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OpsworksGangliaLayer, err error)
...
func (c *opsworksGangliaLayers) List(opts v1.ListOptions) (result *v1alpha1.OpsworksGangliaLayerList, err error) {
...
func (c *opsworksGangliaLayers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksGangliaLayers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
