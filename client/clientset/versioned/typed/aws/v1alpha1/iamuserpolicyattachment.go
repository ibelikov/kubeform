...
func (c *iamUserPolicyAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamUserPolicyAttachment, err error) {
...
func (c *iamUserPolicyAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamUserPolicyAttachmentList, err error) {
...
func (c *iamUserPolicyAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamUserPolicyAttachments) Create(ctx context.Context, iamUserPolicyAttachment *v1alpha1.IamUserPolicyAttachment, opts v1.CreateOptions) (result *v1alpha1.IamUserPolicyAttachment, err error) {
	result = &v1alpha1.IamUserPolicyAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamuserpolicyattachments").
...
func (c *iamUserPolicyAttachments) Update(ctx context.Context, iamUserPolicyAttachment *v1alpha1.IamUserPolicyAttachment, opts v1.UpdateOptions) (result *v1alpha1.IamUserPolicyAttachment, err error) {
	result = &v1alpha1.IamUserPolicyAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamuserpolicyattachments").
...
func (c *iamUserPolicyAttachments) UpdateStatus(ctx context.Context, iamUserPolicyAttachment *v1alpha1.IamUserPolicyAttachment, opts v1.UpdateOptions) (result *v1alpha1.IamUserPolicyAttachment, err error) {
	result = &v1alpha1.IamUserPolicyAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamuserpolicyattachments").
...
func (c *iamUserPolicyAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamUserPolicyAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamUserPolicyAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamUserPolicyAttachment, err error) {
	result = &v1alpha1.IamUserPolicyAttachment{}
