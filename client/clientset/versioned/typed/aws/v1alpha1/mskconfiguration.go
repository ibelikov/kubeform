...
func newMskConfigurations(c *AwsV1alpha1Client, namespace string) *mskConfigurations {
...
func (c *mskConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MskConfiguration, err error) {
...
func (c *mskConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MskConfigurationList, err error) {
...
func (c *mskConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mskConfigurations) Create(ctx context.Context, mskConfiguration *v1alpha1.MskConfiguration, opts v1.CreateOptions) (result *v1alpha1.MskConfiguration, err error) {
	result = &v1alpha1.MskConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mskconfigurations").
...
func (c *mskConfigurations) Update(ctx context.Context, mskConfiguration *v1alpha1.MskConfiguration, opts v1.UpdateOptions) (result *v1alpha1.MskConfiguration, err error) {
	result = &v1alpha1.MskConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mskconfigurations").
...
func (c *mskConfigurations) UpdateStatus(ctx context.Context, mskConfiguration *v1alpha1.MskConfiguration, opts v1.UpdateOptions) (result *v1alpha1.MskConfiguration, err error) {
	result = &v1alpha1.MskConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mskconfigurations").
...
func (c *mskConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mskConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mskConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MskConfiguration, err error) {
	result = &v1alpha1.MskConfiguration{}
