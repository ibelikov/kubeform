...
func (c *autoscalingNotifications) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoscalingNotification, err error) {
...
func (c *autoscalingNotifications) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoscalingNotificationList, err error) {
...
func (c *autoscalingNotifications) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *autoscalingNotifications) Create(ctx context.Context, autoscalingNotification *v1alpha1.AutoscalingNotification, opts v1.CreateOptions) (result *v1alpha1.AutoscalingNotification, err error) {
	result = &v1alpha1.AutoscalingNotification{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("autoscalingnotifications").
...
func (c *autoscalingNotifications) Update(ctx context.Context, autoscalingNotification *v1alpha1.AutoscalingNotification, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingNotification, err error) {
	result = &v1alpha1.AutoscalingNotification{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autoscalingnotifications").
...
func (c *autoscalingNotifications) UpdateStatus(ctx context.Context, autoscalingNotification *v1alpha1.AutoscalingNotification, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingNotification, err error) {
	result = &v1alpha1.AutoscalingNotification{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autoscalingnotifications").
...
func (c *autoscalingNotifications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *autoscalingNotifications) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *autoscalingNotifications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoscalingNotification, err error) {
	result = &v1alpha1.AutoscalingNotification{}
