...
func (c *launchConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LaunchConfiguration, err error) {
...
func (c *launchConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LaunchConfigurationList, err error) {
...
func (c *launchConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *launchConfigurations) Create(ctx context.Context, launchConfiguration *v1alpha1.LaunchConfiguration, opts v1.CreateOptions) (result *v1alpha1.LaunchConfiguration, err error) {
	result = &v1alpha1.LaunchConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("launchconfigurations").
...
func (c *launchConfigurations) Update(ctx context.Context, launchConfiguration *v1alpha1.LaunchConfiguration, opts v1.UpdateOptions) (result *v1alpha1.LaunchConfiguration, err error) {
	result = &v1alpha1.LaunchConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("launchconfigurations").
...
func (c *launchConfigurations) UpdateStatus(ctx context.Context, launchConfiguration *v1alpha1.LaunchConfiguration, opts v1.UpdateOptions) (result *v1alpha1.LaunchConfiguration, err error) {
	result = &v1alpha1.LaunchConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("launchconfigurations").
...
func (c *launchConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *launchConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *launchConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LaunchConfiguration, err error) {
	result = &v1alpha1.LaunchConfiguration{}
