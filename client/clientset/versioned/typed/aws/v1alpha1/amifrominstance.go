...
func (c *amiFromInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AmiFromInstance, err error) {
...
func (c *amiFromInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AmiFromInstanceList, err error) {
...
func (c *amiFromInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *amiFromInstances) Create(ctx context.Context, amiFromInstance *v1alpha1.AmiFromInstance, opts v1.CreateOptions) (result *v1alpha1.AmiFromInstance, err error) {
	result = &v1alpha1.AmiFromInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("amifrominstances").
...
func (c *amiFromInstances) Update(ctx context.Context, amiFromInstance *v1alpha1.AmiFromInstance, opts v1.UpdateOptions) (result *v1alpha1.AmiFromInstance, err error) {
	result = &v1alpha1.AmiFromInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("amifrominstances").
...
func (c *amiFromInstances) UpdateStatus(ctx context.Context, amiFromInstance *v1alpha1.AmiFromInstance, opts v1.UpdateOptions) (result *v1alpha1.AmiFromInstance, err error) {
	result = &v1alpha1.AmiFromInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("amifrominstances").
...
func (c *amiFromInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *amiFromInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *amiFromInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AmiFromInstance, err error) {
	result = &v1alpha1.AmiFromInstance{}
