...
type RedshiftClusterInterface interface {
	Create(*v1alpha1.RedshiftCluster) (*v1alpha1.RedshiftCluster, error)
	Update(*v1alpha1.RedshiftCluster) (*v1alpha1.RedshiftCluster, error)
	UpdateStatus(*v1alpha1.RedshiftCluster) (*v1alpha1.RedshiftCluster, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.RedshiftCluster, error)
	List(opts v1.ListOptions) (*v1alpha1.RedshiftClusterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.RedshiftCluster, err error)
...
func (c *redshiftClusters) List(opts v1.ListOptions) (result *v1alpha1.RedshiftClusterList, err error) {
...
func (c *redshiftClusters) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *redshiftClusters) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
