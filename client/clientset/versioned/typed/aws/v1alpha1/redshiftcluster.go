...
func (c *redshiftClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RedshiftCluster, err error) {
...
func (c *redshiftClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RedshiftClusterList, err error) {
...
func (c *redshiftClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *redshiftClusters) Create(ctx context.Context, redshiftCluster *v1alpha1.RedshiftCluster, opts v1.CreateOptions) (result *v1alpha1.RedshiftCluster, err error) {
	result = &v1alpha1.RedshiftCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("redshiftclusters").
...
func (c *redshiftClusters) Update(ctx context.Context, redshiftCluster *v1alpha1.RedshiftCluster, opts v1.UpdateOptions) (result *v1alpha1.RedshiftCluster, err error) {
	result = &v1alpha1.RedshiftCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redshiftclusters").
...
func (c *redshiftClusters) UpdateStatus(ctx context.Context, redshiftCluster *v1alpha1.RedshiftCluster, opts v1.UpdateOptions) (result *v1alpha1.RedshiftCluster, err error) {
	result = &v1alpha1.RedshiftCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redshiftclusters").
...
func (c *redshiftClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *redshiftClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *redshiftClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RedshiftCluster, err error) {
	result = &v1alpha1.RedshiftCluster{}
