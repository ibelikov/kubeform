...
func (c *lbSSLNegotiationPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LbSSLNegotiationPolicy, err error) {
...
func (c *lbSSLNegotiationPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LbSSLNegotiationPolicyList, err error) {
...
func (c *lbSSLNegotiationPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lbSSLNegotiationPolicies) Create(ctx context.Context, lbSSLNegotiationPolicy *v1alpha1.LbSSLNegotiationPolicy, opts v1.CreateOptions) (result *v1alpha1.LbSSLNegotiationPolicy, err error) {
	result = &v1alpha1.LbSSLNegotiationPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lbsslnegotiationpolicies").
...
func (c *lbSSLNegotiationPolicies) Update(ctx context.Context, lbSSLNegotiationPolicy *v1alpha1.LbSSLNegotiationPolicy, opts v1.UpdateOptions) (result *v1alpha1.LbSSLNegotiationPolicy, err error) {
	result = &v1alpha1.LbSSLNegotiationPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lbsslnegotiationpolicies").
...
func (c *lbSSLNegotiationPolicies) UpdateStatus(ctx context.Context, lbSSLNegotiationPolicy *v1alpha1.LbSSLNegotiationPolicy, opts v1.UpdateOptions) (result *v1alpha1.LbSSLNegotiationPolicy, err error) {
	result = &v1alpha1.LbSSLNegotiationPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lbsslnegotiationpolicies").
...
func (c *lbSSLNegotiationPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lbSSLNegotiationPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lbSSLNegotiationPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LbSSLNegotiationPolicy, err error) {
	result = &v1alpha1.LbSSLNegotiationPolicy{}
