...
func (c *spotInstanceRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpotInstanceRequest, err error) {
...
func (c *spotInstanceRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpotInstanceRequestList, err error) {
...
func (c *spotInstanceRequests) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *spotInstanceRequests) Create(ctx context.Context, spotInstanceRequest *v1alpha1.SpotInstanceRequest, opts v1.CreateOptions) (result *v1alpha1.SpotInstanceRequest, err error) {
	result = &v1alpha1.SpotInstanceRequest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spotinstancerequests").
...
func (c *spotInstanceRequests) Update(ctx context.Context, spotInstanceRequest *v1alpha1.SpotInstanceRequest, opts v1.UpdateOptions) (result *v1alpha1.SpotInstanceRequest, err error) {
	result = &v1alpha1.SpotInstanceRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spotinstancerequests").
...
func (c *spotInstanceRequests) UpdateStatus(ctx context.Context, spotInstanceRequest *v1alpha1.SpotInstanceRequest, opts v1.UpdateOptions) (result *v1alpha1.SpotInstanceRequest, err error) {
	result = &v1alpha1.SpotInstanceRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spotinstancerequests").
...
func (c *spotInstanceRequests) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *spotInstanceRequests) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *spotInstanceRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SpotInstanceRequest, err error) {
	result = &v1alpha1.SpotInstanceRequest{}
