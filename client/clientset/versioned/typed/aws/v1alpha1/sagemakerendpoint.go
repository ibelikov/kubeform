...
type SagemakerEndpointInterface interface {
	Create(*v1alpha1.SagemakerEndpoint) (*v1alpha1.SagemakerEndpoint, error)
	Update(*v1alpha1.SagemakerEndpoint) (*v1alpha1.SagemakerEndpoint, error)
	UpdateStatus(*v1alpha1.SagemakerEndpoint) (*v1alpha1.SagemakerEndpoint, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SagemakerEndpoint, error)
	List(opts v1.ListOptions) (*v1alpha1.SagemakerEndpointList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SagemakerEndpoint, err error)
...
func (c *sagemakerEndpoints) List(opts v1.ListOptions) (result *v1alpha1.SagemakerEndpointList, err error) {
...
func (c *sagemakerEndpoints) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sagemakerEndpoints) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
