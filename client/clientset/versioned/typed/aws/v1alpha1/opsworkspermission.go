...
func (c *opsworksPermissions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksPermission, err error) {
...
func (c *opsworksPermissions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksPermissionList, err error) {
...
func (c *opsworksPermissions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksPermissions) Create(ctx context.Context, opsworksPermission *v1alpha1.OpsworksPermission, opts v1.CreateOptions) (result *v1alpha1.OpsworksPermission, err error) {
	result = &v1alpha1.OpsworksPermission{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("opsworkspermissions").
...
func (c *opsworksPermissions) Update(ctx context.Context, opsworksPermission *v1alpha1.OpsworksPermission, opts v1.UpdateOptions) (result *v1alpha1.OpsworksPermission, err error) {
	result = &v1alpha1.OpsworksPermission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworkspermissions").
...
func (c *opsworksPermissions) UpdateStatus(ctx context.Context, opsworksPermission *v1alpha1.OpsworksPermission, opts v1.UpdateOptions) (result *v1alpha1.OpsworksPermission, err error) {
	result = &v1alpha1.OpsworksPermission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworkspermissions").
...
func (c *opsworksPermissions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *opsworksPermissions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *opsworksPermissions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksPermission, err error) {
	result = &v1alpha1.OpsworksPermission{}
