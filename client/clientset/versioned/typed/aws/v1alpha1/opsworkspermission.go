...
type OpsworksPermissionInterface interface {
	Create(*v1alpha1.OpsworksPermission) (*v1alpha1.OpsworksPermission, error)
	Update(*v1alpha1.OpsworksPermission) (*v1alpha1.OpsworksPermission, error)
	UpdateStatus(*v1alpha1.OpsworksPermission) (*v1alpha1.OpsworksPermission, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.OpsworksPermission, error)
	List(opts v1.ListOptions) (*v1alpha1.OpsworksPermissionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.OpsworksPermission, err error)
...
func (c *opsworksPermissions) List(opts v1.ListOptions) (result *v1alpha1.OpsworksPermissionList, err error) {
...
func (c *opsworksPermissions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksPermissions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
