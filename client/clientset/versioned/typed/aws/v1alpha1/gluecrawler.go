...
func (c *glueCrawlers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlueCrawler, err error) {
...
func (c *glueCrawlers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlueCrawlerList, err error) {
...
func (c *glueCrawlers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *glueCrawlers) Create(ctx context.Context, glueCrawler *v1alpha1.GlueCrawler, opts v1.CreateOptions) (result *v1alpha1.GlueCrawler, err error) {
	result = &v1alpha1.GlueCrawler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gluecrawlers").
...
func (c *glueCrawlers) Update(ctx context.Context, glueCrawler *v1alpha1.GlueCrawler, opts v1.UpdateOptions) (result *v1alpha1.GlueCrawler, err error) {
	result = &v1alpha1.GlueCrawler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gluecrawlers").
...
func (c *glueCrawlers) UpdateStatus(ctx context.Context, glueCrawler *v1alpha1.GlueCrawler, opts v1.UpdateOptions) (result *v1alpha1.GlueCrawler, err error) {
	result = &v1alpha1.GlueCrawler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gluecrawlers").
...
func (c *glueCrawlers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *glueCrawlers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *glueCrawlers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlueCrawler, err error) {
	result = &v1alpha1.GlueCrawler{}
