...
func (c *wafSizeConstraintSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafSizeConstraintSet, err error) {
...
func (c *wafSizeConstraintSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafSizeConstraintSetList, err error) {
...
func (c *wafSizeConstraintSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafSizeConstraintSets) Create(ctx context.Context, wafSizeConstraintSet *v1alpha1.WafSizeConstraintSet, opts v1.CreateOptions) (result *v1alpha1.WafSizeConstraintSet, err error) {
	result = &v1alpha1.WafSizeConstraintSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafsizeconstraintsets").
...
func (c *wafSizeConstraintSets) Update(ctx context.Context, wafSizeConstraintSet *v1alpha1.WafSizeConstraintSet, opts v1.UpdateOptions) (result *v1alpha1.WafSizeConstraintSet, err error) {
	result = &v1alpha1.WafSizeConstraintSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafsizeconstraintsets").
...
func (c *wafSizeConstraintSets) UpdateStatus(ctx context.Context, wafSizeConstraintSet *v1alpha1.WafSizeConstraintSet, opts v1.UpdateOptions) (result *v1alpha1.WafSizeConstraintSet, err error) {
	result = &v1alpha1.WafSizeConstraintSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafsizeconstraintsets").
...
func (c *wafSizeConstraintSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafSizeConstraintSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafSizeConstraintSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafSizeConstraintSet, err error) {
	result = &v1alpha1.WafSizeConstraintSet{}
