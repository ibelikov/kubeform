...
func (c *glueClassifiers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlueClassifier, err error) {
...
func (c *glueClassifiers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlueClassifierList, err error) {
...
func (c *glueClassifiers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *glueClassifiers) Create(ctx context.Context, glueClassifier *v1alpha1.GlueClassifier, opts v1.CreateOptions) (result *v1alpha1.GlueClassifier, err error) {
	result = &v1alpha1.GlueClassifier{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("glueclassifiers").
...
func (c *glueClassifiers) Update(ctx context.Context, glueClassifier *v1alpha1.GlueClassifier, opts v1.UpdateOptions) (result *v1alpha1.GlueClassifier, err error) {
	result = &v1alpha1.GlueClassifier{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("glueclassifiers").
...
func (c *glueClassifiers) UpdateStatus(ctx context.Context, glueClassifier *v1alpha1.GlueClassifier, opts v1.UpdateOptions) (result *v1alpha1.GlueClassifier, err error) {
	result = &v1alpha1.GlueClassifier{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("glueclassifiers").
...
func (c *glueClassifiers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *glueClassifiers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *glueClassifiers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlueClassifier, err error) {
	result = &v1alpha1.GlueClassifier{}
