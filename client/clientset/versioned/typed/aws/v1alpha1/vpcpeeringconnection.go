...
func (c *vpcPeeringConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpcPeeringConnection, err error) {
...
func (c *vpcPeeringConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpcPeeringConnectionList, err error) {
...
func (c *vpcPeeringConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vpcPeeringConnections) Create(ctx context.Context, vpcPeeringConnection *v1alpha1.VpcPeeringConnection, opts v1.CreateOptions) (result *v1alpha1.VpcPeeringConnection, err error) {
	result = &v1alpha1.VpcPeeringConnection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpcpeeringconnections").
...
func (c *vpcPeeringConnections) Update(ctx context.Context, vpcPeeringConnection *v1alpha1.VpcPeeringConnection, opts v1.UpdateOptions) (result *v1alpha1.VpcPeeringConnection, err error) {
	result = &v1alpha1.VpcPeeringConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcpeeringconnections").
...
func (c *vpcPeeringConnections) UpdateStatus(ctx context.Context, vpcPeeringConnection *v1alpha1.VpcPeeringConnection, opts v1.UpdateOptions) (result *v1alpha1.VpcPeeringConnection, err error) {
	result = &v1alpha1.VpcPeeringConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcpeeringconnections").
...
func (c *vpcPeeringConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vpcPeeringConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vpcPeeringConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpcPeeringConnection, err error) {
	result = &v1alpha1.VpcPeeringConnection{}
