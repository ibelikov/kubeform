...
func (c *opsworksStacks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksStack, err error) {
...
func (c *opsworksStacks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksStackList, err error) {
...
func (c *opsworksStacks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksStacks) Create(ctx context.Context, opsworksStack *v1alpha1.OpsworksStack, opts v1.CreateOptions) (result *v1alpha1.OpsworksStack, err error) {
	result = &v1alpha1.OpsworksStack{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("opsworksstacks").
...
func (c *opsworksStacks) Update(ctx context.Context, opsworksStack *v1alpha1.OpsworksStack, opts v1.UpdateOptions) (result *v1alpha1.OpsworksStack, err error) {
	result = &v1alpha1.OpsworksStack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworksstacks").
...
func (c *opsworksStacks) UpdateStatus(ctx context.Context, opsworksStack *v1alpha1.OpsworksStack, opts v1.UpdateOptions) (result *v1alpha1.OpsworksStack, err error) {
	result = &v1alpha1.OpsworksStack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworksstacks").
...
func (c *opsworksStacks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *opsworksStacks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *opsworksStacks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksStack, err error) {
	result = &v1alpha1.OpsworksStack{}
