...
func (c *elasticacheSecurityGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ElasticacheSecurityGroup, err error) {
...
func (c *elasticacheSecurityGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElasticacheSecurityGroupList, err error) {
...
func (c *elasticacheSecurityGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *elasticacheSecurityGroups) Create(ctx context.Context, elasticacheSecurityGroup *v1alpha1.ElasticacheSecurityGroup, opts v1.CreateOptions) (result *v1alpha1.ElasticacheSecurityGroup, err error) {
	result = &v1alpha1.ElasticacheSecurityGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("elasticachesecuritygroups").
...
func (c *elasticacheSecurityGroups) Update(ctx context.Context, elasticacheSecurityGroup *v1alpha1.ElasticacheSecurityGroup, opts v1.UpdateOptions) (result *v1alpha1.ElasticacheSecurityGroup, err error) {
	result = &v1alpha1.ElasticacheSecurityGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticachesecuritygroups").
...
func (c *elasticacheSecurityGroups) UpdateStatus(ctx context.Context, elasticacheSecurityGroup *v1alpha1.ElasticacheSecurityGroup, opts v1.UpdateOptions) (result *v1alpha1.ElasticacheSecurityGroup, err error) {
	result = &v1alpha1.ElasticacheSecurityGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticachesecuritygroups").
...
func (c *elasticacheSecurityGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *elasticacheSecurityGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *elasticacheSecurityGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ElasticacheSecurityGroup, err error) {
	result = &v1alpha1.ElasticacheSecurityGroup{}
