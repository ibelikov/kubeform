...
func (c *dxConnectionAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DxConnectionAssociation, err error) {
...
func (c *dxConnectionAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DxConnectionAssociationList, err error) {
...
func (c *dxConnectionAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dxConnectionAssociations) Create(ctx context.Context, dxConnectionAssociation *v1alpha1.DxConnectionAssociation, opts v1.CreateOptions) (result *v1alpha1.DxConnectionAssociation, err error) {
	result = &v1alpha1.DxConnectionAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dxconnectionassociations").
...
func (c *dxConnectionAssociations) Update(ctx context.Context, dxConnectionAssociation *v1alpha1.DxConnectionAssociation, opts v1.UpdateOptions) (result *v1alpha1.DxConnectionAssociation, err error) {
	result = &v1alpha1.DxConnectionAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dxconnectionassociations").
...
func (c *dxConnectionAssociations) UpdateStatus(ctx context.Context, dxConnectionAssociation *v1alpha1.DxConnectionAssociation, opts v1.UpdateOptions) (result *v1alpha1.DxConnectionAssociation, err error) {
	result = &v1alpha1.DxConnectionAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dxconnectionassociations").
...
func (c *dxConnectionAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dxConnectionAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dxConnectionAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DxConnectionAssociation, err error) {
	result = &v1alpha1.DxConnectionAssociation{}
