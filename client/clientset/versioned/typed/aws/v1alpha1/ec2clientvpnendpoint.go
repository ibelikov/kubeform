...
func (c *ec2ClientVPNEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ec2ClientVPNEndpoint, err error) {
...
func (c *ec2ClientVPNEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.Ec2ClientVPNEndpointList, err error) {
...
func (c *ec2ClientVPNEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ec2ClientVPNEndpoints) Create(ctx context.Context, ec2ClientVPNEndpoint *v1alpha1.Ec2ClientVPNEndpoint, opts v1.CreateOptions) (result *v1alpha1.Ec2ClientVPNEndpoint, err error) {
	result = &v1alpha1.Ec2ClientVPNEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ec2clientvpnendpoints").
...
func (c *ec2ClientVPNEndpoints) Update(ctx context.Context, ec2ClientVPNEndpoint *v1alpha1.Ec2ClientVPNEndpoint, opts v1.UpdateOptions) (result *v1alpha1.Ec2ClientVPNEndpoint, err error) {
	result = &v1alpha1.Ec2ClientVPNEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ec2clientvpnendpoints").
...
func (c *ec2ClientVPNEndpoints) UpdateStatus(ctx context.Context, ec2ClientVPNEndpoint *v1alpha1.Ec2ClientVPNEndpoint, opts v1.UpdateOptions) (result *v1alpha1.Ec2ClientVPNEndpoint, err error) {
	result = &v1alpha1.Ec2ClientVPNEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ec2clientvpnendpoints").
...
func (c *ec2ClientVPNEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ec2ClientVPNEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ec2ClientVPNEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ec2ClientVPNEndpoint, err error) {
	result = &v1alpha1.Ec2ClientVPNEndpoint{}
