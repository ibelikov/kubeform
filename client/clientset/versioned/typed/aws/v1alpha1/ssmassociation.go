...
func (c *ssmAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SsmAssociation, err error) {
...
func (c *ssmAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SsmAssociationList, err error) {
...
func (c *ssmAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssmAssociations) Create(ctx context.Context, ssmAssociation *v1alpha1.SsmAssociation, opts v1.CreateOptions) (result *v1alpha1.SsmAssociation, err error) {
	result = &v1alpha1.SsmAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ssmassociations").
...
func (c *ssmAssociations) Update(ctx context.Context, ssmAssociation *v1alpha1.SsmAssociation, opts v1.UpdateOptions) (result *v1alpha1.SsmAssociation, err error) {
	result = &v1alpha1.SsmAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmassociations").
...
func (c *ssmAssociations) UpdateStatus(ctx context.Context, ssmAssociation *v1alpha1.SsmAssociation, opts v1.UpdateOptions) (result *v1alpha1.SsmAssociation, err error) {
	result = &v1alpha1.SsmAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmassociations").
...
func (c *ssmAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ssmAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ssmAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SsmAssociation, err error) {
	result = &v1alpha1.SsmAssociation{}
