...
func (c *backupVaults) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BackupVault, err error) {
...
func (c *backupVaults) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BackupVaultList, err error) {
...
func (c *backupVaults) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *backupVaults) Create(ctx context.Context, backupVault *v1alpha1.BackupVault, opts v1.CreateOptions) (result *v1alpha1.BackupVault, err error) {
	result = &v1alpha1.BackupVault{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backupvaults").
...
func (c *backupVaults) Update(ctx context.Context, backupVault *v1alpha1.BackupVault, opts v1.UpdateOptions) (result *v1alpha1.BackupVault, err error) {
	result = &v1alpha1.BackupVault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backupvaults").
...
func (c *backupVaults) UpdateStatus(ctx context.Context, backupVault *v1alpha1.BackupVault, opts v1.UpdateOptions) (result *v1alpha1.BackupVault, err error) {
	result = &v1alpha1.BackupVault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backupvaults").
...
func (c *backupVaults) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *backupVaults) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *backupVaults) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BackupVault, err error) {
	result = &v1alpha1.BackupVault{}
