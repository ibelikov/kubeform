...
func (c *apiGatewayAuthorizers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayAuthorizer, err error) {
...
func (c *apiGatewayAuthorizers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayAuthorizerList, err error) {
...
func (c *apiGatewayAuthorizers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiGatewayAuthorizers) Create(ctx context.Context, apiGatewayAuthorizer *v1alpha1.ApiGatewayAuthorizer, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayAuthorizer, err error) {
	result = &v1alpha1.ApiGatewayAuthorizer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigatewayauthorizers").
...
func (c *apiGatewayAuthorizers) Update(ctx context.Context, apiGatewayAuthorizer *v1alpha1.ApiGatewayAuthorizer, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayAuthorizer, err error) {
	result = &v1alpha1.ApiGatewayAuthorizer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewayauthorizers").
...
func (c *apiGatewayAuthorizers) UpdateStatus(ctx context.Context, apiGatewayAuthorizer *v1alpha1.ApiGatewayAuthorizer, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayAuthorizer, err error) {
	result = &v1alpha1.ApiGatewayAuthorizer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewayauthorizers").
...
func (c *apiGatewayAuthorizers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiGatewayAuthorizers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiGatewayAuthorizers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayAuthorizer, err error) {
	result = &v1alpha1.ApiGatewayAuthorizer{}
