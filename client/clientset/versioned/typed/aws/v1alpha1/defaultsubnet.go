...
func (c *defaultSubnets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DefaultSubnet, err error) {
...
func (c *defaultSubnets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DefaultSubnetList, err error) {
...
func (c *defaultSubnets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *defaultSubnets) Create(ctx context.Context, defaultSubnet *v1alpha1.DefaultSubnet, opts v1.CreateOptions) (result *v1alpha1.DefaultSubnet, err error) {
	result = &v1alpha1.DefaultSubnet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("defaultsubnets").
...
func (c *defaultSubnets) Update(ctx context.Context, defaultSubnet *v1alpha1.DefaultSubnet, opts v1.UpdateOptions) (result *v1alpha1.DefaultSubnet, err error) {
	result = &v1alpha1.DefaultSubnet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("defaultsubnets").
...
func (c *defaultSubnets) UpdateStatus(ctx context.Context, defaultSubnet *v1alpha1.DefaultSubnet, opts v1.UpdateOptions) (result *v1alpha1.DefaultSubnet, err error) {
	result = &v1alpha1.DefaultSubnet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("defaultsubnets").
...
func (c *defaultSubnets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *defaultSubnets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *defaultSubnets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DefaultSubnet, err error) {
	result = &v1alpha1.DefaultSubnet{}
