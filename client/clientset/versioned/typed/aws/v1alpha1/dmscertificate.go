...
func (c *dmsCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DmsCertificate, err error) {
...
func (c *dmsCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DmsCertificateList, err error) {
...
func (c *dmsCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dmsCertificates) Create(ctx context.Context, dmsCertificate *v1alpha1.DmsCertificate, opts v1.CreateOptions) (result *v1alpha1.DmsCertificate, err error) {
	result = &v1alpha1.DmsCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dmscertificates").
...
func (c *dmsCertificates) Update(ctx context.Context, dmsCertificate *v1alpha1.DmsCertificate, opts v1.UpdateOptions) (result *v1alpha1.DmsCertificate, err error) {
	result = &v1alpha1.DmsCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dmscertificates").
...
func (c *dmsCertificates) UpdateStatus(ctx context.Context, dmsCertificate *v1alpha1.DmsCertificate, opts v1.UpdateOptions) (result *v1alpha1.DmsCertificate, err error) {
	result = &v1alpha1.DmsCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dmscertificates").
...
func (c *dmsCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dmsCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dmsCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DmsCertificate, err error) {
	result = &v1alpha1.DmsCertificate{}
