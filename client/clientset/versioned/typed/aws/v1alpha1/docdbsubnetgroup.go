...
func (c *docdbSubnetGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DocdbSubnetGroup, err error) {
...
func (c *docdbSubnetGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DocdbSubnetGroupList, err error) {
...
func (c *docdbSubnetGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *docdbSubnetGroups) Create(ctx context.Context, docdbSubnetGroup *v1alpha1.DocdbSubnetGroup, opts v1.CreateOptions) (result *v1alpha1.DocdbSubnetGroup, err error) {
	result = &v1alpha1.DocdbSubnetGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("docdbsubnetgroups").
...
func (c *docdbSubnetGroups) Update(ctx context.Context, docdbSubnetGroup *v1alpha1.DocdbSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.DocdbSubnetGroup, err error) {
	result = &v1alpha1.DocdbSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("docdbsubnetgroups").
...
func (c *docdbSubnetGroups) UpdateStatus(ctx context.Context, docdbSubnetGroup *v1alpha1.DocdbSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.DocdbSubnetGroup, err error) {
	result = &v1alpha1.DocdbSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("docdbsubnetgroups").
...
func (c *docdbSubnetGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *docdbSubnetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *docdbSubnetGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DocdbSubnetGroup, err error) {
	result = &v1alpha1.DocdbSubnetGroup{}
