...
func newIotRoleAliases(c *AwsV1alpha1Client, namespace string) *iotRoleAliases {
...
func (c *iotRoleAliases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IotRoleAlias, err error) {
...
func (c *iotRoleAliases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IotRoleAliasList, err error) {
...
func (c *iotRoleAliases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iotRoleAliases) Create(ctx context.Context, iotRoleAlias *v1alpha1.IotRoleAlias, opts v1.CreateOptions) (result *v1alpha1.IotRoleAlias, err error) {
	result = &v1alpha1.IotRoleAlias{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iotrolealiases").
...
func (c *iotRoleAliases) Update(ctx context.Context, iotRoleAlias *v1alpha1.IotRoleAlias, opts v1.UpdateOptions) (result *v1alpha1.IotRoleAlias, err error) {
	result = &v1alpha1.IotRoleAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iotrolealiases").
...
func (c *iotRoleAliases) UpdateStatus(ctx context.Context, iotRoleAlias *v1alpha1.IotRoleAlias, opts v1.UpdateOptions) (result *v1alpha1.IotRoleAlias, err error) {
	result = &v1alpha1.IotRoleAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iotrolealiases").
...
func (c *iotRoleAliases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iotRoleAliases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iotRoleAliases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IotRoleAlias, err error) {
	result = &v1alpha1.IotRoleAlias{}
