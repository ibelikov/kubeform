...
type CodedeployDeploymentGroupInterface interface {
	Create(*v1alpha1.CodedeployDeploymentGroup) (*v1alpha1.CodedeployDeploymentGroup, error)
	Update(*v1alpha1.CodedeployDeploymentGroup) (*v1alpha1.CodedeployDeploymentGroup, error)
	UpdateStatus(*v1alpha1.CodedeployDeploymentGroup) (*v1alpha1.CodedeployDeploymentGroup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.CodedeployDeploymentGroup, error)
	List(opts v1.ListOptions) (*v1alpha1.CodedeployDeploymentGroupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CodedeployDeploymentGroup, err error)
...
func (c *codedeployDeploymentGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
...
func (c *codedeployDeploymentGroups) List(opts v1.ListOptions) (result *v1alpha1.CodedeployDeploymentGroupList, err error) {
...
func (c *codedeployDeploymentGroups) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *codedeployDeploymentGroups) Create(codedeployDeploymentGroup *v1alpha1.CodedeployDeploymentGroup) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
	result = &v1alpha1.CodedeployDeploymentGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("codedeploydeploymentgroups").
...
func (c *codedeployDeploymentGroups) Update(codedeployDeploymentGroup *v1alpha1.CodedeployDeploymentGroup) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
	result = &v1alpha1.CodedeployDeploymentGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("codedeploydeploymentgroups").
...
func (c *codedeployDeploymentGroups) UpdateStatus(codedeployDeploymentGroup *v1alpha1.CodedeployDeploymentGroup) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
	result = &v1alpha1.CodedeployDeploymentGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("codedeploydeploymentgroups").
...
func (c *codedeployDeploymentGroups) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *codedeployDeploymentGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *codedeployDeploymentGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CodedeployDeploymentGroup, err error) {
	result = &v1alpha1.CodedeployDeploymentGroup{}
