...
func (c *opsworksMemcachedLayers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
...
func (c *opsworksMemcachedLayers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpsworksMemcachedLayerList, err error) {
...
func (c *opsworksMemcachedLayers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *opsworksMemcachedLayers) Create(ctx context.Context, opsworksMemcachedLayer *v1alpha1.OpsworksMemcachedLayer, opts v1.CreateOptions) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
	result = &v1alpha1.OpsworksMemcachedLayer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("opsworksmemcachedlayers").
...
func (c *opsworksMemcachedLayers) Update(ctx context.Context, opsworksMemcachedLayer *v1alpha1.OpsworksMemcachedLayer, opts v1.UpdateOptions) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
	result = &v1alpha1.OpsworksMemcachedLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworksmemcachedlayers").
...
func (c *opsworksMemcachedLayers) UpdateStatus(ctx context.Context, opsworksMemcachedLayer *v1alpha1.OpsworksMemcachedLayer, opts v1.UpdateOptions) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
	result = &v1alpha1.OpsworksMemcachedLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("opsworksmemcachedlayers").
...
func (c *opsworksMemcachedLayers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *opsworksMemcachedLayers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *opsworksMemcachedLayers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpsworksMemcachedLayer, err error) {
	result = &v1alpha1.OpsworksMemcachedLayer{}
