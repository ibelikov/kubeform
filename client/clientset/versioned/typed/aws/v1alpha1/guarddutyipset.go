...
func (c *guarddutyIpsets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GuarddutyIpset, err error) {
...
func (c *guarddutyIpsets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GuarddutyIpsetList, err error) {
...
func (c *guarddutyIpsets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *guarddutyIpsets) Create(ctx context.Context, guarddutyIpset *v1alpha1.GuarddutyIpset, opts v1.CreateOptions) (result *v1alpha1.GuarddutyIpset, err error) {
	result = &v1alpha1.GuarddutyIpset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("guarddutyipsets").
...
func (c *guarddutyIpsets) Update(ctx context.Context, guarddutyIpset *v1alpha1.GuarddutyIpset, opts v1.UpdateOptions) (result *v1alpha1.GuarddutyIpset, err error) {
	result = &v1alpha1.GuarddutyIpset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("guarddutyipsets").
...
func (c *guarddutyIpsets) UpdateStatus(ctx context.Context, guarddutyIpset *v1alpha1.GuarddutyIpset, opts v1.UpdateOptions) (result *v1alpha1.GuarddutyIpset, err error) {
	result = &v1alpha1.GuarddutyIpset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("guarddutyipsets").
...
func (c *guarddutyIpsets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *guarddutyIpsets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *guarddutyIpsets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GuarddutyIpset, err error) {
	result = &v1alpha1.GuarddutyIpset{}
