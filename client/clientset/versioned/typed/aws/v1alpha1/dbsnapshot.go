...
type DbSnapshotInterface interface {
	Create(*v1alpha1.DbSnapshot) (*v1alpha1.DbSnapshot, error)
	Update(*v1alpha1.DbSnapshot) (*v1alpha1.DbSnapshot, error)
	UpdateStatus(*v1alpha1.DbSnapshot) (*v1alpha1.DbSnapshot, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DbSnapshot, error)
	List(opts v1.ListOptions) (*v1alpha1.DbSnapshotList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DbSnapshot, err error)
	DbSnapshotExpansion
}
...
func (c *dbSnapshots) List(opts v1.ListOptions) (result *v1alpha1.DbSnapshotList, err error) {
...
func (c *dbSnapshots) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dbSnapshots) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
