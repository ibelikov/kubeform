...
func (c *dbSnapshots) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DbSnapshot, err error) {
...
func (c *dbSnapshots) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DbSnapshotList, err error) {
...
func (c *dbSnapshots) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dbSnapshots) Create(ctx context.Context, dbSnapshot *v1alpha1.DbSnapshot, opts v1.CreateOptions) (result *v1alpha1.DbSnapshot, err error) {
	result = &v1alpha1.DbSnapshot{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dbsnapshots").
...
func (c *dbSnapshots) Update(ctx context.Context, dbSnapshot *v1alpha1.DbSnapshot, opts v1.UpdateOptions) (result *v1alpha1.DbSnapshot, err error) {
	result = &v1alpha1.DbSnapshot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbsnapshots").
...
func (c *dbSnapshots) UpdateStatus(ctx context.Context, dbSnapshot *v1alpha1.DbSnapshot, opts v1.UpdateOptions) (result *v1alpha1.DbSnapshot, err error) {
	result = &v1alpha1.DbSnapshot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbsnapshots").
...
func (c *dbSnapshots) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dbSnapshots) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dbSnapshots) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DbSnapshot, err error) {
	result = &v1alpha1.DbSnapshot{}
