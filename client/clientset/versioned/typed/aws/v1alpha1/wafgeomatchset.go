...
type WafGeoMatchSetInterface interface {
	Create(*v1alpha1.WafGeoMatchSet) (*v1alpha1.WafGeoMatchSet, error)
	Update(*v1alpha1.WafGeoMatchSet) (*v1alpha1.WafGeoMatchSet, error)
	UpdateStatus(*v1alpha1.WafGeoMatchSet) (*v1alpha1.WafGeoMatchSet, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.WafGeoMatchSet, error)
	List(opts v1.ListOptions) (*v1alpha1.WafGeoMatchSetList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.WafGeoMatchSet, err error)
...
func (c *wafGeoMatchSets) List(opts v1.ListOptions) (result *v1alpha1.WafGeoMatchSetList, err error) {
...
func (c *wafGeoMatchSets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafGeoMatchSets) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
