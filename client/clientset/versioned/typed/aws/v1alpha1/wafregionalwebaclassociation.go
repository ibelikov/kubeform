...
func (c *wafregionalWebACLAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafregionalWebACLAssociation, err error) {
...
func (c *wafregionalWebACLAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafregionalWebACLAssociationList, err error) {
...
func (c *wafregionalWebACLAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafregionalWebACLAssociations) Create(ctx context.Context, wafregionalWebACLAssociation *v1alpha1.WafregionalWebACLAssociation, opts v1.CreateOptions) (result *v1alpha1.WafregionalWebACLAssociation, err error) {
	result = &v1alpha1.WafregionalWebACLAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafregionalwebaclassociations").
...
func (c *wafregionalWebACLAssociations) Update(ctx context.Context, wafregionalWebACLAssociation *v1alpha1.WafregionalWebACLAssociation, opts v1.UpdateOptions) (result *v1alpha1.WafregionalWebACLAssociation, err error) {
	result = &v1alpha1.WafregionalWebACLAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalwebaclassociations").
...
func (c *wafregionalWebACLAssociations) UpdateStatus(ctx context.Context, wafregionalWebACLAssociation *v1alpha1.WafregionalWebACLAssociation, opts v1.UpdateOptions) (result *v1alpha1.WafregionalWebACLAssociation, err error) {
	result = &v1alpha1.WafregionalWebACLAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregionalwebaclassociations").
...
func (c *wafregionalWebACLAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafregionalWebACLAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafregionalWebACLAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafregionalWebACLAssociation, err error) {
	result = &v1alpha1.WafregionalWebACLAssociation{}
