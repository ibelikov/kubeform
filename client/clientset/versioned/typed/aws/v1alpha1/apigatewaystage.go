...
func (c *apiGatewayStages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayStage, err error) {
...
func (c *apiGatewayStages) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayStageList, err error) {
...
func (c *apiGatewayStages) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiGatewayStages) Create(ctx context.Context, apiGatewayStage *v1alpha1.ApiGatewayStage, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayStage, err error) {
	result = &v1alpha1.ApiGatewayStage{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigatewaystages").
...
func (c *apiGatewayStages) Update(ctx context.Context, apiGatewayStage *v1alpha1.ApiGatewayStage, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayStage, err error) {
	result = &v1alpha1.ApiGatewayStage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewaystages").
...
func (c *apiGatewayStages) UpdateStatus(ctx context.Context, apiGatewayStage *v1alpha1.ApiGatewayStage, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayStage, err error) {
	result = &v1alpha1.ApiGatewayStage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewaystages").
...
func (c *apiGatewayStages) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiGatewayStages) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiGatewayStages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayStage, err error) {
	result = &v1alpha1.ApiGatewayStage{}
