...
func (c *glueJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlueJob, err error) {
...
func (c *glueJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlueJobList, err error) {
...
func (c *glueJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *glueJobs) Create(ctx context.Context, glueJob *v1alpha1.GlueJob, opts v1.CreateOptions) (result *v1alpha1.GlueJob, err error) {
	result = &v1alpha1.GlueJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gluejobs").
...
func (c *glueJobs) Update(ctx context.Context, glueJob *v1alpha1.GlueJob, opts v1.UpdateOptions) (result *v1alpha1.GlueJob, err error) {
	result = &v1alpha1.GlueJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gluejobs").
...
func (c *glueJobs) UpdateStatus(ctx context.Context, glueJob *v1alpha1.GlueJob, opts v1.UpdateOptions) (result *v1alpha1.GlueJob, err error) {
	result = &v1alpha1.GlueJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gluejobs").
...
func (c *glueJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *glueJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *glueJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlueJob, err error) {
	result = &v1alpha1.GlueJob{}
