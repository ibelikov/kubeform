...
type CloudwatchLogResourcePolicyInterface interface {
	Create(*v1alpha1.CloudwatchLogResourcePolicy) (*v1alpha1.CloudwatchLogResourcePolicy, error)
	Update(*v1alpha1.CloudwatchLogResourcePolicy) (*v1alpha1.CloudwatchLogResourcePolicy, error)
	UpdateStatus(*v1alpha1.CloudwatchLogResourcePolicy) (*v1alpha1.CloudwatchLogResourcePolicy, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.CloudwatchLogResourcePolicy, error)
	List(opts v1.ListOptions) (*v1alpha1.CloudwatchLogResourcePolicyList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CloudwatchLogResourcePolicy, err error)
...
func (c *cloudwatchLogResourcePolicies) List(opts v1.ListOptions) (result *v1alpha1.CloudwatchLogResourcePolicyList, err error) {
...
func (c *cloudwatchLogResourcePolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudwatchLogResourcePolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
