...
func (c *cloudwatchLogResourcePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudwatchLogResourcePolicy, err error) {
...
func (c *cloudwatchLogResourcePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudwatchLogResourcePolicyList, err error) {
...
func (c *cloudwatchLogResourcePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudwatchLogResourcePolicies) Create(ctx context.Context, cloudwatchLogResourcePolicy *v1alpha1.CloudwatchLogResourcePolicy, opts v1.CreateOptions) (result *v1alpha1.CloudwatchLogResourcePolicy, err error) {
	result = &v1alpha1.CloudwatchLogResourcePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudwatchlogresourcepolicies").
...
func (c *cloudwatchLogResourcePolicies) Update(ctx context.Context, cloudwatchLogResourcePolicy *v1alpha1.CloudwatchLogResourcePolicy, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogResourcePolicy, err error) {
	result = &v1alpha1.CloudwatchLogResourcePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudwatchlogresourcepolicies").
...
func (c *cloudwatchLogResourcePolicies) UpdateStatus(ctx context.Context, cloudwatchLogResourcePolicy *v1alpha1.CloudwatchLogResourcePolicy, opts v1.UpdateOptions) (result *v1alpha1.CloudwatchLogResourcePolicy, err error) {
	result = &v1alpha1.CloudwatchLogResourcePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudwatchlogresourcepolicies").
...
func (c *cloudwatchLogResourcePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudwatchLogResourcePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudwatchLogResourcePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudwatchLogResourcePolicy, err error) {
	result = &v1alpha1.CloudwatchLogResourcePolicy{}
