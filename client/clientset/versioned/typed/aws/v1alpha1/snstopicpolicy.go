...
func newSnsTopicPolicies(c *AwsV1alpha1Client, namespace string) *snsTopicPolicies {
...
func (c *snsTopicPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SnsTopicPolicy, err error) {
...
func (c *snsTopicPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SnsTopicPolicyList, err error) {
...
func (c *snsTopicPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *snsTopicPolicies) Create(ctx context.Context, snsTopicPolicy *v1alpha1.SnsTopicPolicy, opts v1.CreateOptions) (result *v1alpha1.SnsTopicPolicy, err error) {
	result = &v1alpha1.SnsTopicPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("snstopicpolicies").
...
func (c *snsTopicPolicies) Update(ctx context.Context, snsTopicPolicy *v1alpha1.SnsTopicPolicy, opts v1.UpdateOptions) (result *v1alpha1.SnsTopicPolicy, err error) {
	result = &v1alpha1.SnsTopicPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snstopicpolicies").
...
func (c *snsTopicPolicies) UpdateStatus(ctx context.Context, snsTopicPolicy *v1alpha1.SnsTopicPolicy, opts v1.UpdateOptions) (result *v1alpha1.SnsTopicPolicy, err error) {
	result = &v1alpha1.SnsTopicPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snstopicpolicies").
...
func (c *snsTopicPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *snsTopicPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *snsTopicPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SnsTopicPolicy, err error) {
	result = &v1alpha1.SnsTopicPolicy{}
