...
func (c *defaultVpcs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DefaultVpc, err error) {
...
func (c *defaultVpcs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DefaultVpcList, err error) {
...
func (c *defaultVpcs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *defaultVpcs) Create(ctx context.Context, defaultVpc *v1alpha1.DefaultVpc, opts v1.CreateOptions) (result *v1alpha1.DefaultVpc, err error) {
	result = &v1alpha1.DefaultVpc{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("defaultvpcs").
...
func (c *defaultVpcs) Update(ctx context.Context, defaultVpc *v1alpha1.DefaultVpc, opts v1.UpdateOptions) (result *v1alpha1.DefaultVpc, err error) {
	result = &v1alpha1.DefaultVpc{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("defaultvpcs").
...
func (c *defaultVpcs) UpdateStatus(ctx context.Context, defaultVpc *v1alpha1.DefaultVpc, opts v1.UpdateOptions) (result *v1alpha1.DefaultVpc, err error) {
	result = &v1alpha1.DefaultVpc{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("defaultvpcs").
...
func (c *defaultVpcs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *defaultVpcs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *defaultVpcs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DefaultVpc, err error) {
	result = &v1alpha1.DefaultVpc{}
