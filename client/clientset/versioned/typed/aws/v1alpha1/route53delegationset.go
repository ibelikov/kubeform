...
func (c *route53DelegationSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Route53DelegationSet, err error) {
...
func (c *route53DelegationSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.Route53DelegationSetList, err error) {
...
func (c *route53DelegationSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *route53DelegationSets) Create(ctx context.Context, route53DelegationSet *v1alpha1.Route53DelegationSet, opts v1.CreateOptions) (result *v1alpha1.Route53DelegationSet, err error) {
	result = &v1alpha1.Route53DelegationSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("route53delegationsets").
...
func (c *route53DelegationSets) Update(ctx context.Context, route53DelegationSet *v1alpha1.Route53DelegationSet, opts v1.UpdateOptions) (result *v1alpha1.Route53DelegationSet, err error) {
	result = &v1alpha1.Route53DelegationSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("route53delegationsets").
...
func (c *route53DelegationSets) UpdateStatus(ctx context.Context, route53DelegationSet *v1alpha1.Route53DelegationSet, opts v1.UpdateOptions) (result *v1alpha1.Route53DelegationSet, err error) {
	result = &v1alpha1.Route53DelegationSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("route53delegationsets").
...
func (c *route53DelegationSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *route53DelegationSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *route53DelegationSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Route53DelegationSet, err error) {
	result = &v1alpha1.Route53DelegationSet{}
