...
func (c *ssmPatchGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SsmPatchGroup, err error) {
...
func (c *ssmPatchGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SsmPatchGroupList, err error) {
...
func (c *ssmPatchGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssmPatchGroups) Create(ctx context.Context, ssmPatchGroup *v1alpha1.SsmPatchGroup, opts v1.CreateOptions) (result *v1alpha1.SsmPatchGroup, err error) {
	result = &v1alpha1.SsmPatchGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ssmpatchgroups").
...
func (c *ssmPatchGroups) Update(ctx context.Context, ssmPatchGroup *v1alpha1.SsmPatchGroup, opts v1.UpdateOptions) (result *v1alpha1.SsmPatchGroup, err error) {
	result = &v1alpha1.SsmPatchGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmpatchgroups").
...
func (c *ssmPatchGroups) UpdateStatus(ctx context.Context, ssmPatchGroup *v1alpha1.SsmPatchGroup, opts v1.UpdateOptions) (result *v1alpha1.SsmPatchGroup, err error) {
	result = &v1alpha1.SsmPatchGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssmpatchgroups").
...
func (c *ssmPatchGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ssmPatchGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ssmPatchGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SsmPatchGroup, err error) {
	result = &v1alpha1.SsmPatchGroup{}
