...
func (c *shieldProtections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ShieldProtection, err error) {
...
func (c *shieldProtections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ShieldProtectionList, err error) {
...
func (c *shieldProtections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *shieldProtections) Create(ctx context.Context, shieldProtection *v1alpha1.ShieldProtection, opts v1.CreateOptions) (result *v1alpha1.ShieldProtection, err error) {
	result = &v1alpha1.ShieldProtection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shieldprotections").
...
func (c *shieldProtections) Update(ctx context.Context, shieldProtection *v1alpha1.ShieldProtection, opts v1.UpdateOptions) (result *v1alpha1.ShieldProtection, err error) {
	result = &v1alpha1.ShieldProtection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shieldprotections").
...
func (c *shieldProtections) UpdateStatus(ctx context.Context, shieldProtection *v1alpha1.ShieldProtection, opts v1.UpdateOptions) (result *v1alpha1.ShieldProtection, err error) {
	result = &v1alpha1.ShieldProtection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shieldprotections").
...
func (c *shieldProtections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *shieldProtections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *shieldProtections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ShieldProtection, err error) {
	result = &v1alpha1.ShieldProtection{}
