...
func (c *cloudfrontPublicKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudfrontPublicKey, err error) {
...
func (c *cloudfrontPublicKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudfrontPublicKeyList, err error) {
...
func (c *cloudfrontPublicKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudfrontPublicKeys) Create(ctx context.Context, cloudfrontPublicKey *v1alpha1.CloudfrontPublicKey, opts v1.CreateOptions) (result *v1alpha1.CloudfrontPublicKey, err error) {
	result = &v1alpha1.CloudfrontPublicKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudfrontpublickeys").
...
func (c *cloudfrontPublicKeys) Update(ctx context.Context, cloudfrontPublicKey *v1alpha1.CloudfrontPublicKey, opts v1.UpdateOptions) (result *v1alpha1.CloudfrontPublicKey, err error) {
	result = &v1alpha1.CloudfrontPublicKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudfrontpublickeys").
...
func (c *cloudfrontPublicKeys) UpdateStatus(ctx context.Context, cloudfrontPublicKey *v1alpha1.CloudfrontPublicKey, opts v1.UpdateOptions) (result *v1alpha1.CloudfrontPublicKey, err error) {
	result = &v1alpha1.CloudfrontPublicKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudfrontpublickeys").
...
func (c *cloudfrontPublicKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudfrontPublicKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudfrontPublicKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudfrontPublicKey, err error) {
	result = &v1alpha1.CloudfrontPublicKey{}
