...
func (c *dmsReplicationSubnetGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DmsReplicationSubnetGroup, err error) {
...
func (c *dmsReplicationSubnetGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DmsReplicationSubnetGroupList, err error) {
...
func (c *dmsReplicationSubnetGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dmsReplicationSubnetGroups) Create(ctx context.Context, dmsReplicationSubnetGroup *v1alpha1.DmsReplicationSubnetGroup, opts v1.CreateOptions) (result *v1alpha1.DmsReplicationSubnetGroup, err error) {
	result = &v1alpha1.DmsReplicationSubnetGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dmsreplicationsubnetgroups").
...
func (c *dmsReplicationSubnetGroups) Update(ctx context.Context, dmsReplicationSubnetGroup *v1alpha1.DmsReplicationSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.DmsReplicationSubnetGroup, err error) {
	result = &v1alpha1.DmsReplicationSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dmsreplicationsubnetgroups").
...
func (c *dmsReplicationSubnetGroups) UpdateStatus(ctx context.Context, dmsReplicationSubnetGroup *v1alpha1.DmsReplicationSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.DmsReplicationSubnetGroup, err error) {
	result = &v1alpha1.DmsReplicationSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dmsreplicationsubnetgroups").
...
func (c *dmsReplicationSubnetGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dmsReplicationSubnetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dmsReplicationSubnetGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DmsReplicationSubnetGroup, err error) {
	result = &v1alpha1.DmsReplicationSubnetGroup{}
