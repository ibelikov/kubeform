...
func (c *batchJobQueues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BatchJobQueue, err error) {
...
func (c *batchJobQueues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BatchJobQueueList, err error) {
...
func (c *batchJobQueues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *batchJobQueues) Create(ctx context.Context, batchJobQueue *v1alpha1.BatchJobQueue, opts v1.CreateOptions) (result *v1alpha1.BatchJobQueue, err error) {
	result = &v1alpha1.BatchJobQueue{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("batchjobqueues").
...
func (c *batchJobQueues) Update(ctx context.Context, batchJobQueue *v1alpha1.BatchJobQueue, opts v1.UpdateOptions) (result *v1alpha1.BatchJobQueue, err error) {
	result = &v1alpha1.BatchJobQueue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("batchjobqueues").
...
func (c *batchJobQueues) UpdateStatus(ctx context.Context, batchJobQueue *v1alpha1.BatchJobQueue, opts v1.UpdateOptions) (result *v1alpha1.BatchJobQueue, err error) {
	result = &v1alpha1.BatchJobQueue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("batchjobqueues").
...
func (c *batchJobQueues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *batchJobQueues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *batchJobQueues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BatchJobQueue, err error) {
	result = &v1alpha1.BatchJobQueue{}
