...
func (c *rdsClusterEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RdsClusterEndpoint, err error) {
...
func (c *rdsClusterEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RdsClusterEndpointList, err error) {
...
func (c *rdsClusterEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *rdsClusterEndpoints) Create(ctx context.Context, rdsClusterEndpoint *v1alpha1.RdsClusterEndpoint, opts v1.CreateOptions) (result *v1alpha1.RdsClusterEndpoint, err error) {
	result = &v1alpha1.RdsClusterEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rdsclusterendpoints").
...
func (c *rdsClusterEndpoints) Update(ctx context.Context, rdsClusterEndpoint *v1alpha1.RdsClusterEndpoint, opts v1.UpdateOptions) (result *v1alpha1.RdsClusterEndpoint, err error) {
	result = &v1alpha1.RdsClusterEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rdsclusterendpoints").
...
func (c *rdsClusterEndpoints) UpdateStatus(ctx context.Context, rdsClusterEndpoint *v1alpha1.RdsClusterEndpoint, opts v1.UpdateOptions) (result *v1alpha1.RdsClusterEndpoint, err error) {
	result = &v1alpha1.RdsClusterEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rdsclusterendpoints").
...
func (c *rdsClusterEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *rdsClusterEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *rdsClusterEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RdsClusterEndpoint, err error) {
	result = &v1alpha1.RdsClusterEndpoint{}
