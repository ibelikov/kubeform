...
func (c *wafRegexPatternSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WafRegexPatternSet, err error) {
...
func (c *wafRegexPatternSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WafRegexPatternSetList, err error) {
...
func (c *wafRegexPatternSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *wafRegexPatternSets) Create(ctx context.Context, wafRegexPatternSet *v1alpha1.WafRegexPatternSet, opts v1.CreateOptions) (result *v1alpha1.WafRegexPatternSet, err error) {
	result = &v1alpha1.WafRegexPatternSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("wafregexpatternsets").
...
func (c *wafRegexPatternSets) Update(ctx context.Context, wafRegexPatternSet *v1alpha1.WafRegexPatternSet, opts v1.UpdateOptions) (result *v1alpha1.WafRegexPatternSet, err error) {
	result = &v1alpha1.WafRegexPatternSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregexpatternsets").
...
func (c *wafRegexPatternSets) UpdateStatus(ctx context.Context, wafRegexPatternSet *v1alpha1.WafRegexPatternSet, opts v1.UpdateOptions) (result *v1alpha1.WafRegexPatternSet, err error) {
	result = &v1alpha1.WafRegexPatternSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("wafregexpatternsets").
...
func (c *wafRegexPatternSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *wafRegexPatternSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *wafRegexPatternSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WafRegexPatternSet, err error) {
	result = &v1alpha1.WafRegexPatternSet{}
