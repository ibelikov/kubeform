...
func (c *acmCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AcmCertificate, err error) {
...
func (c *acmCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AcmCertificateList, err error) {
...
func (c *acmCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *acmCertificates) Create(ctx context.Context, acmCertificate *v1alpha1.AcmCertificate, opts v1.CreateOptions) (result *v1alpha1.AcmCertificate, err error) {
	result = &v1alpha1.AcmCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("acmcertificates").
...
func (c *acmCertificates) Update(ctx context.Context, acmCertificate *v1alpha1.AcmCertificate, opts v1.UpdateOptions) (result *v1alpha1.AcmCertificate, err error) {
	result = &v1alpha1.AcmCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("acmcertificates").
...
func (c *acmCertificates) UpdateStatus(ctx context.Context, acmCertificate *v1alpha1.AcmCertificate, opts v1.UpdateOptions) (result *v1alpha1.AcmCertificate, err error) {
	result = &v1alpha1.AcmCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("acmcertificates").
...
func (c *acmCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *acmCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *acmCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AcmCertificate, err error) {
	result = &v1alpha1.AcmCertificate{}
