...
func (c *iamAccessKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamAccessKey, err error) {
...
func (c *iamAccessKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamAccessKeyList, err error) {
...
func (c *iamAccessKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamAccessKeys) Create(ctx context.Context, iamAccessKey *v1alpha1.IamAccessKey, opts v1.CreateOptions) (result *v1alpha1.IamAccessKey, err error) {
	result = &v1alpha1.IamAccessKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamaccesskeys").
...
func (c *iamAccessKeys) Update(ctx context.Context, iamAccessKey *v1alpha1.IamAccessKey, opts v1.UpdateOptions) (result *v1alpha1.IamAccessKey, err error) {
	result = &v1alpha1.IamAccessKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamaccesskeys").
...
func (c *iamAccessKeys) UpdateStatus(ctx context.Context, iamAccessKey *v1alpha1.IamAccessKey, opts v1.UpdateOptions) (result *v1alpha1.IamAccessKey, err error) {
	result = &v1alpha1.IamAccessKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamaccesskeys").
...
func (c *iamAccessKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamAccessKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamAccessKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamAccessKey, err error) {
	result = &v1alpha1.IamAccessKey{}
