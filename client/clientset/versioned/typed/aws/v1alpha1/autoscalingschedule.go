...
func (c *autoscalingSchedules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoscalingSchedule, err error) {
...
func (c *autoscalingSchedules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoscalingScheduleList, err error) {
...
func (c *autoscalingSchedules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *autoscalingSchedules) Create(ctx context.Context, autoscalingSchedule *v1alpha1.AutoscalingSchedule, opts v1.CreateOptions) (result *v1alpha1.AutoscalingSchedule, err error) {
	result = &v1alpha1.AutoscalingSchedule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("autoscalingschedules").
...
func (c *autoscalingSchedules) Update(ctx context.Context, autoscalingSchedule *v1alpha1.AutoscalingSchedule, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingSchedule, err error) {
	result = &v1alpha1.AutoscalingSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autoscalingschedules").
...
func (c *autoscalingSchedules) UpdateStatus(ctx context.Context, autoscalingSchedule *v1alpha1.AutoscalingSchedule, opts v1.UpdateOptions) (result *v1alpha1.AutoscalingSchedule, err error) {
	result = &v1alpha1.AutoscalingSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autoscalingschedules").
...
func (c *autoscalingSchedules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *autoscalingSchedules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *autoscalingSchedules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoscalingSchedule, err error) {
	result = &v1alpha1.AutoscalingSchedule{}
