...
func newAppsyncDatasources(c *AwsV1alpha1Client, namespace string) *appsyncDatasources {
...
func (c *appsyncDatasources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppsyncDatasource, err error) {
...
func (c *appsyncDatasources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppsyncDatasourceList, err error) {
...
func (c *appsyncDatasources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *appsyncDatasources) Create(ctx context.Context, appsyncDatasource *v1alpha1.AppsyncDatasource, opts v1.CreateOptions) (result *v1alpha1.AppsyncDatasource, err error) {
	result = &v1alpha1.AppsyncDatasource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("appsyncdatasources").
...
func (c *appsyncDatasources) Update(ctx context.Context, appsyncDatasource *v1alpha1.AppsyncDatasource, opts v1.UpdateOptions) (result *v1alpha1.AppsyncDatasource, err error) {
	result = &v1alpha1.AppsyncDatasource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appsyncdatasources").
...
func (c *appsyncDatasources) UpdateStatus(ctx context.Context, appsyncDatasource *v1alpha1.AppsyncDatasource, opts v1.UpdateOptions) (result *v1alpha1.AppsyncDatasource, err error) {
	result = &v1alpha1.AppsyncDatasource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appsyncdatasources").
...
func (c *appsyncDatasources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *appsyncDatasources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *appsyncDatasources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppsyncDatasource, err error) {
	result = &v1alpha1.AppsyncDatasource{}
