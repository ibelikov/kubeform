...
func (c *apiGatewayBasePathMappings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiGatewayBasePathMapping, err error) {
...
func (c *apiGatewayBasePathMappings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiGatewayBasePathMappingList, err error) {
...
func (c *apiGatewayBasePathMappings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiGatewayBasePathMappings) Create(ctx context.Context, apiGatewayBasePathMapping *v1alpha1.ApiGatewayBasePathMapping, opts v1.CreateOptions) (result *v1alpha1.ApiGatewayBasePathMapping, err error) {
	result = &v1alpha1.ApiGatewayBasePathMapping{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigatewaybasepathmappings").
...
func (c *apiGatewayBasePathMappings) Update(ctx context.Context, apiGatewayBasePathMapping *v1alpha1.ApiGatewayBasePathMapping, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayBasePathMapping, err error) {
	result = &v1alpha1.ApiGatewayBasePathMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewaybasepathmappings").
...
func (c *apiGatewayBasePathMappings) UpdateStatus(ctx context.Context, apiGatewayBasePathMapping *v1alpha1.ApiGatewayBasePathMapping, opts v1.UpdateOptions) (result *v1alpha1.ApiGatewayBasePathMapping, err error) {
	result = &v1alpha1.ApiGatewayBasePathMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewaybasepathmappings").
...
func (c *apiGatewayBasePathMappings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiGatewayBasePathMappings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiGatewayBasePathMappings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiGatewayBasePathMapping, err error) {
	result = &v1alpha1.ApiGatewayBasePathMapping{}
