...
type ApiGatewayBasePathMappingInterface interface {
	Create(*v1alpha1.ApiGatewayBasePathMapping) (*v1alpha1.ApiGatewayBasePathMapping, error)
	Update(*v1alpha1.ApiGatewayBasePathMapping) (*v1alpha1.ApiGatewayBasePathMapping, error)
	UpdateStatus(*v1alpha1.ApiGatewayBasePathMapping) (*v1alpha1.ApiGatewayBasePathMapping, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ApiGatewayBasePathMapping, error)
	List(opts v1.ListOptions) (*v1alpha1.ApiGatewayBasePathMappingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ApiGatewayBasePathMapping, err error)
...
func (c *apiGatewayBasePathMappings) List(opts v1.ListOptions) (result *v1alpha1.ApiGatewayBasePathMappingList, err error) {
...
func (c *apiGatewayBasePathMappings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiGatewayBasePathMappings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
