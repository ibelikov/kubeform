...
func (c *ebsVolumes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EbsVolume, err error) {
...
func (c *ebsVolumes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EbsVolumeList, err error) {
...
func (c *ebsVolumes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ebsVolumes) Create(ctx context.Context, ebsVolume *v1alpha1.EbsVolume, opts v1.CreateOptions) (result *v1alpha1.EbsVolume, err error) {
	result = &v1alpha1.EbsVolume{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ebsvolumes").
...
func (c *ebsVolumes) Update(ctx context.Context, ebsVolume *v1alpha1.EbsVolume, opts v1.UpdateOptions) (result *v1alpha1.EbsVolume, err error) {
	result = &v1alpha1.EbsVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ebsvolumes").
...
func (c *ebsVolumes) UpdateStatus(ctx context.Context, ebsVolume *v1alpha1.EbsVolume, opts v1.UpdateOptions) (result *v1alpha1.EbsVolume, err error) {
	result = &v1alpha1.EbsVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ebsvolumes").
...
func (c *ebsVolumes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ebsVolumes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ebsVolumes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EbsVolume, err error) {
	result = &v1alpha1.EbsVolume{}
