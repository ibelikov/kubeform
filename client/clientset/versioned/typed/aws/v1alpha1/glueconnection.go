...
// GlueConnectionsGetter has a method to return a GlueConnectionInterface.
...
// glueConnections implements GlueConnectionInterface
type glueConnections struct {
	client rest.Interface
	ns     string
}

// newGlueConnections returns a GlueConnections
func newGlueConnections(c *AwsV1alpha1Client, namespace string) *glueConnections {
	return &glueConnections{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *glueConnections) List(opts v1.ListOptions) (result *v1alpha1.GlueConnectionList, err error) {
	...
	result = &v1alpha1.GlueConnectionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("glueconnections").
