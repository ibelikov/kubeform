...
func (c *sesEventDestinations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SesEventDestination, err error) {
...
func (c *sesEventDestinations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SesEventDestinationList, err error) {
...
func (c *sesEventDestinations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sesEventDestinations) Create(ctx context.Context, sesEventDestination *v1alpha1.SesEventDestination, opts v1.CreateOptions) (result *v1alpha1.SesEventDestination, err error) {
	result = &v1alpha1.SesEventDestination{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("seseventdestinations").
...
func (c *sesEventDestinations) Update(ctx context.Context, sesEventDestination *v1alpha1.SesEventDestination, opts v1.UpdateOptions) (result *v1alpha1.SesEventDestination, err error) {
	result = &v1alpha1.SesEventDestination{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("seseventdestinations").
...
func (c *sesEventDestinations) UpdateStatus(ctx context.Context, sesEventDestination *v1alpha1.SesEventDestination, opts v1.UpdateOptions) (result *v1alpha1.SesEventDestination, err error) {
	result = &v1alpha1.SesEventDestination{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("seseventdestinations").
...
func (c *sesEventDestinations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sesEventDestinations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sesEventDestinations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SesEventDestination, err error) {
	result = &v1alpha1.SesEventDestination{}
