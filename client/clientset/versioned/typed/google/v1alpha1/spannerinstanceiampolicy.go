...
func (c *spannerInstanceIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpannerInstanceIamPolicy, err error) {
...
func (c *spannerInstanceIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpannerInstanceIamPolicyList, err error) {
...
func (c *spannerInstanceIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *spannerInstanceIamPolicies) Create(ctx context.Context, spannerInstanceIamPolicy *v1alpha1.SpannerInstanceIamPolicy, opts v1.CreateOptions) (result *v1alpha1.SpannerInstanceIamPolicy, err error) {
	result = &v1alpha1.SpannerInstanceIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spannerinstanceiampolicies").
...
func (c *spannerInstanceIamPolicies) Update(ctx context.Context, spannerInstanceIamPolicy *v1alpha1.SpannerInstanceIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.SpannerInstanceIamPolicy, err error) {
	result = &v1alpha1.SpannerInstanceIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spannerinstanceiampolicies").
...
func (c *spannerInstanceIamPolicies) UpdateStatus(ctx context.Context, spannerInstanceIamPolicy *v1alpha1.SpannerInstanceIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.SpannerInstanceIamPolicy, err error) {
	result = &v1alpha1.SpannerInstanceIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spannerinstanceiampolicies").
...
func (c *spannerInstanceIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *spannerInstanceIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *spannerInstanceIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SpannerInstanceIamPolicy, err error) {
	result = &v1alpha1.SpannerInstanceIamPolicy{}
