...
func newPubsubSubscriptionIamPolicies(c *GoogleV1alpha1Client, namespace string) *pubsubSubscriptionIamPolicies {
...
func (c *pubsubSubscriptionIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PubsubSubscriptionIamPolicy, err error) {
...
func (c *pubsubSubscriptionIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PubsubSubscriptionIamPolicyList, err error) {
...
func (c *pubsubSubscriptionIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pubsubSubscriptionIamPolicies) Create(ctx context.Context, pubsubSubscriptionIamPolicy *v1alpha1.PubsubSubscriptionIamPolicy, opts v1.CreateOptions) (result *v1alpha1.PubsubSubscriptionIamPolicy, err error) {
	result = &v1alpha1.PubsubSubscriptionIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pubsubsubscriptioniampolicies").
...
func (c *pubsubSubscriptionIamPolicies) Update(ctx context.Context, pubsubSubscriptionIamPolicy *v1alpha1.PubsubSubscriptionIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.PubsubSubscriptionIamPolicy, err error) {
	result = &v1alpha1.PubsubSubscriptionIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubsubscriptioniampolicies").
...
func (c *pubsubSubscriptionIamPolicies) UpdateStatus(ctx context.Context, pubsubSubscriptionIamPolicy *v1alpha1.PubsubSubscriptionIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.PubsubSubscriptionIamPolicy, err error) {
	result = &v1alpha1.PubsubSubscriptionIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubsubscriptioniampolicies").
...
func (c *pubsubSubscriptionIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pubsubSubscriptionIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pubsubSubscriptionIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PubsubSubscriptionIamPolicy, err error) {
	result = &v1alpha1.PubsubSubscriptionIamPolicy{}
