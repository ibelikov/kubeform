...
func newComputeTargetInstances(c *GoogleV1alpha1Client, namespace string) *computeTargetInstances {
...
func (c *computeTargetInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeTargetInstance, err error) {
	result = &v1alpha1.ComputeTargetInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeTargetInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeTargetInstanceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ComputeTargetInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computetargetinstances").
...
func (c *computeTargetInstances) Create(ctx context.Context, computeTargetInstance *v1alpha1.ComputeTargetInstance, opts v1.CreateOptions) (result *v1alpha1.ComputeTargetInstance, err error) {
	result = &v1alpha1.ComputeTargetInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computetargetinstances").
...
func (c *computeTargetInstances) Update(ctx context.Context, computeTargetInstance *v1alpha1.ComputeTargetInstance, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetInstance, err error) {
	result = &v1alpha1.ComputeTargetInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetinstances").
...
func (c *computeTargetInstances) UpdateStatus(ctx context.Context, computeTargetInstance *v1alpha1.ComputeTargetInstance, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetInstance, err error) {
	result = &v1alpha1.ComputeTargetInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetinstances").
...
func (c *computeTargetInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeTargetInstance, err error) {
	result = &v1alpha1.ComputeTargetInstance{}
