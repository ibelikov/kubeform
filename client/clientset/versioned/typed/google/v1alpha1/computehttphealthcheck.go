...
func (c *computeHTTPHealthChecks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeHTTPHealthCheck, err error) {
...
func (c *computeHTTPHealthChecks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeHTTPHealthCheckList, err error) {
...
func (c *computeHTTPHealthChecks) Create(ctx context.Context, computeHTTPHealthCheck *v1alpha1.ComputeHTTPHealthCheck, opts v1.CreateOptions) (result *v1alpha1.ComputeHTTPHealthCheck, err error) {
	result = &v1alpha1.ComputeHTTPHealthCheck{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computehttphealthchecks").
...
func (c *computeHTTPHealthChecks) Update(ctx context.Context, computeHTTPHealthCheck *v1alpha1.ComputeHTTPHealthCheck, opts v1.UpdateOptions) (result *v1alpha1.ComputeHTTPHealthCheck, err error) {
	result = &v1alpha1.ComputeHTTPHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehttphealthchecks").
...
func (c *computeHTTPHealthChecks) UpdateStatus(ctx context.Context, computeHTTPHealthCheck *v1alpha1.ComputeHTTPHealthCheck, opts v1.UpdateOptions) (result *v1alpha1.ComputeHTTPHealthCheck, err error) {
	result = &v1alpha1.ComputeHTTPHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehttphealthchecks").
...
func (c *computeHTTPHealthChecks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeHTTPHealthCheck, err error) {
	result = &v1alpha1.ComputeHTTPHealthCheck{}
