...
func (c *pubsubTopics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PubsubTopic, err error) {
...
func (c *pubsubTopics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PubsubTopicList, err error) {
...
func (c *pubsubTopics) Create(ctx context.Context, pubsubTopic *v1alpha1.PubsubTopic, opts v1.CreateOptions) (result *v1alpha1.PubsubTopic, err error) {
	result = &v1alpha1.PubsubTopic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pubsubtopics").
...
func (c *pubsubTopics) Update(ctx context.Context, pubsubTopic *v1alpha1.PubsubTopic, opts v1.UpdateOptions) (result *v1alpha1.PubsubTopic, err error) {
	result = &v1alpha1.PubsubTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubtopics").
...
func (c *pubsubTopics) UpdateStatus(ctx context.Context, pubsubTopic *v1alpha1.PubsubTopic, opts v1.UpdateOptions) (result *v1alpha1.PubsubTopic, err error) {
	result = &v1alpha1.PubsubTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pubsubtopics").
...
func (c *pubsubTopics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PubsubTopic, err error) {
	result = &v1alpha1.PubsubTopic{}
