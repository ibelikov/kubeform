...
func (c *containerAnalysisNotes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ContainerAnalysisNote, err error) {
...
func (c *containerAnalysisNotes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ContainerAnalysisNoteList, err error) {
...
func (c *containerAnalysisNotes) Create(ctx context.Context, containerAnalysisNote *v1alpha1.ContainerAnalysisNote, opts v1.CreateOptions) (result *v1alpha1.ContainerAnalysisNote, err error) {
	result = &v1alpha1.ContainerAnalysisNote{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("containeranalysisnotes").
...
func (c *containerAnalysisNotes) Update(ctx context.Context, containerAnalysisNote *v1alpha1.ContainerAnalysisNote, opts v1.UpdateOptions) (result *v1alpha1.ContainerAnalysisNote, err error) {
	result = &v1alpha1.ContainerAnalysisNote{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("containeranalysisnotes").
...
func (c *containerAnalysisNotes) UpdateStatus(ctx context.Context, containerAnalysisNote *v1alpha1.ContainerAnalysisNote, opts v1.UpdateOptions) (result *v1alpha1.ContainerAnalysisNote, err error) {
	result = &v1alpha1.ContainerAnalysisNote{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("containeranalysisnotes").
...
func (c *containerAnalysisNotes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ContainerAnalysisNote, err error) {
	result = &v1alpha1.ContainerAnalysisNote{}
