...
func (c *computeTargetSSLProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeTargetSSLProxy, err error) {
...
func (c *computeTargetSSLProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeTargetSSLProxyList, err error) {
...
func (c *computeTargetSSLProxies) Create(ctx context.Context, computeTargetSSLProxy *v1alpha1.ComputeTargetSSLProxy, opts v1.CreateOptions) (result *v1alpha1.ComputeTargetSSLProxy, err error) {
	result = &v1alpha1.ComputeTargetSSLProxy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computetargetsslproxies").
...
func (c *computeTargetSSLProxies) Update(ctx context.Context, computeTargetSSLProxy *v1alpha1.ComputeTargetSSLProxy, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetSSLProxy, err error) {
	result = &v1alpha1.ComputeTargetSSLProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetsslproxies").
...
func (c *computeTargetSSLProxies) UpdateStatus(ctx context.Context, computeTargetSSLProxy *v1alpha1.ComputeTargetSSLProxy, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetSSLProxy, err error) {
	result = &v1alpha1.ComputeTargetSSLProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetsslproxies").
...
func (c *computeTargetSSLProxies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeTargetSSLProxy, err error) {
	result = &v1alpha1.ComputeTargetSSLProxy{}
