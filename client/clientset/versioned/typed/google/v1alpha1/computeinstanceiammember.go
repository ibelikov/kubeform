...
func (c *computeInstanceIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeInstanceIamMember, err error) {
...
func (c *computeInstanceIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeInstanceIamMemberList, err error) {
...
func (c *computeInstanceIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeInstanceIamMembers) Create(ctx context.Context, computeInstanceIamMember *v1alpha1.ComputeInstanceIamMember, opts v1.CreateOptions) (result *v1alpha1.ComputeInstanceIamMember, err error) {
	result = &v1alpha1.ComputeInstanceIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeinstanceiammembers").
...
func (c *computeInstanceIamMembers) Update(ctx context.Context, computeInstanceIamMember *v1alpha1.ComputeInstanceIamMember, opts v1.UpdateOptions) (result *v1alpha1.ComputeInstanceIamMember, err error) {
	result = &v1alpha1.ComputeInstanceIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinstanceiammembers").
...
func (c *computeInstanceIamMembers) UpdateStatus(ctx context.Context, computeInstanceIamMember *v1alpha1.ComputeInstanceIamMember, opts v1.UpdateOptions) (result *v1alpha1.ComputeInstanceIamMember, err error) {
	result = &v1alpha1.ComputeInstanceIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinstanceiammembers").
...
func (c *computeInstanceIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeInstanceIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeInstanceIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeInstanceIamMember, err error) {
	result = &v1alpha1.ComputeInstanceIamMember{}
