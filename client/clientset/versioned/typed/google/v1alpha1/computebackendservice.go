...
func (c *computeBackendServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeBackendService, err error) {
...
func (c *computeBackendServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeBackendServiceList, err error) {
...
func (c *computeBackendServices) Create(ctx context.Context, computeBackendService *v1alpha1.ComputeBackendService, opts v1.CreateOptions) (result *v1alpha1.ComputeBackendService, err error) {
	result = &v1alpha1.ComputeBackendService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computebackendservices").
...
func (c *computeBackendServices) Update(ctx context.Context, computeBackendService *v1alpha1.ComputeBackendService, opts v1.UpdateOptions) (result *v1alpha1.ComputeBackendService, err error) {
	result = &v1alpha1.ComputeBackendService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computebackendservices").
...
func (c *computeBackendServices) UpdateStatus(ctx context.Context, computeBackendService *v1alpha1.ComputeBackendService, opts v1.UpdateOptions) (result *v1alpha1.ComputeBackendService, err error) {
	result = &v1alpha1.ComputeBackendService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computebackendservices").
...
func (c *computeBackendServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeBackendService, err error) {
	result = &v1alpha1.ComputeBackendService{}
