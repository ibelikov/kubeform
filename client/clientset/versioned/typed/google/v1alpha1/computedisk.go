...
func (c *computeDisks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeDisk, err error) {
...
func (c *computeDisks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeDiskList, err error) {
...
func (c *computeDisks) Create(ctx context.Context, computeDisk *v1alpha1.ComputeDisk, opts v1.CreateOptions) (result *v1alpha1.ComputeDisk, err error) {
	result = &v1alpha1.ComputeDisk{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computedisks").
...
func (c *computeDisks) Update(ctx context.Context, computeDisk *v1alpha1.ComputeDisk, opts v1.UpdateOptions) (result *v1alpha1.ComputeDisk, err error) {
	result = &v1alpha1.ComputeDisk{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computedisks").
...
func (c *computeDisks) UpdateStatus(ctx context.Context, computeDisk *v1alpha1.ComputeDisk, opts v1.UpdateOptions) (result *v1alpha1.ComputeDisk, err error) {
	result = &v1alpha1.ComputeDisk{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computedisks").
...
func (c *computeDisks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeDisk, err error) {
	result = &v1alpha1.ComputeDisk{}
