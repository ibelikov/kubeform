...
// ProjectIamAuditConfigsGetter has a method to return a ProjectIamAuditConfigInterface.
...
// projectIamAuditConfigs implements ProjectIamAuditConfigInterface
type projectIamAuditConfigs struct {
	client rest.Interface
	ns     string
}

// newProjectIamAuditConfigs returns a ProjectIamAuditConfigs
func newProjectIamAuditConfigs(c *GoogleV1alpha1Client, namespace string) *projectIamAuditConfigs {
	return &projectIamAuditConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *projectIamAuditConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectIamAuditConfigList, err error) {
	...
	result = &v1alpha1.ProjectIamAuditConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectiamauditconfigs").
