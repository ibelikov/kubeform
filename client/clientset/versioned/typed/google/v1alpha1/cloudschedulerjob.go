...
func newCloudSchedulerJobs(c *GoogleV1alpha1Client, namespace string) *cloudSchedulerJobs {
...
func (c *cloudSchedulerJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudSchedulerJob, err error) {
	result = &v1alpha1.CloudSchedulerJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cloudSchedulerJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudSchedulerJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CloudSchedulerJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cloudschedulerjobs").
...
func (c *cloudSchedulerJobs) Create(ctx context.Context, cloudSchedulerJob *v1alpha1.CloudSchedulerJob, opts v1.CreateOptions) (result *v1alpha1.CloudSchedulerJob, err error) {
	result = &v1alpha1.CloudSchedulerJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudschedulerjobs").
...
func (c *cloudSchedulerJobs) Update(ctx context.Context, cloudSchedulerJob *v1alpha1.CloudSchedulerJob, opts v1.UpdateOptions) (result *v1alpha1.CloudSchedulerJob, err error) {
	result = &v1alpha1.CloudSchedulerJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudschedulerjobs").
...
func (c *cloudSchedulerJobs) UpdateStatus(ctx context.Context, cloudSchedulerJob *v1alpha1.CloudSchedulerJob, opts v1.UpdateOptions) (result *v1alpha1.CloudSchedulerJob, err error) {
	result = &v1alpha1.CloudSchedulerJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudschedulerjobs").
...
func (c *cloudSchedulerJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudSchedulerJob, err error) {
	result = &v1alpha1.CloudSchedulerJob{}
