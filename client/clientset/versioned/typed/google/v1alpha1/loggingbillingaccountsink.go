...
func (c *loggingBillingAccountSinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LoggingBillingAccountSink, err error) {
...
func (c *loggingBillingAccountSinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoggingBillingAccountSinkList, err error) {
...
func (c *loggingBillingAccountSinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingBillingAccountSinks) Create(ctx context.Context, loggingBillingAccountSink *v1alpha1.LoggingBillingAccountSink, opts v1.CreateOptions) (result *v1alpha1.LoggingBillingAccountSink, err error) {
	result = &v1alpha1.LoggingBillingAccountSink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loggingbillingaccountsinks").
...
func (c *loggingBillingAccountSinks) Update(ctx context.Context, loggingBillingAccountSink *v1alpha1.LoggingBillingAccountSink, opts v1.UpdateOptions) (result *v1alpha1.LoggingBillingAccountSink, err error) {
	result = &v1alpha1.LoggingBillingAccountSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingbillingaccountsinks").
...
func (c *loggingBillingAccountSinks) UpdateStatus(ctx context.Context, loggingBillingAccountSink *v1alpha1.LoggingBillingAccountSink, opts v1.UpdateOptions) (result *v1alpha1.LoggingBillingAccountSink, err error) {
	result = &v1alpha1.LoggingBillingAccountSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingbillingaccountsinks").
...
func (c *loggingBillingAccountSinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *loggingBillingAccountSinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *loggingBillingAccountSinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LoggingBillingAccountSink, err error) {
	result = &v1alpha1.LoggingBillingAccountSink{}
