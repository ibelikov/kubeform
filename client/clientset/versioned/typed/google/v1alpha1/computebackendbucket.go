...
func newComputeBackendBuckets(c *GoogleV1alpha1Client, namespace string) *computeBackendBuckets {
...
func (c *computeBackendBuckets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeBackendBucket, err error) {
...
func (c *computeBackendBuckets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeBackendBucketList, err error) {
...
func (c *computeBackendBuckets) Create(ctx context.Context, computeBackendBucket *v1alpha1.ComputeBackendBucket, opts v1.CreateOptions) (result *v1alpha1.ComputeBackendBucket, err error) {
	result = &v1alpha1.ComputeBackendBucket{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computebackendbuckets").
...
func (c *computeBackendBuckets) Update(ctx context.Context, computeBackendBucket *v1alpha1.ComputeBackendBucket, opts v1.UpdateOptions) (result *v1alpha1.ComputeBackendBucket, err error) {
	result = &v1alpha1.ComputeBackendBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computebackendbuckets").
...
func (c *computeBackendBuckets) UpdateStatus(ctx context.Context, computeBackendBucket *v1alpha1.ComputeBackendBucket, opts v1.UpdateOptions) (result *v1alpha1.ComputeBackendBucket, err error) {
	result = &v1alpha1.ComputeBackendBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computebackendbuckets").
...
func (c *computeBackendBuckets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeBackendBucket, err error) {
	result = &v1alpha1.ComputeBackendBucket{}
