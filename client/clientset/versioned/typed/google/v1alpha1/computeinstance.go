...
func (c *computeInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeInstance, err error) {
...
func (c *computeInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeInstanceList, err error) {
...
func (c *computeInstances) Create(ctx context.Context, computeInstance *v1alpha1.ComputeInstance, opts v1.CreateOptions) (result *v1alpha1.ComputeInstance, err error) {
	result = &v1alpha1.ComputeInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeinstances").
...
func (c *computeInstances) Update(ctx context.Context, computeInstance *v1alpha1.ComputeInstance, opts v1.UpdateOptions) (result *v1alpha1.ComputeInstance, err error) {
	result = &v1alpha1.ComputeInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinstances").
...
func (c *computeInstances) UpdateStatus(ctx context.Context, computeInstance *v1alpha1.ComputeInstance, opts v1.UpdateOptions) (result *v1alpha1.ComputeInstance, err error) {
	result = &v1alpha1.ComputeInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinstances").
...
func (c *computeInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeInstance, err error) {
	result = &v1alpha1.ComputeInstance{}
