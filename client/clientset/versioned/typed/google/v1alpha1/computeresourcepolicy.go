...
func (c *computeResourcePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeResourcePolicy, err error) {
...
func (c *computeResourcePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeResourcePolicyList, err error) {
...
func (c *computeResourcePolicies) Create(ctx context.Context, computeResourcePolicy *v1alpha1.ComputeResourcePolicy, opts v1.CreateOptions) (result *v1alpha1.ComputeResourcePolicy, err error) {
	result = &v1alpha1.ComputeResourcePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeresourcepolicies").
...
func (c *computeResourcePolicies) Update(ctx context.Context, computeResourcePolicy *v1alpha1.ComputeResourcePolicy, opts v1.UpdateOptions) (result *v1alpha1.ComputeResourcePolicy, err error) {
	result = &v1alpha1.ComputeResourcePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeresourcepolicies").
...
func (c *computeResourcePolicies) UpdateStatus(ctx context.Context, computeResourcePolicy *v1alpha1.ComputeResourcePolicy, opts v1.UpdateOptions) (result *v1alpha1.ComputeResourcePolicy, err error) {
	result = &v1alpha1.ComputeResourcePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeresourcepolicies").
...
func (c *computeResourcePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeResourcePolicy, err error) {
	result = &v1alpha1.ComputeResourcePolicy{}
