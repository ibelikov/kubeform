...
type MonitoringUptimeCheckConfigInterface interface {
	Create(*v1alpha1.MonitoringUptimeCheckConfig) (*v1alpha1.MonitoringUptimeCheckConfig, error)
	Update(*v1alpha1.MonitoringUptimeCheckConfig) (*v1alpha1.MonitoringUptimeCheckConfig, error)
	UpdateStatus(*v1alpha1.MonitoringUptimeCheckConfig) (*v1alpha1.MonitoringUptimeCheckConfig, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MonitoringUptimeCheckConfig, error)
	List(opts v1.ListOptions) (*v1alpha1.MonitoringUptimeCheckConfigList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MonitoringUptimeCheckConfig, err error)
...
func (c *monitoringUptimeCheckConfigs) List(opts v1.ListOptions) (result *v1alpha1.MonitoringUptimeCheckConfigList, err error) {
...
func (c *monitoringUptimeCheckConfigs) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitoringUptimeCheckConfigs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
