...
type StorageBucketIamBindingInterface interface {
	Create(*v1alpha1.StorageBucketIamBinding) (*v1alpha1.StorageBucketIamBinding, error)
	Update(*v1alpha1.StorageBucketIamBinding) (*v1alpha1.StorageBucketIamBinding, error)
	UpdateStatus(*v1alpha1.StorageBucketIamBinding) (*v1alpha1.StorageBucketIamBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.StorageBucketIamBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.StorageBucketIamBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StorageBucketIamBinding, err error)
...
func (c *storageBucketIamBindings) List(opts v1.ListOptions) (result *v1alpha1.StorageBucketIamBindingList, err error) {
...
func (c *storageBucketIamBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageBucketIamBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
