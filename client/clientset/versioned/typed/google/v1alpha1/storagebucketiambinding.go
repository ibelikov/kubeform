...
func (c *storageBucketIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageBucketIamBinding, err error) {
...
func (c *storageBucketIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageBucketIamBindingList, err error) {
...
func (c *storageBucketIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageBucketIamBindings) Create(ctx context.Context, storageBucketIamBinding *v1alpha1.StorageBucketIamBinding, opts v1.CreateOptions) (result *v1alpha1.StorageBucketIamBinding, err error) {
	result = &v1alpha1.StorageBucketIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagebucketiambindings").
...
func (c *storageBucketIamBindings) Update(ctx context.Context, storageBucketIamBinding *v1alpha1.StorageBucketIamBinding, opts v1.UpdateOptions) (result *v1alpha1.StorageBucketIamBinding, err error) {
	result = &v1alpha1.StorageBucketIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebucketiambindings").
...
func (c *storageBucketIamBindings) UpdateStatus(ctx context.Context, storageBucketIamBinding *v1alpha1.StorageBucketIamBinding, opts v1.UpdateOptions) (result *v1alpha1.StorageBucketIamBinding, err error) {
	result = &v1alpha1.StorageBucketIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebucketiambindings").
...
func (c *storageBucketIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageBucketIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageBucketIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageBucketIamBinding, err error) {
	result = &v1alpha1.StorageBucketIamBinding{}
