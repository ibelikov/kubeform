...
func (c *computeRouterInterfaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeRouterInterface, err error) {
...
func (c *computeRouterInterfaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeRouterInterfaceList, err error) {
...
func (c *computeRouterInterfaces) Create(ctx context.Context, computeRouterInterface *v1alpha1.ComputeRouterInterface, opts v1.CreateOptions) (result *v1alpha1.ComputeRouterInterface, err error) {
	result = &v1alpha1.ComputeRouterInterface{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computerouterinterfaces").
...
func (c *computeRouterInterfaces) Update(ctx context.Context, computeRouterInterface *v1alpha1.ComputeRouterInterface, opts v1.UpdateOptions) (result *v1alpha1.ComputeRouterInterface, err error) {
	result = &v1alpha1.ComputeRouterInterface{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computerouterinterfaces").
...
func (c *computeRouterInterfaces) UpdateStatus(ctx context.Context, computeRouterInterface *v1alpha1.ComputeRouterInterface, opts v1.UpdateOptions) (result *v1alpha1.ComputeRouterInterface, err error) {
	result = &v1alpha1.ComputeRouterInterface{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computerouterinterfaces").
...
func (c *computeRouterInterfaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeRouterInterface, err error) {
	result = &v1alpha1.ComputeRouterInterface{}
