...
func (c *spannerDatabases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpannerDatabase, err error) {
...
func (c *spannerDatabases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpannerDatabaseList, err error) {
...
func (c *spannerDatabases) Create(ctx context.Context, spannerDatabase *v1alpha1.SpannerDatabase, opts v1.CreateOptions) (result *v1alpha1.SpannerDatabase, err error) {
	result = &v1alpha1.SpannerDatabase{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spannerdatabases").
...
func (c *spannerDatabases) Update(ctx context.Context, spannerDatabase *v1alpha1.SpannerDatabase, opts v1.UpdateOptions) (result *v1alpha1.SpannerDatabase, err error) {
	result = &v1alpha1.SpannerDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spannerdatabases").
...
func (c *spannerDatabases) UpdateStatus(ctx context.Context, spannerDatabase *v1alpha1.SpannerDatabase, opts v1.UpdateOptions) (result *v1alpha1.SpannerDatabase, err error) {
	result = &v1alpha1.SpannerDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spannerdatabases").
...
func (c *spannerDatabases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SpannerDatabase, err error) {
	result = &v1alpha1.SpannerDatabase{}
