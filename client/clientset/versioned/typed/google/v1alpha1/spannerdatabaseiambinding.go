...
type SpannerDatabaseIamBindingInterface interface {
	Create(*v1alpha1.SpannerDatabaseIamBinding) (*v1alpha1.SpannerDatabaseIamBinding, error)
	Update(*v1alpha1.SpannerDatabaseIamBinding) (*v1alpha1.SpannerDatabaseIamBinding, error)
	UpdateStatus(*v1alpha1.SpannerDatabaseIamBinding) (*v1alpha1.SpannerDatabaseIamBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.SpannerDatabaseIamBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.SpannerDatabaseIamBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.SpannerDatabaseIamBinding, err error)
...
func (c *spannerDatabaseIamBindings) List(opts v1.ListOptions) (result *v1alpha1.SpannerDatabaseIamBindingList, err error) {
...
func (c *spannerDatabaseIamBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *spannerDatabaseIamBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
