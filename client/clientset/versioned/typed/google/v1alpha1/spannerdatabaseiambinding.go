...
func (c *spannerDatabaseIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpannerDatabaseIamBinding, err error) {
...
func (c *spannerDatabaseIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpannerDatabaseIamBindingList, err error) {
...
func (c *spannerDatabaseIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *spannerDatabaseIamBindings) Create(ctx context.Context, spannerDatabaseIamBinding *v1alpha1.SpannerDatabaseIamBinding, opts v1.CreateOptions) (result *v1alpha1.SpannerDatabaseIamBinding, err error) {
	result = &v1alpha1.SpannerDatabaseIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spannerdatabaseiambindings").
...
func (c *spannerDatabaseIamBindings) Update(ctx context.Context, spannerDatabaseIamBinding *v1alpha1.SpannerDatabaseIamBinding, opts v1.UpdateOptions) (result *v1alpha1.SpannerDatabaseIamBinding, err error) {
	result = &v1alpha1.SpannerDatabaseIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spannerdatabaseiambindings").
...
func (c *spannerDatabaseIamBindings) UpdateStatus(ctx context.Context, spannerDatabaseIamBinding *v1alpha1.SpannerDatabaseIamBinding, opts v1.UpdateOptions) (result *v1alpha1.SpannerDatabaseIamBinding, err error) {
	result = &v1alpha1.SpannerDatabaseIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spannerdatabaseiambindings").
...
func (c *spannerDatabaseIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *spannerDatabaseIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *spannerDatabaseIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SpannerDatabaseIamBinding, err error) {
	result = &v1alpha1.SpannerDatabaseIamBinding{}
