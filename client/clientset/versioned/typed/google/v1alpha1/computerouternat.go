...
func (c *computeRouterNATs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeRouterNAT, err error) {
...
func (c *computeRouterNATs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeRouterNATList, err error) {
...
func (c *computeRouterNATs) Create(ctx context.Context, computeRouterNAT *v1alpha1.ComputeRouterNAT, opts v1.CreateOptions) (result *v1alpha1.ComputeRouterNAT, err error) {
	result = &v1alpha1.ComputeRouterNAT{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computerouternats").
...
func (c *computeRouterNATs) Update(ctx context.Context, computeRouterNAT *v1alpha1.ComputeRouterNAT, opts v1.UpdateOptions) (result *v1alpha1.ComputeRouterNAT, err error) {
	result = &v1alpha1.ComputeRouterNAT{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computerouternats").
...
func (c *computeRouterNATs) UpdateStatus(ctx context.Context, computeRouterNAT *v1alpha1.ComputeRouterNAT, opts v1.UpdateOptions) (result *v1alpha1.ComputeRouterNAT, err error) {
	result = &v1alpha1.ComputeRouterNAT{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computerouternats").
...
func (c *computeRouterNATs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeRouterNAT, err error) {
	result = &v1alpha1.ComputeRouterNAT{}
