...
func (c *storageObjectAccessControls) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageObjectAccessControl, err error) {
...
func (c *storageObjectAccessControls) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageObjectAccessControlList, err error) {
...
func (c *storageObjectAccessControls) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageObjectAccessControls) Create(ctx context.Context, storageObjectAccessControl *v1alpha1.StorageObjectAccessControl, opts v1.CreateOptions) (result *v1alpha1.StorageObjectAccessControl, err error) {
	result = &v1alpha1.StorageObjectAccessControl{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storageobjectaccesscontrols").
...
func (c *storageObjectAccessControls) Update(ctx context.Context, storageObjectAccessControl *v1alpha1.StorageObjectAccessControl, opts v1.UpdateOptions) (result *v1alpha1.StorageObjectAccessControl, err error) {
	result = &v1alpha1.StorageObjectAccessControl{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storageobjectaccesscontrols").
...
func (c *storageObjectAccessControls) UpdateStatus(ctx context.Context, storageObjectAccessControl *v1alpha1.StorageObjectAccessControl, opts v1.UpdateOptions) (result *v1alpha1.StorageObjectAccessControl, err error) {
	result = &v1alpha1.StorageObjectAccessControl{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storageobjectaccesscontrols").
...
func (c *storageObjectAccessControls) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageObjectAccessControls) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageObjectAccessControls) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageObjectAccessControl, err error) {
	result = &v1alpha1.StorageObjectAccessControl{}
