...
func (c *loggingFolderExclusions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LoggingFolderExclusion, err error) {
...
func (c *loggingFolderExclusions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoggingFolderExclusionList, err error) {
...
func (c *loggingFolderExclusions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingFolderExclusions) Create(ctx context.Context, loggingFolderExclusion *v1alpha1.LoggingFolderExclusion, opts v1.CreateOptions) (result *v1alpha1.LoggingFolderExclusion, err error) {
	result = &v1alpha1.LoggingFolderExclusion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loggingfolderexclusions").
...
func (c *loggingFolderExclusions) Update(ctx context.Context, loggingFolderExclusion *v1alpha1.LoggingFolderExclusion, opts v1.UpdateOptions) (result *v1alpha1.LoggingFolderExclusion, err error) {
	result = &v1alpha1.LoggingFolderExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingfolderexclusions").
...
func (c *loggingFolderExclusions) UpdateStatus(ctx context.Context, loggingFolderExclusion *v1alpha1.LoggingFolderExclusion, opts v1.UpdateOptions) (result *v1alpha1.LoggingFolderExclusion, err error) {
	result = &v1alpha1.LoggingFolderExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingfolderexclusions").
...
func (c *loggingFolderExclusions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *loggingFolderExclusions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *loggingFolderExclusions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LoggingFolderExclusion, err error) {
	result = &v1alpha1.LoggingFolderExclusion{}
