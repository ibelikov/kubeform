...
type LoggingFolderExclusionInterface interface {
	Create(*v1alpha1.LoggingFolderExclusion) (*v1alpha1.LoggingFolderExclusion, error)
	Update(*v1alpha1.LoggingFolderExclusion) (*v1alpha1.LoggingFolderExclusion, error)
	UpdateStatus(*v1alpha1.LoggingFolderExclusion) (*v1alpha1.LoggingFolderExclusion, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.LoggingFolderExclusion, error)
	List(opts v1.ListOptions) (*v1alpha1.LoggingFolderExclusionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.LoggingFolderExclusion, err error)
...
func (c *loggingFolderExclusions) List(opts v1.ListOptions) (result *v1alpha1.LoggingFolderExclusionList, err error) {
...
func (c *loggingFolderExclusions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingFolderExclusions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
