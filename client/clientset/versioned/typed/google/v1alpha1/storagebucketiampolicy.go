...
func newStorageBucketIamPolicies(c *GoogleV1alpha1Client, namespace string) *storageBucketIamPolicies {
...
func (c *storageBucketIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageBucketIamPolicy, err error) {
...
func (c *storageBucketIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageBucketIamPolicyList, err error) {
...
func (c *storageBucketIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageBucketIamPolicies) Create(ctx context.Context, storageBucketIamPolicy *v1alpha1.StorageBucketIamPolicy, opts v1.CreateOptions) (result *v1alpha1.StorageBucketIamPolicy, err error) {
	result = &v1alpha1.StorageBucketIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagebucketiampolicies").
...
func (c *storageBucketIamPolicies) Update(ctx context.Context, storageBucketIamPolicy *v1alpha1.StorageBucketIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.StorageBucketIamPolicy, err error) {
	result = &v1alpha1.StorageBucketIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebucketiampolicies").
...
func (c *storageBucketIamPolicies) UpdateStatus(ctx context.Context, storageBucketIamPolicy *v1alpha1.StorageBucketIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.StorageBucketIamPolicy, err error) {
	result = &v1alpha1.StorageBucketIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebucketiampolicies").
...
func (c *storageBucketIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageBucketIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageBucketIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageBucketIamPolicy, err error) {
	result = &v1alpha1.StorageBucketIamPolicy{}
