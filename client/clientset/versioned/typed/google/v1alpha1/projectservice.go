...
func newProjectServices(c *GoogleV1alpha1Client, namespace string) *projectServices {
...
func (c *projectServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectService, err error) {
...
func (c *projectServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectServiceList, err error) {
...
func (c *projectServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectServices) Create(ctx context.Context, projectService *v1alpha1.ProjectService, opts v1.CreateOptions) (result *v1alpha1.ProjectService, err error) {
	result = &v1alpha1.ProjectService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectservices").
...
func (c *projectServices) Update(ctx context.Context, projectService *v1alpha1.ProjectService, opts v1.UpdateOptions) (result *v1alpha1.ProjectService, err error) {
	result = &v1alpha1.ProjectService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectservices").
...
func (c *projectServices) UpdateStatus(ctx context.Context, projectService *v1alpha1.ProjectService, opts v1.UpdateOptions) (result *v1alpha1.ProjectService, err error) {
	result = &v1alpha1.ProjectService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectservices").
...
func (c *projectServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectService, err error) {
	result = &v1alpha1.ProjectService{}
