...
func (c *organizationIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OrganizationIamMember, err error) {
...
func (c *organizationIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OrganizationIamMemberList, err error) {
...
func (c *organizationIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *organizationIamMembers) Create(ctx context.Context, organizationIamMember *v1alpha1.OrganizationIamMember, opts v1.CreateOptions) (result *v1alpha1.OrganizationIamMember, err error) {
	result = &v1alpha1.OrganizationIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("organizationiammembers").
...
func (c *organizationIamMembers) Update(ctx context.Context, organizationIamMember *v1alpha1.OrganizationIamMember, opts v1.UpdateOptions) (result *v1alpha1.OrganizationIamMember, err error) {
	result = &v1alpha1.OrganizationIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationiammembers").
...
func (c *organizationIamMembers) UpdateStatus(ctx context.Context, organizationIamMember *v1alpha1.OrganizationIamMember, opts v1.UpdateOptions) (result *v1alpha1.OrganizationIamMember, err error) {
	result = &v1alpha1.OrganizationIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationiammembers").
...
func (c *organizationIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *organizationIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *organizationIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OrganizationIamMember, err error) {
	result = &v1alpha1.OrganizationIamMember{}
