...
func newStorageTransferJobs(c *GoogleV1alpha1Client, namespace string) *storageTransferJobs {
...
func (c *storageTransferJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageTransferJob, err error) {
	result = &v1alpha1.StorageTransferJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *storageTransferJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageTransferJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.StorageTransferJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("storagetransferjobs").
...
func (c *storageTransferJobs) Create(ctx context.Context, storageTransferJob *v1alpha1.StorageTransferJob, opts v1.CreateOptions) (result *v1alpha1.StorageTransferJob, err error) {
	result = &v1alpha1.StorageTransferJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagetransferjobs").
...
func (c *storageTransferJobs) Update(ctx context.Context, storageTransferJob *v1alpha1.StorageTransferJob, opts v1.UpdateOptions) (result *v1alpha1.StorageTransferJob, err error) {
	result = &v1alpha1.StorageTransferJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagetransferjobs").
...
func (c *storageTransferJobs) UpdateStatus(ctx context.Context, storageTransferJob *v1alpha1.StorageTransferJob, opts v1.UpdateOptions) (result *v1alpha1.StorageTransferJob, err error) {
	result = &v1alpha1.StorageTransferJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagetransferjobs").
...
func (c *storageTransferJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageTransferJob, err error) {
	result = &v1alpha1.StorageTransferJob{}
