...
func (c *monitoringAlertPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonitoringAlertPolicy, err error) {
...
func (c *monitoringAlertPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonitoringAlertPolicyList, err error) {
...
func (c *monitoringAlertPolicies) Create(ctx context.Context, monitoringAlertPolicy *v1alpha1.MonitoringAlertPolicy, opts v1.CreateOptions) (result *v1alpha1.MonitoringAlertPolicy, err error) {
	result = &v1alpha1.MonitoringAlertPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitoringalertpolicies").
...
func (c *monitoringAlertPolicies) Update(ctx context.Context, monitoringAlertPolicy *v1alpha1.MonitoringAlertPolicy, opts v1.UpdateOptions) (result *v1alpha1.MonitoringAlertPolicy, err error) {
	result = &v1alpha1.MonitoringAlertPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringalertpolicies").
...
func (c *monitoringAlertPolicies) UpdateStatus(ctx context.Context, monitoringAlertPolicy *v1alpha1.MonitoringAlertPolicy, opts v1.UpdateOptions) (result *v1alpha1.MonitoringAlertPolicy, err error) {
	result = &v1alpha1.MonitoringAlertPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringalertpolicies").
...
func (c *monitoringAlertPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MonitoringAlertPolicy, err error) {
	result = &v1alpha1.MonitoringAlertPolicy{}
