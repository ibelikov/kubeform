...
type MonitoringAlertPolicyInterface interface {
	Create(*v1alpha1.MonitoringAlertPolicy) (*v1alpha1.MonitoringAlertPolicy, error)
	Update(*v1alpha1.MonitoringAlertPolicy) (*v1alpha1.MonitoringAlertPolicy, error)
	UpdateStatus(*v1alpha1.MonitoringAlertPolicy) (*v1alpha1.MonitoringAlertPolicy, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MonitoringAlertPolicy, error)
	List(opts v1.ListOptions) (*v1alpha1.MonitoringAlertPolicyList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MonitoringAlertPolicy, err error)
...
func (c *monitoringAlertPolicies) List(opts v1.ListOptions) (result *v1alpha1.MonitoringAlertPolicyList, err error) {
...
func (c *monitoringAlertPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitoringAlertPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
