...
func (c *cloudbuildTriggers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudbuildTrigger, err error) {
...
func (c *cloudbuildTriggers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudbuildTriggerList, err error) {
...
func (c *cloudbuildTriggers) Create(ctx context.Context, cloudbuildTrigger *v1alpha1.CloudbuildTrigger, opts v1.CreateOptions) (result *v1alpha1.CloudbuildTrigger, err error) {
	result = &v1alpha1.CloudbuildTrigger{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudbuildtriggers").
...
func (c *cloudbuildTriggers) Update(ctx context.Context, cloudbuildTrigger *v1alpha1.CloudbuildTrigger, opts v1.UpdateOptions) (result *v1alpha1.CloudbuildTrigger, err error) {
	result = &v1alpha1.CloudbuildTrigger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudbuildtriggers").
...
func (c *cloudbuildTriggers) UpdateStatus(ctx context.Context, cloudbuildTrigger *v1alpha1.CloudbuildTrigger, opts v1.UpdateOptions) (result *v1alpha1.CloudbuildTrigger, err error) {
	result = &v1alpha1.CloudbuildTrigger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudbuildtriggers").
...
func (c *cloudbuildTriggers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudbuildTrigger, err error) {
	result = &v1alpha1.CloudbuildTrigger{}
