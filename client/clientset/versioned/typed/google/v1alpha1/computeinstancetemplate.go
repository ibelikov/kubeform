...
type ComputeInstanceTemplateInterface interface {
	Create(*v1alpha1.ComputeInstanceTemplate) (*v1alpha1.ComputeInstanceTemplate, error)
	Update(*v1alpha1.ComputeInstanceTemplate) (*v1alpha1.ComputeInstanceTemplate, error)
	UpdateStatus(*v1alpha1.ComputeInstanceTemplate) (*v1alpha1.ComputeInstanceTemplate, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ComputeInstanceTemplate, error)
	List(opts v1.ListOptions) (*v1alpha1.ComputeInstanceTemplateList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ComputeInstanceTemplate, err error)
...
func (c *computeInstanceTemplates) Get(name string, options v1.GetOptions) (result *v1alpha1.ComputeInstanceTemplate, err error) {
...
func (c *computeInstanceTemplates) List(opts v1.ListOptions) (result *v1alpha1.ComputeInstanceTemplateList, err error) {
...
func (c *computeInstanceTemplates) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeInstanceTemplates) Create(computeInstanceTemplate *v1alpha1.ComputeInstanceTemplate) (result *v1alpha1.ComputeInstanceTemplate, err error) {
	result = &v1alpha1.ComputeInstanceTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeinstancetemplates").
...
func (c *computeInstanceTemplates) Update(computeInstanceTemplate *v1alpha1.ComputeInstanceTemplate) (result *v1alpha1.ComputeInstanceTemplate, err error) {
	result = &v1alpha1.ComputeInstanceTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinstancetemplates").
...
func (c *computeInstanceTemplates) UpdateStatus(computeInstanceTemplate *v1alpha1.ComputeInstanceTemplate) (result *v1alpha1.ComputeInstanceTemplate, err error) {
	result = &v1alpha1.ComputeInstanceTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinstancetemplates").
...
func (c *computeInstanceTemplates) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *computeInstanceTemplates) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeInstanceTemplates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ComputeInstanceTemplate, err error) {
	result = &v1alpha1.ComputeInstanceTemplate{}
