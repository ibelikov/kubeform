...
func newStorageBucketIamMembers(c *GoogleV1alpha1Client, namespace string) *storageBucketIamMembers {
...
func (c *storageBucketIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageBucketIamMember, err error) {
...
func (c *storageBucketIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageBucketIamMemberList, err error) {
...
func (c *storageBucketIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageBucketIamMembers) Create(ctx context.Context, storageBucketIamMember *v1alpha1.StorageBucketIamMember, opts v1.CreateOptions) (result *v1alpha1.StorageBucketIamMember, err error) {
	result = &v1alpha1.StorageBucketIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagebucketiammembers").
...
func (c *storageBucketIamMembers) Update(ctx context.Context, storageBucketIamMember *v1alpha1.StorageBucketIamMember, opts v1.UpdateOptions) (result *v1alpha1.StorageBucketIamMember, err error) {
	result = &v1alpha1.StorageBucketIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebucketiammembers").
...
func (c *storageBucketIamMembers) UpdateStatus(ctx context.Context, storageBucketIamMember *v1alpha1.StorageBucketIamMember, opts v1.UpdateOptions) (result *v1alpha1.StorageBucketIamMember, err error) {
	result = &v1alpha1.StorageBucketIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebucketiammembers").
...
func (c *storageBucketIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageBucketIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageBucketIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageBucketIamMember, err error) {
	result = &v1alpha1.StorageBucketIamMember{}
