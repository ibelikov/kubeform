...
func (c *computeImages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeImage, err error) {
...
func (c *computeImages) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeImageList, err error) {
...
func (c *computeImages) Create(ctx context.Context, computeImage *v1alpha1.ComputeImage, opts v1.CreateOptions) (result *v1alpha1.ComputeImage, err error) {
	result = &v1alpha1.ComputeImage{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeimages").
...
func (c *computeImages) Update(ctx context.Context, computeImage *v1alpha1.ComputeImage, opts v1.UpdateOptions) (result *v1alpha1.ComputeImage, err error) {
	result = &v1alpha1.ComputeImage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeimages").
...
func (c *computeImages) UpdateStatus(ctx context.Context, computeImage *v1alpha1.ComputeImage, opts v1.UpdateOptions) (result *v1alpha1.ComputeImage, err error) {
	result = &v1alpha1.ComputeImage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeimages").
...
func (c *computeImages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeImage, err error) {
	result = &v1alpha1.ComputeImage{}
