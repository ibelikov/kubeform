...
func (c *computeNetworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeNetwork, err error) {
...
func (c *computeNetworks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeNetworkList, err error) {
...
func (c *computeNetworks) Create(ctx context.Context, computeNetwork *v1alpha1.ComputeNetwork, opts v1.CreateOptions) (result *v1alpha1.ComputeNetwork, err error) {
	result = &v1alpha1.ComputeNetwork{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computenetworks").
...
func (c *computeNetworks) Update(ctx context.Context, computeNetwork *v1alpha1.ComputeNetwork, opts v1.UpdateOptions) (result *v1alpha1.ComputeNetwork, err error) {
	result = &v1alpha1.ComputeNetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenetworks").
...
func (c *computeNetworks) UpdateStatus(ctx context.Context, computeNetwork *v1alpha1.ComputeNetwork, opts v1.UpdateOptions) (result *v1alpha1.ComputeNetwork, err error) {
	result = &v1alpha1.ComputeNetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenetworks").
...
func (c *computeNetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeNetwork, err error) {
	result = &v1alpha1.ComputeNetwork{}
