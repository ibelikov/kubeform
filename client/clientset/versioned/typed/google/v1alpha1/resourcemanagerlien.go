...
func (c *resourceManagerLiens) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourceManagerLien, err error) {
...
func (c *resourceManagerLiens) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceManagerLienList, err error) {
...
func (c *resourceManagerLiens) Create(ctx context.Context, resourceManagerLien *v1alpha1.ResourceManagerLien, opts v1.CreateOptions) (result *v1alpha1.ResourceManagerLien, err error) {
	result = &v1alpha1.ResourceManagerLien{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourcemanagerliens").
...
func (c *resourceManagerLiens) Update(ctx context.Context, resourceManagerLien *v1alpha1.ResourceManagerLien, opts v1.UpdateOptions) (result *v1alpha1.ResourceManagerLien, err error) {
	result = &v1alpha1.ResourceManagerLien{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcemanagerliens").
...
func (c *resourceManagerLiens) UpdateStatus(ctx context.Context, resourceManagerLien *v1alpha1.ResourceManagerLien, opts v1.UpdateOptions) (result *v1alpha1.ResourceManagerLien, err error) {
	result = &v1alpha1.ResourceManagerLien{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcemanagerliens").
...
func (c *resourceManagerLiens) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourceManagerLien, err error) {
	result = &v1alpha1.ResourceManagerLien{}
