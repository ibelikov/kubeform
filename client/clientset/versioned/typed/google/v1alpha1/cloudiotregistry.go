...
func (c *cloudiotRegistries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudiotRegistry, err error) {
...
func (c *cloudiotRegistries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudiotRegistryList, err error) {
...
func (c *cloudiotRegistries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudiotRegistries) Create(ctx context.Context, cloudiotRegistry *v1alpha1.CloudiotRegistry, opts v1.CreateOptions) (result *v1alpha1.CloudiotRegistry, err error) {
	result = &v1alpha1.CloudiotRegistry{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudiotregistries").
...
func (c *cloudiotRegistries) Update(ctx context.Context, cloudiotRegistry *v1alpha1.CloudiotRegistry, opts v1.UpdateOptions) (result *v1alpha1.CloudiotRegistry, err error) {
	result = &v1alpha1.CloudiotRegistry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudiotregistries").
...
func (c *cloudiotRegistries) UpdateStatus(ctx context.Context, cloudiotRegistry *v1alpha1.CloudiotRegistry, opts v1.UpdateOptions) (result *v1alpha1.CloudiotRegistry, err error) {
	result = &v1alpha1.CloudiotRegistry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudiotregistries").
...
func (c *cloudiotRegistries) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudiotRegistries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudiotRegistries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudiotRegistry, err error) {
	result = &v1alpha1.CloudiotRegistry{}
