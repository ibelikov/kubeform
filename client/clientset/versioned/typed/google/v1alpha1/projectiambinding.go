...
func (c *projectIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectIamBinding, err error) {
...
func (c *projectIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectIamBindingList, err error) {
...
func (c *projectIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectIamBindings) Create(ctx context.Context, projectIamBinding *v1alpha1.ProjectIamBinding, opts v1.CreateOptions) (result *v1alpha1.ProjectIamBinding, err error) {
	result = &v1alpha1.ProjectIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectiambindings").
...
func (c *projectIamBindings) Update(ctx context.Context, projectIamBinding *v1alpha1.ProjectIamBinding, opts v1.UpdateOptions) (result *v1alpha1.ProjectIamBinding, err error) {
	result = &v1alpha1.ProjectIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectiambindings").
...
func (c *projectIamBindings) UpdateStatus(ctx context.Context, projectIamBinding *v1alpha1.ProjectIamBinding, opts v1.UpdateOptions) (result *v1alpha1.ProjectIamBinding, err error) {
	result = &v1alpha1.ProjectIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectiambindings").
...
func (c *projectIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectIamBinding, err error) {
	result = &v1alpha1.ProjectIamBinding{}
