...
func (c *computeHealthChecks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeHealthCheck, err error) {
...
func (c *computeHealthChecks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeHealthCheckList, err error) {
...
func (c *computeHealthChecks) Create(ctx context.Context, computeHealthCheck *v1alpha1.ComputeHealthCheck, opts v1.CreateOptions) (result *v1alpha1.ComputeHealthCheck, err error) {
	result = &v1alpha1.ComputeHealthCheck{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computehealthchecks").
...
func (c *computeHealthChecks) Update(ctx context.Context, computeHealthCheck *v1alpha1.ComputeHealthCheck, opts v1.UpdateOptions) (result *v1alpha1.ComputeHealthCheck, err error) {
	result = &v1alpha1.ComputeHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehealthchecks").
...
func (c *computeHealthChecks) UpdateStatus(ctx context.Context, computeHealthCheck *v1alpha1.ComputeHealthCheck, opts v1.UpdateOptions) (result *v1alpha1.ComputeHealthCheck, err error) {
	result = &v1alpha1.ComputeHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehealthchecks").
...
func (c *computeHealthChecks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeHealthCheck, err error) {
	result = &v1alpha1.ComputeHealthCheck{}
