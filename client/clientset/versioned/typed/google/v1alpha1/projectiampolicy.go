...
type ProjectIamPolicyInterface interface {
	Create(*v1alpha1.ProjectIamPolicy) (*v1alpha1.ProjectIamPolicy, error)
	Update(*v1alpha1.ProjectIamPolicy) (*v1alpha1.ProjectIamPolicy, error)
	UpdateStatus(*v1alpha1.ProjectIamPolicy) (*v1alpha1.ProjectIamPolicy, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ProjectIamPolicy, error)
	List(opts v1.ListOptions) (*v1alpha1.ProjectIamPolicyList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ProjectIamPolicy, err error)
...
func (c *projectIamPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.ProjectIamPolicy, err error) {
...
func (c *projectIamPolicies) List(opts v1.ListOptions) (result *v1alpha1.ProjectIamPolicyList, err error) {
...
func (c *projectIamPolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectIamPolicies) Create(projectIamPolicy *v1alpha1.ProjectIamPolicy) (result *v1alpha1.ProjectIamPolicy, err error) {
	result = &v1alpha1.ProjectIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectiampolicies").
...
func (c *projectIamPolicies) Update(projectIamPolicy *v1alpha1.ProjectIamPolicy) (result *v1alpha1.ProjectIamPolicy, err error) {
	result = &v1alpha1.ProjectIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectiampolicies").
...
func (c *projectIamPolicies) UpdateStatus(projectIamPolicy *v1alpha1.ProjectIamPolicy) (result *v1alpha1.ProjectIamPolicy, err error) {
	result = &v1alpha1.ProjectIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectiampolicies").
...
func (c *projectIamPolicies) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *projectIamPolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectIamPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ProjectIamPolicy, err error) {
	result = &v1alpha1.ProjectIamPolicy{}
