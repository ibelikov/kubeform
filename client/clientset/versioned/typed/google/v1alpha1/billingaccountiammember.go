...
func (c *billingAccountIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BillingAccountIamMember, err error) {
...
func (c *billingAccountIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BillingAccountIamMemberList, err error) {
...
func (c *billingAccountIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *billingAccountIamMembers) Create(ctx context.Context, billingAccountIamMember *v1alpha1.BillingAccountIamMember, opts v1.CreateOptions) (result *v1alpha1.BillingAccountIamMember, err error) {
	result = &v1alpha1.BillingAccountIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("billingaccountiammembers").
...
func (c *billingAccountIamMembers) Update(ctx context.Context, billingAccountIamMember *v1alpha1.BillingAccountIamMember, opts v1.UpdateOptions) (result *v1alpha1.BillingAccountIamMember, err error) {
	result = &v1alpha1.BillingAccountIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("billingaccountiammembers").
...
func (c *billingAccountIamMembers) UpdateStatus(ctx context.Context, billingAccountIamMember *v1alpha1.BillingAccountIamMember, opts v1.UpdateOptions) (result *v1alpha1.BillingAccountIamMember, err error) {
	result = &v1alpha1.BillingAccountIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("billingaccountiammembers").
...
func (c *billingAccountIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *billingAccountIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *billingAccountIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BillingAccountIamMember, err error) {
	result = &v1alpha1.BillingAccountIamMember{}
