...
func (c *bigqueryTables) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BigqueryTable, err error) {
...
func (c *bigqueryTables) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BigqueryTableList, err error) {
...
func (c *bigqueryTables) Create(ctx context.Context, bigqueryTable *v1alpha1.BigqueryTable, opts v1.CreateOptions) (result *v1alpha1.BigqueryTable, err error) {
	result = &v1alpha1.BigqueryTable{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bigquerytables").
...
func (c *bigqueryTables) Update(ctx context.Context, bigqueryTable *v1alpha1.BigqueryTable, opts v1.UpdateOptions) (result *v1alpha1.BigqueryTable, err error) {
	result = &v1alpha1.BigqueryTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bigquerytables").
...
func (c *bigqueryTables) UpdateStatus(ctx context.Context, bigqueryTable *v1alpha1.BigqueryTable, opts v1.UpdateOptions) (result *v1alpha1.BigqueryTable, err error) {
	result = &v1alpha1.BigqueryTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bigquerytables").
...
func (c *bigqueryTables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BigqueryTable, err error) {
	result = &v1alpha1.BigqueryTable{}
