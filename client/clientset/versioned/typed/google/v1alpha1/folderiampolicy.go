...
func (c *folderIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FolderIamPolicy, err error) {
...
func (c *folderIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FolderIamPolicyList, err error) {
...
func (c *folderIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *folderIamPolicies) Create(ctx context.Context, folderIamPolicy *v1alpha1.FolderIamPolicy, opts v1.CreateOptions) (result *v1alpha1.FolderIamPolicy, err error) {
	result = &v1alpha1.FolderIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("folderiampolicies").
...
func (c *folderIamPolicies) Update(ctx context.Context, folderIamPolicy *v1alpha1.FolderIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.FolderIamPolicy, err error) {
	result = &v1alpha1.FolderIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("folderiampolicies").
...
func (c *folderIamPolicies) UpdateStatus(ctx context.Context, folderIamPolicy *v1alpha1.FolderIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.FolderIamPolicy, err error) {
	result = &v1alpha1.FolderIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("folderiampolicies").
...
func (c *folderIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *folderIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *folderIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FolderIamPolicy, err error) {
	result = &v1alpha1.FolderIamPolicy{}
