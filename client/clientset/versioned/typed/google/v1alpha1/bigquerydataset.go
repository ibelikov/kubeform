...
func (c *bigqueryDatasets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BigqueryDataset, err error) {
...
func (c *bigqueryDatasets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BigqueryDatasetList, err error) {
...
func (c *bigqueryDatasets) Create(ctx context.Context, bigqueryDataset *v1alpha1.BigqueryDataset, opts v1.CreateOptions) (result *v1alpha1.BigqueryDataset, err error) {
	result = &v1alpha1.BigqueryDataset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bigquerydatasets").
...
func (c *bigqueryDatasets) Update(ctx context.Context, bigqueryDataset *v1alpha1.BigqueryDataset, opts v1.UpdateOptions) (result *v1alpha1.BigqueryDataset, err error) {
	result = &v1alpha1.BigqueryDataset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bigquerydatasets").
...
func (c *bigqueryDatasets) UpdateStatus(ctx context.Context, bigqueryDataset *v1alpha1.BigqueryDataset, opts v1.UpdateOptions) (result *v1alpha1.BigqueryDataset, err error) {
	result = &v1alpha1.BigqueryDataset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bigquerydatasets").
...
func (c *bigqueryDatasets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BigqueryDataset, err error) {
	result = &v1alpha1.BigqueryDataset{}
