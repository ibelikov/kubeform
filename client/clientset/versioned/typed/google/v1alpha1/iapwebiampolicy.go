...
func (c *iapWebIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IapWebIamPolicy, err error) {
...
func (c *iapWebIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IapWebIamPolicyList, err error) {
...
func (c *iapWebIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iapWebIamPolicies) Create(ctx context.Context, iapWebIamPolicy *v1alpha1.IapWebIamPolicy, opts v1.CreateOptions) (result *v1alpha1.IapWebIamPolicy, err error) {
	result = &v1alpha1.IapWebIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iapwebiampolicies").
...
func (c *iapWebIamPolicies) Update(ctx context.Context, iapWebIamPolicy *v1alpha1.IapWebIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.IapWebIamPolicy, err error) {
	result = &v1alpha1.IapWebIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iapwebiampolicies").
...
func (c *iapWebIamPolicies) UpdateStatus(ctx context.Context, iapWebIamPolicy *v1alpha1.IapWebIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.IapWebIamPolicy, err error) {
	result = &v1alpha1.IapWebIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iapwebiampolicies").
...
func (c *iapWebIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iapWebIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iapWebIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IapWebIamPolicy, err error) {
	result = &v1alpha1.IapWebIamPolicy{}
