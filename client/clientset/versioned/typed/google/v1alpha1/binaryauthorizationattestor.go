...
func (c *binaryAuthorizationAttestors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BinaryAuthorizationAttestor, err error) {
...
func (c *binaryAuthorizationAttestors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BinaryAuthorizationAttestorList, err error) {
...
func (c *binaryAuthorizationAttestors) Create(ctx context.Context, binaryAuthorizationAttestor *v1alpha1.BinaryAuthorizationAttestor, opts v1.CreateOptions) (result *v1alpha1.BinaryAuthorizationAttestor, err error) {
	result = &v1alpha1.BinaryAuthorizationAttestor{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("binaryauthorizationattestors").
...
func (c *binaryAuthorizationAttestors) Update(ctx context.Context, binaryAuthorizationAttestor *v1alpha1.BinaryAuthorizationAttestor, opts v1.UpdateOptions) (result *v1alpha1.BinaryAuthorizationAttestor, err error) {
	result = &v1alpha1.BinaryAuthorizationAttestor{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("binaryauthorizationattestors").
...
func (c *binaryAuthorizationAttestors) UpdateStatus(ctx context.Context, binaryAuthorizationAttestor *v1alpha1.BinaryAuthorizationAttestor, opts v1.UpdateOptions) (result *v1alpha1.BinaryAuthorizationAttestor, err error) {
	result = &v1alpha1.BinaryAuthorizationAttestor{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("binaryauthorizationattestors").
...
func (c *binaryAuthorizationAttestors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BinaryAuthorizationAttestor, err error) {
	result = &v1alpha1.BinaryAuthorizationAttestor{}
