...
func (c *loggingProjectSinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LoggingProjectSink, err error) {
...
func (c *loggingProjectSinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoggingProjectSinkList, err error) {
...
func (c *loggingProjectSinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingProjectSinks) Create(ctx context.Context, loggingProjectSink *v1alpha1.LoggingProjectSink, opts v1.CreateOptions) (result *v1alpha1.LoggingProjectSink, err error) {
	result = &v1alpha1.LoggingProjectSink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loggingprojectsinks").
...
func (c *loggingProjectSinks) Update(ctx context.Context, loggingProjectSink *v1alpha1.LoggingProjectSink, opts v1.UpdateOptions) (result *v1alpha1.LoggingProjectSink, err error) {
	result = &v1alpha1.LoggingProjectSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingprojectsinks").
...
func (c *loggingProjectSinks) UpdateStatus(ctx context.Context, loggingProjectSink *v1alpha1.LoggingProjectSink, opts v1.UpdateOptions) (result *v1alpha1.LoggingProjectSink, err error) {
	result = &v1alpha1.LoggingProjectSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingprojectsinks").
...
func (c *loggingProjectSinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *loggingProjectSinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *loggingProjectSinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LoggingProjectSink, err error) {
	result = &v1alpha1.LoggingProjectSink{}
