...
func (c *filestoreInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FilestoreInstance, err error) {
...
func (c *filestoreInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FilestoreInstanceList, err error) {
...
func (c *filestoreInstances) Create(ctx context.Context, filestoreInstance *v1alpha1.FilestoreInstance, opts v1.CreateOptions) (result *v1alpha1.FilestoreInstance, err error) {
	result = &v1alpha1.FilestoreInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("filestoreinstances").
...
func (c *filestoreInstances) Update(ctx context.Context, filestoreInstance *v1alpha1.FilestoreInstance, opts v1.UpdateOptions) (result *v1alpha1.FilestoreInstance, err error) {
	result = &v1alpha1.FilestoreInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("filestoreinstances").
...
func (c *filestoreInstances) UpdateStatus(ctx context.Context, filestoreInstance *v1alpha1.FilestoreInstance, opts v1.UpdateOptions) (result *v1alpha1.FilestoreInstance, err error) {
	result = &v1alpha1.FilestoreInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("filestoreinstances").
...
func (c *filestoreInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FilestoreInstance, err error) {
	result = &v1alpha1.FilestoreInstance{}
