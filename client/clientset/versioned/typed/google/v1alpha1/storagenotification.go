...
func (c *storageNotifications) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageNotification, err error) {
...
func (c *storageNotifications) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageNotificationList, err error) {
...
func (c *storageNotifications) Create(ctx context.Context, storageNotification *v1alpha1.StorageNotification, opts v1.CreateOptions) (result *v1alpha1.StorageNotification, err error) {
	result = &v1alpha1.StorageNotification{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagenotifications").
...
func (c *storageNotifications) Update(ctx context.Context, storageNotification *v1alpha1.StorageNotification, opts v1.UpdateOptions) (result *v1alpha1.StorageNotification, err error) {
	result = &v1alpha1.StorageNotification{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagenotifications").
...
func (c *storageNotifications) UpdateStatus(ctx context.Context, storageNotification *v1alpha1.StorageNotification, opts v1.UpdateOptions) (result *v1alpha1.StorageNotification, err error) {
	result = &v1alpha1.StorageNotification{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagenotifications").
...
func (c *storageNotifications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageNotification, err error) {
	result = &v1alpha1.StorageNotification{}
