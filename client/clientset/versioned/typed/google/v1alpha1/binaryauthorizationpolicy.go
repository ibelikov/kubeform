...
func (c *binaryAuthorizationPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BinaryAuthorizationPolicy, err error) {
...
func (c *binaryAuthorizationPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BinaryAuthorizationPolicyList, err error) {
...
func (c *binaryAuthorizationPolicies) Create(ctx context.Context, binaryAuthorizationPolicy *v1alpha1.BinaryAuthorizationPolicy, opts v1.CreateOptions) (result *v1alpha1.BinaryAuthorizationPolicy, err error) {
	result = &v1alpha1.BinaryAuthorizationPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("binaryauthorizationpolicies").
...
func (c *binaryAuthorizationPolicies) Update(ctx context.Context, binaryAuthorizationPolicy *v1alpha1.BinaryAuthorizationPolicy, opts v1.UpdateOptions) (result *v1alpha1.BinaryAuthorizationPolicy, err error) {
	result = &v1alpha1.BinaryAuthorizationPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("binaryauthorizationpolicies").
...
func (c *binaryAuthorizationPolicies) UpdateStatus(ctx context.Context, binaryAuthorizationPolicy *v1alpha1.BinaryAuthorizationPolicy, opts v1.UpdateOptions) (result *v1alpha1.BinaryAuthorizationPolicy, err error) {
	result = &v1alpha1.BinaryAuthorizationPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("binaryauthorizationpolicies").
...
func (c *binaryAuthorizationPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BinaryAuthorizationPolicy, err error) {
	result = &v1alpha1.BinaryAuthorizationPolicy{}
