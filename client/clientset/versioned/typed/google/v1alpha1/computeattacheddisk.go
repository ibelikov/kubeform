...
func (c *computeAttachedDisks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeAttachedDisk, err error) {
...
func (c *computeAttachedDisks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeAttachedDiskList, err error) {
...
func (c *computeAttachedDisks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeAttachedDisks) Create(ctx context.Context, computeAttachedDisk *v1alpha1.ComputeAttachedDisk, opts v1.CreateOptions) (result *v1alpha1.ComputeAttachedDisk, err error) {
	result = &v1alpha1.ComputeAttachedDisk{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeattacheddisks").
...
func (c *computeAttachedDisks) Update(ctx context.Context, computeAttachedDisk *v1alpha1.ComputeAttachedDisk, opts v1.UpdateOptions) (result *v1alpha1.ComputeAttachedDisk, err error) {
	result = &v1alpha1.ComputeAttachedDisk{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeattacheddisks").
...
func (c *computeAttachedDisks) UpdateStatus(ctx context.Context, computeAttachedDisk *v1alpha1.ComputeAttachedDisk, opts v1.UpdateOptions) (result *v1alpha1.ComputeAttachedDisk, err error) {
	result = &v1alpha1.ComputeAttachedDisk{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeattacheddisks").
...
func (c *computeAttachedDisks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeAttachedDisks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeAttachedDisks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeAttachedDisk, err error) {
	result = &v1alpha1.ComputeAttachedDisk{}
