...
func (c *computeSecurityPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeSecurityPolicy, err error) {
...
func (c *computeSecurityPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeSecurityPolicyList, err error) {
...
func (c *computeSecurityPolicies) Create(ctx context.Context, computeSecurityPolicy *v1alpha1.ComputeSecurityPolicy, opts v1.CreateOptions) (result *v1alpha1.ComputeSecurityPolicy, err error) {
	result = &v1alpha1.ComputeSecurityPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computesecuritypolicies").
...
func (c *computeSecurityPolicies) Update(ctx context.Context, computeSecurityPolicy *v1alpha1.ComputeSecurityPolicy, opts v1.UpdateOptions) (result *v1alpha1.ComputeSecurityPolicy, err error) {
	result = &v1alpha1.ComputeSecurityPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesecuritypolicies").
...
func (c *computeSecurityPolicies) UpdateStatus(ctx context.Context, computeSecurityPolicy *v1alpha1.ComputeSecurityPolicy, opts v1.UpdateOptions) (result *v1alpha1.ComputeSecurityPolicy, err error) {
	result = &v1alpha1.ComputeSecurityPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesecuritypolicies").
...
func (c *computeSecurityPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeSecurityPolicy, err error) {
	result = &v1alpha1.ComputeSecurityPolicy{}
