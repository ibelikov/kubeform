...
func (c *kmsCryptoKeyIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KmsCryptoKeyIamMember, err error) {
...
func (c *kmsCryptoKeyIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KmsCryptoKeyIamMemberList, err error) {
...
func (c *kmsCryptoKeyIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kmsCryptoKeyIamMembers) Create(ctx context.Context, kmsCryptoKeyIamMember *v1alpha1.KmsCryptoKeyIamMember, opts v1.CreateOptions) (result *v1alpha1.KmsCryptoKeyIamMember, err error) {
	result = &v1alpha1.KmsCryptoKeyIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kmscryptokeyiammembers").
...
func (c *kmsCryptoKeyIamMembers) Update(ctx context.Context, kmsCryptoKeyIamMember *v1alpha1.KmsCryptoKeyIamMember, opts v1.UpdateOptions) (result *v1alpha1.KmsCryptoKeyIamMember, err error) {
	result = &v1alpha1.KmsCryptoKeyIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmscryptokeyiammembers").
...
func (c *kmsCryptoKeyIamMembers) UpdateStatus(ctx context.Context, kmsCryptoKeyIamMember *v1alpha1.KmsCryptoKeyIamMember, opts v1.UpdateOptions) (result *v1alpha1.KmsCryptoKeyIamMember, err error) {
	result = &v1alpha1.KmsCryptoKeyIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmscryptokeyiammembers").
...
func (c *kmsCryptoKeyIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kmsCryptoKeyIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kmsCryptoKeyIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KmsCryptoKeyIamMember, err error) {
	result = &v1alpha1.KmsCryptoKeyIamMember{}
