...
func newFirestoreIndexes(c *GoogleV1alpha1Client, namespace string) *firestoreIndexes {
...
func (c *firestoreIndexes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FirestoreIndex, err error) {
	result = &v1alpha1.FirestoreIndex{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *firestoreIndexes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirestoreIndexList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FirestoreIndexList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("firestoreindexes").
...
func (c *firestoreIndexes) Create(ctx context.Context, firestoreIndex *v1alpha1.FirestoreIndex, opts v1.CreateOptions) (result *v1alpha1.FirestoreIndex, err error) {
	result = &v1alpha1.FirestoreIndex{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("firestoreindexes").
...
func (c *firestoreIndexes) Update(ctx context.Context, firestoreIndex *v1alpha1.FirestoreIndex, opts v1.UpdateOptions) (result *v1alpha1.FirestoreIndex, err error) {
	result = &v1alpha1.FirestoreIndex{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firestoreindexes").
...
func (c *firestoreIndexes) UpdateStatus(ctx context.Context, firestoreIndex *v1alpha1.FirestoreIndex, opts v1.UpdateOptions) (result *v1alpha1.FirestoreIndex, err error) {
	result = &v1alpha1.FirestoreIndex{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firestoreindexes").
...
func (c *firestoreIndexes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FirestoreIndex, err error) {
	result = &v1alpha1.FirestoreIndex{}
