...
func (c *computeInterconnectAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeInterconnectAttachment, err error) {
...
func (c *computeInterconnectAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeInterconnectAttachmentList, err error) {
...
func (c *computeInterconnectAttachments) Create(ctx context.Context, computeInterconnectAttachment *v1alpha1.ComputeInterconnectAttachment, opts v1.CreateOptions) (result *v1alpha1.ComputeInterconnectAttachment, err error) {
	result = &v1alpha1.ComputeInterconnectAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeinterconnectattachments").
...
func (c *computeInterconnectAttachments) Update(ctx context.Context, computeInterconnectAttachment *v1alpha1.ComputeInterconnectAttachment, opts v1.UpdateOptions) (result *v1alpha1.ComputeInterconnectAttachment, err error) {
	result = &v1alpha1.ComputeInterconnectAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinterconnectattachments").
...
func (c *computeInterconnectAttachments) UpdateStatus(ctx context.Context, computeInterconnectAttachment *v1alpha1.ComputeInterconnectAttachment, opts v1.UpdateOptions) (result *v1alpha1.ComputeInterconnectAttachment, err error) {
	result = &v1alpha1.ComputeInterconnectAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinterconnectattachments").
...
func (c *computeInterconnectAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeInterconnectAttachment, err error) {
	result = &v1alpha1.ComputeInterconnectAttachment{}
