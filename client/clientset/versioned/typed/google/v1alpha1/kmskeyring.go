...
func (c *kmsKeyRings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KmsKeyRing, err error) {
...
func (c *kmsKeyRings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KmsKeyRingList, err error) {
...
func (c *kmsKeyRings) Create(ctx context.Context, kmsKeyRing *v1alpha1.KmsKeyRing, opts v1.CreateOptions) (result *v1alpha1.KmsKeyRing, err error) {
	result = &v1alpha1.KmsKeyRing{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kmskeyrings").
...
func (c *kmsKeyRings) Update(ctx context.Context, kmsKeyRing *v1alpha1.KmsKeyRing, opts v1.UpdateOptions) (result *v1alpha1.KmsKeyRing, err error) {
	result = &v1alpha1.KmsKeyRing{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmskeyrings").
...
func (c *kmsKeyRings) UpdateStatus(ctx context.Context, kmsKeyRing *v1alpha1.KmsKeyRing, opts v1.UpdateOptions) (result *v1alpha1.KmsKeyRing, err error) {
	result = &v1alpha1.KmsKeyRing{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmskeyrings").
...
func (c *kmsKeyRings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KmsKeyRing, err error) {
	result = &v1alpha1.KmsKeyRing{}
