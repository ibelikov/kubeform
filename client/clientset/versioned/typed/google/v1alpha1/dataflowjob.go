...
func (c *dataflowJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataflowJob, err error) {
...
func (c *dataflowJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataflowJobList, err error) {
...
func (c *dataflowJobs) Create(ctx context.Context, dataflowJob *v1alpha1.DataflowJob, opts v1.CreateOptions) (result *v1alpha1.DataflowJob, err error) {
	result = &v1alpha1.DataflowJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dataflowjobs").
...
func (c *dataflowJobs) Update(ctx context.Context, dataflowJob *v1alpha1.DataflowJob, opts v1.UpdateOptions) (result *v1alpha1.DataflowJob, err error) {
	result = &v1alpha1.DataflowJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataflowjobs").
...
func (c *dataflowJobs) UpdateStatus(ctx context.Context, dataflowJob *v1alpha1.DataflowJob, opts v1.UpdateOptions) (result *v1alpha1.DataflowJob, err error) {
	result = &v1alpha1.DataflowJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataflowjobs").
...
func (c *dataflowJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataflowJob, err error) {
	result = &v1alpha1.DataflowJob{}
