...
type DataflowJobInterface interface {
	Create(*v1alpha1.DataflowJob) (*v1alpha1.DataflowJob, error)
	Update(*v1alpha1.DataflowJob) (*v1alpha1.DataflowJob, error)
	UpdateStatus(*v1alpha1.DataflowJob) (*v1alpha1.DataflowJob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DataflowJob, error)
	List(opts v1.ListOptions) (*v1alpha1.DataflowJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DataflowJob, err error)
...
func (c *dataflowJobs) List(opts v1.ListOptions) (result *v1alpha1.DataflowJobList, err error) {
...
func (c *dataflowJobs) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataflowJobs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
