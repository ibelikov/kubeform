...
func (c *containerClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ContainerCluster, err error) {
...
func (c *containerClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ContainerClusterList, err error) {
...
func (c *containerClusters) Create(ctx context.Context, containerCluster *v1alpha1.ContainerCluster, opts v1.CreateOptions) (result *v1alpha1.ContainerCluster, err error) {
	result = &v1alpha1.ContainerCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("containerclusters").
...
func (c *containerClusters) Update(ctx context.Context, containerCluster *v1alpha1.ContainerCluster, opts v1.UpdateOptions) (result *v1alpha1.ContainerCluster, err error) {
	result = &v1alpha1.ContainerCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("containerclusters").
...
func (c *containerClusters) UpdateStatus(ctx context.Context, containerCluster *v1alpha1.ContainerCluster, opts v1.UpdateOptions) (result *v1alpha1.ContainerCluster, err error) {
	result = &v1alpha1.ContainerCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("containerclusters").
...
func (c *containerClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ContainerCluster, err error) {
	result = &v1alpha1.ContainerCluster{}
