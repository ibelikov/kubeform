...
func (c *computeNodeGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeNodeGroup, err error) {
...
func (c *computeNodeGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeNodeGroupList, err error) {
...
func (c *computeNodeGroups) Create(ctx context.Context, computeNodeGroup *v1alpha1.ComputeNodeGroup, opts v1.CreateOptions) (result *v1alpha1.ComputeNodeGroup, err error) {
	result = &v1alpha1.ComputeNodeGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computenodegroups").
...
func (c *computeNodeGroups) Update(ctx context.Context, computeNodeGroup *v1alpha1.ComputeNodeGroup, opts v1.UpdateOptions) (result *v1alpha1.ComputeNodeGroup, err error) {
	result = &v1alpha1.ComputeNodeGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenodegroups").
...
func (c *computeNodeGroups) UpdateStatus(ctx context.Context, computeNodeGroup *v1alpha1.ComputeNodeGroup, opts v1.UpdateOptions) (result *v1alpha1.ComputeNodeGroup, err error) {
	result = &v1alpha1.ComputeNodeGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenodegroups").
...
func (c *computeNodeGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeNodeGroup, err error) {
	result = &v1alpha1.ComputeNodeGroup{}
