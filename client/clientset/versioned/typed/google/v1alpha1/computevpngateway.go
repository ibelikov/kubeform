...
func (c *computeVPNGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeVPNGateway, err error) {
...
func (c *computeVPNGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeVPNGatewayList, err error) {
...
func (c *computeVPNGateways) Create(ctx context.Context, computeVPNGateway *v1alpha1.ComputeVPNGateway, opts v1.CreateOptions) (result *v1alpha1.ComputeVPNGateway, err error) {
	result = &v1alpha1.ComputeVPNGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computevpngateways").
...
func (c *computeVPNGateways) Update(ctx context.Context, computeVPNGateway *v1alpha1.ComputeVPNGateway, opts v1.UpdateOptions) (result *v1alpha1.ComputeVPNGateway, err error) {
	result = &v1alpha1.ComputeVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computevpngateways").
...
func (c *computeVPNGateways) UpdateStatus(ctx context.Context, computeVPNGateway *v1alpha1.ComputeVPNGateway, opts v1.UpdateOptions) (result *v1alpha1.ComputeVPNGateway, err error) {
	result = &v1alpha1.ComputeVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computevpngateways").
...
func (c *computeVPNGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeVPNGateway, err error) {
	result = &v1alpha1.ComputeVPNGateway{}
