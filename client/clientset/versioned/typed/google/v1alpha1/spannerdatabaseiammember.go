...
func (c *spannerDatabaseIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpannerDatabaseIamMember, err error) {
...
func (c *spannerDatabaseIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpannerDatabaseIamMemberList, err error) {
...
func (c *spannerDatabaseIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *spannerDatabaseIamMembers) Create(ctx context.Context, spannerDatabaseIamMember *v1alpha1.SpannerDatabaseIamMember, opts v1.CreateOptions) (result *v1alpha1.SpannerDatabaseIamMember, err error) {
	result = &v1alpha1.SpannerDatabaseIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spannerdatabaseiammembers").
...
func (c *spannerDatabaseIamMembers) Update(ctx context.Context, spannerDatabaseIamMember *v1alpha1.SpannerDatabaseIamMember, opts v1.UpdateOptions) (result *v1alpha1.SpannerDatabaseIamMember, err error) {
	result = &v1alpha1.SpannerDatabaseIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spannerdatabaseiammembers").
...
func (c *spannerDatabaseIamMembers) UpdateStatus(ctx context.Context, spannerDatabaseIamMember *v1alpha1.SpannerDatabaseIamMember, opts v1.UpdateOptions) (result *v1alpha1.SpannerDatabaseIamMember, err error) {
	result = &v1alpha1.SpannerDatabaseIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spannerdatabaseiammembers").
...
func (c *spannerDatabaseIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *spannerDatabaseIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *spannerDatabaseIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SpannerDatabaseIamMember, err error) {
	result = &v1alpha1.SpannerDatabaseIamMember{}
