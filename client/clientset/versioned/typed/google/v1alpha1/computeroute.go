...
func (c *computeRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeRoute, err error) {
...
func (c *computeRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeRouteList, err error) {
...
func (c *computeRoutes) Create(ctx context.Context, computeRoute *v1alpha1.ComputeRoute, opts v1.CreateOptions) (result *v1alpha1.ComputeRoute, err error) {
	result = &v1alpha1.ComputeRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeroutes").
...
func (c *computeRoutes) Update(ctx context.Context, computeRoute *v1alpha1.ComputeRoute, opts v1.UpdateOptions) (result *v1alpha1.ComputeRoute, err error) {
	result = &v1alpha1.ComputeRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeroutes").
...
func (c *computeRoutes) UpdateStatus(ctx context.Context, computeRoute *v1alpha1.ComputeRoute, opts v1.UpdateOptions) (result *v1alpha1.ComputeRoute, err error) {
	result = &v1alpha1.ComputeRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeroutes").
...
func (c *computeRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeRoute, err error) {
	result = &v1alpha1.ComputeRoute{}
