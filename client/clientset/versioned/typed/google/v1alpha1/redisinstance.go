...
func (c *redisInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RedisInstance, err error) {
...
func (c *redisInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RedisInstanceList, err error) {
...
func (c *redisInstances) Create(ctx context.Context, redisInstance *v1alpha1.RedisInstance, opts v1.CreateOptions) (result *v1alpha1.RedisInstance, err error) {
	result = &v1alpha1.RedisInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("redisinstances").
...
func (c *redisInstances) Update(ctx context.Context, redisInstance *v1alpha1.RedisInstance, opts v1.UpdateOptions) (result *v1alpha1.RedisInstance, err error) {
	result = &v1alpha1.RedisInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redisinstances").
...
func (c *redisInstances) UpdateStatus(ctx context.Context, redisInstance *v1alpha1.RedisInstance, opts v1.UpdateOptions) (result *v1alpha1.RedisInstance, err error) {
	result = &v1alpha1.RedisInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redisinstances").
...
func (c *redisInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RedisInstance, err error) {
	result = &v1alpha1.RedisInstance{}
