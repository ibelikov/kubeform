...
func newComputeReservations(c *GoogleV1alpha1Client, namespace string) *computeReservations {
...
func (c *computeReservations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeReservation, err error) {
	result = &v1alpha1.ComputeReservation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeReservations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeReservationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ComputeReservationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computereservations").
...
func (c *computeReservations) Create(ctx context.Context, computeReservation *v1alpha1.ComputeReservation, opts v1.CreateOptions) (result *v1alpha1.ComputeReservation, err error) {
	result = &v1alpha1.ComputeReservation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computereservations").
...
func (c *computeReservations) Update(ctx context.Context, computeReservation *v1alpha1.ComputeReservation, opts v1.UpdateOptions) (result *v1alpha1.ComputeReservation, err error) {
	result = &v1alpha1.ComputeReservation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computereservations").
...
func (c *computeReservations) UpdateStatus(ctx context.Context, computeReservation *v1alpha1.ComputeReservation, opts v1.UpdateOptions) (result *v1alpha1.ComputeReservation, err error) {
	result = &v1alpha1.ComputeReservation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computereservations").
...
func (c *computeReservations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeReservation, err error) {
	result = &v1alpha1.ComputeReservation{}
