...
func (c *computeNodeTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeNodeTemplate, err error) {
...
func (c *computeNodeTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeNodeTemplateList, err error) {
...
func (c *computeNodeTemplates) Create(ctx context.Context, computeNodeTemplate *v1alpha1.ComputeNodeTemplate, opts v1.CreateOptions) (result *v1alpha1.ComputeNodeTemplate, err error) {
	result = &v1alpha1.ComputeNodeTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computenodetemplates").
...
func (c *computeNodeTemplates) Update(ctx context.Context, computeNodeTemplate *v1alpha1.ComputeNodeTemplate, opts v1.UpdateOptions) (result *v1alpha1.ComputeNodeTemplate, err error) {
	result = &v1alpha1.ComputeNodeTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenodetemplates").
...
func (c *computeNodeTemplates) UpdateStatus(ctx context.Context, computeNodeTemplate *v1alpha1.ComputeNodeTemplate, opts v1.UpdateOptions) (result *v1alpha1.ComputeNodeTemplate, err error) {
	result = &v1alpha1.ComputeNodeTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenodetemplates").
...
func (c *computeNodeTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeNodeTemplate, err error) {
	result = &v1alpha1.ComputeNodeTemplate{}
