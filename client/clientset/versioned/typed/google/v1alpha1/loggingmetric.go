...
func (c *loggingMetrics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LoggingMetric, err error) {
...
func (c *loggingMetrics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoggingMetricList, err error) {
...
func (c *loggingMetrics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingMetrics) Create(ctx context.Context, loggingMetric *v1alpha1.LoggingMetric, opts v1.CreateOptions) (result *v1alpha1.LoggingMetric, err error) {
	result = &v1alpha1.LoggingMetric{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loggingmetrics").
...
func (c *loggingMetrics) Update(ctx context.Context, loggingMetric *v1alpha1.LoggingMetric, opts v1.UpdateOptions) (result *v1alpha1.LoggingMetric, err error) {
	result = &v1alpha1.LoggingMetric{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingmetrics").
...
func (c *loggingMetrics) UpdateStatus(ctx context.Context, loggingMetric *v1alpha1.LoggingMetric, opts v1.UpdateOptions) (result *v1alpha1.LoggingMetric, err error) {
	result = &v1alpha1.LoggingMetric{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingmetrics").
...
func (c *loggingMetrics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *loggingMetrics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *loggingMetrics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LoggingMetric, err error) {
	result = &v1alpha1.LoggingMetric{}
