...
func (c *computeURLMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeURLMap, err error) {
...
func (c *computeURLMaps) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeURLMapList, err error) {
...
func (c *computeURLMaps) Create(ctx context.Context, computeURLMap *v1alpha1.ComputeURLMap, opts v1.CreateOptions) (result *v1alpha1.ComputeURLMap, err error) {
	result = &v1alpha1.ComputeURLMap{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeurlmaps").
...
func (c *computeURLMaps) Update(ctx context.Context, computeURLMap *v1alpha1.ComputeURLMap, opts v1.UpdateOptions) (result *v1alpha1.ComputeURLMap, err error) {
	result = &v1alpha1.ComputeURLMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeurlmaps").
...
func (c *computeURLMaps) UpdateStatus(ctx context.Context, computeURLMap *v1alpha1.ComputeURLMap, opts v1.UpdateOptions) (result *v1alpha1.ComputeURLMap, err error) {
	result = &v1alpha1.ComputeURLMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeurlmaps").
...
func (c *computeURLMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeURLMap, err error) {
	result = &v1alpha1.ComputeURLMap{}
