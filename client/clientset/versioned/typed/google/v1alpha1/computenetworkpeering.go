...
func (c *computeNetworkPeerings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeNetworkPeering, err error) {
...
func (c *computeNetworkPeerings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeNetworkPeeringList, err error) {
...
func (c *computeNetworkPeerings) Create(ctx context.Context, computeNetworkPeering *v1alpha1.ComputeNetworkPeering, opts v1.CreateOptions) (result *v1alpha1.ComputeNetworkPeering, err error) {
	result = &v1alpha1.ComputeNetworkPeering{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computenetworkpeerings").
...
func (c *computeNetworkPeerings) Update(ctx context.Context, computeNetworkPeering *v1alpha1.ComputeNetworkPeering, opts v1.UpdateOptions) (result *v1alpha1.ComputeNetworkPeering, err error) {
	result = &v1alpha1.ComputeNetworkPeering{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenetworkpeerings").
...
func (c *computeNetworkPeerings) UpdateStatus(ctx context.Context, computeNetworkPeering *v1alpha1.ComputeNetworkPeering, opts v1.UpdateOptions) (result *v1alpha1.ComputeNetworkPeering, err error) {
	result = &v1alpha1.ComputeNetworkPeering{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenetworkpeerings").
...
func (c *computeNetworkPeerings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeNetworkPeering, err error) {
	result = &v1alpha1.ComputeNetworkPeering{}
