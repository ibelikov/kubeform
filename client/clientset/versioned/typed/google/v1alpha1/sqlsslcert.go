...
func (c *sqlSSLCerts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlSSLCert, err error) {
...
func (c *sqlSSLCerts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlSSLCertList, err error) {
...
func (c *sqlSSLCerts) Create(ctx context.Context, sqlSSLCert *v1alpha1.SqlSSLCert, opts v1.CreateOptions) (result *v1alpha1.SqlSSLCert, err error) {
	result = &v1alpha1.SqlSSLCert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqlsslcerts").
...
func (c *sqlSSLCerts) Update(ctx context.Context, sqlSSLCert *v1alpha1.SqlSSLCert, opts v1.UpdateOptions) (result *v1alpha1.SqlSSLCert, err error) {
	result = &v1alpha1.SqlSSLCert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlsslcerts").
...
func (c *sqlSSLCerts) UpdateStatus(ctx context.Context, sqlSSLCert *v1alpha1.SqlSSLCert, opts v1.UpdateOptions) (result *v1alpha1.SqlSSLCert, err error) {
	result = &v1alpha1.SqlSSLCert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlsslcerts").
...
func (c *sqlSSLCerts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlSSLCert, err error) {
	result = &v1alpha1.SqlSSLCert{}
