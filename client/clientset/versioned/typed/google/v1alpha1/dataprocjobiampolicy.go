...
// DataprocJobIamPoliciesGetter has a method to return a DataprocJobIamPolicyInterface.
...
// dataprocJobIamPolicies implements DataprocJobIamPolicyInterface
type dataprocJobIamPolicies struct {
	client rest.Interface
	ns     string
}

// newDataprocJobIamPolicies returns a DataprocJobIamPolicies
func newDataprocJobIamPolicies(c *GoogleV1alpha1Client, namespace string) *dataprocJobIamPolicies {
	return &dataprocJobIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *dataprocJobIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataprocJobIamPolicy, err error) {
	result = &v1alpha1.DataprocJobIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dataprocjobiampolicies").
		Name(name).
...
func (c *dataprocJobIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataprocJobIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DataprocJobIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dataprocjobiampolicies").
...
func (c *dataprocJobIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataprocJobIamPolicies) Create(ctx context.Context, dataprocJobIamPolicy *v1alpha1.DataprocJobIamPolicy, opts v1.CreateOptions) (result *v1alpha1.DataprocJobIamPolicy, err error) {
	result = &v1alpha1.DataprocJobIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dataprocjobiampolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataprocJobIamPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dataprocJobIamPolicies) Update(ctx context.Context, dataprocJobIamPolicy *v1alpha1.DataprocJobIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.DataprocJobIamPolicy, err error) {
	result = &v1alpha1.DataprocJobIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataprocjobiampolicies").
		Name(dataprocJobIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataprocJobIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *dataprocJobIamPolicies) UpdateStatus(ctx context.Context, dataprocJobIamPolicy *v1alpha1.DataprocJobIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.DataprocJobIamPolicy, err error) {
	result = &v1alpha1.DataprocJobIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataprocjobiampolicies").
...
func (c *dataprocJobIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataprocJobIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataprocJobIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataprocJobIamPolicy, err error) {
	result = &v1alpha1.DataprocJobIamPolicy{}
