...
func (c *computeTargetPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeTargetPool, err error) {
...
func (c *computeTargetPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeTargetPoolList, err error) {
...
func (c *computeTargetPools) Create(ctx context.Context, computeTargetPool *v1alpha1.ComputeTargetPool, opts v1.CreateOptions) (result *v1alpha1.ComputeTargetPool, err error) {
	result = &v1alpha1.ComputeTargetPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computetargetpools").
...
func (c *computeTargetPools) Update(ctx context.Context, computeTargetPool *v1alpha1.ComputeTargetPool, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetPool, err error) {
	result = &v1alpha1.ComputeTargetPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetpools").
...
func (c *computeTargetPools) UpdateStatus(ctx context.Context, computeTargetPool *v1alpha1.ComputeTargetPool, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetPool, err error) {
	result = &v1alpha1.ComputeTargetPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetpools").
...
func (c *computeTargetPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeTargetPool, err error) {
	result = &v1alpha1.ComputeTargetPool{}
