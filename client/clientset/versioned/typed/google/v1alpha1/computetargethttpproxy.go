...
func (c *computeTargetHTTPProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeTargetHTTPProxy, err error) {
...
func (c *computeTargetHTTPProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeTargetHTTPProxyList, err error) {
...
func (c *computeTargetHTTPProxies) Create(ctx context.Context, computeTargetHTTPProxy *v1alpha1.ComputeTargetHTTPProxy, opts v1.CreateOptions) (result *v1alpha1.ComputeTargetHTTPProxy, err error) {
	result = &v1alpha1.ComputeTargetHTTPProxy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computetargethttpproxies").
...
func (c *computeTargetHTTPProxies) Update(ctx context.Context, computeTargetHTTPProxy *v1alpha1.ComputeTargetHTTPProxy, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetHTTPProxy, err error) {
	result = &v1alpha1.ComputeTargetHTTPProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargethttpproxies").
...
func (c *computeTargetHTTPProxies) UpdateStatus(ctx context.Context, computeTargetHTTPProxy *v1alpha1.ComputeTargetHTTPProxy, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetHTTPProxy, err error) {
	result = &v1alpha1.ComputeTargetHTTPProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargethttpproxies").
...
func (c *computeTargetHTTPProxies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeTargetHTTPProxy, err error) {
	result = &v1alpha1.ComputeTargetHTTPProxy{}
