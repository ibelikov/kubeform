...
var bigtableinstanceiambindingsResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "bigtableinstanceiambindings"}
...
func (c *FakeBigtableInstanceIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BigtableInstanceIamBinding, err error) {
	...
	return obj.(*v1alpha1.BigtableInstanceIamBinding), err
}
...
func (c *FakeBigtableInstanceIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BigtableInstanceIamBindingList, err error) {
	...
	list := &v1alpha1.BigtableInstanceIamBindingList{ListMeta: obj.(*v1alpha1.BigtableInstanceIamBindingList).ListMeta}
	for _, item := range obj.(*v1alpha1.BigtableInstanceIamBindingList).Items {
