...
func (c *FakeStorageDefaultObjectACLs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageDefaultObjectACL, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageDefaultObjectACLs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageDefaultObjectACLList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageDefaultObjectACLs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeStorageDefaultObjectACLs) Create(ctx context.Context, storageDefaultObjectACL *v1alpha1.StorageDefaultObjectACL, opts v1.CreateOptions) (result *v1alpha1.StorageDefaultObjectACL, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageDefaultObjectACLs) Update(ctx context.Context, storageDefaultObjectACL *v1alpha1.StorageDefaultObjectACL, opts v1.UpdateOptions) (result *v1alpha1.StorageDefaultObjectACL, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageDefaultObjectACLs) UpdateStatus(ctx context.Context, storageDefaultObjectACL *v1alpha1.StorageDefaultObjectACL, opts v1.UpdateOptions) (*v1alpha1.StorageDefaultObjectACL, error) {
	obj, err := c.Fake.
...
func (c *FakeStorageDefaultObjectACLs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeStorageDefaultObjectACLs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(storagedefaultobjectaclsResource, c.ns, listOpts)
