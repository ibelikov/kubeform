...
func (c *FakeComputeSubnetworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeSubnetwork, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(computesubnetworksResource, c.ns, name), &v1alpha1.ComputeSubnetwork{})
...
func (c *FakeComputeSubnetworks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeSubnetworkList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(computesubnetworksResource, computesubnetworksKind, c.ns, opts), &v1alpha1.ComputeSubnetworkList{})
...
func (c *FakeComputeSubnetworks) Create(ctx context.Context, computeSubnetwork *v1alpha1.ComputeSubnetwork, opts v1.CreateOptions) (result *v1alpha1.ComputeSubnetwork, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(computesubnetworksResource, c.ns, computeSubnetwork), &v1alpha1.ComputeSubnetwork{})
...
func (c *FakeComputeSubnetworks) Update(ctx context.Context, computeSubnetwork *v1alpha1.ComputeSubnetwork, opts v1.UpdateOptions) (result *v1alpha1.ComputeSubnetwork, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(computesubnetworksResource, c.ns, computeSubnetwork), &v1alpha1.ComputeSubnetwork{})
...
func (c *FakeComputeSubnetworks) UpdateStatus(ctx context.Context, computeSubnetwork *v1alpha1.ComputeSubnetwork, opts v1.UpdateOptions) (*v1alpha1.ComputeSubnetwork, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(computesubnetworksResource, "status", c.ns, computeSubnetwork), &v1alpha1.ComputeSubnetwork{})
...
func (c *FakeComputeSubnetworks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(computesubnetworksResource, c.ns, name), &v1alpha1.ComputeSubnetwork{})
...
func (c *FakeComputeSubnetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeSubnetwork, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(computesubnetworksResource, c.ns, name, pt, data, subresources...), &v1alpha1.ComputeSubnetwork{})
