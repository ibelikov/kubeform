...
func (c *FakeBinaryAuthorizationPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BinaryAuthorizationPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeBinaryAuthorizationPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BinaryAuthorizationPolicyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeBinaryAuthorizationPolicies) Create(ctx context.Context, binaryAuthorizationPolicy *v1alpha1.BinaryAuthorizationPolicy, opts v1.CreateOptions) (result *v1alpha1.BinaryAuthorizationPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeBinaryAuthorizationPolicies) Update(ctx context.Context, binaryAuthorizationPolicy *v1alpha1.BinaryAuthorizationPolicy, opts v1.UpdateOptions) (result *v1alpha1.BinaryAuthorizationPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeBinaryAuthorizationPolicies) UpdateStatus(ctx context.Context, binaryAuthorizationPolicy *v1alpha1.BinaryAuthorizationPolicy, opts v1.UpdateOptions) (*v1alpha1.BinaryAuthorizationPolicy, error) {
	obj, err := c.Fake.
