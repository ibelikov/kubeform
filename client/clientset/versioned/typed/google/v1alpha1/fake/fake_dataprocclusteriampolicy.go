...
var dataprocclusteriampoliciesResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "dataprocclusteriampolicies"}
...
func (c *FakeDataprocClusterIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataprocClusterIamPolicy, err error) {
	...
	return obj.(*v1alpha1.DataprocClusterIamPolicy), err
}
...
func (c *FakeDataprocClusterIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataprocClusterIamPolicyList, err error) {
	...
	list := &v1alpha1.DataprocClusterIamPolicyList{ListMeta: obj.(*v1alpha1.DataprocClusterIamPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.DataprocClusterIamPolicyList).Items {
