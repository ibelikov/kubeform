...
var cloudfunctionsfunctioniammembersResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "cloudfunctionsfunctioniammembers"}
...
func (c *FakeCloudfunctionsFunctionIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudfunctionsFunctionIamMember, err error) {
	...
	return obj.(*v1alpha1.CloudfunctionsFunctionIamMember), err
}
...
func (c *FakeCloudfunctionsFunctionIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudfunctionsFunctionIamMemberList, err error) {
	...
	list := &v1alpha1.CloudfunctionsFunctionIamMemberList{ListMeta: obj.(*v1alpha1.CloudfunctionsFunctionIamMemberList).ListMeta}
	for _, item := range obj.(*v1alpha1.CloudfunctionsFunctionIamMemberList).Items {
