...
func (c *FakeSpannerInstanceIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpannerInstanceIamPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeSpannerInstanceIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpannerInstanceIamPolicyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSpannerInstanceIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSpannerInstanceIamPolicies) Create(ctx context.Context, spannerInstanceIamPolicy *v1alpha1.SpannerInstanceIamPolicy, opts v1.CreateOptions) (result *v1alpha1.SpannerInstanceIamPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeSpannerInstanceIamPolicies) Update(ctx context.Context, spannerInstanceIamPolicy *v1alpha1.SpannerInstanceIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.SpannerInstanceIamPolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeSpannerInstanceIamPolicies) UpdateStatus(ctx context.Context, spannerInstanceIamPolicy *v1alpha1.SpannerInstanceIamPolicy, opts v1.UpdateOptions) (*v1alpha1.SpannerInstanceIamPolicy, error) {
	obj, err := c.Fake.
...
func (c *FakeSpannerInstanceIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeSpannerInstanceIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(spannerinstanceiampoliciesResource, c.ns, listOpts)
