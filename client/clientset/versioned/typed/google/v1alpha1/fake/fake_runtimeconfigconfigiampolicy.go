...
var runtimeconfigconfigiampoliciesResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "runtimeconfigconfigiampolicies"}
...
func (c *FakeRuntimeconfigConfigIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RuntimeconfigConfigIamPolicy, err error) {
	...
	return obj.(*v1alpha1.RuntimeconfigConfigIamPolicy), err
}
...
func (c *FakeRuntimeconfigConfigIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RuntimeconfigConfigIamPolicyList, err error) {
	...
	list := &v1alpha1.RuntimeconfigConfigIamPolicyList{ListMeta: obj.(*v1alpha1.RuntimeconfigConfigIamPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.RuntimeconfigConfigIamPolicyList).Items {
