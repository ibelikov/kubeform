...
func (c *FakeMonitoringUptimeCheckConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonitoringUptimeCheckConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeMonitoringUptimeCheckConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonitoringUptimeCheckConfigList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMonitoringUptimeCheckConfigs) Create(ctx context.Context, monitoringUptimeCheckConfig *v1alpha1.MonitoringUptimeCheckConfig, opts v1.CreateOptions) (result *v1alpha1.MonitoringUptimeCheckConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeMonitoringUptimeCheckConfigs) Update(ctx context.Context, monitoringUptimeCheckConfig *v1alpha1.MonitoringUptimeCheckConfig, opts v1.UpdateOptions) (result *v1alpha1.MonitoringUptimeCheckConfig, err error) {
	obj, err := c.Fake.
...
func (c *FakeMonitoringUptimeCheckConfigs) UpdateStatus(ctx context.Context, monitoringUptimeCheckConfig *v1alpha1.MonitoringUptimeCheckConfig, opts v1.UpdateOptions) (*v1alpha1.MonitoringUptimeCheckConfig, error) {
	obj, err := c.Fake.
