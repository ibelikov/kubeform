...
var computediskresourcepolicyattachmentsResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "computediskresourcepolicyattachments"}

var computediskresourcepolicyattachmentsKind = schema.GroupVersionKind{Group: "google.kubeform.com", Version: "v1alpha1", Kind: "ComputeDiskResourcePolicyAttachment"}
...
func (c *FakeComputeDiskResourcePolicyAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(computediskresourcepolicyattachmentsResource, c.ns, name), &v1alpha1.ComputeDiskResourcePolicyAttachment{})
