...
var mlenginemodelsResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "mlenginemodels"}

var mlenginemodelsKind = schema.GroupVersionKind{Group: "google.kubeform.com", Version: "v1alpha1", Kind: "MlEngineModel"}
...
func (c *FakeMlEngineModels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(mlenginemodelsResource, c.ns, name), &v1alpha1.MlEngineModel{})
