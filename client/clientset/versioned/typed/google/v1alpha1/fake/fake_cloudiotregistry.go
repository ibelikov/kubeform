...
func (c *FakeCloudiotRegistries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudiotRegistryList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCloudiotRegistries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCloudiotRegistries) UpdateStatus(ctx context.Context, cloudiotRegistry *v1alpha1.CloudiotRegistry, opts v1.UpdateOptions) (*v1alpha1.CloudiotRegistry, error) {
	obj, err := c.Fake.
...
func (c *FakeCloudiotRegistries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(cloudiotregistriesResource, c.ns, listOpts)
