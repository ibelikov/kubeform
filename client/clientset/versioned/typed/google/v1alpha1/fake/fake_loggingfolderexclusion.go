...
func (c *FakeLoggingFolderExclusions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LoggingFolderExclusion, err error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingFolderExclusions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoggingFolderExclusionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingFolderExclusions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeLoggingFolderExclusions) Create(ctx context.Context, loggingFolderExclusion *v1alpha1.LoggingFolderExclusion, opts v1.CreateOptions) (result *v1alpha1.LoggingFolderExclusion, err error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingFolderExclusions) Update(ctx context.Context, loggingFolderExclusion *v1alpha1.LoggingFolderExclusion, opts v1.UpdateOptions) (result *v1alpha1.LoggingFolderExclusion, err error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingFolderExclusions) UpdateStatus(ctx context.Context, loggingFolderExclusion *v1alpha1.LoggingFolderExclusion, opts v1.UpdateOptions) (*v1alpha1.LoggingFolderExclusion, error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingFolderExclusions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeLoggingFolderExclusions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(loggingfolderexclusionsResource, c.ns, listOpts)
