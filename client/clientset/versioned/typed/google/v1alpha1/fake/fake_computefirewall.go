...
var computefirewallsKind = schema.GroupVersionKind{Group: "google.kubeform.com", Version: "v1alpha1", Kind: "ComputeFirewall"}
...
func (c *FakeComputeFirewalls) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeFirewall, err error) {
	...
	return obj.(*v1alpha1.ComputeFirewall), err
}

// List takes label and field selectors, and returns the list of ComputeFirewalls that match those selectors.
func (c *FakeComputeFirewalls) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeFirewallList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.ComputeFirewallList{ListMeta: obj.(*v1alpha1.ComputeFirewallList).ListMeta}
	for _, item := range obj.(*v1alpha1.ComputeFirewallList).Items {
