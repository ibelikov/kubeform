...
var computeinstanceiambindingsResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "computeinstanceiambindings"}
...
func (c *FakeComputeInstanceIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeInstanceIamBinding, err error) {
	...
	return obj.(*v1alpha1.ComputeInstanceIamBinding), err
}
...
func (c *FakeComputeInstanceIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeInstanceIamBindingList, err error) {
	...
	list := &v1alpha1.ComputeInstanceIamBindingList{ListMeta: obj.(*v1alpha1.ComputeInstanceIamBindingList).ListMeta}
	for _, item := range obj.(*v1alpha1.ComputeInstanceIamBindingList).Items {
