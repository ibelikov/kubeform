...
func (c *FakePubsubTopicIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PubsubTopicIamMember, err error) {
	obj, err := c.Fake.
...
func (c *FakePubsubTopicIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PubsubTopicIamMemberList, err error) {
	obj, err := c.Fake.
...
func (c *FakePubsubTopicIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakePubsubTopicIamMembers) UpdateStatus(ctx context.Context, pubsubTopicIamMember *v1alpha1.PubsubTopicIamMember, opts v1.UpdateOptions) (*v1alpha1.PubsubTopicIamMember, error) {
	obj, err := c.Fake.
...
func (c *FakePubsubTopicIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakePubsubTopicIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(pubsubtopiciammembersResource, c.ns, listOpts)
