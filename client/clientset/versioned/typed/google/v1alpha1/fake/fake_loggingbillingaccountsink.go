...
func (c *FakeLoggingBillingAccountSinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LoggingBillingAccountSink, err error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingBillingAccountSinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoggingBillingAccountSinkList, err error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingBillingAccountSinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeLoggingBillingAccountSinks) Create(ctx context.Context, loggingBillingAccountSink *v1alpha1.LoggingBillingAccountSink, opts v1.CreateOptions) (result *v1alpha1.LoggingBillingAccountSink, err error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingBillingAccountSinks) Update(ctx context.Context, loggingBillingAccountSink *v1alpha1.LoggingBillingAccountSink, opts v1.UpdateOptions) (result *v1alpha1.LoggingBillingAccountSink, err error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingBillingAccountSinks) UpdateStatus(ctx context.Context, loggingBillingAccountSink *v1alpha1.LoggingBillingAccountSink, opts v1.UpdateOptions) (*v1alpha1.LoggingBillingAccountSink, error) {
	obj, err := c.Fake.
...
func (c *FakeLoggingBillingAccountSinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeLoggingBillingAccountSinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(loggingbillingaccountsinksResource, c.ns, listOpts)
