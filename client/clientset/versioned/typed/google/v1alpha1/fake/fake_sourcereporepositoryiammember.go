...
var sourcereporepositoryiammembersResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "sourcereporepositoryiammembers"}
...
func (c *FakeSourcerepoRepositoryIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SourcerepoRepositoryIamMember, err error) {
	...
	return obj.(*v1alpha1.SourcerepoRepositoryIamMember), err
}
...
func (c *FakeSourcerepoRepositoryIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SourcerepoRepositoryIamMemberList, err error) {
	...
	list := &v1alpha1.SourcerepoRepositoryIamMemberList{ListMeta: obj.(*v1alpha1.SourcerepoRepositoryIamMemberList).ListMeta}
	for _, item := range obj.(*v1alpha1.SourcerepoRepositoryIamMemberList).Items {
