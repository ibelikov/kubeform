...
var computeimagesKind = schema.GroupVersionKind{Group: "google.kubeform.com", Version: "v1alpha1", Kind: "ComputeImage"}
...
func (c *FakeComputeImages) Get(name string, options v1.GetOptions) (result *v1alpha1.ComputeImage, err error) {
	...
	return obj.(*v1alpha1.ComputeImage), err
}
...
func (c *FakeComputeImages) List(opts v1.ListOptions) (result *v1alpha1.ComputeImageList, err error) {
	...
	list := &v1alpha1.ComputeImageList{ListMeta: obj.(*v1alpha1.ComputeImageList).ListMeta}
	for _, item := range obj.(*v1alpha1.ComputeImageList).Items {
