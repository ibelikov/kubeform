...
func (c *FakeComputeTargetSSLProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeTargetSSLProxy, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeTargetSSLProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeTargetSSLProxyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeTargetSSLProxies) Create(ctx context.Context, computeTargetSSLProxy *v1alpha1.ComputeTargetSSLProxy, opts v1.CreateOptions) (result *v1alpha1.ComputeTargetSSLProxy, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeTargetSSLProxies) Update(ctx context.Context, computeTargetSSLProxy *v1alpha1.ComputeTargetSSLProxy, opts v1.UpdateOptions) (result *v1alpha1.ComputeTargetSSLProxy, err error) {
	obj, err := c.Fake.
...
func (c *FakeComputeTargetSSLProxies) UpdateStatus(ctx context.Context, computeTargetSSLProxy *v1alpha1.ComputeTargetSSLProxy, opts v1.UpdateOptions) (*v1alpha1.ComputeTargetSSLProxy, error) {
	obj, err := c.Fake.
