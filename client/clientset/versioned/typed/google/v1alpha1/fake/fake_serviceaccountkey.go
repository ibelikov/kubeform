...
var serviceaccountkeysResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "serviceaccountkeys"}
...
func (c *FakeServiceAccountKeys) Get(name string, options v1.GetOptions) (result *v1alpha1.ServiceAccountKey, err error) {
	...
	return obj.(*v1alpha1.ServiceAccountKey), err
}
...
func (c *FakeServiceAccountKeys) List(opts v1.ListOptions) (result *v1alpha1.ServiceAccountKeyList, err error) {
	...
	list := &v1alpha1.ServiceAccountKeyList{ListMeta: obj.(*v1alpha1.ServiceAccountKeyList).ListMeta}
	for _, item := range obj.(*v1alpha1.ServiceAccountKeyList).Items {
