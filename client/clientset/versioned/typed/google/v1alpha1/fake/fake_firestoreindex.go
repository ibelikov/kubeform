...
var firestoreindexesResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "firestoreindexes"}
...
func (c *FakeFirestoreIndexes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FirestoreIndex, err error) {
	...
	return obj.(*v1alpha1.FirestoreIndex), err
}
...
func (c *FakeFirestoreIndexes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirestoreIndexList, err error) {
	...
	list := &v1alpha1.FirestoreIndexList{ListMeta: obj.(*v1alpha1.FirestoreIndexList).ListMeta}
	for _, item := range obj.(*v1alpha1.FirestoreIndexList).Items {
