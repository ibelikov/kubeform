...
var loggingmetricsResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "loggingmetrics"}
...
func (c *FakeLoggingMetrics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LoggingMetric, err error) {
	...
	return obj.(*v1alpha1.LoggingMetric), err
}
...
func (c *FakeLoggingMetrics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoggingMetricList, err error) {
	...
	list := &v1alpha1.LoggingMetricList{ListMeta: obj.(*v1alpha1.LoggingMetricList).ListMeta}
	for _, item := range obj.(*v1alpha1.LoggingMetricList).Items {
