...
var sourcereporepositoryiambindingsResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "sourcereporepositoryiambindings"}
...
func (c *FakeSourcerepoRepositoryIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SourcerepoRepositoryIamBinding, err error) {
	...
	return obj.(*v1alpha1.SourcerepoRepositoryIamBinding), err
}
...
func (c *FakeSourcerepoRepositoryIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SourcerepoRepositoryIamBindingList, err error) {
	...
	list := &v1alpha1.SourcerepoRepositoryIamBindingList{ListMeta: obj.(*v1alpha1.SourcerepoRepositoryIamBindingList).ListMeta}
	for _, item := range obj.(*v1alpha1.SourcerepoRepositoryIamBindingList).Items {
