...
func (c *FakeEndpointsServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointsServiceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpointsServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeEndpointsServices) UpdateStatus(ctx context.Context, endpointsService *v1alpha1.EndpointsService, opts v1.UpdateOptions) (*v1alpha1.EndpointsService, error) {
	obj, err := c.Fake.
...
func (c *FakeEndpointsServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(endpointsservicesResource, c.ns, listOpts)
