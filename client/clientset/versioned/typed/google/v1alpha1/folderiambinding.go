...
func (c *folderIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FolderIamBinding, err error) {
...
func (c *folderIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FolderIamBindingList, err error) {
...
func (c *folderIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *folderIamBindings) Create(ctx context.Context, folderIamBinding *v1alpha1.FolderIamBinding, opts v1.CreateOptions) (result *v1alpha1.FolderIamBinding, err error) {
	result = &v1alpha1.FolderIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("folderiambindings").
...
func (c *folderIamBindings) Update(ctx context.Context, folderIamBinding *v1alpha1.FolderIamBinding, opts v1.UpdateOptions) (result *v1alpha1.FolderIamBinding, err error) {
	result = &v1alpha1.FolderIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("folderiambindings").
...
func (c *folderIamBindings) UpdateStatus(ctx context.Context, folderIamBinding *v1alpha1.FolderIamBinding, opts v1.UpdateOptions) (result *v1alpha1.FolderIamBinding, err error) {
	result = &v1alpha1.FolderIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("folderiambindings").
...
func (c *folderIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *folderIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *folderIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FolderIamBinding, err error) {
	result = &v1alpha1.FolderIamBinding{}
