...
func (c *computeSubnetworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeSubnetwork, err error) {
...
func (c *computeSubnetworks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeSubnetworkList, err error) {
...
func (c *computeSubnetworks) Create(ctx context.Context, computeSubnetwork *v1alpha1.ComputeSubnetwork, opts v1.CreateOptions) (result *v1alpha1.ComputeSubnetwork, err error) {
	result = &v1alpha1.ComputeSubnetwork{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computesubnetworks").
...
func (c *computeSubnetworks) Update(ctx context.Context, computeSubnetwork *v1alpha1.ComputeSubnetwork, opts v1.UpdateOptions) (result *v1alpha1.ComputeSubnetwork, err error) {
	result = &v1alpha1.ComputeSubnetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesubnetworks").
...
func (c *computeSubnetworks) UpdateStatus(ctx context.Context, computeSubnetwork *v1alpha1.ComputeSubnetwork, opts v1.UpdateOptions) (result *v1alpha1.ComputeSubnetwork, err error) {
	result = &v1alpha1.ComputeSubnetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesubnetworks").
...
func (c *computeSubnetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeSubnetwork, err error) {
	result = &v1alpha1.ComputeSubnetwork{}
