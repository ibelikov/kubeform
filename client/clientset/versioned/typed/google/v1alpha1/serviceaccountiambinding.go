...
func (c *serviceAccountIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceAccountIamBinding, err error) {
...
func (c *serviceAccountIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceAccountIamBindingList, err error) {
...
func (c *serviceAccountIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceAccountIamBindings) Create(ctx context.Context, serviceAccountIamBinding *v1alpha1.ServiceAccountIamBinding, opts v1.CreateOptions) (result *v1alpha1.ServiceAccountIamBinding, err error) {
	result = &v1alpha1.ServiceAccountIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceaccountiambindings").
...
func (c *serviceAccountIamBindings) Update(ctx context.Context, serviceAccountIamBinding *v1alpha1.ServiceAccountIamBinding, opts v1.UpdateOptions) (result *v1alpha1.ServiceAccountIamBinding, err error) {
	result = &v1alpha1.ServiceAccountIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceaccountiambindings").
...
func (c *serviceAccountIamBindings) UpdateStatus(ctx context.Context, serviceAccountIamBinding *v1alpha1.ServiceAccountIamBinding, opts v1.UpdateOptions) (result *v1alpha1.ServiceAccountIamBinding, err error) {
	result = &v1alpha1.ServiceAccountIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceaccountiambindings").
...
func (c *serviceAccountIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *serviceAccountIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *serviceAccountIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceAccountIamBinding, err error) {
	result = &v1alpha1.ServiceAccountIamBinding{}
