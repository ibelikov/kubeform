...
type ServiceAccountIamBindingInterface interface {
	Create(*v1alpha1.ServiceAccountIamBinding) (*v1alpha1.ServiceAccountIamBinding, error)
	Update(*v1alpha1.ServiceAccountIamBinding) (*v1alpha1.ServiceAccountIamBinding, error)
	UpdateStatus(*v1alpha1.ServiceAccountIamBinding) (*v1alpha1.ServiceAccountIamBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ServiceAccountIamBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.ServiceAccountIamBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServiceAccountIamBinding, err error)
...
func (c *serviceAccountIamBindings) List(opts v1.ListOptions) (result *v1alpha1.ServiceAccountIamBindingList, err error) {
...
func (c *serviceAccountIamBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceAccountIamBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
