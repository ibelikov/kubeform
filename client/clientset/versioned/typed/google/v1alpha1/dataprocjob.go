...
type DataprocJobInterface interface {
	Create(*v1alpha1.DataprocJob) (*v1alpha1.DataprocJob, error)
	Update(*v1alpha1.DataprocJob) (*v1alpha1.DataprocJob, error)
	UpdateStatus(*v1alpha1.DataprocJob) (*v1alpha1.DataprocJob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.DataprocJob, error)
	List(opts v1.ListOptions) (*v1alpha1.DataprocJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.DataprocJob, err error)
...
func (c *dataprocJobs) List(opts v1.ListOptions) (result *v1alpha1.DataprocJobList, err error) {
...
func (c *dataprocJobs) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataprocJobs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
