...
func (c *folderIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FolderIamMember, err error) {
...
func (c *folderIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FolderIamMemberList, err error) {
...
func (c *folderIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *folderIamMembers) Create(ctx context.Context, folderIamMember *v1alpha1.FolderIamMember, opts v1.CreateOptions) (result *v1alpha1.FolderIamMember, err error) {
	result = &v1alpha1.FolderIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("folderiammembers").
...
func (c *folderIamMembers) Update(ctx context.Context, folderIamMember *v1alpha1.FolderIamMember, opts v1.UpdateOptions) (result *v1alpha1.FolderIamMember, err error) {
	result = &v1alpha1.FolderIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("folderiammembers").
...
func (c *folderIamMembers) UpdateStatus(ctx context.Context, folderIamMember *v1alpha1.FolderIamMember, opts v1.UpdateOptions) (result *v1alpha1.FolderIamMember, err error) {
	result = &v1alpha1.FolderIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("folderiammembers").
...
func (c *folderIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *folderIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *folderIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FolderIamMember, err error) {
	result = &v1alpha1.FolderIamMember{}
