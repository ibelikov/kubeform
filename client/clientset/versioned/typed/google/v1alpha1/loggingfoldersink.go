...
func (c *loggingFolderSinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LoggingFolderSink, err error) {
...
func (c *loggingFolderSinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LoggingFolderSinkList, err error) {
...
func (c *loggingFolderSinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingFolderSinks) Create(ctx context.Context, loggingFolderSink *v1alpha1.LoggingFolderSink, opts v1.CreateOptions) (result *v1alpha1.LoggingFolderSink, err error) {
	result = &v1alpha1.LoggingFolderSink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("loggingfoldersinks").
...
func (c *loggingFolderSinks) Update(ctx context.Context, loggingFolderSink *v1alpha1.LoggingFolderSink, opts v1.UpdateOptions) (result *v1alpha1.LoggingFolderSink, err error) {
	result = &v1alpha1.LoggingFolderSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingfoldersinks").
...
func (c *loggingFolderSinks) UpdateStatus(ctx context.Context, loggingFolderSink *v1alpha1.LoggingFolderSink, opts v1.UpdateOptions) (result *v1alpha1.LoggingFolderSink, err error) {
	result = &v1alpha1.LoggingFolderSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("loggingfoldersinks").
...
func (c *loggingFolderSinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *loggingFolderSinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *loggingFolderSinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LoggingFolderSink, err error) {
	result = &v1alpha1.LoggingFolderSink{}
