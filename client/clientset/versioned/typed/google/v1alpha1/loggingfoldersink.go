...
type LoggingFolderSinkInterface interface {
	Create(*v1alpha1.LoggingFolderSink) (*v1alpha1.LoggingFolderSink, error)
	Update(*v1alpha1.LoggingFolderSink) (*v1alpha1.LoggingFolderSink, error)
	UpdateStatus(*v1alpha1.LoggingFolderSink) (*v1alpha1.LoggingFolderSink, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.LoggingFolderSink, error)
	List(opts v1.ListOptions) (*v1alpha1.LoggingFolderSinkList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.LoggingFolderSink, err error)
...
func (c *loggingFolderSinks) List(opts v1.ListOptions) (result *v1alpha1.LoggingFolderSinkList, err error) {
...
func (c *loggingFolderSinks) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingFolderSinks) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
