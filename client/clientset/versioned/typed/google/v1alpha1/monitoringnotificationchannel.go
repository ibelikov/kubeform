...
func (c *monitoringNotificationChannels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MonitoringNotificationChannel, err error) {
...
func (c *monitoringNotificationChannels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MonitoringNotificationChannelList, err error) {
...
func (c *monitoringNotificationChannels) Create(ctx context.Context, monitoringNotificationChannel *v1alpha1.MonitoringNotificationChannel, opts v1.CreateOptions) (result *v1alpha1.MonitoringNotificationChannel, err error) {
	result = &v1alpha1.MonitoringNotificationChannel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitoringnotificationchannels").
...
func (c *monitoringNotificationChannels) Update(ctx context.Context, monitoringNotificationChannel *v1alpha1.MonitoringNotificationChannel, opts v1.UpdateOptions) (result *v1alpha1.MonitoringNotificationChannel, err error) {
	result = &v1alpha1.MonitoringNotificationChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringnotificationchannels").
...
func (c *monitoringNotificationChannels) UpdateStatus(ctx context.Context, monitoringNotificationChannel *v1alpha1.MonitoringNotificationChannel, opts v1.UpdateOptions) (result *v1alpha1.MonitoringNotificationChannel, err error) {
	result = &v1alpha1.MonitoringNotificationChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringnotificationchannels").
...
func (c *monitoringNotificationChannels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MonitoringNotificationChannel, err error) {
	result = &v1alpha1.MonitoringNotificationChannel{}
