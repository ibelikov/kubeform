...
func (c *runtimeconfigConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RuntimeconfigConfig, err error) {
...
func (c *runtimeconfigConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RuntimeconfigConfigList, err error) {
...
func (c *runtimeconfigConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *runtimeconfigConfigs) Create(ctx context.Context, runtimeconfigConfig *v1alpha1.RuntimeconfigConfig, opts v1.CreateOptions) (result *v1alpha1.RuntimeconfigConfig, err error) {
	result = &v1alpha1.RuntimeconfigConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("runtimeconfigconfigs").
...
func (c *runtimeconfigConfigs) Update(ctx context.Context, runtimeconfigConfig *v1alpha1.RuntimeconfigConfig, opts v1.UpdateOptions) (result *v1alpha1.RuntimeconfigConfig, err error) {
	result = &v1alpha1.RuntimeconfigConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("runtimeconfigconfigs").
...
func (c *runtimeconfigConfigs) UpdateStatus(ctx context.Context, runtimeconfigConfig *v1alpha1.RuntimeconfigConfig, opts v1.UpdateOptions) (result *v1alpha1.RuntimeconfigConfig, err error) {
	result = &v1alpha1.RuntimeconfigConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("runtimeconfigconfigs").
...
func (c *runtimeconfigConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *runtimeconfigConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *runtimeconfigConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RuntimeconfigConfig, err error) {
	result = &v1alpha1.RuntimeconfigConfig{}
