...
func (c *kmsKeyRingIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KmsKeyRingIamPolicy, err error) {
...
func (c *kmsKeyRingIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KmsKeyRingIamPolicyList, err error) {
...
func (c *kmsKeyRingIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kmsKeyRingIamPolicies) Create(ctx context.Context, kmsKeyRingIamPolicy *v1alpha1.KmsKeyRingIamPolicy, opts v1.CreateOptions) (result *v1alpha1.KmsKeyRingIamPolicy, err error) {
	result = &v1alpha1.KmsKeyRingIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kmskeyringiampolicies").
...
func (c *kmsKeyRingIamPolicies) Update(ctx context.Context, kmsKeyRingIamPolicy *v1alpha1.KmsKeyRingIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.KmsKeyRingIamPolicy, err error) {
	result = &v1alpha1.KmsKeyRingIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmskeyringiampolicies").
...
func (c *kmsKeyRingIamPolicies) UpdateStatus(ctx context.Context, kmsKeyRingIamPolicy *v1alpha1.KmsKeyRingIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.KmsKeyRingIamPolicy, err error) {
	result = &v1alpha1.KmsKeyRingIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kmskeyringiampolicies").
...
func (c *kmsKeyRingIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kmsKeyRingIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kmsKeyRingIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KmsKeyRingIamPolicy, err error) {
	result = &v1alpha1.KmsKeyRingIamPolicy{}
