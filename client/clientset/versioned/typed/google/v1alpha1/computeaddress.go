...
func (c *computeAddresses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeAddress, err error) {
...
func (c *computeAddresses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeAddressList, err error) {
...
func (c *computeAddresses) Create(ctx context.Context, computeAddress *v1alpha1.ComputeAddress, opts v1.CreateOptions) (result *v1alpha1.ComputeAddress, err error) {
	result = &v1alpha1.ComputeAddress{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeaddresses").
...
func (c *computeAddresses) Update(ctx context.Context, computeAddress *v1alpha1.ComputeAddress, opts v1.UpdateOptions) (result *v1alpha1.ComputeAddress, err error) {
	result = &v1alpha1.ComputeAddress{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeaddresses").
...
func (c *computeAddresses) UpdateStatus(ctx context.Context, computeAddress *v1alpha1.ComputeAddress, opts v1.UpdateOptions) (result *v1alpha1.ComputeAddress, err error) {
	result = &v1alpha1.ComputeAddress{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeaddresses").
...
func (c *computeAddresses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeAddress, err error) {
	result = &v1alpha1.ComputeAddress{}
