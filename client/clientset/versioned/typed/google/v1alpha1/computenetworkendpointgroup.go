...
func newComputeNetworkEndpointGroups(c *GoogleV1alpha1Client, namespace string) *computeNetworkEndpointGroups {
...
func (c *computeNetworkEndpointGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeNetworkEndpointGroupList, err error) {
	...
	result = &v1alpha1.ComputeNetworkEndpointGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computenetworkendpointgroups").
