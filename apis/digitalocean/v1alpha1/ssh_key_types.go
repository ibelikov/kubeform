...
type SshKeySpec struct {
	...
	// +optional
	Fingerprint string `json:"fingerprint,omitempty" tf:"fingerprint,omitempty" protobuf:"bytes,3,opt,name=fingerprint"`
	Name        string `json:"name" tf:"name" protobuf:"bytes,4,opt,name=name"`
	PublicKey   string `json:"publicKey" tf:"public_key" protobuf:"bytes,5,opt,name=publicKey"`
}
