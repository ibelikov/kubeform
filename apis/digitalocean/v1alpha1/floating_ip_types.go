...
type FloatingIPSpec struct {
	...
	// +optional
	DropletID int64 `json:"dropletID,omitempty" tf:"droplet_id,omitempty" protobuf:"varint,3,opt,name=dropletID"`
	// +optional
	IpAddress string `json:"ipAddress,omitempty" tf:"ip_address,omitempty" protobuf:"bytes,4,opt,name=ipAddress"`
	Region    string `json:"region" tf:"region" protobuf:"bytes,5,opt,name=region"`
	// the uniform resource name for the floating ip
	// +optional
	Urn string `json:"urn,omitempty" tf:"urn,omitempty" protobuf:"bytes,6,opt,name=urn"`
}
...
type FloatingIPStatus struct {
	...
	// +optional
	Output *FloatingIPSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type FloatingIPList struct {
	...
	Items []FloatingIP `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
