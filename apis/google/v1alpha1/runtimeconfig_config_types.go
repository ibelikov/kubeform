...
type RuntimeconfigConfig struct {
	...
	Spec              RuntimeconfigConfigSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            RuntimeconfigConfigStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type RuntimeconfigConfigStatus struct {
	...
	// +optional
	Output *RuntimeconfigConfigSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type RuntimeconfigConfigList struct {
	...
	Items []RuntimeconfigConfig `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
