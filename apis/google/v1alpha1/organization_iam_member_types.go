...
type OrganizationIamMember struct {
	...
	Spec              OrganizationIamMemberSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            OrganizationIamMemberStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type OrganizationIamMemberStatus struct {
	...
	// +optional
	Output *OrganizationIamMemberSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type OrganizationIamMemberList struct {
	...
	Items []OrganizationIamMember `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
