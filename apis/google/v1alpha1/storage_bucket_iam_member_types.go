...
type StorageBucketIamMember struct {
	...
	Spec              StorageBucketIamMemberSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            StorageBucketIamMemberStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type StorageBucketIamMemberStatus struct {
	...
	// +optional
	Output *StorageBucketIamMemberSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type StorageBucketIamMemberList struct {
	...
	Items []StorageBucketIamMember `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
