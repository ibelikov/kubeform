...
type SpannerInstanceIamMember struct {
	...
	Spec              SpannerInstanceIamMemberSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            SpannerInstanceIamMemberStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type SpannerInstanceIamMemberStatus struct {
	...
	// +optional
	Output *SpannerInstanceIamMemberSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type SpannerInstanceIamMemberList struct {
	...
	Items []SpannerInstanceIamMember `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
