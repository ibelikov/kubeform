...
type OrganizationIamBinding struct {
	...
	Spec              OrganizationIamBindingSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            OrganizationIamBindingStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type OrganizationIamBindingStatus struct {
	...
	// +optional
	Output *OrganizationIamBindingSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type OrganizationIamBindingList struct {
	...
	Items []OrganizationIamBinding `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
