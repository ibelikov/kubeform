...
type ComputeSubnetworkIamMember struct {
	...
	Spec              ComputeSubnetworkIamMemberSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ComputeSubnetworkIamMemberStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ComputeSubnetworkIamMemberStatus struct {
	...
	// +optional
	Output *ComputeSubnetworkIamMemberSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ComputeSubnetworkIamMemberList struct {
	...
	Items []ComputeSubnetworkIamMember `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
