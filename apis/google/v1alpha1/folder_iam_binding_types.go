...
type FolderIamBinding struct {
	...
	Spec              FolderIamBindingSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            FolderIamBindingStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type FolderIamBindingStatus struct {
	...
	// +optional
	Output *FolderIamBindingSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type FolderIamBindingList struct {
	...
	Items []FolderIamBinding `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
