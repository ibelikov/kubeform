...
type LoggingProjectExclusion struct {
	...
	Spec              LoggingProjectExclusionSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            LoggingProjectExclusionStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type LoggingProjectExclusionStatus struct {
	...
	// +optional
	Output *LoggingProjectExclusionSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type LoggingProjectExclusionList struct {
	...
	Items []LoggingProjectExclusion `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
