...
type ServiceAccountIamBinding struct {
	...
	Spec              ServiceAccountIamBindingSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ServiceAccountIamBindingStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ServiceAccountIamBindingStatus struct {
	...
	// +optional
	Output *ServiceAccountIamBindingSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ServiceAccountIamBindingList struct {
	...
	Items []ServiceAccountIamBinding `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
