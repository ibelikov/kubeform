...
type LoggingOrganizationSink struct {
	...
	Spec              LoggingOrganizationSinkSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            LoggingOrganizationSinkStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type LoggingOrganizationSinkSpec struct {
	...
	// +optional
	IncludeChildren bool   `json:"includeChildren,omitempty" tf:"include_children,omitempty" protobuf:"varint,5,opt,name=includeChildren"`
...
type LoggingOrganizationSinkStatus struct {
	...
	// +optional
	Output *LoggingOrganizationSinkSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type LoggingOrganizationSinkList struct {
	...
	Items []LoggingOrganizationSink `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
