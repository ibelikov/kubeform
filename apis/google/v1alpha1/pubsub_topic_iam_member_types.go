...
type PubsubTopicIamMember struct {
	...
	Spec              PubsubTopicIamMemberSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            PubsubTopicIamMemberStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type PubsubTopicIamMemberStatus struct {
	...
	// +optional
	Output *PubsubTopicIamMemberSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type PubsubTopicIamMemberList struct {
	...
	Items []PubsubTopicIamMember `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
