...
type ProjectIamBinding struct {
	...
	Spec              ProjectIamBindingSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ProjectIamBindingStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ProjectIamBindingStatus struct {
	...
	// +optional
	Output *ProjectIamBindingSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ProjectIamBindingList struct {
	...
	Items []ProjectIamBinding `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
