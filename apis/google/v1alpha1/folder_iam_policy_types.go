...
type FolderIamPolicy struct {
	...
	Spec              FolderIamPolicySpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            FolderIamPolicyStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type FolderIamPolicyStatus struct {
	...
	// +optional
	Output *FolderIamPolicySpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type FolderIamPolicyList struct {
	...
	Items []FolderIamPolicy `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
