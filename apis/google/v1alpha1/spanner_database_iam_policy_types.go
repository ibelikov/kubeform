...
type SpannerDatabaseIamPolicy struct {
	...
	Spec              SpannerDatabaseIamPolicySpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            SpannerDatabaseIamPolicyStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type SpannerDatabaseIamPolicyStatus struct {
	...
	// +optional
	Output *SpannerDatabaseIamPolicySpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type SpannerDatabaseIamPolicyList struct {
	...
	Items []SpannerDatabaseIamPolicy `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
