...
type BillingAccountIamBinding struct {
	...
	Spec              BillingAccountIamBindingSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            BillingAccountIamBindingStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type BillingAccountIamBindingStatus struct {
	...
	// +optional
	Output *BillingAccountIamBindingSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type BillingAccountIamBindingList struct {
	...
	Items []BillingAccountIamBinding `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
