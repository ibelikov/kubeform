...
type ProjectUsageExportBucket struct {
	...
	Spec              ProjectUsageExportBucketSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ProjectUsageExportBucketStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ProjectUsageExportBucketStatus struct {
	...
	// +optional
	Output *ProjectUsageExportBucketSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ProjectUsageExportBucketList struct {
	...
	Items []ProjectUsageExportBucket `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
