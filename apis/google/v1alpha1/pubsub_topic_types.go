...
type PubsubTopic struct {
	...
	Spec              PubsubTopicSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            PubsubTopicStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type PubsubTopicStatus struct {
	...
	// +optional
	Output *PubsubTopicSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type PubsubTopicList struct {
	...
	Items []PubsubTopic `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
