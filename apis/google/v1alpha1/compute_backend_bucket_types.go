...
type ComputeBackendBucket struct {
	...
	Spec              ComputeBackendBucketSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ComputeBackendBucketStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ComputeBackendBucketSpec struct {
	...
	BucketName string `json:"bucketName" tf:"bucket_name" protobuf:"bytes,3,opt,name=bucketName"`
	// +optional
	...
	// +optional
	EnableCdn bool   `json:"enableCdn,omitempty" tf:"enable_cdn,omitempty" protobuf:"varint,6,opt,name=enableCdn"`
...
type ComputeBackendBucketStatus struct {
	...
	// +optional
	Output *ComputeBackendBucketSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ComputeBackendBucketList struct {
	...
	Items []ComputeBackendBucket `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
