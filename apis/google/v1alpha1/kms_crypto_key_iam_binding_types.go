...
type KmsCryptoKeyIamBinding struct {
	...
	Spec              KmsCryptoKeyIamBindingSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            KmsCryptoKeyIamBindingStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type KmsCryptoKeyIamBindingStatus struct {
	...
	// +optional
	Output *KmsCryptoKeyIamBindingSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type KmsCryptoKeyIamBindingList struct {
	...
	Items []KmsCryptoKeyIamBinding `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
