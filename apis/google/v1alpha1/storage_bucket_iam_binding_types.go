...
type StorageBucketIamBinding struct {
	...
	Spec              StorageBucketIamBindingSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            StorageBucketIamBindingStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type StorageBucketIamBindingStatus struct {
	...
	// +optional
	Output *StorageBucketIamBindingSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type StorageBucketIamBindingList struct {
	...
	Items []StorageBucketIamBinding `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
