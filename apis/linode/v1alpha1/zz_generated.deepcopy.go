...
func (in *LkeClusterSpec) DeepCopyInto(out *LkeClusterSpec) {
	*out = *in
	...
	if in.Pool != nil {
		...
		*out = make([]LkeClusterSpecPool, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LkeClusterSpecPool) DeepCopyInto(out *LkeClusterSpecPool) {
	*out = *in
	if in.Nodes != nil {
		...
		*out = make([]LkeClusterSpecPoolNodes, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *LkeClusterSpecPoolNodes) DeepCopy() *LkeClusterSpecPoolNodes {
	...
	out := new(LkeClusterSpecPoolNodes)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ObjectStorageKeyList) DeepCopyInto(out *ObjectStorageKeyList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ObjectStorageKey, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ObjectStorageKeyStatus) DeepCopy() *ObjectStorageKeyStatus {
	...
	out := new(ObjectStorageKeyStatus)
	in.DeepCopyInto(out)
	return out
}
