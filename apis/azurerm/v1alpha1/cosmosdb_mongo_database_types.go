...
type CosmosdbMongoDatabase struct {
	...
	Spec              CosmosdbMongoDatabaseSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            CosmosdbMongoDatabaseStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type CosmosdbMongoDatabaseStatus struct {
	...
	// +optional
	Output *CosmosdbMongoDatabaseSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type CosmosdbMongoDatabaseList struct {
	...
	Items []CosmosdbMongoDatabase `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
