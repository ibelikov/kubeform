...
type CosmosdbTable struct {
	...
	Spec              CosmosdbTableSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            CosmosdbTableStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type CosmosdbTableStatus struct {
	...
	// +optional
	Output *CosmosdbTableSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type CosmosdbTableList struct {
	...
	Items []CosmosdbTable `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
