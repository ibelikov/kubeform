...
type CosmosdbSQLDatabase struct {
	...
	Spec              CosmosdbSQLDatabaseSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            CosmosdbSQLDatabaseStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type CosmosdbSQLDatabaseStatus struct {
	...
	// +optional
	Output *CosmosdbSQLDatabaseSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type CosmosdbSQLDatabaseList struct {
	...
	Items []CosmosdbSQLDatabase `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
