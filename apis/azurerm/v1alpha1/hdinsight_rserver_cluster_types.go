...
type HdinsightRserverCluster struct {
	...
	Spec              HdinsightRserverClusterSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            HdinsightRserverClusterStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type HdinsightRserverClusterSpecRoles struct {
	...
	EdgeNode []HdinsightRserverClusterSpecRolesEdgeNode `json:"edgeNode" tf:"edge_node" protobuf:"bytes,1,rep,name=edgeNode"`
	// +kubebuilder:validation:MaxItems=1
	HeadNode []HdinsightRserverClusterSpecRolesHeadNode `json:"headNode" tf:"head_node" protobuf:"bytes,2,rep,name=headNode"`
	// +kubebuilder:validation:MaxItems=1
	WorkerNode []HdinsightRserverClusterSpecRolesWorkerNode `json:"workerNode" tf:"worker_node" protobuf:"bytes,3,rep,name=workerNode"`
	// +kubebuilder:validation:MaxItems=1
	ZookeeperNode []HdinsightRserverClusterSpecRolesZookeeperNode `json:"zookeeperNode" tf:"zookeeper_node" protobuf:"bytes,4,rep,name=zookeeperNode"`
}
...
type HdinsightRserverClusterSpec struct {
	...
	// +kubebuilder:validation:MaxItems=1
	Gateway []HdinsightRserverClusterSpecGateway `json:"gateway" tf:"gateway" protobuf:"bytes,6,rep,name=gateway"`
	// +optional
	...
	// +kubebuilder:validation:MaxItems=1
	Roles   []HdinsightRserverClusterSpecRoles `json:"roles" tf:"roles" protobuf:"bytes,11,rep,name=roles"`
	...
	StorageAccount []HdinsightRserverClusterSpecStorageAccount `json:"storageAccount" tf:"storage_account" protobuf:"bytes,14,rep,name=storageAccount"`
	// +optional
...
type HdinsightRserverClusterStatus struct {
	...
	// +optional
	Output *HdinsightRserverClusterSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type HdinsightRserverClusterList struct {
	...
	Items []HdinsightRserverCluster `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
