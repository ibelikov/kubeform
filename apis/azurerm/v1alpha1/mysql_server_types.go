...
type MysqlServer struct {
	...
	Spec              MysqlServerSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            MysqlServerStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type MysqlServerSpec struct {
	...
	Sku            []MysqlServerSpecSku `json:"sku" tf:"sku" protobuf:"bytes,9,rep,name=sku"`
	SslEnforcement string               `json:"sslEnforcement" tf:"ssl_enforcement" protobuf:"bytes,10,opt,name=sslEnforcement"`
	// +kubebuilder:validation:MaxItems=1
	StorageProfile []MysqlServerSpecStorageProfile `json:"storageProfile" tf:"storage_profile" protobuf:"bytes,11,rep,name=storageProfile"`
	// +optional
...
type MysqlServerStatus struct {
	...
	// +optional
	Output *MysqlServerSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type MysqlServerList struct {
	...
	Items []MysqlServer `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
