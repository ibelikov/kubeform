...
type DnsARecord struct {
	...
	Spec              DnsARecordSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            DnsARecordStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type DnsARecordStatus struct {
	...
	// +optional
	Output *DnsARecordSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type DnsARecordList struct {
	...
	Items []DnsARecord `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
