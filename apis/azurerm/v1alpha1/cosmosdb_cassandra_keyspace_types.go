...
type CosmosdbCassandraKeyspace struct {
	...
	Spec              CosmosdbCassandraKeyspaceSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            CosmosdbCassandraKeyspaceStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type CosmosdbCassandraKeyspaceStatus struct {
	...
	// +optional
	Output *CosmosdbCassandraKeyspaceSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type CosmosdbCassandraKeyspaceList struct {
	...
	Items []CosmosdbCassandraKeyspace `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
