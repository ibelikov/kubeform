...
type HdinsightMlServicesCluster struct {
	...
	Spec              HdinsightMlServicesClusterSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            HdinsightMlServicesClusterStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type HdinsightMlServicesClusterSpecRoles struct {
	...
	EdgeNode []HdinsightMlServicesClusterSpecRolesEdgeNode `json:"edgeNode" tf:"edge_node" protobuf:"bytes,1,rep,name=edgeNode"`
	// +kubebuilder:validation:MaxItems=1
	HeadNode []HdinsightMlServicesClusterSpecRolesHeadNode `json:"headNode" tf:"head_node" protobuf:"bytes,2,rep,name=headNode"`
	// +kubebuilder:validation:MaxItems=1
	WorkerNode []HdinsightMlServicesClusterSpecRolesWorkerNode `json:"workerNode" tf:"worker_node" protobuf:"bytes,3,rep,name=workerNode"`
	// +kubebuilder:validation:MaxItems=1
	ZookeeperNode []HdinsightMlServicesClusterSpecRolesZookeeperNode `json:"zookeeperNode" tf:"zookeeper_node" protobuf:"bytes,4,rep,name=zookeeperNode"`
}
...
type HdinsightMlServicesClusterSpec struct {
	...
	// +optional
	EdgeSSHEndpoint string `json:"edgeSSHEndpoint,omitempty" tf:"edge_ssh_endpoint,omitempty" protobuf:"bytes,5,opt,name=edgeSSHEndpoint"`
	// +kubebuilder:validation:MaxItems=1
	Gateway []HdinsightMlServicesClusterSpecGateway `json:"gateway" tf:"gateway" protobuf:"bytes,6,rep,name=gateway"`
	// +optional
	...
	// +kubebuilder:validation:MaxItems=1
	Roles   []HdinsightMlServicesClusterSpecRoles `json:"roles" tf:"roles" protobuf:"bytes,11,rep,name=roles"`
	Rstudio bool                                  `json:"rstudio" tf:"rstudio" protobuf:"varint,12,opt,name=rstudio"`
	// +optional
	SshEndpoint    string                                         `json:"sshEndpoint,omitempty" tf:"ssh_endpoint,omitempty" protobuf:"bytes,13,opt,name=sshEndpoint"`
	StorageAccount []HdinsightMlServicesClusterSpecStorageAccount `json:"storageAccount" tf:"storage_account" protobuf:"bytes,14,rep,name=storageAccount"`
	// +optional
	Tags map[string]string `json:"tags,omitempty" tf:"tags,omitempty" protobuf:"bytes,15,rep,name=tags"`
	Tier string            `json:"tier" tf:"tier" protobuf:"bytes,16,opt,name=tier"`
}
...
type HdinsightMlServicesClusterStatus struct {
	...
	// +optional
	Output *HdinsightMlServicesClusterSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type HdinsightMlServicesClusterList struct {
	...
	Items []HdinsightMlServicesCluster `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
