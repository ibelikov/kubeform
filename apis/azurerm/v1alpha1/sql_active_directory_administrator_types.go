...
type SqlActiveDirectoryAdministrator struct {
	...
	Spec              SqlActiveDirectoryAdministratorSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            SqlActiveDirectoryAdministratorStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type SqlActiveDirectoryAdministratorSpec struct {
	...
	Login             string `json:"login" tf:"login" protobuf:"bytes,3,opt,name=login"`
...
type SqlActiveDirectoryAdministratorStatus struct {
	...
	// +optional
	Output *SqlActiveDirectoryAdministratorSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type SqlActiveDirectoryAdministratorList struct {
	...
	Items []SqlActiveDirectoryAdministrator `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
