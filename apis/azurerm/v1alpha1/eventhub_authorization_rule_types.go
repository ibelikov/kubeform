...
type EventhubAuthorizationRule struct {
	...
	Spec              EventhubAuthorizationRuleSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            EventhubAuthorizationRuleStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type EventhubAuthorizationRuleSpec struct {
	...
	EventhubName string `json:"eventhubName" tf:"eventhub_name" protobuf:"bytes,4,opt,name=eventhubName"`
	// +optional
	Listen bool `json:"listen,omitempty" tf:"listen,omitempty" protobuf:"varint,5,opt,name=listen"`
	// +optional
	// Deprecated
	Location string `json:"location,omitempty" tf:"location,omitempty" protobuf:"bytes,6,opt,name=location"`
	// +optional
	Manage        bool   `json:"manage,omitempty" tf:"manage,omitempty" protobuf:"varint,7,opt,name=manage"`
	Name          string `json:"name" tf:"name" protobuf:"bytes,8,opt,name=name"`
	NamespaceName string `json:"namespaceName" tf:"namespace_name" protobuf:"bytes,9,opt,name=namespaceName"`
	// +optional
...
type EventhubAuthorizationRuleStatus struct {
	...
	// +optional
	Output *EventhubAuthorizationRuleSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type EventhubAuthorizationRuleList struct {
	...
	Items []EventhubAuthorizationRule `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
