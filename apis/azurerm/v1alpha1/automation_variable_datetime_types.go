...
type AutomationVariableDatetime struct {
	...
	Spec              AutomationVariableDatetimeSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            AutomationVariableDatetimeStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type AutomationVariableDatetimeSpec struct {
	...
	// +optional
	Encrypted         bool   `json:"encrypted,omitempty" tf:"encrypted,omitempty" protobuf:"varint,5,opt,name=encrypted"`
...
type AutomationVariableDatetimeStatus struct {
	...
	// +optional
	Output *AutomationVariableDatetimeSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type AutomationVariableDatetimeList struct {
	...
	Items []AutomationVariableDatetime `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
