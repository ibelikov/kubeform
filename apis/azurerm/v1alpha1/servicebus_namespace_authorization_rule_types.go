...
type ServicebusNamespaceAuthorizationRule struct {
	...
	Spec              ServicebusNamespaceAuthorizationRuleSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ServicebusNamespaceAuthorizationRuleStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ServicebusNamespaceAuthorizationRuleStatus struct {
	...
	// +optional
	Output *ServicebusNamespaceAuthorizationRuleSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ServicebusNamespaceAuthorizationRuleList struct {
	...
	Items []ServicebusNamespaceAuthorizationRule `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
