...
type NetworkDdosProtectionPlan struct {
	...
	Spec              NetworkDdosProtectionPlanSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            NetworkDdosProtectionPlanStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type NetworkDdosProtectionPlanSpec struct {
	...
	// +optional
	VirtualNetworkIDS []string `json:"virtualNetworkIDS,omitempty" tf:"virtual_network_ids,omitempty" protobuf:"bytes,7,rep,name=virtualNetworkIDS"`
}
...
type NetworkDdosProtectionPlanStatus struct {
	...
	// +optional
	Output *NetworkDdosProtectionPlanSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type NetworkDdosProtectionPlanList struct {
	...
	Items []NetworkDdosProtectionPlan `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
