...
type SecurityCenterSubscriptionPricing struct {
	...
	Spec              SecurityCenterSubscriptionPricingSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            SecurityCenterSubscriptionPricingStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type SecurityCenterSubscriptionPricingStatus struct {
	...
	// +optional
	Output *SecurityCenterSubscriptionPricingSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type SecurityCenterSubscriptionPricingList struct {
	...
	Items []SecurityCenterSubscriptionPricing `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
