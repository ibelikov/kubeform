...
type MysqlVirtualNetworkRule struct {
	...
	Spec              MysqlVirtualNetworkRuleSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            MysqlVirtualNetworkRuleStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type MysqlVirtualNetworkRuleSpec struct {
	...
	SubnetID          string `json:"subnetID" tf:"subnet_id" protobuf:"bytes,6,opt,name=subnetID"`
}
...
type MysqlVirtualNetworkRuleStatus struct {
	...
	// +optional
	Output *MysqlVirtualNetworkRuleSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type MysqlVirtualNetworkRuleList struct {
	...
	Items []MysqlVirtualNetworkRule `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
