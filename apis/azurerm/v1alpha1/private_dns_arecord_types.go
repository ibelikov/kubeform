...
type PrivateDNSARecord struct {
	...
	Spec              PrivateDNSARecordSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            PrivateDNSARecordStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type PrivateDNSARecordSpec struct {
	...
	Records           []string `json:"records" tf:"records" protobuf:"bytes,4,rep,name=records"`
...
type PrivateDNSARecordStatus struct {
	...
	// +optional
	Output *PrivateDNSARecordSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type PrivateDNSARecordList struct {
	...
	Items []PrivateDNSARecord `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
