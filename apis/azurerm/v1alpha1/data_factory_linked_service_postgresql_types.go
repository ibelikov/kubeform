...
type DataFactoryLinkedServicePostgresql struct {
	...
	Spec              DataFactoryLinkedServicePostgresqlSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            DataFactoryLinkedServicePostgresqlStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type DataFactoryLinkedServicePostgresqlSpec struct {
	...
	ConnectionString string   `json:"connectionString" tf:"connection_string" protobuf:"bytes,5,opt,name=connectionString"`
	DataFactoryName  string   `json:"dataFactoryName" tf:"data_factory_name" protobuf:"bytes,6,opt,name=dataFactoryName"`
	// +optional
	Description string `json:"description,omitempty" tf:"description,omitempty" protobuf:"bytes,7,opt,name=description"`
	// +optional
	IntegrationRuntimeName string `json:"integrationRuntimeName,omitempty" tf:"integration_runtime_name,omitempty" protobuf:"bytes,8,opt,name=integrationRuntimeName"`
...
type DataFactoryLinkedServicePostgresqlStatus struct {
	...
	// +optional
	Output *DataFactoryLinkedServicePostgresqlSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type DataFactoryLinkedServicePostgresqlList struct {
	...
	Items []DataFactoryLinkedServicePostgresql `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
