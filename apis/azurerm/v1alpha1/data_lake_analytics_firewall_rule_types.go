...
type DataLakeAnalyticsFirewallRule struct {
	...
	Spec              DataLakeAnalyticsFirewallRuleSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            DataLakeAnalyticsFirewallRuleStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type DataLakeAnalyticsFirewallRuleSpec struct {
	...
	EndIPAddress      string `json:"endIPAddress" tf:"end_ip_address" protobuf:"bytes,4,opt,name=endIPAddress"`
...
type DataLakeAnalyticsFirewallRuleStatus struct {
	...
	// +optional
	Output *DataLakeAnalyticsFirewallRuleSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type DataLakeAnalyticsFirewallRuleList struct {
	...
	Items []DataLakeAnalyticsFirewallRule `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
