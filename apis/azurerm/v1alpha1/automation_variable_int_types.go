...
type AutomationVariableInt struct {
	...
	Spec              AutomationVariableIntSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            AutomationVariableIntStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type AutomationVariableIntSpec struct {
	...
	// +optional
	Value int64 `json:"value,omitempty" tf:"value,omitempty" protobuf:"varint,8,opt,name=value"`
}
...
type AutomationVariableIntStatus struct {
	...
	// +optional
	Output *AutomationVariableIntSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type AutomationVariableIntList struct {
	...
	Items []AutomationVariableInt `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
