...
type RecoveryServicesVault struct {
	...
	Spec              RecoveryServicesVaultSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            RecoveryServicesVaultStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type RecoveryServicesVaultSpec struct {
	...
	Sku               string `json:"sku" tf:"sku" protobuf:"bytes,6,opt,name=sku"`
	// +optional
...
type RecoveryServicesVaultStatus struct {
	...
	// +optional
	Output *RecoveryServicesVaultSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type RecoveryServicesVaultList struct {
	...
	Items []RecoveryServicesVault `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
