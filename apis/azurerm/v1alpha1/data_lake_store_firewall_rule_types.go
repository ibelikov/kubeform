...
type DataLakeStoreFirewallRule struct {
	...
	Spec              DataLakeStoreFirewallRuleSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            DataLakeStoreFirewallRuleStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type DataLakeStoreFirewallRuleStatus struct {
	...
	// +optional
	Output *DataLakeStoreFirewallRuleSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type DataLakeStoreFirewallRuleList struct {
	...
	Items []DataLakeStoreFirewallRule `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
