...
type SqlVirtualNetworkRule struct {
	...
	Spec              SqlVirtualNetworkRuleSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            SqlVirtualNetworkRuleStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type SqlVirtualNetworkRuleStatus struct {
	...
	// +optional
	Output *SqlVirtualNetworkRuleSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type SqlVirtualNetworkRuleList struct {
	...
	Items []SqlVirtualNetworkRule `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
