...
type ApiManagementProductGroup struct {
	...
	Spec              ApiManagementProductGroupSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ApiManagementProductGroupStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ApiManagementProductGroupSpec struct {
	...
	GroupName         string `json:"groupName" tf:"group_name" protobuf:"bytes,4,opt,name=groupName"`
	ProductID         string `json:"productID" tf:"product_id" protobuf:"bytes,5,opt,name=productID"`
...
type ApiManagementProductGroupStatus struct {
	...
	// +optional
	Output *ApiManagementProductGroupSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ApiManagementProductGroupList struct {
	...
	Items []ApiManagementProductGroup `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
