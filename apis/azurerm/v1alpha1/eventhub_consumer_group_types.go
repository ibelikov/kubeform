...
type EventhubConsumerGroup struct {
	...
	Spec              EventhubConsumerGroupSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            EventhubConsumerGroupStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type EventhubConsumerGroupSpec struct {
	...
	EventhubName string `json:"eventhubName" tf:"eventhub_name" protobuf:"bytes,3,opt,name=eventhubName"`
	// +optional
	// Deprecated
	...
	// +optional
	UserMetadata string `json:"userMetadata,omitempty" tf:"user_metadata,omitempty" protobuf:"bytes,8,opt,name=userMetadata"`
}
...
type EventhubConsumerGroupStatus struct {
	...
	// +optional
	Output *EventhubConsumerGroupSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type EventhubConsumerGroupList struct {
	...
	Items []EventhubConsumerGroup `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
