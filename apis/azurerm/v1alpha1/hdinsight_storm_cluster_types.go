...
type HdinsightStormCluster struct {
	...
	Spec              HdinsightStormClusterSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            HdinsightStormClusterStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}

type HdinsightStormClusterSpecComponentVersion struct {
	Storm string `json:"storm" tf:"storm" protobuf:"bytes,1,opt,name=storm"`
}
...
type HdinsightStormClusterSpecRoles struct {
	...
	HeadNode []HdinsightStormClusterSpecRolesHeadNode `json:"headNode" tf:"head_node" protobuf:"bytes,1,rep,name=headNode"`
	// +kubebuilder:validation:MaxItems=1
	WorkerNode []HdinsightStormClusterSpecRolesWorkerNode `json:"workerNode" tf:"worker_node" protobuf:"bytes,2,rep,name=workerNode"`
	// +kubebuilder:validation:MaxItems=1
	ZookeeperNode []HdinsightStormClusterSpecRolesZookeeperNode `json:"zookeeperNode" tf:"zookeeper_node" protobuf:"bytes,3,rep,name=zookeeperNode"`
}
...
type HdinsightStormClusterSpec struct {
	...
	// +kubebuilder:validation:MaxItems=1
	ComponentVersion []HdinsightStormClusterSpecComponentVersion `json:"componentVersion" tf:"component_version" protobuf:"bytes,5,rep,name=componentVersion"`
	// +kubebuilder:validation:MaxItems=1
	Gateway []HdinsightStormClusterSpecGateway `json:"gateway" tf:"gateway" protobuf:"bytes,6,rep,name=gateway"`
	// +optional
	...
	// +kubebuilder:validation:MaxItems=1
	Roles []HdinsightStormClusterSpecRoles `json:"roles" tf:"roles" protobuf:"bytes,11,rep,name=roles"`
	// +optional
	SshEndpoint    string                                    `json:"sshEndpoint,omitempty" tf:"ssh_endpoint,omitempty" protobuf:"bytes,12,opt,name=sshEndpoint"`
	StorageAccount []HdinsightStormClusterSpecStorageAccount `json:"storageAccount" tf:"storage_account" protobuf:"bytes,13,rep,name=storageAccount"`
	// +optional
...
type HdinsightStormClusterStatus struct {
	...
	// +optional
	Output *HdinsightStormClusterSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type HdinsightStormClusterList struct {
	...
	Items []HdinsightStormCluster `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
