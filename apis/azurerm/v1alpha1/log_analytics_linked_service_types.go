...
type LogAnalyticsLinkedService struct {
	...
	Spec              LogAnalyticsLinkedServiceSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            LogAnalyticsLinkedServiceStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type LogAnalyticsLinkedServiceSpec struct {
	...
	// +optional
	LinkedServiceProperties []LogAnalyticsLinkedServiceSpecLinkedServiceProperties `json:"linkedServiceProperties,omitempty" tf:"linked_service_properties,omitempty" protobuf:"bytes,4,rep,name=linkedServiceProperties"`
	// +optional
...
type LogAnalyticsLinkedServiceStatus struct {
	...
	// +optional
	Output *LogAnalyticsLinkedServiceSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type LogAnalyticsLinkedServiceList struct {
	...
	Items []LogAnalyticsLinkedService `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
