...
type MonitorMetricAlertrule struct {
	...
	Spec              MonitorMetricAlertruleSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            MonitorMetricAlertruleStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type MonitorMetricAlertruleSpec struct {
	...
	EmailAction []MonitorMetricAlertruleSpecEmailAction `json:"emailAction,omitempty" tf:"email_action,omitempty" protobuf:"bytes,5,rep,name=emailAction"`
	// +optional
	...
	// +optional
	// +kubebuilder:validation:MaxItems=1
	WebhookAction []MonitorMetricAlertruleSpecWebhookAction `json:"webhookAction,omitempty" tf:"webhook_action,omitempty" protobuf:"bytes,16,rep,name=webhookAction"`
}
...
type MonitorMetricAlertruleStatus struct {
	...
	// +optional
	Output *MonitorMetricAlertruleSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type MonitorMetricAlertruleList struct {
	...
	Items []MonitorMetricAlertrule `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
