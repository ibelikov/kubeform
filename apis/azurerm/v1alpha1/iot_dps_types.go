...
type IotDps struct {
	...
	Spec              IotDpsSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            IotDpsStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type IotDpsSpec struct {
	...
	Sku []IotDpsSpecSku `json:"sku" tf:"sku" protobuf:"bytes,6,rep,name=sku"`
	// +optional
...
type IotDpsStatus struct {
	...
	// +optional
	Output *IotDpsSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type IotDpsList struct {
	...
	Items []IotDps `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
