...
type DdosProtectionPlan struct {
	...
	Spec              DdosProtectionPlanSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            DdosProtectionPlanStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type DdosProtectionPlanStatus struct {
	...
	// +optional
	Output *DdosProtectionPlanSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type DdosProtectionPlanList struct {
	...
	Items []DdosProtectionPlan `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
