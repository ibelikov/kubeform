...
type HdinsightHadoopCluster struct {
	...
	Spec              HdinsightHadoopClusterSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            HdinsightHadoopClusterStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}

type HdinsightHadoopClusterSpecComponentVersion struct {
	Hadoop string `json:"hadoop" tf:"hadoop" protobuf:"bytes,1,opt,name=hadoop"`
}
...
type HdinsightHadoopClusterSpecRoles struct {
	...
	HeadNode []HdinsightHadoopClusterSpecRolesHeadNode `json:"headNode" tf:"head_node" protobuf:"bytes,1,rep,name=headNode"`
	// +kubebuilder:validation:MaxItems=1
	WorkerNode []HdinsightHadoopClusterSpecRolesWorkerNode `json:"workerNode" tf:"worker_node" protobuf:"bytes,2,rep,name=workerNode"`
	// +kubebuilder:validation:MaxItems=1
	ZookeeperNode []HdinsightHadoopClusterSpecRolesZookeeperNode `json:"zookeeperNode" tf:"zookeeper_node" protobuf:"bytes,3,rep,name=zookeeperNode"`
}
...
type HdinsightHadoopClusterSpec struct {
	...
	// +kubebuilder:validation:MaxItems=1
	ComponentVersion []HdinsightHadoopClusterSpecComponentVersion `json:"componentVersion" tf:"component_version" protobuf:"bytes,5,rep,name=componentVersion"`
	// +kubebuilder:validation:MaxItems=1
	Gateway []HdinsightHadoopClusterSpecGateway `json:"gateway" tf:"gateway" protobuf:"bytes,6,rep,name=gateway"`
	// +optional
	...
	// +kubebuilder:validation:MaxItems=1
	Roles []HdinsightHadoopClusterSpecRoles `json:"roles" tf:"roles" protobuf:"bytes,11,rep,name=roles"`
	// +optional
	SshEndpoint    string                                     `json:"sshEndpoint,omitempty" tf:"ssh_endpoint,omitempty" protobuf:"bytes,12,opt,name=sshEndpoint"`
	StorageAccount []HdinsightHadoopClusterSpecStorageAccount `json:"storageAccount" tf:"storage_account" protobuf:"bytes,13,rep,name=storageAccount"`
	// +optional
...
type HdinsightHadoopClusterStatus struct {
	...
	// +optional
	Output *HdinsightHadoopClusterSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type HdinsightHadoopClusterList struct {
	...
	Items []HdinsightHadoopCluster `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
