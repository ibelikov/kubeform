...
type ApiManagementProductAPI struct {
	...
	Spec              ApiManagementProductAPISpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ApiManagementProductAPIStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ApiManagementProductAPIStatus struct {
	...
	// +optional
	Output *ApiManagementProductAPISpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ApiManagementProductAPIList struct {
	...
	Items []ApiManagementProductAPI `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
