...
type ApiManagementSubscription struct {
	...
	Spec              ApiManagementSubscriptionSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ApiManagementSubscriptionStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ApiManagementSubscriptionSpec struct {
	...
	ProductID         string `json:"productID" tf:"product_id" protobuf:"bytes,6,opt,name=productID"`
	...
	// +optional
	SubscriptionID string `json:"subscriptionID,omitempty" tf:"subscription_id,omitempty" protobuf:"bytes,9,opt,name=subscriptionID"`
	UserID         string `json:"userID" tf:"user_id" protobuf:"bytes,10,opt,name=userID"`
}
...
type ApiManagementSubscriptionStatus struct {
	...
	// +optional
	Output *ApiManagementSubscriptionSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ApiManagementSubscriptionList struct {
	...
	Items []ApiManagementSubscription `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
