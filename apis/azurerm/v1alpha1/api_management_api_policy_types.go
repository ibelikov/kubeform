...
type ApiManagementAPIPolicy struct {
	...
	Spec              ApiManagementAPIPolicySpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ApiManagementAPIPolicyStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ApiManagementAPIPolicyStatus struct {
	...
	// +optional
	Output *ApiManagementAPIPolicySpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ApiManagementAPIPolicyList struct {
	...
	Items []ApiManagementAPIPolicy `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
