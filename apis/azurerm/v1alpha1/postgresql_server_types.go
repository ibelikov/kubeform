...
type PostgresqlServer struct {
	...
	Spec              PostgresqlServerSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            PostgresqlServerStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type PostgresqlServerSpec struct {
	...
	Sku            []PostgresqlServerSpecSku `json:"sku" tf:"sku" protobuf:"bytes,9,rep,name=sku"`
	SslEnforcement string                    `json:"sslEnforcement" tf:"ssl_enforcement" protobuf:"bytes,10,opt,name=sslEnforcement"`
	// +kubebuilder:validation:MaxItems=1
	StorageProfile []PostgresqlServerSpecStorageProfile `json:"storageProfile" tf:"storage_profile" protobuf:"bytes,11,rep,name=storageProfile"`
	// +optional
...
type PostgresqlServerStatus struct {
	...
	// +optional
	Output *PostgresqlServerSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type PostgresqlServerList struct {
	...
	Items []PostgresqlServer `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
