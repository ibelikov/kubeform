...
type AutomationDscConfiguration struct {
	...
	Spec              AutomationDscConfigurationSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            AutomationDscConfigurationStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type AutomationDscConfigurationSpec struct {
	...
	ContentEmbedded       string `json:"contentEmbedded" tf:"content_embedded" protobuf:"bytes,4,opt,name=contentEmbedded"`
	// +optional
	...
	// +optional
	LogVerbose        bool   `json:"logVerbose,omitempty" tf:"log_verbose,omitempty" protobuf:"varint,7,opt,name=logVerbose"`
...
type AutomationDscConfigurationStatus struct {
	...
	// +optional
	Output *AutomationDscConfigurationSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type AutomationDscConfigurationList struct {
	...
	Items []AutomationDscConfiguration `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
