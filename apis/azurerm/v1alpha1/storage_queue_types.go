...
type StorageQueue struct {
	...
	Spec              StorageQueueSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            StorageQueueStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type StorageQueueStatus struct {
	...
	// +optional
	Output *StorageQueueSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type StorageQueueList struct {
	...
	Items []StorageQueue `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
