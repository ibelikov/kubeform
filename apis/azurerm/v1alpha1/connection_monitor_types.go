...
type ConnectionMonitor struct {
	...
	Spec              ConnectionMonitorSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ConnectionMonitorStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ConnectionMonitorSpec struct {
	...
	Destination []ConnectionMonitorSpecDestination `json:"destination" tf:"destination" protobuf:"bytes,4,rep,name=destination"`
	// +optional
	...
	// +kubebuilder:validation:MaxItems=1
	Source []ConnectionMonitorSpecSource `json:"source" tf:"source" protobuf:"bytes,10,rep,name=source"`
	// +optional
...
type ConnectionMonitorStatus struct {
	...
	// +optional
	Output *ConnectionMonitorSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ConnectionMonitorList struct {
	...
	Items []ConnectionMonitor `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
