...
type AutomationVariableString struct {
	...
	Spec              AutomationVariableStringSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            AutomationVariableStringStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type AutomationVariableStringStatus struct {
	...
	// +optional
	Output *AutomationVariableStringSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type AutomationVariableStringList struct {
	...
	Items []AutomationVariableString `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
