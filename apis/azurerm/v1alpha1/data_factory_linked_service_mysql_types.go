...
type DataFactoryLinkedServiceMysql struct {
	...
	Spec              DataFactoryLinkedServiceMysqlSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            DataFactoryLinkedServiceMysqlStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type DataFactoryLinkedServiceMysqlStatus struct {
	...
	// +optional
	Output *DataFactoryLinkedServiceMysqlSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type DataFactoryLinkedServiceMysqlList struct {
	...
	Items []DataFactoryLinkedServiceMysql `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
