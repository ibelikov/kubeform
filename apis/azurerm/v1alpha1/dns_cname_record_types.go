...
type DnsCnameRecord struct {
	...
	Spec              DnsCnameRecordSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            DnsCnameRecordStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type DnsCnameRecordSpec struct {
	...
	Record            string `json:"record" tf:"record" protobuf:"bytes,4,opt,name=record"`
...
type DnsCnameRecordStatus struct {
	...
	// +optional
	Output *DnsCnameRecordSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type DnsCnameRecordList struct {
	...
	Items []DnsCnameRecord `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
