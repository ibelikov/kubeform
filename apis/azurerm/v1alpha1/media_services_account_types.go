...
type MediaServicesAccount struct {
	...
	Spec              MediaServicesAccountSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            MediaServicesAccountStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}

type MediaServicesAccountSpecStorageAccount struct {
	ID string `json:"ID" tf:"id" protobuf:"bytes,1,opt,name=ID"`
	// +optional
	IsPrimary bool `json:"isPrimary,omitempty" tf:"is_primary,omitempty" protobuf:"varint,2,opt,name=isPrimary"`
}
...
type MediaServicesAccountSpec struct {
	...
	StorageAccount    []MediaServicesAccountSpecStorageAccount `json:"storageAccount" tf:"storage_account" protobuf:"bytes,6,rep,name=storageAccount"`
}
...
type MediaServicesAccountStatus struct {
	...
	// +optional
	Output *MediaServicesAccountSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type MediaServicesAccountList struct {
	...
	Items []MediaServicesAccount `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
