...
type ApplicationInsights struct {
	...
	Spec              ApplicationInsightsSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
	Status            ApplicationInsightsStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}
...
type ApplicationInsightsSpec struct {
	...
	// +optional
	AppID           string `json:"appID,omitempty" tf:"app_id,omitempty" protobuf:"bytes,4,opt,name=appID"`
	ApplicationType string `json:"applicationType" tf:"application_type" protobuf:"bytes,5,opt,name=applicationType"`
	// +optional
...
type ApplicationInsightsStatus struct {
	...
	// +optional
	Output *ApplicationInsightsSpec `json:"output,omitempty" protobuf:"bytes,2,opt,name=output"`
	// +optional
...
type ApplicationInsightsList struct {
	...
	Items []ApplicationInsights `json:"items,omitempty" protobuf:"bytes,2,rep,name=items"`
}
